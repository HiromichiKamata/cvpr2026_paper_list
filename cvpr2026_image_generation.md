...
**Total: 333 papers** | Poster: 257 | Project page: 53 | 和訳済み: 333
...
## 1. Attribution as Retrieval: Model-Agnostic AI-Generated Image Attribution
...
## 2. Guiding a Diffusion Model by Swapping Its Tokens
...
## 4. Streaming Diffusion Model for Fast Infrared and Visible Video Fusion
...
## 5. ChordEdit: One-Step Low-Energy Transport for Image Editing
...
## 6. Where Culture Fades: Revealing the Cultural Gap in Text-to-Image Generation
...
## 7. CoLoGen: Progressive Learning of Concept–Localization Duality for Unified Image Generation
...
## 8. When Safety Collides: Resolving Multi-Category Harmful Conflicts in Text-to-Image Diffusion via Adaptive Safety Guidance
...
## 9. PSR: Scaling Multi-Subject Personalized Image Generation with Pairwise Subject-Consistency Rewards
...
## 11. PromptEnhancer: Taming Your Rewriter for Text-to-Image Generation via Fine-Grained Reward
...
## 12. VINS-120K: Ultra High-Resolution Image Editing with A Large-Scale Dataset
...
## 13. I2I-Bench: A Comprehensive Benchmark Suite for Image-to-Image Editing Models
...
## 14. Degradation-Consistent Test-Time Adaptation for All-in-One Image Restoration
...
## 15. Restore, Assess, Repeat: A Unified Framework for Iterative Image Restoration
...
## 16. Scan Clusters, Not Pixels: A Cluster-Centric Paradigm for Efficient Ultra-high-definition Image Restoration
...
## 17. Dynamic Exposure Burst Image Restoration
...
## 18. FAPE-IR: Frequency-Aware Planning and Execution Framework for All-in-One Image Restoration
...
## 19. MicroFM: Physics-guided Flow Matching for Isotropic Microscopy Reconstruction

> 🇯🇵 **物理ガイド付きフロー マッチングを用いた等方的顕微鏡の再構成（MicroFM）**

> 💡 光学系の異方的点拡がり関数による低い軸方向解像度を克服するため、物理的PSFと流マッチングを組み合わせた等方的顕微鏡再構成法。

**著者:** Xingzu Zhan, Runmin Jiang, Vatsal Gupta, Tanush Swaminathan, Yanwen Wang, Genpei Zhang, Haili Wang, Min Xu
...
![Poster](posters/image_generation/40244.png)
...
## 20. Hidden Dangers of Compositional Generation: Diagnosing Semantic Safety Failures in Text-to-Image Models
...
## 21. JANUS: A Lightweight Framework for Jailbreaking Text-to-Image Models via Distribution Optimization
...
## 23. Few-shot Acoustic Synthesis with Multimodal Flow Matching

> 🇯🇵 **マルチモーダル・フロー・マッチング による少数ショット音響合成**

> 💡 確率的なフロー・マッチング・トランスフォーマーを用い、最小限のシーン情報から複数の音響インパルス応答を生成。

**著者:** Amandine Brunetto

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Brunetto_Few-shot_Acoustic_Synthesis_with_Multimodal_Flow_Matching_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.19176) | [🌐 Project](https://amandinebtto.github.io/FLAC/)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/38492.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://amandinebtto.github.io/FLAC/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 24. Linear Image Generation by Synthesizing Exposure Brackets
...
## 25. UniGenDet: A Unified Generative-Discriminative Framework for Co-Evolutionary Image Generation and Generated Image Detection
...
## 26. iMontage: Unified, Versatile, Highly Dynamic Many-to-many Image Generation
...
## 27. Toward Real-world Infrared Image Super-Resolution: A Unified Autoregressive Framework and Benchmark Dataset

> 🇯🇵 **現実世界の赤外線画像超解像度への取り組み: 統一的な自己回帰フレームワークとベンチマークデータセット**

> 💡 熱構造ガイダンスと適応的コードブックにより、赤外線画像の熱忠実性と構造的鮮鋭度を段階的に復元。

**著者:** Yang Zou, Jun Ma, Zhidong Jiao, Xingyuan Li, Zhiying Jiang, Jinyuan Liu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zou_Toward_Real-world_Infrared_Image_Super-Resolution_A_Unified_Autoregressive_Framework_and_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.04745)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/40091.png)
...
## 28. PatchScene: Patch-based Voxel Diffusion Model for Large-Scale Scene Completion
...
## 29. Prototype-Guided Concept Erasure in Diffusion Models
...
## 30. Do Less, Achieve More: Do We Need Every-Step Optimization for RL Fine-tuning of Diffusion Models?
...
## 31. CSF: Black-box Fingerprinting via Compositional Semantics for Text-to-Image Models
...
## 32. Selectively Extracting and Injecting Visual Attributes into Text-to-Image Models
...
## 33. Neighbor-Aware Localized Concept Erasure in Text-to-Image Diffusion Models
...
## 34. WeMMU: Enhanced Bridging of Vision-Language Models and Diffusion Models via Noisy Query Tokens
...
## 36. Locate-Then-Examine: Grounded Region Reasoning Improves Detection of AI-Generated Images

> 🇯🇵 **位置確認・次点検査: 根拠領域推理によるAI生成画像検出の改善**

> 💡 生成領域を根拠付けて検出することで、AI生成画像の識別精度を向上させるグラウンディング法。

**著者:** Yikun Ji, Yan Hong, Bowen Deng, Jun Lan, Huijia Zhu, Weiqiang Wang, Liqing Zhang, Jianfu Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ji_Locate-Then-Examine_Grounded_Region_Reasoning_Improves_Detection_of_AI-Generated_Images_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.04225)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/39299.png)
...
## 39. Self-Corrected Image Generation with Explainable Latent Rewards
...
## 40. PoseD-Flow: Versatile and Guided Flow Matching Model of Human Pose

> 🇯🇵 **PoseD-Flow: 人間姿勢の多用途ガイド付きフロー・マッチング・モデル**

> 💡 フロー・マッチングを活用し、人間姿勢の多様な生成と制御に対応する汎用モデル。

**著者:** Jebastin Nadar, Simone Foti, Tolga Birdal

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Nadar_PoseD-Flow_Versatile_and_Guided_Flow_Matching_Model_of_Human_Pose_CVPR_2026_paper.html)
...
## 42. PPM-CLIP: Probabilistic Prompt Modeling for Generalizable AI-Generated Image Detection

> 🇯🇵 **PPM-CLIP: AI生成画像検出のための確率的プロンプト・モデリング**

> 💡 CLIPの確率的プロンプト・モデリングでAI生成画像の汎化的な検出を実現。

**著者:** WANG XINYUAN, Yingxin Lai, Zhiming Luo, Zhihui Liu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_PPM-CLIP_Probabilistic_Prompt_Modeling_for_Generalizable_AI-Generated_Image_Detection_CVPR_2026_paper.html)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/38970.png)
...
## 43. MagicQuill V2: Precise and Interactive Image Editing with Layered Visual Cues
...
## 44. NEAF: Natural Image Editing with Attention Fusion for Generalizable Test-time Optimization in Text-Guided Image Editing
...
## 45. Hybrid Agents for Image Restoration
...
## 46. Self-supervised Dynamic Heterogeneous Degradation Modeling for Unified Zero-Shot Image Restoration
...
## 47. LLaDA-MedV: Exploring Large Language Diffusion Models for Biomedical Image Understanding
...
## 48. FastHybrid: Accelerating Hybrid Autoregressive Image Generation with Lookahead and Guided Decoding
...
## 49. From Scale to Speed: Adaptive Test-Time Scaling for Image Editing
...
## 50. ReasonEdit: Towards Reasoning-Enhanced Image Editing Models
...
## 51. DiT360: High-Fidelity Panoramic Image Generation via Hybrid Training
...
## 54. One-Step Diffusion Transformer for Controllable Real-World Image Super-Resolution

> 🇯🇵 **制御可能現実世界画像超解像の単一ステップ拡散トランスフォーマー**

> 💡 単一ステップの拡散トランスで、制御可能な現実世界画像超解像を実現する。

**著者:** Yushun Fang, Yuxiang Chen, Shibo Yin, Qiang Hu, Jiangchao Yao, Ya Zhang, Xiaoyun Zhang, Yanfeng Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Fang_One-Step_Diffusion_Transformer_for_Controllable_Real-World_Image_Super-Resolution_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.17138)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37372.png)
...
## 55. FRAMER: Frequency-Aligned Self-Distillation with Adaptive Modulation Leveraging Diffusion Priors for Real-World Image Super-Resolution
...
## 56. HDW-SR: High-Frequency Guided Diffusion Model based on Wavelet Decomposition for Image Super-Resolution
...
## 57. Interact2Ar: Full-Body Human-Human Interaction Generation via Autoregressive Diffusion Models
...
## 58. WAM-Flow: Parallel Coarse-to-Fine Motion Planning via Discrete Flow Matching for Autonomous Driving

> 🇯🇵 **離散フロー整合の並列粗密動作計画自動運転**

> 💡 粗密階層の並列処理で自動運転の動作計画を高速化する。

**著者:** Yifang Xu, Jiahao Cui, Zhihao Zhu, Hanlin Shang, Shan Luan, Mingwang Xu, Feipeng Cai, Neng Zhang, Yaoyi Li, Jia Cai, Siyu Zhu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xu_WAM-Flow_Parallel_Coarse-to-Fine_Motion_Planning_via_Discrete_Flow_Matching_for_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.06112)
...
## 60. FlowDC: Flow-Based Decoupling-Decay for Complex Image Editing
...
## 61. Head-wise Adaptive Rotary Positional Encoding for Fine-Grained Image Generation
...
## 62. Uni-DAD: Unified Distillation and Adaptation of Diffusion Models for Few-step Few-shot Image Generation
...
## 63. Iris: Bringing Real-World Priors into Diffusion Model for Monocular Depth Estimation
...
## 64. Realiz3D: 3D Generation Made Photorealistic via Domain-Aware Learning
...
## 65. Enhancing Spatial Understanding in Image Generation via Reward Modeling
...
## 66. ChangeBridge: Spatiotemporal Image Generation with Multimodal Controls for Remote Senisng
...
## 67. LacTokGen: Latent Consistency Tokenizer for 1024-pixel Image Generation by 256 Tokens
...
## 68. GraspLDP: Towards Generalizable Grasping Policy via Latent Diffusion
...
## 69. Optical Flow Matching: Reframing Optical Flow as Continuous Transport Dynamics

> 🇯🇵 **[翻訳が必要]**

> 💡 [まとめが必要]

**著者:** Ao Luo, XIN LI, Fan Yang, Yuezun Li, Zhaoquan Yuan, SHAN ZHAO, Bing Su, Xiao WU

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Luo_Optical_Flow_Matching_Reframing_Optical_Flow_as_Continuous_Transport_Dynamics_CVPR_2026_paper.html)
...
## 71. Agentic Retoucher for Text-To-Image Generation
...
## 72. Premier: Personalized Preference Modulation with Learnable User Embedding in Text-to-Image Generation
...
## 73. Aligning Multi-Character Narrative Image Generation with Multi-Aspect Human Preferences
...
## 74. DCoAR: Deep Concept Injection into Unified Autoregressive Models for Personalized Text-to-Image Generation
...
## 75. AutoDebias: An Automated Framework for Detecting and Mitigating Backdoor Biases in Text-to-Image Models
...
## 76. PromptLoop: Plug-and-Play Prompt Refinement via Latent Feedback for Diffusion Model Alignment
...
## 77. UniGen-1.5: Enhancing Image Generation and Editing through Reward Unification in RL
...
## 78. FlowSteer: Guiding Few-Step Image Synthesis with Authentic Trajectories
...
## 79. SCIEval: Evaluating and Benchmarking the Faithfulness of Scientific Image Generation and Interpretation with Large Multimodal Models
...
## 80. Multinex: Lightweight Low-light Image Enhancement via Multi-prior Retinex
...
## 81. Beyond Ground-Truth: Leveraging Image Quality Priors for Real-World Image Restoration
...
## 82. UCMNet: Uncertainty-Aware Context Memory Network for Under-Display Camera Image Restoration
...
## 83. ShiftLUT: Spatial Shift Enhanced Look-Up Tables for Efficient Image Restoration
...
## 84. TINA: Text-Free Inversion Attack for Unlearned Text-to-Image Diffusion Models
...
## 85. BlackMirror: Black-Box Backdoor Detection for Text-to-Image Models via Instruction-Response Deviation
...
## 86. Adapter Shield: A Unified Framework with Built-in Authentication for Preventing Unauthorized Zero-Shot Image-to-Image Generation
...
## 89. Beyond Fixed Formulas: Data-Driven Linear Predictor for Efficient Diffusion Models
...
## 90. Diff-SemiER: Transparency-Aware Adaptive Fusion Diffusion Model with Generative Prior for Semi-Transparent Eyeglasses Removal
...
## 91. Elucidating the Design Space of Arbitrary-Noise-Based Diffusion Models
...
## 92. Taming Generative Diffusion Model for Task-Oriented Infrared Imaging
...
## 93. Guiding Diffusion Models with Fine-Grained Conditions and Semantics-Preserving Sampling for One-Shot Federated Learning
...
## 94. Personalized Federated Training of Diffusion Models with Privacy Guarantees
...
## 95. Heterogeneous Decentralized Diffusion Models
...
## 96. CADC: Content Adaptive Diffusion-Based Generative Image Compression
...
## 97. Photo3D: Advancing Photorealistic 3D Generation through Structure‑Aligned Detail Enhancement

> 🇯🇵 **構造整列細部向上によるフォトリアリスティック3D生成向上**

> 💡 構造制約と細部向上で、フォトリアリスティック3D生成を改善する。

**著者:** Xinyue Liang, Zhiyuan Ma, Lingchen Sun, Yanjun Guo, Lei Zhang

**Links:** [📄 Paper](https://cvpr.thecvf.com/virtual/2026/poster/36318)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/36318.png)
...
## 98. Leveraging Verifier-Based Reinforcement Learning in Image Editing
...
## 99. PaCo-RL: Advancing Reinforcement Learning for Consistent Image Generation with Pairwise Reward Modeling
...
## 100. Red-teaming Retrieval-Augmented Diffusion Models via Poisoning Knowledge Bases
...
## 103. RegionRoute: Regional Style Transfer with Diffusion Model
...
## 104. Low-Rank Residual Diffusion Models
...
## 105. Guiding Token-Sparse Diffusion Models
...
## 106. See and Fix the Flaws: Enabling VLMs and Diffusion Models to Comprehend Visual Artifacts via Agentic Data Synthesis
...
## 107. CRAFT: Aligning Diffusion Models with Fine-Tuning Is Easier Than You Think
...
## 108. SpeeDiff: Scalable Pixel-Anchored End-to-End Latent Diffusion Model
...
## 109. Focal–General Diffusion Model with Semantic Consistent Guidance for Sign Language Production
...
## 110. PixelRush: Ultra-Fast, Training-Free High-Resolution Image Generation via One-step Diffusion
...
## 111. Decoupled Residual Denoising Diffusion Models for Unified and Data Efficient Image-to-Image Translation
...
## 112. Cross-modal Representation Learning for Diffusion-generated Image Detection
...
## 113. DiP: Taming Diffusion Models in Pixel Space
...
## 114. Compositional Text-to-Image Generation Via Region-aware Bimodal Direct Preference Optimization
...
## 115. Extending One-Step Image Generation from Class Labels to Text via Discriminative Text Representation
...
## 116. DiffGraph: An Automated Agent-driven Model Merging Framework for In-the-Wild Text-to-Image Generation
...
## 117. HiCoGen: Hierarchical Compositional Text-to-Image Generation in Diffusion Models via Reinforcement Learning
...
## 118. WiseEdit: Benchmarking Cognition- and Creativity-Informed Image Editing
...
## 119. Inter-Edit: First Benchmark for Interactive Instruction-Based Image Editing
...
## 120. Benchmarking Endoscopic Surgical Image Restoration and Beyond
...
## 121. SDUIE: Semi-Supervised Diffusion for Underwater Image Enhancement with Quant-Text Dual Control
...
## 122. Bi-Bridge: Bidirectional Diffusion Bridges for Low-Light Image Enhancement
...
## 123. UniLDiff: Unlocking the Power of Diffusion Priors for All-in-One Image Restoration
...
## 124. StableMTL: Repurposing Latent Diffusion Models for Multi-Task Learning from Partially Annotated Synthetic Datasets
...
## 125. Kontinuous Kontext: Continuous Strength Control for Instruction-based Image Editing
...
## 126. Meta-CoT: Enhancing Granularity and Generalization in Image Editing
...
## 127. EditMGT: Unleashing Potentials of Masked Generative Transformers in Image Editing
...
## 128. Towards Robust Sequential Decomposition for Complex Image Editing
...
## 129. DNF-SR: Dual-Input and Negative-Aware Feature Fine-Tuning for Real-World Image Super-Resolution
...
## 130. IFCSR: Inference-Free Fidelity-Realism Control for One-Step Diffusion-based Real-World Image Super-Resolution
...
## 131. Disentangled Textual Priors for Diffusion-based Image Super-Resolution

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Lei Jiang, Xin Liu, Xinze Tong, Zhiliang Li, Jie Liu, Jie Tang, Gangshan Wu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Jiang_Disentangled_Textual_Priors_for_Diffusion-based_Image_Super-Resolution_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.07430)

**Session:** Poster Session 6


![Poster](posters/image_generation/38376.png)
...
## 133. A Temporal and Content Co-Awareness Latent Diffusion for Controllable Hand Image Generation
...
## 134. Toward Early Quality Assessment of Text-to-Image Diffusion Models
...
## 135. Language-Guided One-Step Diffusion Model for Nighttime Flare Removal
...
## 136. Landscape-Awareness for Geometric View Diffusion Model
...
## 137. Otil: Accelerating Diffusion Model Inference via Communication-Efficient Multi-GPU Parallelism
...
## 138. CAST: Context-Aware Dynamic Latent Space Transformation for Interactive Text-to-Image Retrieval
...
## 139. FMPose3D: monocular 3D pose estimation via flow matching

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Ti Wang, Xiaohang Yu, Mackenzie Weygandt Mathis

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_FMPose3D_monocular_3D_pose_estimation_via_flow_matching_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.05755) | [🌐 Project](https://xiu-cs.github.io/FMPose3D/)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/38362.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://xiu-cs.github.io/FMPose3D/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 140. When Understanding Becomes a Risk: Authenticity and Safety Risks in the Emerging Image Generation Paradigm
...
## 141. GeodesicNVS: Probability Density Geodesic Flow Matching for Novel View Synthesis
...
## 142. Diversity over Uniformity: Rethinking Representation in Generated Image Detection

> 🇯🇵 **均一性を超えた多様性：生成画像検出における表現の再考**

> 💡 偽造手掛かりの過度な重複を抑制し多様な判断根拠を保持する表現学習により、未知の生成モデルに対する生成画像検出の汎化性能と信頼性を向上させる。

**著者:** Qinghui He, Haifeng Zhang, Qiao Qin, Bo Liu, Xiuli Bi, Bin Xiao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/He_Diversity_over_Uniformity_Rethinking_Representation_in_Generated_Image_Detection_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/image_generation/39118.png)
...
## 143. RenderFlow: Single-Step Neural Rendering via Flow Matching
...
## 144. FailureAtlas: Mapping the Failure Landscape of T2I Models via Active Exploration
...
## 145. BiEvLight: Bi-level Learning of Task-Aware Event Refinement for Low-Light Image Enhancement
...
## 146. Enhancing Unregistered Hyperspectral Image Super-Resolution via Unmixing-based Abundance Fusion Learning

> 🇯🇵 **非登録ハイパースペクトル画像超解像度の強化：アンミキシングベース豊度融合学習**

> 💡 特異値分解による分光的アンミキシングと変形可能集約モジュールを組み合わせることで、非登録参照画像との融合による超解像度で高品質なハイパースペクトル画像を生成する。

**著者:** Yingkai Zhang, Tao Zhang, Jing Nie, Ying Fu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_Enhancing_Unregistered_Hyperspectral_Image_Super-Resolution_via_Unmixing-based_Abundance_Fusion_Learning_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.07918)

**Session:** Poster Session 6


![Poster](posters/image_generation/40224.png)
...
## 147. Phased DMD: Few-step Distribution Matching Distillation via Score Matching within Subintervals
...
## 148. FINE: Factorizing Knowledge for Initialization of Variable-sized Diffusion Models
...
## 149. FlowDIS: Language-Guided Dichotomous Image Segmentation with Flow Matching
...
## 150. Beyond Pixel Simulation: Pathology Image Generation via Diagnostic Semantic Tokens and Prototype Control
...
## 151. Zero-shot Detection of AI-Generated Image via RAW-RGB Alignment

> 🇯🇵 **RAW-RGB整列によるAI生成画像のゼロショット検出**

> 💡 カメラの物理的フォーリア・デジタル変換プロセスで保存される固有の相関構造をRAW-RGB特徴空間で捉える手法により、未知生成器に対するゼロショット検出を実現する。

**著者:** Haiwei Wu, Fengpeng Li, Zhilin Tu, Yuanman Li, Xiong Li, Jiantao Zhou

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wu_Zero-shot_Detection_of_AI-Generated_Image_via_RAW-RGB_Alignment_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/image_generation/38851.png)
...
## 152. Scaling Up AI-Generated Image Detection with Generator-Aware Prototypes

> 🇯🇵 **生成器認識プロトタイプによるAI生成画像検出スケーリング**

> 💡 規範的偽造プロトタイプを学習し低ランク適応で特徴抽出器をファインチューニングすることで、多様な未知生成器に対する堅牢な検出性能の向上を実現する。

**著者:** Ziheng Qin, Yuheng Ji, Renshuai Tao, Yuxuan Tian, Yuyang Liu, Yipu Wang, Xiaolong Zheng

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Qin_Scaling_Up_AI-Generated_Image_Detection_with_Generator-Aware_Prototypes_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.12982)

**Session:** Poster Session 6


![Poster](posters/image_generation/40102.png)
...
## 153. HP-Edit: A Human-Preference Post-Training Framework for Image Editing
...
## 154. RebRL: Reinforcing Discrete Visual Diffusion Models with Rebalanced Timestep Credits
...
## 155. Towards Fine-Grained Attribution: Instance-Aware Preference Optimization for Aligning Diffusion Models
...
## 156. UniPercept: A Unified Diffusion Model for Generalizable Visual Perception
...
## 157. Visual Diffusion Models are Geometric Solvers
...
## 158. Smoothing the Score Function to Enhance Generalization in Diffusion Models
...
## 159. Vision Foundation Models Can Be Good Tokenizers for Latent Diffusion Models
...
## 160. Proxy-Tuning: Tailoring Multimodal Autoregressive Models for Subject-Driven Image Generation
...
## 161. EasyOmnimatte: Taming Pretrained Inpainting Diffusion Models for End-to-End Video Layered Decompositio
...
## 162. 2ndMatch: Finetuning Pruned Diffusion Models via Second-Order Jacobian Matching
...
## 163. MacTok: Robust Continuous Tokenization for Image Generation
...
## 164. DiffusionHarmonizer: Bridging Neural Reconstruction and Photorealistic Simulation with Online Diffusion Enhancer
...
## 165. FreqEdit: Preserving High-Frequency Features for Robust Multi-Turn Image Editing
...
## 166. Graph-Guided Online Concept Erasure for Text-to-Image Diffusion Models
...
## 167. CTCal: Rethinking Text-to-Image Diffusion Models via Cross-Timestep Self-Calibration
...
## 168. Edit2Perceive: Image Editing Diffusion Models Are Strong Dense Perceivers
...
## 169. DeCo: Frequency-Decoupled Pixel Diffusion for End-to-End Image Generation
...
## 170. Accelerating Diffusion Model Training under Minimal Budgets: A Condensation-Based Perspective
...
## 171. Denoising as Path Planning: Training-Free Acceleration of Diffusion Models with DPCache
...
## 172. Taming Sampling Perturbations with Variance Expansion Loss for Latent Diffusion Models
...
## 173. Guiding Diffusion Models with Semantically Degraded Conditions
...
## 174. Semantics Lead the Way: Harmonizing Semantic and Texture Modeling with Asynchronous Latent Diffusion
...
## 175. SegQuant: A Semantics-Aware and Generalizable Quantization Framework for Diffusion Models
...
## 176. Refracting Reality: Generating Images with Realistic Transparent Objects

> 🇯🇵 **現実の屈折：透明な物体を持つ現実的な画像生成**

> 💡 スネルの屈折法則を用いてテキストから透明物体の屈折と反射を正確に生成する手法を提案し、光学的に妥当な画像を実現する。

**著者:** Yue Yin, Enze Tao, Dylan Campbell

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yin_Refracting_Reality_Generating_Images_with_Realistic_Transparent_Objects_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.17340) | [🌐 Project](https://github.com/YueYin27/snellcaster)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/39713.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/YueYin27/snellcaster" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 177. Image Generation from Contextually-Contradictory Prompts
...
## 178. Test-Time Alignment of Text-to-Image Diffusion Models via Null-Text Embedding Optimisation
...
## 179. LeapAlign: Post-training Flow Matching Models at Any Generation Step by Building Two-Step Trajectories

> 🇯🇵 **LeapAlign：2段階軌跡による任意世代ステップでのフローマッチングモデルの事後訓練**

> 💡 長い軌跡を2段階の飛躍に短縮して計算効率を改善し、報酬信号を早期ステップ潜在表現に効率的に逆伝播させる手法を提案する。

**著者:** Zhanhao Liang, Tao Yang, Jie Wu, Chengjian Feng, Liang Zheng

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liang_LeapAlign_Post-training_Flow_Matching_Models_at_Any_Generation_Step_by_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.15311)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37658.png)
...
## 180. C-GenReg: Training-Free 3D Point Cloud Registration by Multi-View-Consistent Geometry-to-Image Generation with Probabilistic Modalities Fusion
...
## 181. Progress by Pieces: Test-Time Scaling for Autoregressive Image Generation
...
## 182. Erasing Thousands of Concepts: Towards Scalable and Practical Concept Erasure for Text-to-Image Diffusion Models
...
## 184. Attention, May I Have Your Decision? Localizing Generative Choices in Diffusion Models
...
## 185. 3D Space as a Scratchpad for Editable Text-to-Image Generation
...
## 186. When Pretty Isn’t Useful: Investigating Why Modern Text-to-Image Models Fail as Reliable Training Data Generators
...
## 187. Camera Control for Text-to-Image Generation via Learning Viewpoint Tokens
...
## 188. Resolving the Identity Crisis in Text-to-Image Generation
...
## 189. Unleashing Stealthy Backdoor Pandemic by Infecting a Single Diffusion Model
...
## 190. Efﬁcient and Training-Free Single-Image Diffusion Models
...
## 191. Stable Mean Flow: Lyapunov-Inspired One-Step Flow Matching

> 🇯🇵 **安定な平均フロー：リャプノフ理論に着想を得たワンステップフローマッチング**

> 💡 リャプノフ理論から着想を得た安定性正則化で単一ステップ輸送写像の局所非拡張性を強制し、一段生成の品質を改善する。

**著者:** Guangxun Zhang, Mason Haberle, Davi Geiger

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_Stable_Mean_Flow_Lyapunov-Inspired_One-Step_Flow_Matching_CVPR_2026_paper.html)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/36747.png)


**Abstract:** The Mean Flow Matching algorithm is the state-of-the-art for one-step generative models.  Building on this idea, we propose the Stable Mean Flow algorithm and introduce a Lyapunov-inspired stability regularizer that enforces local non-expansivity of the single-step transport map. This design guarantees uniqueness of characteristics and bounds trajectory drift. We conduct experiments that show improved output quality and convergence speed over Mean Flow. Moreover, we establish explicit upper bounds on error growth for both one-step and multi-step generation.


---

## 192. Towards GUI Agents: Vision-Language Diffusion Models for GUI Grounding
...
## 193. Any2Any 3D Diffusion Models with Knowledge Transfer: A Radiotherapy Planning Study
...
## 194. Multi-Patch Global-to-Local Transformer Architecture For Efficient Flow Matching and Diffusion Model
...
## 195. GDRO: Group-level Reward Post-training Suitable for Diffusion Models
...
## 196. Latent Diffusion Inversion Requires Understanding the Latent Space
...
## 197. Reward Sharpness-Aware Fine-Tuning for Diffusion Models
...
## 198. Spatiotemporal Pyramid Flow Matching for Climate Emulation

> 🇯🇵 **気候エミュレーションのための時空間ピラミッドフローマッチング**

> 💡 階層的時空間ピラミッドで複数時間スケールでの並列気候エミュレーションを実現し、大規模気候モデルデータセットで検証する。

**著者:** Jeremy A. Irvin, Jiaqi Han, Zikui Wang, Abdulaziz Alharbi, Yufei Zhao, Nomin-Erdene Bayarsaikhan, Daniele Visioni, Andrew Y. Ng, Duncan Watson-Parris

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Irvin_Spatiotemporal_Pyramid_Flow_Matching_for_Climate_Emulation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.02268)

**Session:** Poster Session 6


![Poster](posters/image_generation/37833.png)
...
## 199. COT-FM: Cluster-wise Optimal Transport Flow Matching

> 🇯🇵 **COT-FM：クラスタ単位最適輸送フローマッチング**

> 💡 標本をクラスタ化して各クラスタに最適な輸送写像を構築し、より直線的な速度場で高速かつ高品質な生成を実現する。

**著者:** Chiensheng Chiang, Kuan-Hsun Tu, Jia-Wei Liao, Cheng-Fu Chou, Tsung-Wei Ke

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chiang_COT-FM_Cluster-wise_Optimal_Transport_Flow_Matching_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.13395)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/39881.png)


**Abstract:** We introduce COT-FM, a general framework that reshapes the probability path in Flow Matching (FM) to achieve faster and more reliable generation. FM models often produce curved trajectories due to random or batch-wise couplings, which increase discretization error and reduce sample quality. COT-FM fixes this by clustering target samples and assigning each cluster a dedicated source distribution obtained by reversing pretrained FM models. This divide-and-conquer strategy yields more accurate local transport and significantly straighter vector fields, all without changing the model architecture. As a plug-and-play approach, COT-FM consistently accelerates sampling and improves generation quality across 2D datasets, image benchmarks, and robotic manipulation tasks.


---

## 200. HumanNOVA: Photorealistic, Universal and Rapid 3D Human Avatar Modeling from a Single Image
...
## 201. Learning Straight Flows: Variational Flow Matching for Efficient Generation

> 🇯🇵 **効率的な生成のための直線的フロー学習：変分フローマッチング**

> 💡 フロー マッチングに直線軌跡を導入することで、ワンステップ生成の効率性と品質を大幅に改善する。

**著者:** Chenrui Ma, Xi Xiao, Tianyang Wang, Xiao Wang, Yanning Shen

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ma_Learning_Straight_Flows_Variational_Flow_Matching_for_Efficient_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.17583)
...
## 202. Roots Beneath the Cut: Uncovering the Risk of Concept Recovery in Pruning-Based Unlearning for Diffusion Models
...
## 203. Coupled Diffusion Sampling for Training-Free Multi-View Image Editing
...
## 204. MotionEdit: Benchmarking and Learning Motion-Centric Image Editing
...
## 205. Event-Illumination Collaborative Low-light Image Enhancement with a High-resolution Real-world Dataset
...
## 206. A Difference-in-Difference Approach to Detecting AI-Generated Images
...
## 207. DBMSolver: A Training-free Diffusion Bridge Sampler for High-Quality Image-to-Image Translation
...
## 208. OSPO: Object-Centric Self-Improving Preference Optimization for Text-to-Image Generation
...
## 209. OrthoFuse: Training-free Riemannian Fusion of Orthogonal Style-Concept Adapters for Diffusion Models
...
## 210. SeeThrough3D: Occlusion Aware 3D Control in Text-to-Image Generation
...
## 211. What Is It Like to Be a Noise? An Entropy-based Gaussian Noise Regularization for Diffusion Models
...
## 212. UniEdit-I: Training-free Image Editing for Unified VLM via Iterative Understanding, Editing and Verifying
...
## 213. VOSR: A Vision-Only Generative Model for Image Super-Resolution
...
## 214. Flash-DMD: Towards High-Fidelity Few-Step Image Generation with Efficient Distillation and Joint Reinforcement Learning
...
## 215. Remote Sensing Image Super-Resolution for Imbalanced Textures: A Texture-Aware Diffusion Framework

> 🇯🇵 **[翻訳が必要]**

> 💡 [まとめが必要]

**著者:** Enzhuo Zhang, Sijie Zhao, Dilxat Muhtar, Zhenshi Li, Xueliang Zhang, Pengfeng Xiao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_Remote_Sensing_Image_Super-Resolution_for_Imbalanced_Textures_A_Texture-Aware_Diffusion_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.13994)

**Session:** Poster Session 6


![Poster](posters/image_generation/39390.png)


**Abstract:** Generative diffusion priors have recently achieved state-of-the-art performance in Natural Image Super-Resolution, demonstrating a powerful capability to synthesize photorealistic details. However, their direct application to Remote Sensing Image Super-Resolution (RSISR) reveals significant shortcomings. Remote sensing images present a unique challenge: ground objects often exhibit globally stochastic yet locally clustered patterns. This characteristic leads to highly imbalanced texture distributions, posing a significant hurdle to the model's spatial perception. To address this, we propose TexADiff, a novel framework that begins by estimating a Relative Texture Density Map (RTDM) that reflects the underlying texture distribution. TexADiff then leverages this RTDM in three synergistic ways: as an explicit spatial conditioning to guide the diffusion process, as a loss modulation term to prioritize texture-rich regions, and as a dynamic adapter for the sampling schedule. These modifications are designed to endow the model with explicit texture-aware capabilities. Experiments demonstrate that TexADiff achieves superior quantitative metrics. Furthermore, qualitative results show that our model generates faithful high-frequency details while effectively suppressing texture hallucinations. This improved reconstruction quality also results in significant gains in downstream task performance.


---

## 216. VisiLock: Authorizing Instruction-based Image editing with Dual Score Distillation
...
## 217. Sampling-Aware Quantization for Diffusion Models
...
## 218. GenColorBench: A Color Evaluation Benchmark for Text-to-Image Generation
...
## 219. Exploring Conditions for Diffusion Models in Robotic Control
...
## 220. FlashIn: Fast and Accurate Image Inversion for Real-time Image Editing
...
## 221. PixelDiT: Pixel Diffusion Transformers for Image Generation
...
## 222. Bridging Fidelity-Reality with Controllable One-Step Diffusion for Image Super-Resolution
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chen_Bridging_Fidelity-Reality_with_Controllable_One-Step_Diffusion_for_Image_Super-Resolution_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.14061)
...
## 223. UltraFlux: Data-Model Co-Design for High-quality Native 4K Text-to-Image Generation across Diverse Aspect Ratios
...
## 224. Your Latent Mask is Wrong: Pixel-Equivalent Latent Compositing for Diffusion Models
...
## 225. Anatomica: Localized Control over Geometric and Topological Properties for Anatomical Diffusion Models
...
## 226. Self-Evaluation Unlocks Any-Step Text-to-Image Generation
...
## 227. SeaCache: Spectral-Evolution-Aware Cache for Accelerating Diffusion Models
...
## 228. SeaCache: Spectral-Evolution-Aware Cache for Accelerating Diffusion Models
...
## 229. SenCache: Accelerating Diffusion Model Inference via Sensitivity-Aware Caching
...
## 230. Frequency-Aware Flow Matching for High-Quality Image Generation
...
## 231. Flow Matching for Multimodal Distributions

> 🇯🇵 **マルチモーダル分布のためのフロー マッチング**

> 💡 複数のモード分布を扱うフロー マッチング手法を提案し、多様な生成タスクの性能を向上させる。

**著者:** Gaoxiang Luo, Frank Cole, Sihang Zhang, Yuxiang Wan, Yulong Lu, Ju Sun

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Luo_Flow_Matching_for_Multimodal_Distributions_CVPR_2026_paper.html) | [🌐 Project](https://mm-flow.github.io/)
...
<iframe src="https://mm-flow.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 232. SliderEdit: Continuous Image Editing with Fine-Grained Instruction Control
...
## 233. HalluGen: Synthesizing Realistic and Controllable Hallucinations for Evaluating Image Restoration
...
## 234. DRiffusion: Draft-and-Refine Process Parallelizes Diffusion Models with Ease
...
## 235. ClusterMark: Towards Robust Watermarking for Autoregressive Image Generators with Visual Token Clustering
...
## 236. Time-Aware One Step Diffusion Network for Real-World Image Super-Resolution

> 🇯🇵 **[翻訳が必要]**

> 💡 [まとめが必要]

**著者:** Tianyi Zhang, Zheng-Peng Duan, Chunle Guo, Peng-Tao Jiang, Bo Li, Mingming Cheng, Chongyi Li

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_Time-Aware_One_Step_Diffusion_Network_for_Real-World_Image_Super-Resolution_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2508.16557)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/36237.png)
...
## 237. NanoSD: Edge Efficient Foundation Model for Real Time Image Restoration
...
## 238. BiFM: Bidirectional Flow Matching for Few-Step Image Editing and Generation
...
## 239. Synthetic Curriculum Reinforces Compositional Text-to-Image Generation
...
## 240. When Anonymity Breaks: Identifying Models Behind Text-to-Image Leaderboards
...
## 241. RAISE: Requirement-Adaptive Evolutionary Refinement for Training-Free Text-to-Image Alignment
...
## 242. RDF-MIG: A Robust Diffusion Framework for Masked Image Generation to Augment Semantic Segmentation and Change Detection
...
## 243. Image Diffusion Preview with Consistency Solver
...
## 244. DMAligner: Enhancing Image Alignment via Diffusion Model Based View Synthesis
...
## 245. ProjFlow: Projection Sampling with Flow Matching for Zero‑Shot Exact Spatial Motion Control
...
## 246. Curriculum Group Policy Optimization: Adaptive Sampling for Unleashing the Potential of Text-to-Image Generation
...
## 247. Training-free, Perceptually Consistent Low-Resolution Previews with High-Resolution Image for Efficient Workflows of Diffusion Models
...
## 248. OrionEdit: Bridging Reference and Source Images for Generalized Cross-Image Editing
...
## 249. Diffusion Probe: Generated Image Result Prediction Using CNN Probes
...
## 250. ObjectMorpher: 3D-Aware Image Editing via Deformable 3DGS
...
## 251. A Style is Worth One Code: Unlocking Code-to-Style Image Generation with Discrete Style Space
...
## 252. Pico-Banana-400K: A Large-Scale Dataset for Text-Guided Image Editing
...
## 253. OctoT2I: A Self-Evolving Agentic Text-to-Image Router
...
## 254. InvAD: Inversion-based Reconstruction-Free Anomaly Detection with Diffusion Models
...
## 255. Delta Rectified Flow Sampling for Text-to-Image Editing
...
## 256. Forensic-Friendly Image Manipulation via Controllable Latent Diffusion
...
## 257. Disentangling to Re-couple: Resolving the Similarity-Controllability Paradox in Subject-Driven Text-to-Image Generation
...
## 258. RewardFlow: Generate Images by Optimizing What You Reward
...
## 259. It's Never Too Late: Noise Optimization for Collapse Recovery in Trained Diffusion Models
...
## 260. GROW: Watermark Generation with Progressive Guidance for Diffusion Models
...
## 261. Ani3DHuman: Photorealistic 3D Human Animation with Self-guided Stochastic Sampling
...
![Poster](posters/image_generation/38317.png)
...
## 262. Beyond the Ground Truth: Enhanced Supervision for Image Restoration
...
## 263. CARE-Edit: Condition-Aware Routing of Experts for Contextual Image Editing
...
## 264. LESA: Learnable Stage-Aware Predictors for Diffusion Model Acceleration
...
## 265. Reviving ConvNeXt for Efficient Convolutional Diffusion Models
...
## 266. TANGO: Learning Distribution-wise Foundation Prior Consistency and Instance-wise Style Calibration for Medical Image Generalization

> 🇯🇵 **[翻訳が必要]**

> 💡 [まとめが必要]

**著者:** Chuang Liu, Yichao Cao, Xiu Su, Haogang Zhu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liu_TANGO_Learning_Distribution-wise_Foundation_Prior_Consistency_and_Instance-wise_Style_Calibration_CVPR_2026_paper.html)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37435.png)
...
## 267. SliderEdit: Continuous Image Editing with Fine-Grained Instruction Control
...
## 268. Differentiable Vector Quantization for Rate-Distortion Optimization of Generative Image Compression

> 🇯🇵 **[翻訳が必要]**

> 💡 [まとめが必要]

**著者:** SHIYIN JIANG, Wei Long, Minghao Han, Zhenghao Chen, Ce Zhu, Shuhang Gu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Jiang_Differentiable_Vector_Quantization_for_Rate-Distortion_Optimization_of_Generative_Image_Compression_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.10546) | [🌐 Project](https://github.com/CVL-UESTC/RDVQ)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/37375.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/CVL-UESTC/RDVQ" width="100%" height="600" loading="lazy" style="border:none;"></iframe>

</details>


**Abstract:** The proliferation of visual data under tight storage and bandwidth budgets makes extremely low–bitrate generative image compression increasingly important. Vector quantization (VQ) is compelling in this regime because codebooks encode cross-channel correlations and dataset-level semantics, enabling perceptually faithful reconstructions when bits are scarce. We propose RDVQ, a vector-quantization (VQ) based generative image compression method designed for extremely low bitrates. While end-to-end learned image codecs rely on a differentiable rate term for rate–distortion (RD) optimization, however, a key challenge is that naïvely integrating VQ introduces non-differentiability and is not directly compatible with entropy modeling, forcing prior work to regulate bitrate only indirectly. We resolve this by defining a distance-aware soft posterior over codebook indices and training a conditional autoregressive entropy model to predict it. Therefore the cross-entropy between the approximate and predicted posteriors yields a differentiable rate loss, restoring a gradient pathway from rate to the encoder via codeword distances. Such predicted codebook index distribution enables prefix-only transmission at inference, with the model imputing the rest of the indices, delivering retraining-free bitrate control over a practical range. Our end-to-end RD optimized RDVQ outperforms all baseline methods in terms of DISTS and CLIPIQA, which reflect superior structural restoration and better alignment with human visual perception on the Kodak, DIV2K and CLIC2020 datasets.


---

## 269. Towards Photorealistic and Efficient Bokeh Rendering via Diffusion Framework

> 🇯🇵 **[翻訳が必要]**

> 💡 [まとめが必要]

**著者:** Linxiao Shi, Siming Zheng, Zerong Wang, Hao Zhang, Jinwei Chen, Bo Li, Shifeng Chen, Peng-Tao Jiang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Shi_Towards_Photorealistic_and_Efficient_Bokeh_Rendering_via_Diffusion_Framework_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2605.07429)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/38973.png)
...
## 270. Towards Photorealistic and Efficient Bokeh Rendering via Diffusion Framework
...
## 271. Masked Region Transformer for Layered Image Generation and Editing at Scale
...
## 272. Denoising, Fast and Slow: Difficulty-Aware Adaptive Sampling for Image Generation
...
## 273. OPRO: Orthogonal Panel-Relative Operators for Panel-Aware In-Context Image Generation
...
## 274. A Style is Worth One Code: Unlocking Code-to-Style Image Generation with Discrete Style Space
...
## 275. SmokeSVD: Smoke Reconstruction from A Single View via Progressive Novel View Synthesis and Refinement with Diffusion Models
...
## 276. Guiding a Diffusion Model by Swapping Its Tokens
...
## 277. PixelDiT: Pixel Diffusion Transformers for Image Generation
...
## 278. Streaming Diffusion Model for Fast Infrared and Visible Video Fusion
...
## 279. ChordEdit: One-Step Low-Energy Transport for Image Editing
...
## 280. Differentiable Vector Quantization for Rate-Distortion Optimization of Generative Image Compression
...
## 281. Optical Flow Matching: Reframing Optical Flow as Continuous Transport Dynamics
...
## 283. ImageRAGTurbo: Towards One-step Text-to-Image Generation with Retrieval-Augmented Diffusion Models
...
## 284. SpatialReward: Verifiable Spatial Reward Modeling for Fine-Grained Spatial Consistency in Text-to-Image Generation
...
## 288. CogniEdit: Dense Gradient Flow Optimization for Fine-Grained Image Editing
...
## 289. Retrieve-to-Restore: Efficient All-in-One Image Restoration with a Retrieval-Based Degradation Bank
...
## 290. ZeroIDIR: Zero-Reference Illumination Degradation Image Restoration with Perturbed Consistency Diffusion Models
...
## 291. Towards Human-Imperceptible Backdoor Attacks on Text-to-Image Diffusion Models
...
## 292. DiverseGRPO: Mitigating Mode Collapse in Image Generation via Diversity-Aware GRPO
...
## 293. The Consistency Critic: Correcting Inconsistencies in Generated Images via Reference-Guided Attentive Alignment

> 🇯🇵 **参照ガイド付きアテンション整列による生成画像の矛盾補正（ImageCritic）**

> 💡 生成画像の細粒度な矛盾を補正する参照ガイド型ポスト編集法、アテンション整列と詳細エンコーダを使用。

**著者:** Ziheng Ouyang, Yiren Song, Yaoli Liu, Shihao Zhu, Qibin Hou, Mingming Cheng, Mike Zheng Shou

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ouyang_The_Consistency_Critic_Correcting_Inconsistencies_in_Generated_Images_via_Reference-Guided_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.20614)
...
## 294. GDPO-SR: Group Direct Preference Optimization for One-Step Generative Image Super-Resolution
...
## 295. Correspondence-Attention Alignment for Multi-View Diffusion Models
...
## 296. GenErase: Generalizable and Semantically-Aware Concept Erasure in Diffusion Models
...
## 297. ConceptPrism: Concept Disentanglement in Personalized Diffusion Models via Residual Token Optimization
...
## 298. A Debiased Reconstruction-based Framework for Training-Free Detection of AI-Generated Images
...
## 299. GuideFlow: Constraint-Guided Flow Matching for Planning in End-to-End Autonomous Driving

> 🇯🇵 **GuideFlow：自動運転計画のための制約ガイド付きフロー整合**

> 💡 制約ガイド付きフロー整合で自動運転計画を最適化。

**著者:** Lin Liu, Caiyan Jia, Guanyi Yu, Ziying Song, Junqiao Li, Feiyang Jia, Peiliang Wu, Xiaoshuai Hao, Yadan Luo

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liu_GuideFlow_Constraint-Guided_Flow_Matching_for_Planning_in_End-to-End_Autonomous_Driving_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.18729)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/36332.png)
...
## 300. SAIDO: Generalizable Detection of AI-Generated Images via Scene-Aware and Importance-Guided Dynamic Optimization in Continual Learning
...
## 301. Reflection Separation from a Single Image via Joint Latent Diffusion
...
## 302. Multi-Scale Local Speculative Decoding for Image Generation
...
## 303. LIFT and PLACE: A Simple, Stable, and Effective Knowledge Distillation Framework for Lightweight Diffusion Models
...
## 304. WaDi: Weight Direction-aware Distillation for One-step Image Synthesis
...
## 305. MaskFocus: Focusing Policy Optimization on Critical Steps for Masked Image Generation
...
## 306. GRPO-Guard: Mitigating Implicit Over-Optimization in Flow Matching via Regulated Clipping

> 🇯🇵 **GRPO-Guard：調整クリッピングによるフロー整合の過最適化軽減**

> 💡 調整クリッピングでフロー整合の過最適化を防止。
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_GRPO-Guard_Mitigating_Implicit_Over-Optimization_in_Flow_Matching_via_Regulated_Clipping_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.22319)
...
## 307. The Drift Kernel: Why Diffusion Models Change Even When Told Not To
...
## 308. The Image as Its Own Reward: Reinforcement Learning with Adversarial Reward for Image Generation
...
## 309. FlowFM: Advancing Dark Optical Flow Estimation with Flow Matching
...
## 310. SmokeSVD: Smoke Reconstruction from A Single View via Progressive Novel View Synthesis and Refinement with Diffusion Models
...
## 311. PureCC: Pure Learning for Text-to-Image Concept Customization
...
## 312. Scone: Bridging Composition and Distinction in Subject-Driven Image Generation via Unified Understanding-Generation Modeling
...
## 313. PROMPTMINER: Black-Box Prompt Stealing against Text-to-Image Generative Models via Reinforcement Learning and VLM-Guided Optimization
...
## 314. MICON-Bench: Benchmarking and Enhancing Multi-Image Context Image Generation in Unified Multimodal Models
...
## 315. The Devil is in Attention Sharing: Improving Complex Non-rigid Image Editing Faithfulness via Attention Synergy
...
## 316. Residual Diffusion Bridge Model for Image Restoration
...
## 318. MR. Illuminate: Zero-Shot Low-Light Image Enhancement with Diffusion Prior
...
## 319. FoundIR-v2: Optimizing Pre-Training Data Mixtures for Image Restoration Foundation Model
...
## 320. When LoRA Betrays: Backdooring Text-to-Image Models by Masquerading as Benign Adapters
...
## 321. LogCD: Local-to-global Consistency Distillation for Few-step Image Generation
...
## 322. Parallel Jacobi Decoding for Fast Autoregressive Image Generation
...
## 323. Re-Align: Structured Reasoning-guided Alignment for In-Context Image Generation and Editing
...
## 324. VisionDirector: Vision-Language Guided Closed-Loop Refinement for Generative Image Synthesis
...
## 325. MotionHiFlow: Text-to-Motion via Hierarchical Flow Matching

> 🇯🇵 **階層的フロー マッチングによるテキスト動作生成（MotionHiFlow）**

> 💡 複数時間スケール階層で意味整列と細粒度動作詳細を両立した3D人間運動生成。

**著者:** Heng Li, Xiaotong Lin, Ling-An Zeng, Yulei Kang, Shuai Li, Jian-Fang Hu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_MotionHiFlow_Text-to-Motion_via_Hierarchical_Flow_Matching_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.23264) | [🌐 Project](https://github.com/ai-lh/MotionHiFlow)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37748.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/ai-lh/MotionHiFlow" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 326. A Self-Conditioned Representation Guided Diffusion Model for Realistic Text-to-LiDAR Scene Generation
...
## 327. When Local Rules Create Global Order: Self-Organized Representation Learning for Latent Diffusion Models
...
## 328. LLaDA-V: Large Language Diffusion Models with Visual Instruction Tuning
...
## 329. Can We Build Scene Graphs, Not Classify Them? FlowSG: Progressive Image-Conditioned Scene Graph Generation with Flow Matching

> 🇯🇵 **FlowSG：フロー整合による段階的画像条件付きシーングラフ生成**

> 💡 段階的フロー整合でシーングラフを生成。

**著者:** Xin Hu, Ke Qin, Wen Yin, Yuan-Fang Li, Ming Li, Tao He

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Hu_Can_We_Build_Scene_Graphs_Not_Classify_Them_FlowSG_Progressive_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.18623)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37711.png)
...
## 330. StreamAvatar: Streaming Diffusion Models for Real-Time Interactive Human Avatars
...
## 331. Layer-wise Instance Binding for Regional and Occlusion Control in Text-to-Image Diffusion Transformers
...
## 332. DMGD: Train-Free Dataset Distillation with Semantic-Distribution Matching in Diffusion Models
...
## 333. Beyond the Static-World: Lifelong Learning for All-in-One Medical Image Restoration
