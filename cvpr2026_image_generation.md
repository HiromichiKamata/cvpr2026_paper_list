# CVPR 2026 — Image Generation Papers
...
## 1. FINE: Factorizing Knowledge for Initialization of Variable-sized Diffusion Models

> 🇯🇵 **FINE：可変サイズ拡散モデル初期化のための知識因数分解**

> 💡 重み行列の低ランク分解による転移可能な学習遺伝子により、複数のモデルサイズに対して効率的な初期化と軽量なアダプテーションを可能にする。

**著者:** Yucheng Xie, Fu Feng, Ruixiao Shi, Jianlu Shen, Jing Wang, Yong Rui, Xin Geng

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xie_FINE_Factorizing_Knowledge_for_Initialization_of_Variable-sized_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2409.19289)

**Session:** Poster Session 6


![Poster](posters/image_generation/38645.png)
...
## 2. PyramidalWan: On Making Pretrained Video Model Pyramidal for Efficient Inference

> 🇯🇵 **PyramidalWan: 事前学習動画モデルのピラミッド構造化**

> 💡 事前学習済みモデルの多スケール対応: ピラミッド構造により単一モデルで様々な解像度に対応

**著者:** Denis Korzhenkov, Adil Karjauv, Animesh Karnewar, Mohsen Ghafoorian, Amir Habibian

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Korzhenkov_PyramidalWan_On_Making_Pretrained_Video_Model_Pyramidal_for_Efficient_Inference_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.04792)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/37214.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Sanyal_NanoSD_Edge_Efficient_Foundation_Model_for_Real_Time_Image_Restoration_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.09823)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/38843.png)
...
## 4. EasyOmnimatte: Taming Pretrained Inpainting Diffusion Models for End-to-End Video Layered Decompositio

> 🇯🇵 **EasyOmnimatte：ビデオ層状分解のための事前学習インペイント拡散モデル活用**

> 💡 効果感応的DiTブロックと品質ブロックの双専門家戦略により、高品質かつ低計算コストなビデオ層状分解と効果保護を同時実現する統一フレームワーク。

**著者:** Yihan Hu, Xuelin Chen, Xiaodong Cun

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Hu_EasyOmnimatte_Taming_Pretrained_Inpainting_Diffusion_Models_for_End-to-End_Video_Layered_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/image_generation/37696.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kadry_Anatomica_Localized_Control_over_Geometric_and_Topological_Properties_for_Anatomical_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.20587)
...
## 7. Physical Simulator In-the-Loop Video Generation

> 🇯🇵 **物理シミュレータインループ動画生成**

> 💡 物理シミュレータを拡散過程に統合し、生成動画が物理法則に従う軌跡を生成させ、視覚的品質を保ちながら物理的一貫性を実現した。

**著者:** Lin Geng Foo, Mark He Huang, Alexandros Lattas, Stylianos Moschoglou, Thabo Beeler, Christian Theobalt

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Foo_Physical_Simulator_In-the-Loop_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.06408) | [🌐 Project](https://vcai.mpi-inf.mpg.de/projects/PSIVG/)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/39262.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://vcai.mpi-inf.mpg.de/projects/PSIVG/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
> 🇯🇵 **拡散モデルの統一蒸留適応少数ステップ少数ショット画像生成**

> 💡 蒸留適応で、少数ステップ・少数ショット条件下での画像生成を実現する。

**著者:** Yara Bahram, Mélodie Desbos, Mohammadhadi Shateri, Eric Granger

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Bahram_Uni-DAD_Unified_Distillation_and_Adaptation_of_Diffusion_Models_for_Few-step_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.18281)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/38901.png)
...
## 10. CRAFT: Aligning Diffusion Models with Fine-Tuning Is Easier Than You Think

> 🇯🇵 **微調整は容易：拡散モデル整列の簡潔手法**

> 💡 シンプルな微調整で拡散モデルを効果的に整列させる。

**著者:** Zening Sun, Zhengpeng Xie, Lichen Bai, Shitong Shao, Shuo Yang, Zeke Xie

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Sun_CRAFT_Aligning_Diffusion_Models_with_Fine-Tuning_Is_Easier_Than_You_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.18991)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/37287.png)
...
## 11. Towards Storytelling Animations: Joint Synthesis of Human and Camera Motions
...
## 12. Scaling Instruction-Based Video Editing with a High-Quality Synthetic Dataset

> 🇯🇵 **指示型動画編集の大規模スケーリング**

> 💡 指示型編集の精度向上: テキスト指示型動画編集を大規模データで訓練して高精度化
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Bai_Scaling_Instruction-Based_Video_Editing_with_a_High-Quality_Synthetic_Dataset_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.15742) | [🌐 Project](https://editto.net/)

**Session:** Poster Session 6


![Poster](posters/video_generation/36851.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://editto.net/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 13. DiffGraph: An Automated Agent-driven Model Merging Framework for In-the-Wild Text-to-Image Generation

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Zhuoling Li, Hossein Rahmani, Jiarui Zhang, Yu Xue, Majid Mirmehdi, Jason Kuen, Jiuxiang Gu, Jun Liu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_DiffGraph_An_Automated_Agent-driven_Model_Merging_Framework_for_In-the-Wild_Text-to-Image_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.20470)

**Session:** Poster Session 6


![Poster](posters/image_generation/37271.png)
...
## 14. Streaming Diffusion Model for Fast Infrared and Visible Video Fusion

> 🇯🇵 **ストリーミング拡散モデルによる高速赤外線・可視光ビデオ融合**

> 💡 ストリーミング拡散モデルで赤外線と可視光ビデオを高速融合
...
## 15. CTCal: Rethinking Text-to-Image Diffusion Models via Cross-Timestep Self-Calibration

> 🇯🇵 **CTCal：クロスタイムステップ自己キャリブレーション再考テキスト・ツー・イメージ拡散**

> 💡 低ノイズ時の正確なテキスト・画像対応を利用して高ノイズ時の表現学習を教示することで、拡散モデルのテキスト・画像整列精度を向上させる汎用手法。

**著者:** Xiefan Guo, Xinzhu Ma, Haiyu Zhang, Di Huang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Guo_CTCal_Rethinking_Text-to-Image_Diffusion_Models_via_Cross-Timestep_Self-Calibration_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.20741)

**Session:** Poster Session 6


![Poster](posters/image_generation/36355.png)
...
> 🇯🇵 **知識転移による任意から任意への3D拡散モデル：放射線治療計画研究**

> 💡 事前訓練済みビデオ拡散モデルの知識転移と臨床指標に基づいた強化学習で、放射線治療の用量予測を一般化可能にする。

**著者:** Yuhan Wang, Zihan Li, Han Liu, Simon Arberet, Martin F. Kraus, Yuyin Zhou, Florin-Cristian Ghesu, Dorin Comaniciu, Ali Kamen, Riqiang Gao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Any2Any_3D_Diffusion_Models_with_Knowledge_Transfer_A_Radiotherapy_Planning_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2605.09622)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/36230.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Jeong_Training-free_Perceptually_Consistent_Low-Resolution_Previews_with_High-Resolution_Image_for_Efficient_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.09227) | [🌐 Project](https://ignoww.github.io/Preview_project/)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/39735.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://ignoww.github.io/Preview_project/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 18. RDF-MIG: A Robust Diffusion Framework for Masked Image Generation to Augment Semantic Segmentation and Change Detection

> 🇯🇵 **セマンティックセグメンテーション：ピクセルレベル分類**

> 💡 全ピクセルのカテゴリを予測することで、シーン理解と画像解析の精度を向上させる。

**著者:** Zian Cao, Wei Wei, QINGSHAN GAO, Yuanyuan Fu
...
## 20. SpeeDiff: Scalable Pixel-Anchored End-to-End Latent Diffusion Model

> 🇯🇵 **高解像度画像単一ステップ拡散スケーラブルピクセルアンカー**

> 💡 ピクセルアンカー手法で単一ステップ高解像度生成をスケーリングする。

**著者:** Bingliang Zhang, Wenda Chu, Yizhuo Li, Linjie Yang, Yisong Yue, Katherine L. Bouman, Yang Song, Qiushan Guo
...
## 22. SegQuant: A Semantics-Aware and Generalizable Quantization Framework for Diffusion Models

> 🇯🇵 **SegQuant：拡散モデルのための意味認識かつ一般化可能な量子化フレームワーク**

> 💡 グラフベースの量子化戦略と双スケール量子化で構造意味論を保持し、拡散モデルの効率的なデプロイメントを実現する。

**著者:** Jiaji Zhang, Ruichao Sun, Hailiang Zhao, Jiaju Wu, Peng Chen, Hao Li, Yuying Liu, Kingsum Chow, GANG XIONG, Shuiguang Deng

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_SegQuant_A_Semantics-Aware_and_Generalizable_Quantization_Framework_for_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2507.14811) | [🌐 Project](https://optisys-zju.github.io/segquant/)

**Session:** Poster Session 6


![Poster](posters/image_generation/37801.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://optisys-zju.github.io/segquant/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Haghighi_SenCache_Accelerating_Diffusion_Model_Inference_via_Sensitivity-Aware_Caching_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.24208)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/39219.png)
...
## 24. Efficient Training for Human Video Generation with Entropy-Guided Prioritized Progressive Learning

> 🇯🇵 **人物ビデオ生成の効率的学習：エントロピー誘導優先度学習**

> 💡 エントロピー誘導優先度戦略により、人物ビデオ生成の学習効率と品質を大幅に向上させる。

**著者:** Changlin Li, Jiawei Zhang, Shuhao Liu, Sihao Lin, Zeyi Shi, Zhihui Li, Xiaojun Chang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_Efficient_Training_for_Human_Video_Generation_with_Entropy-Guided_Prioritized_Progressive_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.21136)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/38045.png)
...
## 25. BlackMirror: Black-Box Backdoor Detection for Text-to-Image Models via Instruction-Response Deviation

> 🇯🇵 **背後ドア検出テキスト画像モデル命令応答偏差経由**

> 💡 命令応答の偏差を検出し、テキスト画像モデルの背後ドア攻撃を防ぐ。

**著者:** Feiran Li, Qianqian Xu, Shilong Bao, Zhiyong Yang, Xilin Zhao, Xiaochun Cao, Qingming Huang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_BlackMirror_Black-Box_Backdoor_Detection_for_Text-to-Image_Models_via_Instruction-Response_Deviation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.05921)
...
## 27. Reward Sharpness-Aware Fine-Tuning for Diffusion Models

> 🇯🇵 **拡散モデルの報酬鋭敏度認識ファインチューニング**

> 💡 報酬勾配の非ロバスト性からの報酬ハッキングを軽減する強化学習で、摂動で平坦化された報酬モデルから勾配を利用する手法を提案する。

**著者:** Kwanyoung Kim, Byeongsu Sim

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kim_Reward_Sharpness-Aware_Fine-Tuning_for_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.21175)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/37984.png)
...
## 28. Agentic Retoucher for Text-To-Image Generation

> 🇯🇵 **テキスト画像生成エージェンティック調整者**

> 💡 エージェンティック機構で生成画像の自動調整を実現する。

**著者:** Shaocheng Shen, Jianfeng Liang, Chunlei Cai, Cong Geng, Huiyu Duan, Xiaoyun Zhang, Qiang Hu, Guangtao Zhai

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Shen_Agentic_Retoucher_for_Text-To-Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.02046)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/37350.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xie_ObjectMorpher_3D-Aware_Image_Editing_via_Deformable_3DGS_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.28152)
...
## 30. Self-supervised Dynamic Heterogeneous Degradation Modeling for Unified Zero-Shot Image Restoration

> 🇯🇵 **統一的ゼロショット画像復元のための自己教師あり動的異質劣化モデリング**

> 💡 自己教師あり学習で動的に異質な劣化パターンを捉え、ゼロショット復元を実現。

**著者:** Xiaowan Hu, Jing Yang, Henan Liu, HuaQiu Li, Mai Xu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Hu_Self-supervised_Dynamic_Heterogeneous_Degradation_Modeling_for_Unified_Zero-Shot_Image_Restoration_CVPR_2026_paper.html)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37758.png)
...
> 🇯🇵 **意味論が道を示す：非同期レイテント拡散による意味論とテクスチャモデリングの調和**

> 💡 意味論とテクスチャの生成を異なるスケジュールで非同期に実行し、意味情報がテクスチャ生成に先行することで品質と収束速度を改善する。

**著者:** Yueming Pan, Ruoyu Feng, Qi Dai, Yuqi Wang, Wenfeng LIN, MINGYU GUO, Chong Luo, Nanning Zheng

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Pan_Semantics_Lead_the_Way_Harmonizing_Semantic_and_Texture_Modeling_with_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.04926)

**Session:** Poster Session 6


![Poster](posters/image_generation/38958.png)


**Abstract:** Latent Diffusion Models (LDMs) inherently follow a coarse-to-fine generation process, where high-level semantic structure is generated slightly earlier than fine-grained texture. This indicates the preceding semantics potentially benefit the texture generation by providing a semantic anchor. Recent advances have integrated semantic priors from pretrained visual encoders to further enhance LDMs, yet they still denoise semantic and VAE-encoded texture synchronously, neglecting such ordering. Observing these, we propose Semantic-First Diffusion (SFD), a latent diffusion paradigm that explicitly prioritizes semantic formation. SFD first constructs composite latents by combining the compact semantic latent, which is extracted from pretrained visual encoder via a dedicated Semantic VAE, with the texture latent. The core of SFD is to denoise the semantic and texture latents asynchronously using separate noise schedules: semantics precede textures by a temporal offset, providing clearer high-level guidance for texture refinement and enabling natural coarse-to-fine generation. On ImageNet 256$\times$256 with guidance, SFD achieves FID 1.06  (LightningDiT-XL) and FID 1.04 (1.0B LightningDiT-XXL), while achieving up to 100$\times$ faster convergence than original DiT without guidance. SFD also improves existing methods like ReDi and VA-VAE, demonstrating the effectiveness of asynchronous, semantics-led modeling.


---

## 32. Adaptive Video Distillation: Mitigating Oversaturation and Temporal Collapse in Few-Step Generation

> 🇯🇵 **Adaptive Video Distillation: 少数ステップ生成における過飽和と時間崩壊の緩和**

> 💡 適応損失と時間正則化で少数ステップ動画生成の破綻と崩壊を抑制

**著者:** Yuyang You, Yongzhi Li, Jiahui Li, Yadong Mu, Quan Chen, Peng Jiang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/You_Adaptive_Video_Distillation_Mitigating_Oversaturation_and_Temporal_Collapse_in_Few-Step_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.21864)

**Session:** Poster Session 6


![Poster](posters/video_generation/37903.png)
...
## 33. RebRL: Reinforcing Discrete Visual Diffusion Models with Rebalanced Timestep Credits

> 🇯🇵 **RebRL：再バランス化タイムステップクレジットによる離散視覚拡散モデルの強化**

> 💡 生成ステップ間のクレジット割り当ての不均衡を解決するため、早期ステップへのクレジット再配分により、探索効率と訓練効率を向上させた強化学習手法。

**著者:** Mu Zhang, Tianren Ma, Yunfan Liu, Kun Hu, Qixiang Ye

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_RebRL_Reinforcing_Discrete_Visual_Diffusion_Models_with_Rebalanced_Timestep_Credits_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/image_generation/38327.png)
...
## 34. PromptEnhancer: Taming Your Rewriter for Text-to-Image Generation via Fine-Grained Reward

> 🇯🇵 **PromptEnhancer: 細粒度報酬によるText-to-Image用リライタの制御**

> 💡 報酬学習で複雑な指示を忠実に書き換え画像と文の整合性を改善する

**著者:** Linqing Wang, zhiyong xu, XiMing Xing, YIJI CHENG, Zhiyuan Zhao, Donghao Li, Tiankai Hang, Zhenxi Li, Jiale Tao, Qixun Wang, Ruihuang Li, Comi Chen, Xin LI, Mingrui Wu, Xinchi Deng, Shuyang Gu, Chunyu Wang, qinglin lu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_PromptEnhancer_Taming_Your_Rewriter_for_Text-to-Image_Generation_via_Fine-Grained_Reward_CVPR_2026_paper.html)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/37548.png)
...
## 35. Bi-Bridge: Bidirectional Diffusion Bridges for Low-Light Image Enhancement

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Zeyu Hua, HUI LI, Yu Wang, Song Wang, Congchao Zhu, Caixia Zheng

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Hua_Bi-Bridge_Bidirectional_Diffusion_Bridges_for_Low-Light_Image_Enhancement_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/image_generation/39388.png)
...
## 36. DynFusion: Rethinking Condition Fusion for Adaptive Multi-Conditional Text-to-Image Generation

> 🇯🇵 **適応型マルチ条件テキスト画像生成の条件融合再考**

> 💡 動的条件融合でマルチ条件テキスト画像生成を改善する。

**著者:** Zheng Fang, Lichuan Xiang, Xu Cai, Bing Wang, Bo Yang, Hongkai Wen
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_Towards_Decompositional_Human_Motion_Generation_with_Energy-Based_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.22324)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/36997.png)
...
## 38. Chain of Event-Centric Causal Thought for Physically Plausible Video Generation

> 🇯🇵 **物理的に妥当な動画生成のためのイベント中心因果思考チェーン**

> 💡 物理法則制約付きの因果イベント連鎖で物理的に妥当な動画を生成

**著者:** Zixuan Wang, Yixin Hu, Haolan Wang, Feng Chen, Yan Liu, Wen Li, Yinjie Lei

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Chain_of_Event-Centric_Causal_Thought_for_Physically_Plausible_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.09094)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chen_Flash-DMD_Towards_High-Fidelity_Few-Step_Image_Generation_with_Efficient_Distillation_and_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.20549)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/38389.png)
...
## 43. Phased DMD: Few-step Distribution Matching Distillation via Score Matching within Subintervals

> 🇯🇵 **フェーズDMD：サブインターバル内スコアマッチングによる数ステップ分布マッチング蒸留**

> 💡 段階的分布マッチングと混合専門家モデルを用いた多段階蒸留により、生成ダイバーシティと運動ダイナミクスを損なわない効率的な蒸留を実現する。

**著者:** Xiangyu Fan, Zesong Qiu, Zhuguanyu Wu, Fanzhou Wang, Zhiqian Lin, Tianxiang Ren, Dahua Lin, RUIHAO GONG, Lei Yang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Fan_Phased_DMD_Few-step_Distribution_Matching_Distillation_via_Score_Matching_within_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.27684)

**Session:** Poster Session 6


![Poster](posters/image_generation/36917.png)
...
## 44. Self-Corrected Image Generation with Explainable Latent Rewards

> 🇯🇵 **説明可能潜在報酬を用いた自己補正画像生成**

> 💡 説明可能な潜在報酬を利用して、生成過程での自己補正によって高品質な画像生成を実現。

**著者:** Yinyi Luo, Hrishikesh Gokhale, Marios Savvides, Jindong Wang, Shengfeng He

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Luo_Self-Corrected_Image_Generation_with_Explainable_Latent_Rewards_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.24965)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/39529.png)
...
## 45. RFDM: Residual Flow Diffusion Models for Video Editing
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zarei_SliderEdit_Continuous_Image_Editing_with_Fine-Grained_Instruction_Control_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.09715) | [🌐 Project](https://armanzarei.github.io/SliderEdit/)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/37433.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://armanzarei.github.io/SliderEdit/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 49. Goal-Driven Reward by Video Diffusion Models for Reinforcement Learning

> 🇯🇵 **動画拡散モデルによる目標駆動報酬を用いた強化学習**

> 💡 事前学習動画拡散モデルの潜在表現を報酬関数として活用し、設計不要で汎用的な目標駆動の強化学習エージェント訓練を実現した。

**著者:** Qi Wang, Mian Wu, Yuyang Zhang, Mingqi Yuan, Wenyao Zhang, Haoxiang You, Yunbo Wang, Xin Jin, Xiaokang Yang, Wenjun Zeng

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Goal-Driven_Reward_by_Video_Diffusion_Models_for_Reinforcement_Learning_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.00961) | [🌐 Project](https://qiwang067.github.io/genreward)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/36875.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://qiwang067.github.io/genreward" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 50. UniGenDet: A Unified Generative-Discriminative Framework for Co-Evolutionary Image Generation and Generated Image Detection

> 🇯🇵 **UniGenDet: 画像生成と生成画像検出の統一的な生成・識別フレームワーク**

> 💡 対称的なマルチモーダル注意機構により、生成と検出の相互作用を通じて両タスクの性能を向上させる統一フレームワーク。

**著者:** Yanran Zhang, Wenzhao Zheng, Yifei Li, Bingyao Yu, Yu Zheng, Lei Chen, Jiwen Lu, Jie Zhou

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_UniGenDet_A_Unified_Generative-Discriminative_Framework_for_Co-Evolutionary_Image_Generation_and_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.21904) | [🌐 Project](https://ivg-yanranzhang.github.io/UniGenDet/)
...
<iframe src="https://ivg-yanranzhang.github.io/UniGenDet/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 51. DiffusionHarmonizer: Bridging Neural Reconstruction and Photorealistic Simulation with Online Diffusion Enhancer

> 🇯🇵 **DiffusionHarmonizer：神経再構成と光リアル性シミュレーションをつなぐオンライン拡散エンハンサー**

> 💡 事前学習拡散モデルから単一ステップエンハンサーに変換し、複雑なシーンレンダリングの光リアル性と時間的一貫性を改善してシミュレータに統合する。

**著者:** Yuxuan Zhang, Katarina Tothova, Zian Wang, Kangxue Yin, Haithem Turki, Riccardo de Lutio, Yen-Yu Chang, Or Litany, Sanja Fidler, Žan Gojčič

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_DiffusionHarmonizer_Bridging_Neural_Reconstruction_and_Photorealistic_Simulation_with_Online_Diffusion_CVPR_2026_paper.html)
...
## 52. SCIEval: Evaluating and Benchmarking the Faithfulness of Scientific Image Generation and Interpretation with Large Multimodal Models

> 🇯🇵 **大規模マルチモーダルモデルによる科学画像生成解釈忠実性評価ベンチマーク**

> 💡 科学画像生成・解釈の忠実性を評価するベンチマークを提供する。

**著者:** Guanghui Ye, Huan Zhao, Zhixue Zhao, Tengfei Ma, Kehan Wang, Steffen Eger, Zhihua Jiang
...
![Poster](posters/image_generation/38375.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Harrington_Its_Never_Too_Late_Noise_Optimization_for_Collapse_Recovery_in_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/image_generation/36895.png)
...
## 54. Erasing Thousands of Concepts: Towards Scalable and Practical Concept Erasure for Text-to-Image Diffusion Models

> 🇯🇵 **数千の概念の消去：テキスト画像拡散モデルに対するスケーラブルかつ実用的な概念消去**

> 💡 スチューデントt分布混合モデルと最適輸送で低ランク概念分布をモデル化し、MoEベースのモジュールで数千概念の大規模消去を実現する。

**著者:** Hoigi Seo, Byung Hyun Lee, Jaehyun Cho, Sungjin Lim, Se Young Chun

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Seo_Erasing_Thousands_of_Concepts_Towards_Scalable_and_Practical_Concept_Erasure_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.16481) | [🌐 Project](https://seohoiki3215.github.io/ETC_project_page/)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37007.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://seohoiki3215.github.io/ETC_project_page/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 59. CADC: Content Adaptive Diffusion-Based Generative Image Compression

> 🇯🇵 **内容適応拡散ベース生成画像圧縮**

> 💡 内容に応じた適応的圧縮で、拡散ベースの高効率画像圧縮を実現する。

**著者:** Xihua Sheng, lingyu ZHU, Tianyu Zhang, Dong Liu, Shiqi Wang, Jing Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Sheng_CADC_Content_Adaptive_Diffusion-Based_Generative_Image_Compression_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.21591)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/37955.png)
...
## 60. NOVA: Sparse Control, Dense Synthesis for Pair-Free Video Editing

> 🇯🇵 **スパース制御密集合成ペアフリービデオ編集**

> 💡 ペアデータ不要な方法でスパース指令から密集編集を実現する。

**著者:** Tianlin Pan, Jiayi Dai, Chenpu Yuan, Zhengyao Lv, Binxin Yang, Hubery Yin, Chen Li, Jing LYU, Caifeng Shan, Chenyang Si

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Pan_NOVA_Sparse_Control_Dense_Synthesis_for_Pair-Free_Video_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.02802)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/39703.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wu_VOSR_A_Vision-Only_Generative_Model_for_Image_Super-Resolution_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.03225)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/39146.png)
...
## 62. PromptLoop: Plug-and-Play Prompt Refinement via Latent Feedback for Diffusion Model Alignment

> 🇯🇵 **潜在フィードバックによるプラグアンドプレイプロンプト改良拡散モデル整列**

> 💡 潜在空間フィードバックで動的なプロンプト改良を実現する。

**著者:** Suhyeon Lee, Jong Chul

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lee_PromptLoop_Plug-and-Play_Prompt_Refinement_via_Latent_Feedback_for_Diffusion_Model_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.00430)

**Session:** Poster Session 6


![Poster](posters/image_generation/40140.png)
...
## 63. Camera Control for Text-to-Image Generation via Learning Viewpoint Tokens

> 🇯🇵 **視点トークン学習によるテキスト画像生成のカメラ制御**

> 💡 パラメータ化カメラトークンの学習で正確なカメラ制御を実現し、幾何表現は未知の物体カテゴリにも転移可能な因子化表現を学習する。

**著者:** Xinxuan Lu, Charless Fowlkes, Alex Berg

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lu_Camera_Control_for_Text-to-Image_Generation_via_Learning_Viewpoint_Tokens_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.19954) | [🌐 Project](https://randdl.github.io/camera_control)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/36882.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://randdl.github.io/camera_control" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 64. BiEvLight: Bi-level Learning of Task-Aware Event Refinement for Low-Light Image Enhancement

> 🇯🇵 **BiEvLight：タスク認識型イベント精密化による低照度画像強調**

> 💡 イベントカメラの背景ノイズを除去するタスク認識型二段階最適化により、イベント・ベース画像融合の性能ボトルネックを解決して低照度画像強調を実現する。

**著者:** Zishu Yao, Xiang-Xiang Su, Shengning Zhou, Guang-Yong Chen, Guodong Fan, Xing Chen

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yao_BiEvLight_Bi-level_Learning_of_Task-Aware_Event_Refinement_for_Low-Light_Image_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.04975)

**Session:** Poster Session 6


![Poster](posters/image_generation/37023.png)
...
## 65. VideoMaMa: Mask-Guided Video Matting via Generative Prior

> 🇯🇵 **生成事前分布による動画マット処理**

> 💡 生成モデルの事前分布を活用したマスク誘導ビデオマット処理を実現する。

**著者:** Sangbeom Lim, Seoung Wug Oh, Gabriel Huang, Heeji Yoon, Seungryong Kim, Joon-Young Lee

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lim_VideoMaMa_Mask-Guided_Video_Matting_via_Generative_Prior_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.14255) | [🌐 Project](https://cvlab-kaist.github.io/VideoMaMa/)
...
<iframe src="https://cvlab-kaist.github.io/VideoMaMa/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 66. The Drift Kernel: Why Diffusion Models Change Even When Told Not To

> 🇯🇵 **ドリフトカーネル：指示に従わない拡散モデルの変化メカニズム**

> 💡 拡散モデルの変化メカニズムを理論的に解明。

**著者:** Gokul Srinath Seetha Ram, Rashmi Elavazhagan

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ram_The_Drift_Kernel_Why_Diffusion_Models_Change_Even_When_Told_CVPR_2026_paper.html)
...
## 67. D2Cache: Second-Order Delta Caching for Higher Video Diffusion Acceleration

> 🇯🇵 **D2Cache: より高速な動画Diffusionのための二階差分キャッシング**

> 💡 二階残差差分の予測で動画Diffusionの高速化と誤差抑制を両立

**著者:** Enhuai Liu, Yunke Wang, Changming Sun, Chang Xu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liu_D2Cache_Second-Order_Delta_Caching_for_Higher_Video_Diffusion_Acceleration_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/video_generation/37494.png)
...
## 68. Red-teaming Retrieval-Augmented Diffusion Models via Poisoning Knowledge Bases

> 🇯🇵 **知識ベース汚染検索拡張拡散モデル赤チーム化**

> 💡 知識ベース毒性攻撃で検索拡張拡散モデルの脆弱性を検証する。

**著者:** Xinqi Lyu, Liu of second author, Dong Wang, Bin Xiao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lyu_Red-teaming_Retrieval-Augmented_Diffusion_Models_via_Poisoning_Knowledge_Bases_CVPR_2026_paper.html)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/37654.png)


**Abstract:** Retrieval-augmented diffusion models (RAG-DMs) have been increasingly deployed across applications, alleviating the data and compute demands of conventional diffusion models. Despite the success, their trustworthiness remains underexplored. Existing backdoor attacks focus on either manipulating the generation phase or the retrieval phase under the white-box setting, which suffer from knowledge conflicts between retrieved images and user prompts. To bridge this gap, we propose a novel red-teaming approach JOB, which is the first jointly optimized backdoor attack tailored to black-box RAG-DMs. Specifically, JOB poisons the knowledge base with a small number of target class images and learns a trigger through multi-objective optimization, steering retrieval toward poisoned images and aligning the generated outputs with the target class, while preserving benign performance. Experiments show that JOB effectively attacks black-box RAG-DMs, achieving high success rates and outperforming state-of-the-art baselines.


---

## 69. Diff-SemiER: Transparency-Aware Adaptive Fusion Diffusion Model with Generative Prior for Semi-Transparent Eyeglasses Removal

> 🇯🇵 **半透明眼鏡除去生成事前分布を用いた透明度認識適応融合拡散**

> 💡 透明度を考慮した拡散モデルで、眼鏡反射除去を実現する。

**著者:** Jiahao Li, Shiqi Yin, Zhenxiang Lian, jingtao guo

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_Diff-SemiER_Transparency-Aware_Adaptive_Fusion_Diffusion_Model_with_Generative_Prior_for_CVPR_2026_paper.html)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/36680.png)
...
## 70. One-to-All Animation: Alignment-Free Character Animation and Image Pose Transfer
...
## 71. DUO-VSR: Dual-Stream Distillation for One-Step Video Super-Resolution

> 🇯🇵 **DUO-VSR: 動画超解像のための双ストリーム蒸留**

> 💡 1ステップ動画超解像の効率化: 双ストリーム蒸留により1ステップで高速かつ高品質な動画超解像を実現

**著者:** Zhengyao Lv, Menghan Xia, Xintao Wang, Kwan-Yee K. Wong

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lv_DUO-VSR_Dual-Stream_Distillation_for_One-Step_Video_Super-Resolution_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.22271)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/36291.png)


**Abstract:** Diffusion-based video super-resolution (VSR) achieves remarkable fidelity but suffers from prohibitive sampling cost. While distribution matching distillation (DMD) accelerates diffusion models to one-step generation, directly applying it to VSR leads to training instability and degraded, insufficient supervision.To address these issues, we propose \textbf{DUO-VSR}, a three-stage framework centered on a \textbf{DU}al-Stream Distillation strategy that integrates distribution matching and adversarial supervision for \textbf{O}ne-step VSR.We first adopt a Progressive Guided Distillation Initialization to stabilize subsequent training through trajectory-preserving distillation.We then introduce a Dual-Stream Distillation Strategy to jointly optimize DMD and Real–Fake Score Feature GAN (RFS-GAN) streams, with the latter providing complementary adversarial supervision using features from both real and fake score models.Finally, a Preference-Guided Refinement aligns the student with perceptual quality preferences.Comprehensive experiments demonstrate that DUO-VSR achieves superior visual quality and efficiency over previous one-step VSR methods.


---

## 72. When Numbers Speak: Aligning Textual Numerals and Visual Instances in Text-to-Video Diffusion Models

> 🇯🇵 **拡散モデルを用いた生成型学習の高度な手法**

> 💡 拡散モデルの効率性と品質を向上させる新しい最適化手法を提案した。

**著者:** Zhengyang Sun, Yu Chen, Xin Zhou, Xiaofan Li, Xiwu Chen, Dingkang Liang, Xiang Bai

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Sun_When_Numbers_Speak_Aligning_Textual_Numerals_and_Visual_Instances_in_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.08546) | [🌐 Project](https://h-embodvis.github.io/NUMINA/)
...
<iframe src="https://h-embodvis.github.io/NUMINA/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 73. Free-Lunch Long Video Generation via Layer-Adaptive O.O.D Correction

> 🇯🇵 **層適応的分布外補正による訓練不要長動画生成**

> 💡 相対位置と文脈長の分布外問題を層別に補正する訓練不要フレームワークで長動画生成の品質向上を実現した。

**著者:** Jiahao Tian, Chenxi Song, Wei Cheng, Chi Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Tian_Free-Lunch_Long_Video_Generation_via_Layer-Adaptive_O.O.D_Correction_CVPR_2026_paper.html) | [🌐 Project](https://github.com/Westlake-AGI-Lab/FreeLOC)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/36880.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/Westlake-AGI-Lab/FreeLOC" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 74. StreamAvatar: Streaming Diffusion Models for Real-Time Interactive Human Avatars

> 🇯🇵 **StreamAvatar：リアルタイム対話的人間アバター用ストリーミング拡散モデル**

> 💡 ストリーミング拡散でリアルタイムアバター生成。

**著者:** Zhiyao Sun, Ziqiao Peng, Yifeng Ma, Yi Chen, zhengguang zhou, Zixiang Zhou, Guozhen Zhang, Youliang Zhang, Yuan Zhou, qinglin lu, Yong-Jin Liu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Sun_StreamAvatar_Streaming_Diffusion_Models_for_Real-Time_Interactive_Human_Avatars_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.22065)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37416.png)
...
## 75. Correspondence-Attention Alignment for Multi-View Diffusion Models

> 🇯🇵 **マルチビュー拡散モデルの対応アテンション整列（CAMEO）**

> 💡 幾何的対応によるアテンション教師学習で、マルチビュー拡散モデルの訓練効率と生成品質を向上。

**著者:** Minkyung Kwon, Jinhyeok Choi, Jiho Park, Seonghu Jeon, Jinhyuk Jang, Junyoung Seo, Minseop Kwak, Jin-Hwa Kim, Seungryong Kim

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kwon_Correspondence-Attention_Alignment_for_Multi-View_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.03045) | [🌐 Project](https://cvlab-kaist.github.io/CAMEO/)
...
<iframe src="https://cvlab-kaist.github.io/CAMEO/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 76. iMontage: Unified, Versatile, Highly Dynamic Many-to-many Image Generation

> 🇯🇵 **iMontage: 統一的で多用途な高ダイナミック・レンジの多対多画像生成**

> 💡 ビデオモデルの時間的コヒーレンス事前知識に画像データの多様性を統合して、複数画像セットの生成・編集を統一的に実行。

**著者:** ZHOUJIE FU, Xianfang Zeng, jinghong lan, Xinyao Liao, Chen Cheng, Junyi Chen, Jiacheng Wei, Wei Cheng, Shiyu Liu, Yunuo Chen, Gang Yu, Guosheng Lin

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Fu_iMontage_Unified_Versatile_Highly_Dynamic_Many-to-many_Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.20635)
...
## 77. A Temporal and Content Co-Awareness Latent Diffusion for Controllable Hand Image Generation

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Shuang Hao, Pengfei Ren, Haifeng Sun, Ting Pan, Qi Qi, Lei Zhang, Cong Liu, Jianxin Liao, Jingyu Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Hao_A_Temporal_and_Content_Co-Awareness_Latent_Diffusion_for_Controllable_Hand_CVPR_2026_paper.html)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ryou_Beyond_the_Ground_Truth_Enhanced_Supervision_for_Image_Restoration_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.03932) | [🌐 Project](https://hij1112.github.io/beyond-the-ground-truth/)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/38942.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://hij1112.github.io/beyond-the-ground-truth/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 79. I2I-Bench: A Comprehensive Benchmark Suite for Image-to-Image Editing Models

> 🇯🇵 **I2I-Bench: 画像から画像編集モデルのための包括的ベンチマーク群**

> 💡 多様な編集課題を自動かつ多面的に評価する包括的I2Iベンチマーク

**著者:** Juntong Wang, Wang Jiarui, Huiyu Duan, Jiaxiang Kang, Guangtao Zhai, Xiongkuo Min

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_I2I-Bench_A_Comprehensive_Benchmark_Suite_for_Image-to-Image_Editing_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.04660)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/39664.png)
...
## 80. FlowSteer: Guiding Few-Step Image Synthesis with Authentic Trajectories

> 🇯🇵 **少数ステップ画像合成を真正軌跡で誘導**

> 💡 真正軌跡情報で少数ステップでの高品質画像合成を実現する。

**著者:** Lei Ke, Hubery Yin, Gongye Liu, Zhengyao Lv, Jingcai Guo, Chen Li, Wenhan Luo, Yujiu Yang, Jing LYU

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ke_FlowSteer_Guiding_Few-Step_Image_Synthesis_with_Authentic_Trajectories_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.18834)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/39408.png)
...
## 81. Meta-CoT: Enhancing Granularity and Generalization in Image Editing
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_Meta-CoT_Enhancing_Granularity_and_Generalization_in_Image_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.24625)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yang_Omni_IIE_Bench_Benchmarking_the_Practical_Capabilities_of_Image_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.16944)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/40173.png)
...
## 83. Accelerating Diffusion Model Training under Minimal Budgets: A Condensation-Based Perspective

> 🇯🇵 **最小限予算での拡散モデル訓練加速：データ凝縮的視点から**

> 💡 拡散困難度スコアリングと豊かな意味・視覚表現の増強により、元データセットの0.8%で高品質な拡散モデル訓練を100倍以上高速化する凝縮フレームワーク。

**著者:** Rui Huang, Shitong Shao, zikai zhou, Pukun Zhao, Hangyu Guo, Tian Ye, Lichen Bai, Shuo Yang, Zeke Xie

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Huang_Accelerating_Diffusion_Model_Training_under_Minimal_Budgets_A_Condensation-Based_Perspective_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2507.05914)

**Session:** Poster Session 6


![Poster](posters/image_generation/38847.png)
...
## 84. Guiding Token-Sparse Diffusion Models

> 🇯🇵 **トークン疎な拡散モデル誘導**

> 💡 疎なトークン表現で拡散モデルを効率的に制御する。

**著者:** Felix Krause, Stefan Andreas Baumann, Johannes Schusterbauer, Olga Grebenkova, Ming Gui, Vincent Tao Hu, Björn Ommer

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Krause_Guiding_Token-Sparse_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.01608)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/37530.png)
...
## 85. GeodesicNVS: Probability Density Geodesic Flow Matching for Novel View Synthesis

> 🇯🇵 **測地線確率密度フロー・マッチングによるノベルビュー合成**

> 💡 確率密度の測地線補間を用いたフロー・マッチングにより、ペア画像間の決定的変換を学習して、ビューコンシステント性を持つ高品質なノベルビュー合成を実現する。

**著者:** Xuqin Wang, Tao Wu, Yanfeng Zhang, Lu Liu, mingwei Sun, Yongliang Wang, Niclas Zeller, Daniel Cremers

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_GeodesicNVS_Probability_Density_Geodesic_Flow_Matching_for_Novel_View_Synthesis_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.01010)

**Session:** Poster Session 6


![Poster](posters/image_generation/37757.png)
...
## 86. Rethinking Diffusion Model-Based Video Super-Resolution: Leveraging Dense Guidance from Aligned Features

> 🇯🇵 **Diffusion Modelベース動画超解像の再考: 整列特徴の高密度ガイダンス活用**

> 💡 整列特徴への高密度条件付けで画質・忠実度・時間的一貫性を大幅改善

**著者:** Jingyi Xu, Meisong Zheng, Ying Chen, Minglang Qiao, Xin Deng, Mai Xu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xu_Rethinking_Diffusion_Model-Based_Video_Super-Resolution_Leveraging_Dense_Guidance_from_Aligned_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.16928)

**Session:** Poster Session 6


![Poster](posters/video_generation/36781.png)
...
## 87. Attention, May I Have Your Decision? Localizing Generative Choices in Diffusion Models

> 🇯🇵 **注意をいただけますか？拡散モデルの生成的選択の局所化**

> 💡 プローブベースの局所化で自己注意層が暗黙的な決定を担当することを特定し、それらの層への標的介入でバイアス低減を実現する。

**著者:** Katarzyna Zaleska, Łukasz Popek, Monika Wysoczańska, Kamil Deja

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zaleska_Attention_May_I_Have_Your_Decision_Localizing_Generative_Choices_in_CVPR_2026_paper.html)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/39974.png)
...
## 88. Neighbor-Aware Localized Concept Erasure in Text-to-Image Diffusion Models
...
## 89. Group Diffusion: Enhancing Image Generation by Unlocking Cross-Sample Collaboration

> 🇯🇵 **グループ拡散：クロスサンプル協調アンロックによる画像生成向上**

> 💡 複数サンプル間の協調を活用して画像生成品質を向上させる。

**著者:** Sicheng Mo, Thao Nguyen, Richard Zhang, Nick Kolkin, Siddharth Srinivasan Iyer, Eli Shechtman, Krishna Kumar Singh, Yong Jae Lee, Bolei Zhou, Yuheng Li

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Mo_Group_Diffusion_Enhancing_Image_Generation_by_Unlocking_Cross-Sample_Collaboration_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.10954)
...
## 90. Forensic-Friendly Image Manipulation via Controllable Latent Diffusion

> 🇯🇵 **潜在空間での拡散モデル**

> 💡 潜在空間で拡散過程を実行することで、画像生成の計算効率と品質を大幅に改善する。

**著者:** Hanyu Chen, Haiwei Wu, Jinyu Tian, Jianqing Li, Jiantao Zhou

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chen_Forensic-Friendly_Image_Manipulation_via_Controllable_Latent_Diffusion_CVPR_2026_paper.html)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/36941.png)
...
## 91. Extending One-Step Image Generation from Class Labels to Text via Discriminative Text Representation
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhao_Extending_One-Step_Image_Generation_from_Class_Labels_to_Text_via_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.18168)

**Session:** Poster Session 6


![Poster](posters/image_generation/36947.png)
...
## 92. CAST: Context-Aware Dynamic Latent Space Transformation for Interactive Text-to-Image Retrieval

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Xuanzuo Lin, Min Zhang, Daizong Liu, Zhiwen Zuo, Xun Yang, Changting Lin, Xun Wang, Jianfeng Dong

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lin_CAST_Context-Aware_Dynamic_Latent_Space_Transformation_for_Interactive_Text-to-Image_Retrieval_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/image_generation/36861.png)
...
## 93. Proxy-Tuning: Tailoring Multimodal Autoregressive Models for Subject-Driven Image Generation

> 🇯🇵 **Proxy-Tuning：対象駆動画像生成のための多元自己回帰モデルの調整**

> 💡 拡散モデルからの弱い監督で自己回帰モデルをファインチューニングすることで、対象忠実度と多主体構成で拡散モデルを上回る弱-強一般化現象を実現する。

**著者:** Yi Wu, Shengju Qian, Lingting Zhu, Lei Liu, Wandi Qiao, Ziqiang Li, Lequan Yu, Bin Li

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wu_Proxy-Tuning_Tailoring_Multimodal_Autoregressive_Models_for_Subject-Driven_Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2503.10125)

**Session:** Poster Session 6


![Poster](posters/image_generation/37425.png)
...
## 94. PixelDiT: Pixel Diffusion Transformers for Image Generation

> 🇯🇵 **ピクセルディット：画像生成用ピクセル拡散トランスフォーマー**

> 💡 ピクセルレベル拡散トランスフォーマーで画像生成
...
## 95. Taming Video Models for 3D and 4D Generation via Zero-Shot Camera Control

> 🇯🇵 **ゼロショットカメラ制御による3D/4D生成向け動画モデルの制御**

> 💡 推論時のみの軌道整合ガイダンスで3D/4D生成制御を高精度化

**著者:** Chenxi Song, Yanming Yang, Tong Zhao, Ruibo Li, Chi Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Song_Taming_Video_Models_for_3D_and_4D_Generation_via_Zero-Shot_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2509.15130)

**Session:** Poster Session 6


![Poster](posters/video_generation/36610.png)
...
## 96. Lighting-grounded Video Generation with Renderer-based Agent Reasoning

> 🇯🇵 **レンダラー基盤エージェント推論による照明接地ビデオ生成**

> 💡 物理ベースレンダラーと推論エージェントで、正確な照明条件のビデオ生成を実現する。

**著者:** Ziqi Cai, Taoyu Yang, Zheng Chang, Si Li, Han Jiang, Shuchen Weng, Boxin Shi

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Cai_Lighting-grounded_Video_Generation_with_Renderer-based_Agent_Reasoning_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.07966) | [🌐 Project](https://caiziqi.com/research/liver/)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/38815.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://caiziqi.com/research/liver/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 98. MaskFocus: Focusing Policy Optimization on Critical Steps for Masked Image Generation

> 🇯🇵 **MaskFocus：マスク画像生成の重要ステップへのポリシー最適化**

> 💡 重要ステップに焦点化したポリシーでマスク画像生成。

**著者:** Guohui Zhang, Hu Yu, Xiaoxiao Ma, Yaning Pan, Hang Xu, Jie Huang, Feng Zhao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_MaskFocus_Focusing_Policy_Optimization_on_Critical_Steps_for_Masked_Image_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.18766)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/40114.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Jiang_RAISE_Requirement-Adaptive_Evolutionary_Refinement_for_Training-Free_Text-to-Image_Alignment_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.00483) | [🌐 Project](https://github.com/LiyaoJiang1998/RAISE)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/39206.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/LiyaoJiang1998/RAISE" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 101. The Devil is in Attention Sharing: Improving Complex Non-rigid Image Editing Faithfulness via Attention Synergy

> 🇯🇵 **注意共有の悪魔：注意共鳴による複雑な非剛体画像編集の忠実性向上**

> 💡 注意共鳴で非剛体画像編集の精度を向上。

**著者:** Zhuo Chen, Fanyue Wei, Runze Xu, Jingjing Li, Lixin Duan, Angela Yao, Wen Li

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chen_The_Devil_is_in_Attention_Sharing_Improving_Complex_Non-rigid_Image_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.14423)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37474.png)
...
## 102. DiverseGRPO: Mitigating Mode Collapse in Image Generation via Diversity-Aware GRPO

> 🇯🇵 **多様性を考慮したGRPOによる画像生成のモード崩壊軽減（DiverseGRPO）**

> 💡 強化学習における報酬設計と生成動力学から多様性低下の問題に取り組み、画像品質と多様性の新パレート境界を確立。

**著者:** Henglin Liu, Huijuan Huang, Jing Wang, Chang Liu, Xiu Li, Xiangyang Ji

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liu_DiverseGRPO_Mitigating_Mode_Collapse_in_Image_Generation_via_Diversity-Aware_GRPO_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.21514)
...
## 103. Edit2Perceive: Image Editing Diffusion Models Are Strong Dense Perceivers

> 🇯🇵 **Edit2Perceive：画像編集拡散モデルは強力な高密度知覚器である**

> 💡 編集特化型の画像・画像一貫性を持つ拡散モデルをファインチューニングすることで、深度・法線・マッティング等の高密度知覚タスクでの最先端性能を実現する。

**著者:** Yiqing Shi, Yiren Song, Mike Zheng Shou

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Shi_Edit2Perceive_Image_Editing_Diffusion_Models_Are_Strong_Dense_Perceivers_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.18673)

**Session:** Poster Session 6


![Poster](posters/image_generation/39395.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Beaudouin_Delta_Rectified_Flow_Sampling_for_Text-to-Image_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2509.05342)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/36472.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zeng_Sampling-Aware_Quantization_for_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2505.02242)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/38959.png)
...
## 106. TempoControl: Temporal Attention Guidance for Text-to-Video Models

> 🇯🇵 **テキスト生成ビデオモデルの時間的注意誘導制御**

> 💡 時間的注意機構で細粒度な時間制御をテキスト生成ビデオに付与する。

**著者:** Shira Schiber, Ofir Lindenbaum, Idan Schwartz

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Schiber_TempoControl_Temporal_Attention_Guidance_for_Text-to-Video_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.02226)
...
## 107. Pantheon360: Taming Digital Twin Generation via 3D-Aware 360° Video Diffusion

> 🇯🇵 **Pantheon360: 3D対応360°動画Diffusionによるデジタルツイン生成の制御**

> 💡 360度入力と3D Cacheで整合的なデジタルツイン動画を生成
...
**Links:** [📄 Paper](https://cvpr.thecvf.com/virtual/2026/poster/37612)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/37612.png)
...
## 108. Beyond the Static-World: Lifelong Learning for All-in-One Medical Image Restoration

> 🇯🇵 **静的世界を超えて：全機能医療画像復元の生涯学習**

> 💡 生涯学習で医療画像復元を継続的に改善。

**著者:** Shihao Shan, Hongying Liu, Fanhua Shang, Liang Wan, Jingjing Deng

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Shan_Beyond_the_Static-World_Lifelong_Learning_for_All-in-One_Medical_Image_Restoration_CVPR_2026_paper.html)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37720.png)
...
## 109. Transition Matching Distillation for Fast Video Generation

> 🇯🇵 **高速ビデオ生成のための遷移整合蒸留**

> 💡 生成過程の遷移を蒸留することで、高速で高品質なビデオ生成を実現する。

**著者:** Weili Nie, Julius Berner, Nanye Ma, Chao Liu, Saining Xie, Arash Vahdat

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Nie_Transition_Matching_Distillation_for_Fast_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.09881) | [🌐 Project](https://research.nvidia.com/labs/genair/tmd/)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/36665.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://research.nvidia.com/labs/genair/tmd/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 110. When LoRA Betrays: Backdooring Text-to-Image Models by Masquerading as Benign Adapters

> 🇯🇵 **良性アダプタを装うテキスト画像モデルへのバックドア攻撃（LoRA悪用）**

> 💡 LoRA機構を悪用し、テキスト画像モデルに隠れた悪意を注入する99.8%の攻撃成功率。

**著者:** Liangwei Lyu, Jiaqi Xu, Jianwei Ding, Qiyao Deng

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lyu_When_LoRA_Betrays_Backdooring_Text-to-Image_Models_by_Masquerading_as_Benign_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.21977) | [🌐 Project](https://github.com/spectre-init/MasqLora)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/36523.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/spectre-init/MasqLora" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
![Poster](posters/image_generation/38427.png)
...
## 112. Restore Text First, Enhance Image Later: Two-Stage Scene Text Image Super-Resolution with Glyph Structure Guidance

> 🇯🇵 **グリフ構造誘導二段階シーンテキスト画像超解像**

> 💡 テキストを優先復元する二段階手法で、シーンテキスト画像超解像を実現する。

**著者:** Minxing Luo, Linlong Fan, Qiushi Wang, Ge Wu, Yiyan Luo, Yuhang Yu, Jinwei Chen, Yaxing Wang, Qingnan Fan, Jian Yang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Luo_Restore_Text_First_Enhance_Image_Later_Two-Stage_Scene_Text_Image_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.21590)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/36753.png)
...
## 113. SynthRGB-T: Language-Vision Guided Image Translation for Diversity Synthesis

> 🇯🇵 **シンスRGB-T：言語視覚ガイド付き多様性合成の画像翻訳**

> 💡 言語視覚ガイドで多様な画像翻訳を実現

**著者:** Jiangang Ding, Yiquan Du, Pengxiang Li, Lili Pei, Yuanlin Zhao, Wei Li
...
## 114. Real-Time Generation of Streamable Talking Portrait Video with Reference-Guided Deep Compression VAEs

> 🇯🇵 **参照誘導深層圧縮VAEによるストリーミング可能な話者ポートレート動画のリアルタイム生成**

> 💡 参照画像と音声から高品質な会話ポートレート動画をリアルタイム生成
...
![Poster](posters/image_generation/38133.png)
...
## 116. 3D Space as a Scratchpad for Editable Text-to-Image Generation

> 🇯🇵 **3Dスペースを編集可能なテキスト画像生成の作業領域として活用**

> 💡 テキストプロンプトを解析して3Dメッシュで表現し、エージェント計画で空間配置を最適化して空間的に一貫した画像生成を実現する。

**著者:** Oindrila Saha, Vojtech Krs, Radomir Mech, Subhransu Maji, Matheus Gadelha, Kevin Blackburn-Matzen

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Saha_3D_Space_as_a_Scratchpad_for_Editable_Text-to-Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.14602)
...
## 117. FoundIR-v2: Optimizing Pre-Training Data Mixtures for Image Restoration Foundation Model

> 🇯🇵 **画像復元基盤モデルの学習データ混合比最適化（FoundIR-v2）**

> 💡 データ均衡スケジュール設計と専門家混合で50以上の復元タスクに対応する基盤モデル。

**著者:** Xiang Chen, Jinshan Pan, Jiangxin Dong, Jian Yang, Jinhui Tang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chen_FoundIR-v2_Optimizing_Pre-Training_Data_Mixtures_for_Image_Restoration_Foundation_Model_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.09282)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37767.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Retrieve-to-Restore_Efficient_All-in-One_Image_Restoration_with_a_Retrieval-Based_Degradation_Bank_CVPR_2026_paper.html)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/36814.png)
...
## 119. Accelerating Autoregressive Video Diffusion via History-Guided Cache and Residual Correction

> 🇯🇵 **履歴誘導キャッシュと残差補正による自己回帰動画Diffusionの高速化**

> 💡 履歴情報に基づくキャッシュ制御で長尺自己回帰動画生成を高速化
...
## 121. Hist2Style: Histogram-Guided Stylization with Bilateral Grids
...
## 122. PropFly: Learning to Propagate via On-the-Fly Supervision from Pre-trained Video Diffusion Models

> 🇯🇵 **PropFly: 事前学習Video Diffusion Modelsからのオンザフライ監督による伝播学習**

> 💡 事前学習VDMの即時生成ペアを用いて高品質な伝播型動画編集を学習

**著者:** Wonyong Seo, Jaeho Moon, Jaehyup Lee, Soo Ye Kim, Munchurl Kim

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Seo_PropFly_Learning_to_Propagate_via_On-the-Fly_Supervision_from_Pre-trained_Video_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.20583)

**Session:** Poster Session 6


![Poster](posters/video_generation/36257.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Aliev_OrthoFuse_Training-free_Riemannian_Fusion_of_Orthogonal_Style-Concept_Adapters_for_Diffusion_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.05183)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/38447.png)
...
## 124. Generating Humanless Environment Walkthroughs from Egocentric Walking Tour Videos

> 🇯🇵 **自己中心ツアービデオからの人物なし環境ウォークスルー生成**

> 💡 自己中心視点動画から周辺環境のみの新規ウォークスルーを生成する。

**著者:** Yujin Ham, Junho Kim, Vivek Boominathan, Guha Balakrishnan

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ham_Generating_Humanless_Environment_Walkthroughs_from_Egocentric_Walking_Tour_Videos_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.29036)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/39106.png)
...
## 125. DCoAR: Deep Concept Injection into Unified Autoregressive Models for Personalized Text-to-Image Generation

> 🇯🇵 **統一自動回帰モデルへの深い概念注入個人化テキスト画像生成**

> 💡 概念注入により個人化されたテキスト画像生成を実現する。

**著者:** Fangtai Wu, Mushui Liu, Weijie He, Zhao Wang, Yunlong Yu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wu_DCoAR_Deep_Concept_Injection_into_Unified_Autoregressive_Models_for_Personalized_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2508.07341)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/36844.png)
...
## 126. Anti-I2V: Safeguarding your Photos from Malicious Image-to-video Generation
...
## 127. Language-Guided One-Step Diffusion Model for Nighttime Flare Removal

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Aoxiang Ning, Kailong Yu, Minglong Xue, Liyuan Pan, Jinhong He, Wenchao Yan, Mingliang Zhou, Yirui Wu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ning_Language-Guided_One-Step_Diffusion_Model_for_Nighttime_Flare_Removal_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/image_generation/37707.png)
...
## 128. DNF-SR: Dual-Input and Negative-Aware Feature Fine-Tuning for Real-World Image Super-Resolution

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Shuhao Han, Wenjie Liao, Hayden Vance, Hang Dong, Rui Zhang, Chunle Guo, Chongyi Li

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Han_DNF-SR_Dual-Input_and_Negative-Aware_Feature_Fine-Tuning_for_Real-World_Image_Super-Resolution_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/image_generation/36284.png)
...
## 129. DeltaQuant: 4-bit Video Diffusion Models with Spatiotemporal Delta Smoothing

> 🇯🇵 **DeltaQuant: 時空間デルタスムージングを用いた4ビット動画拡散モデル**

> 💡 ビデオ拡散モデルの効率化: 時空間類似性を活用した4ビット量子化により計算コスト削減と生成品質維持を実現
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_DeltaQuant_4-bit_Video_Diffusion_Models_with_Spatiotemporal_Delta_Smoothing_CVPR_2026_paper.html)
...
## 130. GDRO: Group-level Reward Post-training Suitable for Diffusion Models

> 🇯🇵 **GDRO：拡散モデルに適した群レベル報酬事後訓練**

> 💡 群レベル報酬最適化で拡散モデルの効率化と安定性を改善し、完全オフライン訓練と報酬ハッキング軽減を実現する。

**著者:** Yiyang Wang, Xi Chen, Xiaogang Xu, Yu Liu, Hengshuang Zhao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_GDRO_Group-level_Reward_Post-training_Suitable_for_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.02036)

**Session:** Poster Session 6


![Poster](posters/image_generation/38661.png)
...
## 131. Progress by Pieces: Test-Time Scaling for Autoregressive Image Generation

> 🇯🇵 **進捗をピースで：自己回帰画像生成のテスト時スケーリング**

> 💡 グリッド分割進行生成で候補を早期枝刈りし、レイアウト指定プロンプト改定で視野不足を補うテスト時スケーリング手法を提案する。

**著者:** Joonhyung Park, Hyeongwon Jang, Joowon Kim, Eunho Yang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Park_Progress_by_Pieces_Test-Time_Scaling_for_Autoregressive_Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.21185)

**Session:** Poster Session 6


![Poster](posters/image_generation/37357.png)
...
## 132. DreamSR: Towards Ultra-High-Resolution Image Super-Resolution via a Receptive-Field Enhanced Diffusion Transformer

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Qingji Dong, Hang Dong, Mingqin Chen, Rui Zhang, Yitong Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Dong_DreamSR_Towards_Ultra-High-Resolution_Image_Super-Resolution_via_a_Receptive-Field_Enhanced_Diffusion_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2605.15682)

**Session:** Poster Session 6


![Poster](posters/image_generation/37337.png)
...
## 134. When Local Rules Create Global Order: Self-Organized Representation Learning for Latent Diffusion Models

> 🇯🇵 **局所規則が大域秩序を生成するとき：潜在拡散モデルの自己組織表現学習**

> 💡 自己組織学習で潜在拡散モデルを改善。

**著者:** Junrong Lian, Weijian Deng, Pengxu Wei, Yaqin Chen, Qixiang Ye, Liang Lin

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lian_When_Local_Rules_Create_Global_Order_Self-Organized_Representation_Learning_for_CVPR_2026_paper.html)
...
## 135. Layer-wise Instance Binding for Regional and Occlusion Control in Text-to-Image Diffusion Transformers

> 🇯🇵 **テキスト画像拡散トランスフォーマーの領域遮蔽制御のための層別インスタンス結合**

> 💡 層別インスタンス結合で領域制御を精密化。

**著者:** Ruidong Chen, Yancheng Bai, Xuanpu Zhang, Jianhao Zeng, Lanjun Wang, Dan Song, Lei Sun, Xiangxiang Chu, An-An Liu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chen_Layer-wise_Instance_Binding_for_Regional_and_Occlusion_Control_in_Text-to-Image_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.05769)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37200.png)
...
## 136. DisCa: Accelerating Video Diffusion Transformers with Distillation-Compatible Learnable Feature Caching

> 🇯🇵 **蒸留互換学習特徴キャッシュでのビデオ拡散トランス加速**

> 💡 学習可能キャッシュと蒸留互換性で、ビデオ拡散トランスの高速化を実現する。

**著者:** Chang Zou, Changlin Li, Songtao Liu, Zhao Zhong, Kailin Huang, Linfeng Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zou_DisCa_Accelerating_Video_Diffusion_Transformers_with_Distillation-Compatible_Learnable_Feature_Caching_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.05449)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/38714.png)
...
## 137. SwitchCraft: Training-Free Multi-Event Video Generation with Attention Controls

> 🇯🇵 **SwitchCraft: 訓練不要で複数イベント動画生成**

> 💡 訓練不要な複雑動画生成: 複数の異なるイベントを含む動画を訓練なしで自動生成可能に

**著者:** Qianxun Xu, Chenxi Song, Yujun Cai, Chi Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xu_SwitchCraft_Training-Free_Multi-Event_Video_Generation_with_Attention_Controls_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.23956)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/39197.png)
...
## 138. VerseCrafter: Dynamic Realistic Video World Model with 4D Geometric Control

> 🇯🇵 **VerseCrafter: 4D幾何制御を備えた動的で写実的な動画世界モデル**

> 💡 4D幾何表現によりカメラと複数物体運動を統一制御する世界モデル

**著者:** Sixiao Zheng, Minghao Yin, Wenbo Hu, Xiaoyu Li, Ying Shan, Yanwei Fu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zheng_VerseCrafter_Dynamic_Realistic_Video_World_Model_with_4D_Geometric_Control_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.05138) | [🌐 Project](https://sixiaozheng.github.io/VerseCrafter_page/)

**Session:** Poster Session 6


![Poster](posters/video_generation/37385.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://sixiaozheng.github.io/VerseCrafter_page/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 139. DiP: Taming Diffusion Models in Pixel Space
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chen_DiP_Taming_Diffusion_Models_in_Pixel_Space_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.18822)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/36464.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yu_Self-Evaluation_Unlocks_Any-Step_Text-to-Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.22374)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Shin_Exploring_Conditions_for_Diffusion_Models_in_Robotic_Control_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.15510)
...
## 142. LIFT and PLACE: A Simple, Stable, and Effective Knowledge Distillation Framework for Lightweight Diffusion Models

> 🇯🇵 **LIFT and PLACE：軽量拡散モデルの知識蒸留フレームワーク**

> 💡 知識蒸留で軽量な拡散モデルを効率的に学習。

**著者:** Hyunsoo Han, Sangyeop Yeo, Jaejun Yoo

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Han_LIFT_and_PLACE_A_Simple_Stable_and_Effective_Knowledge_Distillation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2605.19729)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/38890.png)
...
## 143. LLaDA-V: Large Language Diffusion Models with Visual Instruction Tuning

> 🇯🇵 **LLaDA-V：視覚指示チューニング付き大規模言語拡散モデル**

> 💡 視覚指示で大規模言語拡散モデルを制御。

**著者:** Zebin You, Shen Nie, Xiaolu Zhang, JUN ZHOU, Zhiwu Lu, Ji-Rong Wen, Chongxuan Li

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/You_LLaDA-V_Large_Language_Diffusion_Models_with_Visual_Instruction_Tuning_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2505.16933)
...
## 144. ConceptPrism: Concept Disentanglement in Personalized Diffusion Models via Residual Token Optimization

> 🇯🇵 **ConceptPrism：残差トークン最適化による個人化拡散モデルの概念分離**

> 💡 個人化拡散モデルで概念を分離し、望む特性のみを生成。

**著者:** Minseo Kim, Minchan Kwon, Dongyeun Lee, Yunho Jeon, Junmo Kim

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kim_ConceptPrism_Concept_Disentanglement_in_Personalized_Diffusion_Models_via_Residual_Token_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.19575) | [🌐 Project](https://github.com/Minseo-Kimm/ConceptPrism)
...
<iframe src="https://github.com/Minseo-Kimm/ConceptPrism" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 145. Degradation-Consistent Test-Time Adaptation for All-in-One Image Restoration

> 🇯🇵 **All-in-One画像復元のための劣化一貫なテスト時適応**

> 💡 再劣化生成と重要パラメータ選択で未知劣化分布への適応を実現する

**著者:** Ni Tang, Shenghao nie, Xiaotong Luo, Yuan Xie, Yanyun Qu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Tang_Degradation-Consistent_Test-Time_Adaptation_for_All-in-One_Image_Restoration_CVPR_2026_paper.html)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/37745.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Jiang_ZeroIDIR_Zero-Reference_Illumination_Degradation_Image_Restoration_with_Perturbed_Consistency_Diffusion_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2605.11435)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/38358.png)
...
## 148. Residual Diffusion Bridge Model for Image Restoration

> 🇯🇵 **画像復元のための残差拡散ブリッジモデル**

> 💡 残差拡散ブリッジで様々な画像復元に対応。

**著者:** Hebaixu Wang, Jing Zhang, Haoyang Chen, Haonan Guo, Di Wang, Jiayi Ma, Bo Du

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Residual_Diffusion_Bridge_Model_for_Image_Restoration_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.23116)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/38142.png)
...
## 149. Inter-Edit: First Benchmark for Interactive Instruction-Based Image Editing

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Delong Liu, Haotian Hou, Zhaohui Hou, Zhiyuan Huang, Shihao Han, Mingjie Zhan, Zhicheng Zhao, Fei Su

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liu_Inter-Edit_First_Benchmark_for_Interactive_Instruction-Based_Image_Editing_CVPR_2026_paper.html)
...
## 150. The Image as Its Own Reward: Reinforcement Learning with Adversarial Reward for Image Generation

> 🇯🇵 **画像自体が報酬：画像生成のための敵対的報酬強化学習**

> 💡 敵対的報酬強化学習で目的に合った画像生成。

**著者:** Weijia Mao, Hao Chen, Zhenheng Yang, Mike Zheng Shou

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Mao_The_Image_as_Its_Own_Reward_Reinforcement_Learning_with_Adversarial_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.20256)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/39882.png)
...
## 151. Multinex: Lightweight Low-light Image Enhancement via Multi-prior Retinex

> 🇯🇵 **マルチ事前分布レティネックス低照度画像向上軽量化**

> 💡 複数事前分布とレティネックス理論で低照度画像を軽量に改善する。

**著者:** Alexandru Brateanu, Tingting Mu, Codruta O. Ancuti, Cosmin Ancuti

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Brateanu_Multinex_Lightweight_Low-light_Image_Enhancement_via_Multi-prior_Retinex_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.10359) | [🌐 Project](https://albrateanu.github.io/multinex/)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/40003.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://albrateanu.github.io/multinex/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
> 🇯🇵 **GUIエージェントへの道：GUI接地のための視覚言語拡散モデル**

> 💡 離散拡散視覚言語モデルをGUIタスク用に適応し、階層的境界ボックス構造を捉える混合マスキングスケジュールで接地精度を向上させる。

**著者:** Shrinidhi Kumbhar, Haofu Liao, srikar appalaraju, Kunwar Yashraj Singh

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kumbhar_Towards_GUI_Agents_Vision-Language_Diffusion_Models_for_GUI_Grounding_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.26211)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37261.png)
...
## 153. Attribution as Retrieval: Model-Agnostic AI-Generated Image Attribution

> 🇯🇵 **Attribution as Retrieval: モデル非依存なAI生成画像帰属**

> 💡 画像分類でなく検索問題としてAI生成画像の出所モデルを高精度特定

**著者:** Hongsong Wang, Renxi Cheng, Chaolei Han, Jie Gui

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Attribution_as_Retrieval_Model-Agnostic_AI-Generated_Image_Attribution_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.10583)
...
## 154. Reward Forcing: Efficient Streaming Video Generation with Rewarded Distribution Matching Distillation

> 🇯🇵 **報酬強制: 効率的ストリーミング動画生成**

> 💡 報酬最適化による高速化: 報酬強制で効率的なストリーミング型動画生成を大幅加速
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lu_Reward_Forcing_Efficient_Streaming_Video_Generation_with_Rewarded_Distribution_Matching_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.04678) | [🌐 Project](https://reward-forcing.github.io/)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/37619.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://reward-forcing.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 155. Video-as-Answer: Predict and Generate Next Video Event with Joint-GRPO

> 🇯🇵 **動画理解の時間相互作用モデリング**

> 💡 時間依存性と空間相互作用の効率的モデリングで動画行動認識精度を向上。

**著者:** JUNHAO CHENG, Liang Hou, Xin Tao, Jing Liao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Cheng_Video-as-Answer_Predict_and_Generate_Next_Video_Event_with_Joint-GRPO_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.16669)

**Session:** Poster Session 6


![Poster](posters/video_generation/38217.png)
...
## 156. Identity-Preserving Image-to-Video Generation via Reward-Guided Optimization

> 🇯🇵 **視覚認識のための多段階特徴抽出手法**

> 💡 画像理解において、複数スケールの特徴を効果的に統合する新しいアーキテクチャを提案した。

**著者:** Liao Shen, Wentao Jiang, Yiran Zhu, Jiahe Li, Tiezheng Ge, Zhiguo Cao, Bo Zheng

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Shen_Identity-Preserving_Image-to-Video_Generation_via_Reward-Guided_Optimization_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.14255)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/39047.png)
...
## 157. Multi-Scale Local Speculative Decoding for Image Generation

> 🇯🇵 **画像生成のためのマルチスケール局所推測デコーディング**

> 💡 マルチスケール推測デコーディングで画像生成を高速化。

**著者:** Elia Peruzzo, Guillaume Sautiere, Amir Habibian

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Peruzzo_Multi-Scale_Local_Speculative_Decoding_for_Image_Generation_CVPR_2026_paper.html)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/38412.png)
...
## 158. Sketch2CT: Multimodal Diffusion for Structure-Aware 3D Medical Volume Generation
...
## 159. Training-free Motion Factorization for Compositional Video Generation

> 🇯🇵 **合成ビデオ生成の無学習動作因子分解**

> 💡 学習なしで動作の因子分解を実現し、合成ビデオの多様で柔軟な生成を可能にする。

**著者:** Zixuan Wang, Ziqin Zhou, Feng Chen, DUO PENG, Yixin Hu, Changsheng Li, Yinjie Lei

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Training-free_Motion_Factorization_for_Compositional_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.09104)
...
## 160. PatchScene: Patch-based Voxel Diffusion Model for Large-Scale Scene Completion

> 🇯🇵 **PatchScene: 大規模シーン補完用パッチベース・ボクセル拡散モデル**

> 💡 環状フロー戦略でLiDAR走査の放射状密度パターンを活用し、重複パッチと隣接フレームから空間的に制限されないシーン補完を実現。

**著者:** Qingdong Xu, Jiajun Zhu, Shilin Zhu, Xinjing He, Chao Lu, Huanran Wang, Jiyao Zhang
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_Guiding_a_Diffusion_Model_by_Swapping_Its_Tokens_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.08048)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lu_ChordEdit_One-Step_Low-Energy_Transport_for_Image_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.19083) | [🌐 Project](https://chordedit.github.io/)

**Session:** Oral Session 3C: Generative Editing
...
<iframe src="https://chordedit.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Synthetic_Curriculum_Reinforces_Compositional_Text-to-Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.18378)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/38336.png)
...
## 165. FastHybrid: Accelerating Hybrid Autoregressive Image Generation with Lookahead and Guided Decoding

> 🇯🇵 **FastHybrid: ルックアヘッド・ガイド付き復号化による雑種自己回帰画像生成の高速化**

> 💡 ルックアヘッド機構とガイド付き復号化で雑種自己回帰生成を加速化。

**著者:** j zg, Fang Zhang, YongXiang Hua, Bocheng Li, Wentao Zhang, Linli Xu
...
![Poster](posters/image_generation/38500.png)
...
## 166. C-GenReg: Training-Free 3D Point Cloud Registration by Multi-View-Consistent Geometry-to-Image Generation with Probabilistic Modalities Fusion

> 🇯🇵 **C-GenReg：確率的モダリティ融合による多視点整合的な幾何画像生成による訓練フリーな3D点群登録**

> 💡 幾何基礎モデルで合成した多視点RGB画像と幾何情報を確率的に融合し、ゼロショット3D点群登録を実現する。

**著者:** Yuval Haitman, Amit Efraim, Joseph M. Francos

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Haitman_C-GenReg_Training-Free_3D_Point_Cloud_Registration_by_Multi-View-Consistent_Geometry-to-Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.16680) | [🌐 Project](https://yuvalh9.github.io/CGenReg/)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/37025.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://yuvalh9.github.io/CGenReg/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ye_UltraFlux_Data-Model_Co-Design_for_High-quality_Native_4K_Text-to-Image_Generation_across_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.18050)
...
## 168. FreqEdit: Preserving High-Frequency Features for Robust Multi-Turn Image Editing

> 🇯🇵 **FreqEdit：多段階画像編集で堅牢に高周波特性を保存する**

> 💡 参照速度場から高周波成分を注入し、適応的注入と経路補正により、10回以上の連続編集での品質劣化を防ぐ訓練不要フレームワーク。

**著者:** Yucheng Liao, Jiajun Liang, Kaiqian Cui, Baoquan Zhao, Haoran Xie, Wei Liu, Qing Li, Xudong Mao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liao_FreqEdit_Preserving_High-Frequency_Features_for_Robust_Multi-Turn_Image_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.01755)

**Session:** Poster Session 6


![Poster](posters/image_generation/39055.png)
...
## 169. Towards Robust Sequential Decomposition for Complex Image Editing

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Zilai Zeng, Mingdeng Cao, Zijie Li, Xiaochen Lian, Yichun Shi, Peihao Zhu, Chen Sun, Peng Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zeng_Towards_Robust_Sequential_Decomposition_for_Complex_Image_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2605.09233)
...
## 170. Improving Text-to-Image Generation with Intrinsic Self-Confidence Rewards

> 🇯🇵 **内在的自己信頼報酬によるText-to-Image生成の改善**

> 💡 自己デノイズ信頼度を報酬化し教師なしで画像生成品質と整合性を向上

**著者:** Seungwook Kim, Minsu Cho

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kim_Improving_Text-to-Image_Generation_with_Intrinsic_Self-Confidence_Rewards_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.00918)
...
## 171. 2ndMatch: Finetuning Pruned Diffusion Models via Second-Order Jacobian Matching

> 🇯🇵 **2ndMatch：二階ヤコビアン・マッチングによる刈込拡散モデルのファインチューニング**

> 💡 刈込モデルに密集モデルの時間的感度を模倣させることで、チューニング時の効果的知識移行と出力品質向上を実現する汎用フレームワーク。

**著者:** Caleb Zheng, Eli Shlizerman

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zheng_2ndMatch_Finetuning_Pruned_Diffusion_Models_via_Second-Order_Jacobian_Matching_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2506.05398)

**Session:** Poster Session 6


![Poster](posters/image_generation/39432.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_HP-Edit_A_Human-Preference_Post-Training_Framework_for_Image_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.19406)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Susladkar_RewardFlow_Generate_Images_by_Optimizing_What_You_Reward_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.08536) | [🌐 Project](https://plan-lab.github.io/projects/rewardflow/)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/37655.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://plan-lab.github.io/projects/rewardflow/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>

</details>


**Abstract:** RewardFlow is a zero-shot, training-free framework for text-guided image editing and generation based on reward-guided Langevin dynamics. We steer pretrained diffusion and flow-matching models at inference time using a diverse set of differentiable rewards, and control their influence with a prompt-aware adaptive policy that parses the text instruction, infers edit intent, and dynamically adjusts update steps. Our design includes a differentiable VQA-based reward for fine-grained semantic supervision and a SAM-guided reward for precise, localized edits with minimal leakage. Across standard image editing and compositional generation benchmarks, RewardFlow achieves state-of-the-art zero-shot edit fidelity and compositional alignment. We will release the code and an open-source demo upon acceptance of the paper.


---

## 175. Interact2Ar: Full-Body Human-Human Interaction Generation via Autoregressive Diffusion Models

> 🇯🇵 **全身人間相互作用自動回帰拡散モデル生成**

> 💡 自動回帰拡散で複雑な人間相互作用の全身動作生成を実現する。

**著者:** Pablo Ruiz-Ponce, Sergio Escalera, Jose Garcia-Rodriguez, Jiankang Deng, Rolandos Alexandros Potamias

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ruiz-Ponce_Interact2Ar_Full-Body_Human-Human_Interaction_Generation_via_Autoregressive_Diffusion_Models_CVPR_2026_paper.html) | [🌐 Project](https://pabloruizponce.com/papers/Interact2Ar)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/38710.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://pabloruizponce.com/papers/Interact2Ar" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 176. Training-free Detection of Generated Videos via Spatial-Temporal Likelihoods

> 🇯🇵 **生成動画のための訓練不要検出: 時空間周波数分析**

> 💡 生成AI動画の検出: 時空間周波数領域の特性を分析して訓練なしで生成動画を自動判別

**著者:** Omer Ben Hayun, Roy Betser, Meir Yossef Levi, Levi Kassel, Guy Gilboa

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Hayun_Training-free_Detection_of_Generated_Videos_via_Spatial-Temporal_Likelihoods_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.15026) | [🌐 Project](https://omerbenhayun.github.io/stall-video/)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/37242.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://omerbenhayun.github.io/stall-video/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 178. HiCoGen: Hierarchical Compositional Text-to-Image Generation in Diffusion Models via Reinforcement Learning

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Hongji Yang, Yucheng Zhou, Wencheng Han, Runzhou Tao, Zhongying Qiu, Jianfei Yang, Jianbing Shen

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yang_HiCoGen_Hierarchical_Compositional_Text-to-Image_Generation_in_Diffusion_Models_via_Reinforcement_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.19965)

**Session:** Poster Session 6


![Poster](posters/image_generation/36654.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lee_OPRO_Orthogonal_Panel-Relative_Operators_for_Panel-Aware_In-Context_Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.27637)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/36252.png)
...
## 180. AutoDebias: An Automated Framework for Detecting and Mitigating Backdoor Biases in Text-to-Image Models

> 🇯🇵 **テキスト画像モデルの背後バイアス検出緩和自動フレームワーク**

> 💡 自動フレームワークで、モデルの背後バイアスを検出し緩和する。

**著者:** Hongyi Cai, HONGYI CAI, MingKang Dong, Muxin Pu, Moayad Aloqaily, jie li, Xinfeng Li, Jialie Shen, Meikang Qiu, Qingsong Wen

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Cai_AutoDebias_An_Automated_Framework_for_Detecting_and_Mitigating_Backdoor_Biases_CVPR_2026_paper.html)
...
**Abstract:** Text-to-Image (T2I) models generate high-quality images but are vulnerable to malicious backdoor attacks that inject harmful biases (e.g., trigger-activated gender or racial stereotypes). Existing debiasing methods, often designed for natural statistical biases, struggle with these deliberate and subtle injected attacks. We propose AutoDebias, a framework that automatically identifies and mitigates these malicious biases in T2I models without prior knowledge of the specific attack vectors. Specifically, AutoDebias leverages vision-language models to detect trigger-activated visual patterns and constructs neutralization guides by generating counter-prompts. These guides drive a CLIP-guided training process that breaks the harmful associations while preserving the original model's image quality and diversity. Unlike methods designed for natural bias, AutoDebias effectively addresses subtle, injected stereotypes and multiple interacting attacks. We evaluate the framework on a new benchmark covering 17 distinct backdoor attack scenarios, including challenging cases where multiple backdoors co-exist. AutoDebias detects malicious patterns with 91.6\% accuracy and reduces the backdoor success rate from 90\% to negligible levels, while preserving the visual fidelity of the original model.


---

## 181. UCMNet: Uncertainty-Aware Context Memory Network for Under-Display Camera Image Restoration

> 🇯🇵 **不確実性認識文脈記憶ネットワーク：ディスプレイ下カメラ画像復元**

> 💡 不確実性と文脈記憶で、ディスプレイ下カメラの画像復元品質を向上させる。

**著者:** DAEHYUN KIM, Youngmin Kim, Yoon Ju Oh, Tae Hyun Kim

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kim_UCMNet_Uncertainty-Aware_Context_Memory_Network_for_Under-Display_Camera_Image_Restoration_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.00381) | [🌐 Project](https://kdhrick2222.github.io/projects/UCMNet/)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/36653.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://kdhrick2222.github.io/projects/UCMNet/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 182. GenieDrive: Towards Physics-Aware Driving World Model with 4D Occupancy Guided Video Generation

> 🇯🇵 **GenieDrive: 物理対応の運転世界モデル**

> 💡 物理シミュレーション統合: 物理エンジン統合で現実的で法則一貫した運転動画生成

**著者:** Zhenya Yang, Zhe Liu, Yuxiang Lu, Liping Hou, Chenxuan Miao, peng siyi, Bailan Feng, Xiang Bai, Hengshuang Zhao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yang_GenieDrive_Towards_Physics-Aware_Driving_World_Model_with_4D_Occupancy_Guided_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.12751)
...
## 183. Geo2: Geometry-Guided Cross-view Geo-Localization and Image Synthesis

> 🇯🇵 **Geo2：幾何誘導による交差視点地理位置推定と画像合成**

> 💡 幾何基礎モデルから3D認識潜在空間に地上・空中視点を埋込み、地理位置推定と双方向画像合成を統一的に実行する。

**著者:** Yancheng Zhang, Xiaohan Zhang, Guangyu Sun, Zonglin Lyu, Safwan Wshah, Chen Chen

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_Geo2_Geometry-Guided_Cross-view_Geo-Localization_and_Image_Synthesis_CVPR_2026_paper.html)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/39699.png)
...
## 184. Visual Diffusion Models are Geometric Solvers

> 🇯🇵 **視覚拡散モデルは幾何学的ソルバーである**

> 💡 画像生成タスクとして幾何学的問題を定式化し、標準的な拡散モデルで画素空間において長年の難問を近似的に解く、幾何推論と生成モデリングの新たな接続。

**著者:** Nir Goren, Shai Yehezkel, Omer Dahary, Andrey Voynov, Or Patashnik, Daniel Cohen-Or

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Goren_Visual_Diffusion_Models_are_Geometric_Solvers_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.21697)

**Session:** Poster Session 6


![Poster](posters/image_generation/39369.png)
...
## 185. Decoupled Residual Denoising Diffusion Models for Unified and Data Efficient Image-to-Image Translation

> 🇯🇵 **統合的でデータ効率的な画像変換のための分離型残差除去拡散モデル**

> 💡 画像間の変換を効率的に行う拡散モデルを提案し、データ量を削減しながら変換品質と多様性を向上させる。

**著者:** Ziyue Lin, Jiahe Hou, Xia Hongyu, Xinrui Xie, Feifei Wang, Yuyin Zhou, Wei Wang, Jiawei Liu, Liangqiong Qu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lin_Decoupled_Residual_Denoising_Diffusion_Models_for_Unified_and_Data_Efficient_CVPR_2026_paper.html)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/36193.png)
...
## 186. DeX-Portrait: Disentangled and Expressive Portrait Animation via Explicit and Latent Motion Representations
...
## 187. Enhancing Spatial Understanding in Image Generation via Reward Modeling

> 🇯🇵 **報酬モデリングによる画像生成の空間理解向上**

> 💡 報酬モデリングで空間配置の一貫性を改善した画像生成を実現する。

**著者:** Zhenyu Tang, Chaoran Feng, Yufan Deng, Jie Wu, Xiaojie Li, Rui Wang, Yunpeng Chen, Daquan Zhou

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Tang_Enhancing_Spatial_Understanding_in_Image_Generation_via_Reward_Modeling_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.24233)
...
## 188. LogCD: Local-to-global Consistency Distillation for Few-step Image Generation

> 🇯🇵 **少ステップ画像生成の局所から全体への一貫性蒸留（LogCD）**

> 💡 2段階蒸留と知覚的一貫性で、3ステップでSDXL相当の画像品質を実現。

**著者:** Qingsong Xie, Zhenyi Liao, Chen Chen, Zhijie Deng, Haonan Lu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xie_LogCD_Local-to-global_Consistency_Distillation_for_Few-step_Image_Generation_CVPR_2026_paper.html)
...
## 189. PaCo-RL: Advancing Reinforcement Learning for Consistent Image Generation with Pairwise Reward Modeling

> 🇯🇵 **ペアワイズ報酬モデリング一貫性画像生成強化学習向上**

> 💡 ペアワイズ報酬で、一貫性のある画像生成を強化学習で改善する。

**著者:** Bowen Ping, Chengyou Jia, Minnan Luo, Changliang Xia, Xin Shen, Zhuohang Dang, Hangwei Qian

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ping_PaCo-RL_Advancing_Reinforcement_Learning_for_Consistent_Image_Generation_with_Pairwise_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.04784) | [🌐 Project](https://x-gengroup.github.io/HomePage_PaCo-RL/)
...
<iframe src="https://x-gengroup.github.io/HomePage_PaCo-RL/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 190. CREval: An Automated Interpretable Evaluation for Creative Image Manipulation under Complex Instructions

> 🇯🇵 **クリーバル：複雑指示下での創造的画像操作の自動解釈可能評価**

> 💡 複雑指示での創造的画像操作を自動評価

**著者:** Chonghuinan Wang, Zihan Chen, Yuxiang Wei, Tianyi Jiang, Xiaohe Wu, Fan Li, Wangmeng Zuo, Hongxun Yao
...
## 196. Beyond Fixed Formulas: Data-Driven Linear Predictor for Efficient Diffusion Models

> 🇯🇵 **固定式を超えた：効率的拡散モデルデータ駆動線形予測器**

> 💡 線形予測器をデータ駆動で最適化し、拡散モデルの効率を向上させる。

**著者:** Zhirong Shen, Rui Huang, Jiacheng Liu, Chang Zou, Peiliang Cai, Shikang Zheng, zhengyi shi, Liang Feng, Linfeng Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Shen_Beyond_Fixed_Formulas_Data-Driven_Linear_Predictor_for_Efficient_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.26365)
...
## 198. SeaCache: Spectral-Evolution-Aware Cache for Accelerating Diffusion Models

> 🇯🇵 **シーキャッシュ：スペクトル進化認識キャッシュによる拡散モデル加速**

> 💡 スペクトル進化認識キャッシュで拡散モデル高速化
...
## 199. Compositional Text-to-Image Generation Via Region-aware Bimodal Direct Preference Optimization

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Zhuohan Liu, Wujian Peng, Yitong Chen, Zuxuan Wu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liu_Compositional_Text-to-Image_Generation_Via_Region-aware_Bimodal_Direct_Preference_Optimization_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/image_generation/36403.png)
...
## 200. Efﬁcient and Training-Free Single-Image Diffusion Models
...
## 201. PSR: Scaling Multi-Subject Personalized Image Generation with Pairwise Subject-Consistency Rewards

> 🇯🇵 **PSR: ペアワイズ主題一貫性報酬によるマルチ主体個別化画像生成のスケーリング**

> 💡 複数人物生成で主題一貫性と文制御性を報酬学習により同時に高める

**著者:** Shulei Wang, Longhui Wei, XIN HE, Jianbo Ouyang, Hui Lu, Zhou Zhao, Qi Tian

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_PSR_Scaling_Multi-Subject_Personalized_Image_Generation_with_Pairwise_Subject-Consistency_Rewards_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.01236)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/38281.png)
...
## 202. FAPE-IR: Frequency-Aware Planning and Execution Framework for All-in-One Image Restoration

> 🇯🇵 **FAPE-IR: All-in-One画像復元のための周波数認識型計画実行フレームワーク**

> 💡 MLLM計画と周波数専門家選択により多様な劣化を統一的に復元する

**著者:** Jingren Liu, Shuning Xu, Qirui Yang, Yun wang, Xiangyu Chen, Zhong Ji

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liu_FAPE-IR_Frequency-Aware_Planning_and_Execution_Framework_for_All-in-One_Image_Restoration_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.14099)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/36935.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Tang_Masked_Region_Transformer_for_Layered_Image_Generation_and_Editing_at_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/image_generation/39513.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Jiang_OctoT2I_A_Self-Evolving_Agentic_Text-to-Image_Router_CVPR_2026_paper.html)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/38416.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhou_SpatialReward_Verifiable_Spatial_Reward_Modeling_for_Fine-Grained_Spatial_Consistency_in_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.22228)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/36580.png)
...
## 206. GenBreak: Red Teaming Text-to-Image Generation Using Large Language Models

> 🇯🇵 **GenBreak: 大規模言語モデルを用いたテキスト・トゥ・イメージ生成のレッドティーミング**

> 💡 LLMを微調整し、回避性と有害性を両立させる対抗的プロンプトを生成してT2Iモデルの脆弱性を体系的に評価する。

**著者:** Zilong Wang, Xiang Zheng, Xiaosen Wang, Bo Wang, Xingjun Ma

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_GenBreak_Red_Teaming_Text-to-Image_Generation_Using_Large_Language_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2506.10047)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/38385.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Agrawal_SeeThrough3D_Occlusion_Aware_3D_Control_in_Text-to-Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.23359) | [🌐 Project](https://seethrough3d.github.io)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37488.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://seethrough3d.github.io" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 208. Do Less, Achieve More: Do We Need Every-Step Optimization for RL Fine-tuning of Diffusion Models?

> 🇯🇵 **より少なく、より多くを達成する: 拡散モデルのRL微調整に毎ステップ最適化は必要か?**

> 💡 拡散モデルのRL微調整においてすべてのステップの最適化が不要であることを示す、効率的な最適化手法。

**著者:** Renye Yan, Jikang Cheng, Shikun Sun, Yi Sun, You Wu, Wei Peng, Zongwei Wang, Ling Liang, Junliang Xing, Yimao Cai

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yan_Do_Less_Achieve_More_Do_We_Need_Every-Step_Optimization_for_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2605.15855)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/38980.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Huang_Diffusion_Probe_Generated_Image_Result_Prediction_Using_CNN_Probes_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.23783)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/36762.png)
...
## 210. Iris: Bringing Real-World Priors into Diffusion Model for Monocular Depth Estimation

> 🇯🇵 **実世界事前分布をビデオ拡散に統合単眼深度推定**

> 💡 実世界事前分布と拡散モデルで、正確な単眼深度推定を実現する。

**著者:** Xinhao Cai, Gensheng Pei, Zeren Sun, Yazhou Yao, Fumin Shen, Wenguan Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Cai_Iris_Bringing_Real-World_Priors_into_Diffusion_Model_for_Monocular_Depth_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.16340)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/36725.png)
...
> 🇯🇵 **RenderFlow：フロー・マッチングによるシングルステップニューラルレンダリング**

> 💡 流れマッチングに基づいた決定的なニューラルレンダリングフレームワークにより、拡散モデルの遅延と確率性を排除し、物理ベースレンダリングと生成モデルの効率性を融合させる。

**著者:** Shenghao Zhang, Runtao Liu, Christopher Schroers, Yang Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_RenderFlow_Single-Step_Neural_Rendering_via_Flow_Matching_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.06928)

**Session:** Poster Session 6


![Poster](posters/image_generation/37132.png)
...
## 212. ChordEdit: One-Step Low-Energy Transport for Image Editing

> 🇯🇵 **コードエディット：画像編集のための1ステップ低エネルギー輸送**

> 💡 1ステップ低エネルギー輸送で画像編集実現

**著者:** Liangsi Lu, Xuhang Chen, Minzhe Guo, Shichu Li, Jingchao Wang, Yang Shi

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://chordedit.github.io/)
...
## 213. Graph-Guided Online Concept Erasure for Text-to-Image Diffusion Models

> 🇯🇵 **グラフ誘導オンライン概念削除：テキスト・ツー・イメージ拡散モデル向け**

> 💡 意味グラフの動的構築と多ホップトラバーサルによる適応的概念除去で、訓練不要で有害・著作権保護対象概念を除去し非関連概念を保存する手法。

**著者:** Ning Han, Zhenyu Ge, Feng Han, Yuhua Sun, Chengqing Li, Jingjing Chen

**Links:** [📄 Paper](https://cvpr.thecvf.com/virtual/2026/poster/37993)

**Session:** Poster Session 6


![Poster](posters/image_generation/37993.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yu_PixelDiT_Pixel_Diffusion_Transformers_for_Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.20645)
...
## 215. EgoX: Egocentric Video Generation from a Single Exocentric Video

> 🇯🇵 **単一外心動画からの自己中心動画生成**

> 💡 1つの外心視点動画から、対応する自己中心視点動画を生成する新手法を提案する。

**著者:** Taewoong Kang, Kinam Kim, Dohyeon Kim, Minho Park, Junha Hyung, Jaegul Choo

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kang_EgoX_Egocentric_Video_Generation_from_a_Single_Exocentric_Video_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.08269)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Cong_SDUIE_Semi-Supervised_Diffusion_for_Underwater_Image_Enhancement_with_Quant-Text_Dual_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/image_generation/36218.png)
...
## 217. UniGen-1.5: Enhancing Image Generation and Editing through Reward Unification in RL

> 🇯🇵 **報酬統一強化学習による画像生成編集向上**

> 💡 報酬統一フレームワークで、生成と編集の両タスクを改善する。
...
![Poster](posters/image_generation/36567.png)
...
## 218. SAIDO: Generalizable Detection of AI-Generated Images via Scene-Aware and Importance-Guided Dynamic Optimization in Continual Learning

> 🇯🇵 **SAIDO：シーン対応と重要度ガイド動的最適化によるAI画像検出**

> 💡 シーン情報を活用したAI画像検出で連続学習に対応。

**著者:** Yongkang Hu, Yu Cheng, YuShuo Zhang, Yuan Xie, Zhaoxia Yin

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Hu_SAIDO_Generalizable_Detection_of_AI-Generated_Images_via_Scene-Aware_and_Importance-Guided_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.00539)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/38458.png)
...
## 219. Parallel Jacobi Decoding for Fast Autoregressive Image Generation

> 🇯🇵 **並列ヤコビデコーディングによる自己回帰画像生成の高速化**

> 💡 2次元空間並列化で自己回帰画像生成を4.8～6.4倍高速化し品質維持。

**著者:** Boya Liao, Ying Li, Siyong Jian, Huan Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liao_Parallel_Jacobi_Decoding_for_Fast_Autoregressive_Image_Generation_CVPR_2026_paper.html)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/36927.png)
...
## 220. AniMimic: Imitating 3D Animation from Video Priors
...
## 221. Guiding Diffusion Models with Semantically Degraded Conditions

> 🇯🇵 **意味的に劣化した条件による拡散モデルの誘導**

> 💡 ヌルプロンプトの代わりに戦略的に劣化させた条件を用いてクラシファイア不要ガイダンスを改善し、複合的な生成タスクの精度を向上させる。

**著者:** shilong han, Yuming Zhang, Hongxia Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Han_Guiding_Diffusion_Models_with_Semantically_Degraded_Conditions_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.10780)

**Session:** Poster Session 6


![Poster](posters/image_generation/36375.png)
...
## 222. Infinity-RoPE: Action-Controllable Infinite Video Generation Emerges From Autoregressive Self-Rollout

> 🇯🇵 **Infinity-RoPE: 自己ロールアウトから生まれるアクション制御可能な無限動画生成**

> 💡 RoPE拡張とKV更新により長時間で映画的な動画生成と動作制御を実現

**著者:** Hidir Yesiltepe, Tuna Han Salih Meral, Adil Kaan Akan, Kaan Oktay, Pinar Yanardag

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yesiltepe_Infinity-RoPE_Action-Controllable_Infinite_Video_Generation_Emerges_From_Autoregressive_Self-Rollout_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.20649)

**Session:** Poster Session 6


![Poster](posters/video_generation/37370.png)
...
![Poster](posters/image_generation/37558.png)


**Abstract:** Text-to-image (T2I) models are increasingly popular, producing a large share of AI-generated images online. To compare their quality, voting-based leaderboards have become the standard, relying on anonymized model outputs for fairness. In this work, we show that such anonymity can be easily broken. We find that generations from each T2I model form distinctive clusters in the image embedding space, enabling accurate deanonymization without prompt control or training data. Using 22 models and 280 prompts (150K images), our centroid-based method achieves high accuracy and reveals systematic model-specific signatures. We further introduce a prompt-level distinguishability metric and conduct large-scale analyses showing how certain prompts amplify these signatures. Our findings expose fundamental security risks in T2I leaderboards and motivate stronger anonymization defenses.


---

## 224. Denoising as Path Planning: Training-Free Acceleration of Diffusion Models with DPCache

> 🇯🇵 **ノイズ除去をパス計画として：DPCacheによる拡散モデルの訓練フリー加速**

> 💡 拡散モデルのサンプリング加速を経路計画問題として定式化し、動的計画法で最適な時間ステップ列を選択して高速化を実現する手法を提案している。

**著者:** Bowen Cui, Yuanbin Wang, Huajiang Xu, Biaolong Chen, Aixi Zhang, Hao Jiang, Zhengzheng Jin, Xu Liu, Pipei Huang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Cui_Denoising_as_Path_Planning_Training-Free_Acceleration_of_Diffusion_Models_with_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.22654)

**Session:** Poster Session 6


![Poster](posters/image_generation/36824.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Cai_LESA_Learnable_Stage-Aware_Predictors_for_Diffusion_Model_Acceleration_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.20497)

**Session:** Poster Session 6


![Poster](posters/image_generation/37272.png)
...
## 226. MusicInfuser: Making Video Diffusion Listen and Dance

> 🇯🇵 **MusicInfuser: Video Diffusionに音楽を聴かせて踊らせる**

> 💡 既存T2Vを少コスト適応し音楽同期した多様なダンス動画を生成

**著者:** Susung Hong, Ira Kemelmacher-Shlizerman, Brian Curless, Steve M. Seitz

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Hong_MusicInfuser_Making_Video_Diffusion_Listen_and_Dance_CVPR_2026_paper.html) | [🌐 Project](https://susunghong.github.io/MusicInfuser/)

**Session:** Poster Session 6


![Poster](posters/video_generation/36463.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://susunghong.github.io/MusicInfuser/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 227. When Safety Collides: Resolving Multi-Category Harmful Conflicts in Text-to-Image Diffusion via Adaptive Safety Guidance

> 🇯🇵 **安全性が衝突するとき: 適応的安全ガイダンスによるText-to-Image Diffusionの多カテゴリ有害競合の解決**

> 💡 有害カテゴリ間の競合を動的に判別し安全誘導を最適化して危険生成を抑える

**著者:** Yongli Xiang, Ziming Hong, Zhaoqing Wang, Xiangyu Zhao, Bo Han, Tongliang Liu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xiang_When_Safety_Collides_Resolving_Multi-Category_Harmful_Conflicts_in_Text-to-Image_Diffusion_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.20880)
...
## 228. Test-Time Alignment of Text-to-Image Diffusion Models via Null-Text Embedding Optimisation

> 🇯🇵 **ヌルテキスト埋込最適化によるテキスト画像拡散モデルのテスト時調整**

> 💡 クラシファイア不要ガイダンスの無条件埋込を最適化してテスト時調整を行い、意味空間での安定した報酬ハッキング耐性を実現する。

**著者:** Taehoon Kim, Henry Gouk, Timothy Hospedales

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kim_Test-Time_Alignment_of_Text-to-Image_Diffusion_Models_via_Null-Text_Embedding_Optimisation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.20889)

**Session:** Poster Session 6


![Poster](posters/image_generation/39436.png)
...
## 229. BAgger: Backwards Aggregation for Mitigating Drift in Autoregressive Video Diffusion Models

> 🇯🇵 **自動回帰ビデオ拡散での逆向き集約によるドリフト緩和**

> 💡 逆向き集約機構で自動回帰生成モデルの誤差蓄積を軽減し、品質を向上させる。

**著者:** Ryan Po, Eric Ryan Chan, Changan Chen, Gordon Wetzstein

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Po_BAgger_Backwards_Aggregation_for_Mitigating_Drift_in_Autoregressive_Video_Diffusion_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.12080)
...
## 230. GraspLDP: Towards Generalizable Grasping Policy via Latent Diffusion

> 🇯🇵 **潜在拡散による汎化可能つかみ把握政策学習**

> 💡 拡散モデルで把握政策の汎化能力を向上させる。

**著者:** Enda Xiang, Haoxiang Ma, Xinzhu Ma, Zicheng Liu, Di Huang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xiang_GraspLDP_Towards_Generalizable_Grasping_Policy_via_Latent_Diffusion_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.22862)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/38094.png)
...
## 233. EchoVDiff: Cardiac-Cycle Echocardiography Video Generation from Arbitrary Frame

> 🇯🇵 **任意フレームからの心臓周期心エコー動画生成**

> 💡 位相認識拡散モデルで心臓周期の生理学的周期性と空間意味論を分離表現し、任意フレームから完全な心周期再構成を実現した。

**著者:** Jiansong Zhang, Xiaying Yang, Xiaoling Luo, Linlin Shen

**Links:** [📄 Paper](https://cvpr.thecvf.com/virtual/2026/poster/38146)
...
## 235. A Style is Worth One Code: Unlocking Code-to-Style Image Generation with Discrete Style Space

> 🇯🇵 **スタイルは1つのコード価値：離散スタイル空間によるコード-スタイル画像生成**

> 💡 離散スタイル空間でコード-スタイル画像生成

**著者:** Huijie Liu, Shuhao Cui, Haoxiang Cao, Shuai Ma, Kai Wu, Guoliang Kang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference)

**Session:** Oral Session 1A: Multimodal Vision
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kwon_Reviving_ConvNeXt_for_Efficient_Convolutional_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.09408) | [🌐 Project](https://github.com/star-kwon/FCDM)

**Session:** Poster Session 6


![Poster](posters/image_generation/40226.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/star-kwon/FCDM" width="100%" height="600" loading="lazy" style="border:none;"></iframe>

</details>


**Abstract:** Recent diffusion models increasingly favor Transformer backbones, motivated by the remarkable scalability of fully attentional architectures.Yet the locality bias, parameter efficiency, and hardware friendliness—the attributes that established ConvNets as the efficient vision backbone—have seen limited exploration in modern generative modeling. Here we introduce the fully convolutional diffusion model (FCDM), a ConvNeXt-inspired backbone redesigned for conditional diffusion modeling. We find that FCDM-XL, using only 50$\%$ of the FLOPs of DiT-XL/2, achieves comparable performance while delivering 7$\times$ and 7.5$\times$ speedups at 256$\times$256 and 512$\times$512 resolutions, respectively. Remarkably, FCDM-XL can be trained on a 4-GPU system, highlighting the exceptional training efficiency of our architecture. Our results demonstrate that modern convolutional designs provide a competitive and highly efficient alternative for scaling diffusion models, reviving ConvNeXt as a simple yet powerful building block for efficient generative modeling.


---

## 237. MR. Illuminate: Zero-Shot Low-Light Image Enhancement with Diffusion Prior

> 🇯🇵 **拡散事前知識を利用したゼロショット低光度画像強調（MR. Illuminate）**

> 💡 適応的正規化と自己注意で、最適化不要な低光画像強調と自動ホワイトバランス調整を実現。

**著者:** Joshua Cho, Sara Aghajanzadeh, Zhen Zhu, David Forsyth

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Cho_MR._Illuminate_Zero-Shot_Low-Light_Image_Enhancement_with_Diffusion_Prior_CVPR_2026_paper.html)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/38742.png)


**Abstract:** The primary axes of interest in low-light image enhancement (LLIE) are color constancy—ensuring consistent outputs across inputs of the same scene under varying illumination and noise—and generalization across diverse datasets. Existing methods, whether supervised, unsupervised, or zero-shot, rely on auxiliary loss functions and empirically selected hyperparameters, which yield strong results on the datasets used for evaluation but often exhibit limited generalization. To overcome these constraints, we propose MR. Illuminate (pronounced "Mister Illuminate"), the first deep learning-based solution for LLIE that requires no optimization and no degradation assumption. "MR." emphasizes our Modulate–Refine design: global illuminance and color are modulated via Adaptive Instance Normalization (AdaIN), while local structure and color are refined through self-attention features within a pre-trained diffusion model, taking a unique approach from prior methods. Extensive quantitative evaluations show that our approach surpasses SOTA methods on standard LLIE benchmarks, while qualitative results demonstrate improved color fidelity. Moreover, without any modification to our framework, our method achieves competitive results on the auto white balance (AWB) task, underscoring its strong generalization capability.


---

## 238. Adapter Shield: A Unified Framework with Built-in Authentication for Preventing Unauthorized Zero-Shot Image-to-Image Generation
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_CogniEdit_Dense_Gradient_Flow_Optimization_for_Fine-Grained_Image_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.13276)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/37308.png)
...
## 240. FG-Portrait: 3D Flow Guided Editable Portrait Animation
...
## 241. Text-Driven 3D Hand Motion Generation from Sign Language Data

> 🇯🇵 **手話データからのテキスト駆動3D手動作生成**

> 💡 手話映像とLLM記述から汎化性の高いテキスト条件3D手動作生成器を学習

**著者:** Léore Bensabath, Mathis Petrovich, Gul Varol

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Bensabath_Text-Driven_3D_Hand_Motion_Generation_from_Sign_Language_Data_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2508.15902)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/37021.png)
...
## 242. SliderEdit: Continuous Image Editing with Fine-Grained Instruction Control

> 🇯🇵 **スライダーエディット：細粒度指示制御による連続画像編集**
...
## 243. Beyond Pixel Simulation: Pathology Image Generation via Diagnostic Semantic Tokens and Prototype Control

> 🇯🇵 **ピクセルシミュレーションを超えて：診断意味的トークンとプロトタイプ制御による病理画像生成**

> 💡 診断概念を明示的にトークン化し、プロトタイプベースの形態学制御を導入した意味駆動型フレームワークで、忠実な病理画像の制御可能な生成を実現する。

**著者:** Minghao Han, Yichen Liu, Yizhou Liu, Zizhi Chen, Jingqun Tang, Xuecheng Wu, Dingkang Yang, Lihua Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Han_Beyond_Pixel_Simulation_Pathology_Image_Generation_via_Diagnostic_Semantic_Tokens_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.21058)

**Session:** Poster Session 6


![Poster](posters/image_generation/37248.png)
...
## 244. Attention Surgery: An Efficient Recipe to Linearize Your Video Diffusion Transformer

> 🇯🇵 **拡散モデルを用いた生成型学習の高度な手法**

> 💡 拡散モデルの効率性と品質を向上させる新しい最適化手法を提案した。

**著者:** Mohsen Ghafoorian, Denis Korzhenkov, Amir Habibian

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ghafoorian_Attention_Surgery_An_Efficient_Recipe_to_Linearize_Your_Video_Diffusion_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2509.24899) | [🌐 Project](https://qualcomm-ai-research.github.io/attention-surgery/)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/36615.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://qualcomm-ai-research.github.io/attention-surgery/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 245. GDPO-SR: Group Direct Preference Optimization for One-Step Generative Image Super-Resolution

> 🇯🇵 **ワンステップ生成画像超解像のグループ直接選好最適化（GDPO-SR）**

> 💡 強化学習をワンステップ生成超解像に統合するGDPO法、局所領域を考慮した報酬関数設計。

**著者:** Qiaosi Yi, Shuai Li, Rongyuan Wu, Lingchen Sun, Zhengqiang ZHANG, Lei Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yi_GDPO-SR_Group_Direct_Preference_Optimization_for_One-Step_Generative_Image_Super-Resolution_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.16769)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/39624.png)
...
## 246. Beyond Ground-Truth: Leveraging Image Quality Priors for Real-World Image Restoration

> 🇯🇵 **画像品質事前分布を活用した現実世界画像復元**

> 💡 画像品質事前分布を利用し、現実世界の複雑な劣化条件下での高品質画像復元を実現する。

**著者:** Fengyang Xiao, Peng Hu, Lei Xu, XingE Guo, Guanyi Qin, Yuqi Shen, Chengyu Fang, Rihan Zhang, Chunming He, Sina Farsiu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xiao_Beyond_Ground-Truth_Leveraging_Image_Quality_Priors_for_Real-World_Image_Restoration_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.29773)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/39184.png)
...
## 247. SmokeSVD: Smoke Reconstruction from A Single View via Progressive Novel View Synthesis and Refinement with Diffusion Models

> 🇯🇵 **スモークSVD：段階的新規視点合成と拡散モデルによる煙再構成**

> 💡 段階的新規視点合成で煙を単一視点から再構成

**著者:** Chen Li, Shanshan Dong, Sheng Qiu, Jianmin Han, Yibo Zhao, Zan Gao, Taku Komura, Kemeng Huang
...
## 248. Towards Human-Imperceptible Backdoor Attacks on Text-to-Image Diffusion Models

> 🇯🇵 **テキスト・トゥ・イメージ拡散モデルに対する人間知覚不可能なバックドア攻撃の実現に向けて**

> 💡 テキスト・トゥ・イメージ生成モデルに対する新しいバックドア攻撃手法を提案し、特定のトリガーを埋め込むことで有害な画像生成を実現する仕組みを実証しました。

**著者:** Changkun Wu, Chenghao Chen, Wu kun, Chong Fu, Biru Zhu, Zhenyu Wen, Zhen Hong
...
## 250. MagicQuill V2: Precise and Interactive Image Editing with Layered Visual Cues

> 🇯🇵 **MagicQuill V2: 層化視覚手掛かりによる精密で対話的な画像編集**

> 💡 層化視覚手掛かりを用いた直感的インターフェースで精密な画像編集を実現。
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liu_MagicQuill_V2_Precise_and_Interactive_Image_Editing_with_Layered_Visual_CVPR_2026_paper.html)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/38140.png)
...
> 🇯🇵 **メリット：マルチドメイン効率的RAW画像翻訳**

> 💡 複数ドメインで効率的なRAW画像翻訳

**著者:** Wenjun Huang, Shenghao Fu, Yian Jin, Yang Ni, Ziteng Cui, Hanning Chen, Yirui He, Yezi Liu, Sanggeon Yun, SungHeon Jeong, Ryozo Masukawa, William Youngwoo Chung, Mohsen Imani
...
## 252. Prototype-Guided Concept Erasure in Diffusion Models

> 🇯🇵 **拡散モデルにおけるプロトタイプ誘導概念消去**

> 💡 プロトタイプ表現を活用し、拡散モデルから特定の概念を効果的に消去しながら全体の生成品質を保持。

**著者:** Yuze Cai, Jiahao Lu, Hongxiang Shi, Yichao Zhou, Hong Lu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Cai_Prototype-Guided_Concept_Erasure_in_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.08271)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/36673.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_Disentangling_to_Re-couple_Resolving_the_Similarity-Controllability_Paradox_in_Subject-Driven_Text-to-Image_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.00849)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/40053.png)
...
## 255. A Debiased Reconstruction-based Framework for Training-Free Detection of AI-Generated Images

> 🇯🇵 **非バイアス再構成フレームワークによるAI生成画像の訓練不要検出**

> 💡 バイアスのない再構成でAI生成画像を訓練なしで検出。

**著者:** Sungik Choi, Hankook Lee, Jaehoon Lee, Robin Kim, Stanley Jungkyu Choi, Moontae Lee

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Choi_A_Debiased_Reconstruction-based_Framework_for_Training-Free_Detection_of_AI-Generated_Images_CVPR_2026_paper.html)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/39565.png)
...
## 256. DMGD: Train-Free Dataset Distillation with Semantic-Distribution Matching in Diffusion Models

> 🇯🇵 **DMGD：拡散モデルのセマンティック分布整合による訓練不要データセット蒸留**

> 💡 訓練不要なデータセット蒸留で効率化。

**著者:** Qichao Wang, Yunhong Lu, Hengyuan Cao, Junyi Zhang, Min Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_DMGD_Train-Free_Dataset_Distillation_with_Semantic-Distribution_Matching_in_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2605.03877)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/36526.png)
...
## 257. From Scale to Speed: Adaptive Test-Time Scaling for Image Editing

> 🇯🇵 **規模から速度へ: 画像編集のための適応的テスト時スケーリング**

> 💡 テスト時に適応的にスケーリングすることで、画像編集の計算効率と品質のバランスを実現。

**著者:** Xiangyan Qu, Zhenlong Yuan, Jing Tang, Rui Chen, Datao Tang, Meng Yu, Lei Sun, Yancheng Bai, Xiangxiang Chu, Gaopeng Gou, Gang Xiong, Yujun Cai

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Qu_From_Scale_to_Speed_Adaptive_Test-Time_Scaling_for_Image_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.00141)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liu_Streaming_Diffusion_Model_for_Fast_Infrared_and_Visible_Video_Fusion_CVPR_2026_paper.html)
...
## 259. VINS-120K: Ultra High-Resolution Image Editing with A Large-Scale Dataset

> 🇯🇵 **VINS-120K: 大規模データセットによる超高解像度画像編集**

> 💡 4K超画像編集向け12万件データセットと高周波適応法で細部品質を向上

**著者:** Zhizhou Chen, Shanyan Guan, Zhanxin Gao, En Ci, Yanhao Ge, Wei Li, Zhenyu Zhang, Jian Yang, Ying Tai

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chen_VINS-120K_Ultra_High-Resolution_Image_Editing_with_A_Large-Scale_Dataset_CVPR_2026_paper.html)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/38513.png)
...
## 260. Hidden Dangers of Compositional Generation: Diagnosing Semantic Safety Failures in Text-to-Image Models

> 🇯🇵 **合成的生成における隠れた危険性：テキスト画像生成モデルのセマンティック安全性障害の診断**

> 💡 テキスト画像生成モデルの安全フィルタを回避する新しい攻撃法CoRA、複数概念の合成で有害画像を生成可能。

**著者:** Haoming Yang, Ke Ma, ligonf zhang, Xiaojun Jia, Yingfei Sun, Qianqian Xu, Qingming Huang
...
## 262. CoLoGen: Progressive Learning of Concept–Localization Duality for Unified Image Generation

> 🇯🇵 **CoLoGen: 統一画像生成のための概念・局在双対性の漸進的学習**

> 💡 概念理解と位置表現の衝突を段階学習で統合する統一画像拡散生成法

**著者:** YuXin Song, Yu Lu, Haoyuan Sun, Huanjin Yao, Fanglong Liu, Yifan Sun, Haocheng Feng, Hang Zhou, Jingdong Wang

**Links:** [📄 Paper](https://cvpr.thecvf.com/virtual/2026/poster/36642)
...
## 263. All-in-One Slider for Attribute Manipulation in Diffusion Models

> 🇯🇵 **拡散モデルにおける属性操作の統一的スライダー**

> 💡 単一の統一的インターフェースで複数の属性を自在に操作可能な拡散モデルのスライダー機構。

**著者:** Weixin Ye, Hongguang Zhu, Wei Wang, Yahui Liu, Mengyu Wang, Xuecheng Nie

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ye_All-in-One_Slider_for_Attribute_Manipulation_in_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2508.19195)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/37198.png)
...
## 264. DreamShot: Personalized Storyboard Synthesis with Video Diffusion Prior

> 🇯🇵 **DreamShot: 個人化ストーリーボード合成**

> 💡 個人写真からストーリー化: 個人の写真を入力として自動的に一貫したストーリー動画を生成

**著者:** Junjia Huang, Binbin Yang, Pengxiang Yan, Jiyang Liu, Bin Xia, Zhao Wang, Yitong Wang, Liang Lin, Guanbin Li

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Huang_DreamShot_Personalized_Storyboard_Synthesis_with_Video_Diffusion_Prior_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.17195)

**Session:** Poster Session 6


![Poster](posters/video_generation/38197.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Bradbury_Your_Latent_Mask_is_Wrong_Pixel-Equivalent_Latent_Compositing_for_Diffusion_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.05198)
...
## 266. RegionRoute: Regional Style Transfer with Diffusion Model
...
## 267. EditMGT: Unleashing Potentials of Masked Generative Transformers in Image Editing
...
## 268. HDW-SR: High-Frequency Guided Diffusion Model based on Wavelet Decomposition for Image Super-Resolution

> 🇯🇵 **ウェーブレット分解高周波誘導拡散画像超解像**

> 💡 ウェーブレット分解で高周波成分を抽出し、画像超解像を改善する。

**著者:** Chao Yang, Boqian Zhang, Jinghao Xu, Guang Jiang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yang_HDW-SR_High-Frequency_Guided_Diffusion_Model_based_on_Wavelet_Decomposition_for_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.13175)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/39527.png)
...
## 269. TINA: Text-Free Inversion Attack for Unlearned Text-to-Image Diffusion Models

> 🇯🇵 **テキスト生成画像拡散モデルへのテキスト不要反転攻撃**

> 💡 テキスト情報なしで拡散モデルへの反転攻撃を実現する脆弱性を暴露する。

**著者:** Qianlong Xiang, Miao Zhang, Haoyu Zhang, Kun Wang, Junhui Hou, Liqiang Nie

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xiang_TINA_Text-Free_Inversion_Attack_for_Unlearned_Text-to-Image_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.17828)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/38100.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Oh_OSPO_Object-Centric_Self-Improving_Preference_Optimization_for_Text-to-Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2506.02015)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/38550.png)
...
## 273. UniDef: Universal Defense Against Unauthorized Image Manipulation

> 🇯🇵 **ユニデフ：不正な画像操作に対する普遍的防御**

> 💡 不正な画像操作から汎用的に防御

**著者:** Mingwen Shao, Lingzhuang Meng, Xiang Lv, Mengyao Wu, Xinyuan Chen, Qiao Zhang, Chang Liu, Yuanjian Qiao, Chao Dong
...
## 274. Premier: Personalized Preference Modulation with Learnable User Embedding in Text-to-Image Generation

> 🇯🇵 **学習可能ユーザ埋め込みテキスト画像生成の個人化選好変調**

> 💡 ユーザ埋め込みで個人化された画像生成を実現する。

**著者:** Zihao Wang, Yuxiang Wei, Xinpeng Zhou, Tianyu Zhang, Tao Liang, Yalong Bai, Hongzhi Zhang, Wangmeng Zuo

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Premier_Personalized_Preference_Modulation_with_Learnable_User_Embedding_in_Text-to-Image_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.20725) | [🌐 Project](https://github.com/120L020904/Premier)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/37526.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/120L020904/Premier" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 275. Hybrid Agents for Image Restoration

> 🇯🇵 **画像復元のためのハイブリッド・エージェント**

> 💡 複数の専門的エージェントの協調によって多様な画像復元タスクに対応する統一的フレームワーク。

**著者:** Bingchen Li, Xin Li, Yiting Lu, Zhibo Chen

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_Hybrid_Agents_for_Image_Restoration_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2503.10120)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/38816.png)
...
## 276. Less is More: Data-Efficient Adaptation for Controllable Text-to-Video Generation

> 🇯🇵 **テキスト・トゥ・ビデオ生成のための効率的な適応制御学習**

> 💡 テキスト指定のビデオ生成において、物理カメラパラメータなどの制御を学習するために、データ効率的な微調整戦略を提案し、低品質合成データでも高品質データより優れた結果を達成した。

**著者:** Shihan Cheng, Nilesh Kulkarni, David Hyde, Dmitriy Smirnov

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Cheng_Less_is_More_Data-Efficient_Adaptation_for_Controllable_Text-to-Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.17844)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/39312.png)
...
## 277. See and Fix the Flaws: Enabling VLMs and Diffusion Models to Comprehend Visual Artifacts via Agentic Data Synthesis

> 🇯🇵 **欠陥認識視覚修正：VLM拡散モデルのエージェンティック合成データ**

> 💡 エージェンティック合成でVLMと拡散モデルが視覚的欠陥を理解・修正できる。

**著者:** Jaehyun Park, Minyoung Ahn, Minkyu Kim, Jonghyun Lee, Jae-Gil Lee, Dongmin Park

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Park_See_and_Fix_the_Flaws_Enabling_VLMs_and_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.20951) | [🌐 Project](https://cabbalett.github.io/publications/ArtiAgent/)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/38333.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://cabbalett.github.io/publications/ArtiAgent/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Dai_BiFM_Bidirectional_Flow_Matching_for_Few-Step_Image_Editing_and_Generation_CVPR_2026_paper.html)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/36632.png)
...
## 279. Cross-modal Representation Learning for Diffusion-generated Image Detection

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Tao Gong, Dayong Wang, Qi Chu, Bin Liu, Nenghai Yu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Gong_Cross-modal_Representation_Learning_for_Diffusion-generated_Image_Detection_CVPR_2026_paper.html)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/37096.png)
...
## 280. Mind the Generative Details: Direct Localized Detail Preference Optimization for Video Diffusion Models

> 🇯🇵 **生成モデルによる高品質コンテンツ生成手法**

> 💡 生成的対抗ネットワークを用いて、より現実的で多様なコンテンツ生成を実現する新しいアプローチを提案した。

**著者:** Zitong Huang, Kaidong Zhang, Yukang Ding, Chao Gao, Rui Ding, Ying Chen, Wangmeng Zuo

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Huang_Mind_the_Generative_Details_Direct_Localized_Detail_Preference_Optimization_for_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.04068)
...
## 281. Scone: Bridging Composition and Distinction in Subject-Driven Image Generation via Unified Understanding-Generation Modeling

> 🇯🇵 **Scone：統一理解生成モデルによる主体駆動画像生成の構成と区別**

> 💡 統一モデルで主体駆動画像生成の質を向上。

**著者:** Yuran Wang, Bohan Zeng, Chengzhuo Tong, Wenxuan Liu, Yang Shi, Xiaochen Ma, Hao Liang, Yuanxing Zhang, Wentao Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Scone_Bridging_Composition_and_Distinction_in_Subject-Driven_Image_Generation_via_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.12675) | [🌐 Project](https://github.com/Ryann-Ran/Scone)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/36776.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/Ryann-Ran/Scone" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 284. WiseEdit: Benchmarking Cognition- and Creativity-Informed Image Editing
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Pan_WiseEdit_Benchmarking_Cognition-_and_Creativity-Informed_Image_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.00387)
...
## 285. Content-Aware Dynamic Patchification for Efficient Video Diffusion

> 🇯🇵 **内容認識動的パッチ化による効率的ビデオ拡散**

> 💡 画像の重要度に応じた動的パッチ分割で、ビデオ拡散モデルの計算効率を大幅に向上させる。

**著者:** Sheng Li, Connelly Barnes, Mamshad Nayeem Rizve, Hongwu Peng, Zhengang Li, Ohi Dibua, Alireza Ganjdanesh, Xulong Tang, Yan Kang, Yifan Gong

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_Content-Aware_Dynamic_Patchification_for_Efficient_Video_Diffusion_CVPR_2026_paper.html)
...
**Links:** [📄 Paper](https://cvpr.thecvf.com/virtual/2026/poster/36240)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Jia_CompBench_Benchmarking_Complex_Instruction-guided_Image_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2505.12200)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/38519.png)
...
## 288. PixelRush: Ultra-Fast, Training-Free High-Resolution Image Generation via One-step Diffusion

> 🇯🇵 **超高速無学習単一ステップ拡散高解像度画像生成**

> 💡 学習不要な単一ステップで、超高速な高解像度画像生成を実現する。

**著者:** Hong-Phuc Lai, Phong Nguyen, Anh Tran

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lai_PixelRush_Ultra-Fast_Training-Free_High-Resolution_Image_Generation_via_One-step_Diffusion_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.12769)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/37825.png)
...
## 289. ShiftLUT: Spatial Shift Enhanced Look-Up Tables for Efficient Image Restoration

> 🇯🇵 **空間シフト強化ルックアップテーブル効率的画像復元**

> 💡 空間シフト処理で効率的なルックアップテーブル画像復元を実現する。

**著者:** ZENG XIAOLONG, Yitong Yu, Shiyao Xiong, Jinhua Hao, Ming Sun, Chao Zhou, Bin Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zeng_ShiftLUT_Spatial_Shift_Enhanced_Look-Up_Tables_for_Efficient_Image_Restoration_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.00906)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/37871.png)
...
## 290. MotionEnhancer: Leveraging Video Diffusion for Motion-Enhanced Vision-Language Models

> 🇯🇵 **動画拡散モデルを用いた動作強化ビジョン言語モデル**

> 💡 動画拡散モデルから抽出した動作先験知識で、ビジョン言語モデルの動作理解能力を訓練パラメータ追加なしで向上させた。

**著者:** Yifan Xu, Chao Zhang, Ruifei Ma, Fei Gao, Zhifei Yang, Jiaxing Qi, Zhipeng Chen

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xu_MotionEnhancer_Leveraging_Video_Diffusion_for_Motion-Enhanced_Vision-Language_Models_CVPR_2026_paper.html)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/37872.png)
...
## 291. Taming Sampling Perturbations with Variance Expansion Loss for Latent Diffusion Models

> 🇯🇵 **分散拡張損失によるレイテント拡散モデルのサンプリング擾乱への耐性の向上**

> 💡 レイテント空間の過度なコンパクト化がサンプリング擾乱への感度を高めることを指摘し、分散拡張損失で耐性を改善する手法を提案する。

**著者:** Qifan Li, Xingyu Zhou, Jinhua Zhang, Weiyi You, Shuhang Gu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_Taming_Sampling_Perturbations_with_Variance_Expansion_Loss_for_Latent_Diffusion_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.21085) | [🌐 Project](https://github.com/CVL-UESTC/VE-Loss)

**Session:** Poster Session 6


![Poster](posters/image_generation/40090.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/CVL-UESTC/VE-Loss" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 292. FlowFM: Advancing Dark Optical Flow Estimation with Flow Matching

> 🇯🇵 **FlowFM：フロー整合による暗い光学フロー推定の進展**

> 💡 フロー整合で暗い環境での光学フロー推定を改善。

**著者:** Fengyuan Zuo, Haiyan Jin, Yuanlin Zhang, Zhaolin Xiao, Bin Wang, Yuerong Mu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zuo_FlowFM_Advancing_Dark_Optical_Flow_Estimation_with_Flow_Matching_CVPR_2026_paper.html)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/36838.png)
...
## 293. ChangeBridge: Spatiotemporal Image Generation with Multimodal Controls for Remote Senisng

> 🇯🇵 **マルチモーダル制御リモートセンシング時空間画像生成**

> 💡 マルチモーダル条件で、リモートセンシング画像の時空間変化を生成する。

**著者:** Zhenghui Zhao, Chen Wu, Xiangyong Cao, Di Wang, Hongruixuan Chen, Datao Tang, Liangpei Zhang, Zhuo Zheng

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhao_ChangeBridge_Spatiotemporal_Image_Generation_with_Multimodal_Controls_for_Remote_Senisng_CVPR_2026_paper.html)
...
## 294. Towards Fine-Grained Attribution: Instance-Aware Preference Optimization for Aligning Diffusion Models

> 🇯🇵 **微粒度帰属へ向けて：拡散モデル整列のためのインスタンス認識選好最適化**

> 💡 領域レベルの選好ラベルで重み付きマスクを導入することで、画像全体ではなくインスタンス単位の細粒度な人間選好整列を実現する効率的な最適化手法。

**著者:** Jiayang Sun, Pin Wang, Hongbo Wang, Xinyue Liu, Huaibo Huang, Ran He
...
![Poster](posters/image_generation/39035.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Qi_A_Difference-in-Difference_Approach_to_Detecting_AI-Generated_Images_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.23732)

**Session:** Poster Session 6


![Poster](posters/image_generation/38744.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Bai_UniEdit-I_Training-free_Image_Editing_for_Unified_VLM_via_Iterative_Understanding_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2508.03142)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/36435.png)
...
## 297. WaDi: Weight Direction-aware Distillation for One-step Image Synthesis

> 🇯🇵 **WaDi：重み方向対応蒸留による一段階画像合成**

> 💡 重み方向を活用した蒸留で一段階画像合成を実現。

**著者:** Lei Wang, Yang Cheng, Senmao Li, Ge Wu, Yaxing Wang, Jian Yang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_WaDi_Weight_Direction-aware_Distillation_for_One-step_Image_Synthesis_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.08258) | [🌐 Project](https://gudaochangsheng.github.io/WaDi-Page/)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/39112.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://gudaochangsheng.github.io/WaDi-Page/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 298. Linear Image Generation by Synthesizing Exposure Brackets

> 🇯🇵 **露出ブラケット合成による線形画像生成**

> 💡 高ダイナミック・レンジの線形画像を複数の露出ブラケットに分解して段階的に生成するDiTベースのフロー・マッチング。

**著者:** Yuekun Dai, Zhoutong Zhang, Shangchen Zhou, Nanxuan Zhao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Dai_Linear_Image_Generation_by_Synthesizing_Exposure_Brackets_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.21008) | [🌐 Project](https://ykdai.github.io/projects/raw_gen)
...
<iframe src="https://ykdai.github.io/projects/raw_gen" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 299. Resolving the Identity Crisis in Text-to-Image Generation

> 🇯🇵 **テキスト画像生成におけるアイデンティティ危機の解決**

> 💡 多人物画像の顔の重複や同一性の混同を強化学習で最適化し、画像内・サンプル間の同一性多様性を確保する手法を提案する。

**著者:** Shubhankar Borse, Farzad Farhadzadeh, Munawar Hayat, Fatih Porikli

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Borse_Resolving_the_Identity_Crisis_in_Text-to-Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.01399) | [🌐 Project](https://qualcomm-ai-research.github.io/disco/)

**Session:** Poster Session 6


![Poster](posters/image_generation/38166.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://qualcomm-ai-research.github.io/disco/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 300. SketchRevive: Fine-Grained Pixel-to-Vector Sketch Completion with Diffusion-Prior-Guided Multimodal LLMs
...
## 301. DeCo: Frequency-Decoupled Pixel Diffusion for End-to-End Image Generation

> 🇯🇵 **DeCo：終端間画像生成のための周波数分離画素拡散**

> 💡 高低周波成分の分離生成により、画素拡散での訓練推論速度を向上させながら、潜在拡散と同等の高品質画像生成を実現する効率的フレームワーク。

**著者:** Zehong Ma, Longhui Wei, Shuai Wang, Shiliang Zhang, Qi Tian

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ma_DeCo_Frequency-Decoupled_Pixel_Diffusion_for_End-to-End_Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.19365)
...
## 302. Multi-Patch Global-to-Local Transformer Architecture For Efficient Flow Matching and Diffusion Model

> 🇯🇵 **効率的フローマッチングと拡散モデルのための多パッチグローバル・ローカル変換器アーキテクチャ**

> 💡 初期段では大きなパッチで全体文脈を捉え後期段では小パッチで局所詳細を処理し、計算量を50%削減しながら生成性能を維持する。

**著者:** Minh Quan Dao, Dimitris Metaxas

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Dao_Multi-Patch_Global-to-Local_Transformer_Architecture_For_Efficient_Flow_Matching_and_Diffusion_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.26357) | [🌐 Project](https://quandao10.github.io/MPDiT/)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/37715.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://quandao10.github.io/MPDiT/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 303. Dynamic Exposure Burst Image Restoration

> 🇯🇵 **動的露光バースト画像復元**

> 💡 撮影環境に応じて露光時間を最適化しバースト画像復元を高精度化

**著者:** Woohyeok Kim, Jaesung Rim, Daeyeon Kim, Sunghyun Cho

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kim_Dynamic_Exposure_Burst_Image_Restoration_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.21784)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/36232.png)
...
## 304. Head-wise Adaptive Rotary Positional Encoding for Fine-Grained Image Generation

> 🇯🇵 **細粒度画像生成のための頭部適応回転位置符号化**

> 💡 頭部ごとの適応的位置符号化で、細粒度な画像生成を実現する。

**著者:** Li jiaye, Baoyou Chen, Hui Li, Zilong Dong, Jingdong Wang, Siyu Zhu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_Head-wise_Adaptive_Rotary_Positional_Encoding_for_Fine-Grained_Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.10489)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37260.png)


**Abstract:** Transformers rely on explicit positional encoding to model structure in data. WhileRotary Position Embedding (RoPE) excels in 1D domains, its application to im_x0002_age generation reveals significant limitations such as fine-grained spatial relationmodeling, color cues, and object counting. This paper identifies key limitationsof standard multi-dimensional RoPE—rigid frequency allocation, axis-wise inde_x0002_pendence, and uniform head treatment—in capturing the complex structural biasesrequired for fine-grained image generation. We propose HARoPE, a head-wiseadaptive extension that inserts a learnable linear transformation parameterized viasingular value decomposition (SVD) before the rotary mapping. This lightweightmodification enables dynamic frequency reallocation, semantic alignment of rotaryplanes, and head-specific positional receptive fields while rigorously preservingRoPE’s relative-position property. Extensive experiments on class-conditional Ima_x0002_geNet and text-to-image generation (Flux and MMDiT) demonstrate that HARoPEconsistently improves performance over strong RoPE baselines and other exten_x0002_sions. The method serves as an effective drop-in replacement, offering a principledand adaptable solution for enhancing positional awareness in transformer-basedimage generative models.


---

## 305. Latent Diffusion Inversion Requires Understanding the Latent Space

> 🇯🇵 **レイテント拡散反転は潜在空間の理解を必要とする**

> 💡 レイテント空間でのメモ化分析から、デコーダ距離計測に基づいて潜在次元をランク付けして会員推論攻撃を改善する手法を提案する。

**著者:** Mingxing Rao, Bowen Qu, Daniel Moyer

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Rao_Latent_Diffusion_Inversion_Requires_Understanding_the_Latent_Space_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.20592)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/37487.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Luo_DMAligner_Enhancing_Image_Alignment_via_Diffusion_Model_Based_View_Synthesis_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.23022) | [🌐 Project](https://github.com/boomluo02/DMAligner)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/39505.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/boomluo02/DMAligner" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 307. ReasonEdit: Towards Reasoning-Enhanced Image Editing Models

> 🇯🇵 **ReasonEdit: 推理機能強化型画像編集モデルへ向けて**

> 💡 推理機能を統合した画像編集モデルで、より複雑な意図的編集タスクに対応。

**著者:** Fukun Yin, Shiyu Liu, Yucheng Han, Zhibo Wang, Peng Xing, Rui Wang, Wei Cheng, Yingming Wang, Aojie Li, Zixin Yin, Pengtao Chen, Xianfang Zeng, Gang Yu, Daxin Jiang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yin_ReasonEdit_Towards_Reasoning-Enhanced_Image_Editing_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.22625)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xu_Event-Illumination_Collaborative_Low-light_Image_Enhancement_with_a_High-resolution_Real-world_Dataset_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2605.22186)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/36609.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Bai_DRiffusion_Draft-and-Refine_Process_Parallelizes_Diffusion_Models_with_Ease_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.25872)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Sakai_InvAD_Inversion-based_Reconstruction-Free_Anomaly_Detection_with_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2504.05662) | [🌐 Project](https://invad-project.com)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/38900.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://invad-project.com" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 311. Kontinuous Kontext: Continuous Strength Control for Instruction-based Image Editing
...
## 312. DiT360: High-Fidelity Panoramic Image Generation via Hybrid Training

> 🇯🇵 **ハイブリッド学習によるパノラマ画像高忠実度生成**

> 💡 ハイブリッド学習アプローチで360°パノラマ画像の高忠実度生成を実現する。

**著者:** Haoran Feng, Dizhe Zhang, Xiangtai Li, Bo Du, Lu Qi

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Feng_DiT360_High-Fidelity_Panoramic_Image_Generation_via_Hybrid_Training_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.11712)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/38258.png)
...
## 313. FlashVSR: Towards Real-time Diffusion-Based Streaming Video Super Resolution

> 🇯🇵 **高速拡散ベースストリーミングビデオ超解像**

> 💡 リアルタイム処理対応の拡散ベース手法で、ストリーミング条件下でも高速なビデオ超解像を実現する。

**著者:** Junhao Zhuang, Shi Guo, Xin Cai, Xiaohui Li, Yihao Liu, Chun Yuan, Tianfan Xue

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhuang_FlashVSR_Towards_Real-time_Diffusion-Based_Streaming_Video_Super_Resolution_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.12747) | [🌐 Project](https://zhuang2002.github.io/FlashVSR/)

**Session:** Poster Session 6


![Poster](posters/video_generation/38690.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://zhuang2002.github.io/FlashVSR/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>

</details>


**Abstract:** Diffusion models have recently advanced video restoration, but applying them to real-world and AIGC-generated video super-resolution (VSR) remains challenging due to high latency, prohibitive computation, and poor generalization to ultra-high resolutions. Our goal in this work is to make diffusion-based VSR practical by achieving efficiency, scalability, and near real-time performance. To this end, we propose **FlashVSR**, the first diffusion-based one-step streaming framework for efficient video super-resolution. FlashVSR runs at approximately 17 FPS for 768×1408 videos on a single A100 GPU by combining three complementary innovations: (i) a train-friendly three-stage distillation pipeline that enables streaming super-resolution, (ii) locality-constrained sparse attention that reduces redundant computation while bridging the train–test resolution gap, and (iii) a tiny conditional decoder that accelerates reconstruction without sacrificing quality. To support large-scale training, we also construct **VSR-120K**, a new dataset containing 120K videos and 180K images. Extensive experiments demonstrate that FlashVSR scales reliably to ultra-high resolutions and achieves state-of-the-art performance with up to approximately 12× speed-up over prior one-step diffusion-based VSR models. We will release the code, pretrained models, and dataset to foster future research in efficient diffusion-based video super-resolution.


---

## 314. WeMMU: Enhanced Bridging of Vision-Language Models and Diffusion Models via Noisy Query Tokens

> 🇯🇵 **WeMMU: ノイズクエリトークンによる視覚言語モデルと拡散モデルの橋渡しの強化**

> 💡 ノイズクエリトークンを導入して、視覚言語モデルと拡散モデル間の効果的な相互作用を実現。

**著者:** Jian Yang, Dacheng Yin, Xiaoxuan He, Yong Li, Fengyun Rao, Jing LYU, Wei Zhai, Yang Cao, Zheng-Jun Zha

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yang_WeMMU_Enhanced_Bridging_of_Vision-Language_Models_and_Diffusion_Models_via_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.02536)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/39097.png)
...
## 315. Diverse Video Generation with Determinantal Point Process-Guided Policy Optimization

> 🇯🇵 **Determinantal Point Process誘導ポリシー最適化による多様な動画生成**

> 💡 DPPとGRPOで単一プロンプトから多様な動画群を生成する枠組み

**著者:** Tahira Kazimi, Connor Dunlop, Pinar Yanardag

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kazimi_Diverse_Video_Generation_with_Determinantal_Point_Process-Guided_Policy_Optimization_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.20647) | [🌐 Project](https://diverse-video.github.io/)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/36959.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://diverse-video.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 316. PLACID: Identity-Preserving Multi-Object Compositing via Video Diffusion with Synthetic Trajectories

> 🇯🇵 **合成軌跡による同一性保持マルチオブジェクト合成**

> 💡 拡散モデルと合成軌跡で、複数物体の同一性を保持した動画合成を実現する。

**著者:** Gemma Canet Tarrés, Manel Baradad, Francesc Moreno-Noguer, Yumeng Li

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Tarres_PLACID_Identity-Preserving_Multi-Object_Compositing_via_Video_Diffusion_with_Synthetic_Trajectories_CVPR_2026_paper.html) | [🌐 Project](https://gemmact.github.io/placid/)

**Session:** Poster Session 6


![Poster](posters/video_generation/39480.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://gemmact.github.io/placid/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 317. MMDIR: Multimodal Instruction-Driven Framework for Mixed-Degradation Document Image Restoration

> 🇯🇵 **MMDIR：混合劣化文書画像復元のマルチモーダル指示駆動フレームワーク**

> 💡 マルチモーダル指示駆動で複雑な文書画像を復元。

**著者:** Heng Li, Xingyuan Wang, Yang Fan, Yunan Zhang, Xiangping Wu, Qingcai Chen

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_MMDIR_Multimodal_Instruction-Driven_Framework_for_Mixed-Degradation_Document_Image_Restoration_CVPR_2026_paper.html)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/38350.png)
...
## 318. ActionMesh: Animated 3D Mesh Generation with Temporal 3D Diffusion
...
> 🇯🇵 **ジャービスエボ：相乗的最適化による自己進化写真編集エージェント**

> 💡 相乗的最適化で自己進化する写真編集エージェント
...
## 320. MoCoDiff: A Controllable Autoregressive Diffusion Model for Expressive Motion Generation
...
![Poster](posters/image_generation/39762.png)
...
## 322. MICON-Bench: Benchmarking and Enhancing Multi-Image Context Image Generation in Unified Multimodal Models

> 🇯🇵 **MICON-Bench：統一マルチモーダルモデルのマルチ画像文脈画像生成ベンチマーク**

> 💡 マルチ画像文脈でマルチモーダルモデルをベンチマーク。

**著者:** Mingrui Wu, Hang Liu, Jiayi Ji, Xiaoshuai Sun, Rongrong Ji

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wu_MICON-Bench_Benchmarking_and_Enhancing_Multi-Image_Context_Image_Generation_in_Unified_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.19497)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/37387.png)
...
## 323. Restore, Assess, Repeat: A Unified Framework for Iterative Image Restoration

> 🇯🇵 **Restore, Assess, Repeat: 反復的画像復元のための統一フレームワーク**

> 💡 品質評価と復元を潜在空間で統合し未知複合劣化画像を反復改善する

**著者:** I-Hsiang (Aaron) Chen, Isma Hadji, Enrique Sanchez, Adrian Bulat, Sy-Yen Kuo, Radu Timofte, Georgios Tzimiropoulos, Brais Martinez

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chen_Restore_Assess_Repeat_A_Unified_Framework_for_Iterative_Image_Restoration_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.26385)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/39838.png)
...
## 324. Re-Align: Structured Reasoning-guided Alignment for In-Context Image Generation and Editing

> 🇯🇵 **構造化推論ガイドによるコンテキスト画像生成編集の整列（Re-Align）**

> 💡 思考連鎖による構造化推論と強化学習で、複雑な指示の画像生成編集を改善。
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/He_Re-Align_Structured_Reasoning-guided_Alignment_for_In-Context_Image_Generation_and_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.05124)
...
## 325. Selectively Extracting and Injecting Visual Attributes into Text-to-Image Models

> 🇯🇵 **テキスト・トゥ・イメージ・モデルへの視覚属性の選別的抽出と注入**

> 💡 属性を選別的に抽出・操作して、T2Iモデルへの効果的な属性制御と概念編集を実現。

**著者:** Seunghwan Choi, Jooyeol Yun, Youngdo Lee, Jaegul Choo

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Choi_Selectively_Extracting_and_Injecting_Visual_Attributes_into_Text-to-Image_Models_CVPR_2026_paper.html)
...
## 326. FlowDC: Flow-Based Decoupling-Decay for Complex Image Editing

> 🇯🇵 **フロー基盤結合減衰複雑画像編集**

> 💡 フロー理論に基づく結合減衰メカニズムで複雑な画像編集を実現する。

**著者:** Yilei Jiang, Zhen Wang, Yanghao Wang, Jun Yu, Yueting Zhuang, Jun Xiao, Long Chen

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Jiang_FlowDC_Flow-Based_Decoupling-Decay_for_Complex_Image_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.11395)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/39701.png)
...
## 327. VideoCoF: Unified Video Editing with Temporal Reasoner

> 🇯🇵 **時間推論器を用いた統一ビデオ編集**

> 💡 統一的な時間推論機構でテキスト・マスク・動作など多様なビデオ編集タスクを実現する。

**著者:** xiangpeng yang, Ji Xie, Yiyuan Yang, Yue Ma, Yan Huang, Min Xu, Qiang Wu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yang_VideoCoF_Unified_Video_Editing_with_Temporal_Reasoner_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.07469)

**Session:** Poster Session 6


![Poster](posters/video_generation/39507.png)
...
## 328. Vision Foundation Models Can Be Good Tokenizers for Latent Diffusion Models

> 🇯🇵 **視覚基盤モデルは潜在拡散モデルの優れたトークナイザーになり得る**

> 💡 蒸留ではなく凍結された視覚基盤モデルを直接活用する新型デコーダ設計により、効率的で高忠実度な遅延拡散モデルのトークン化を実現する。

**著者:** Tianci Bi, Xiaoyi Zhang, Yan Lu, Nanning Zheng

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Bi_Vision_Foundation_Models_Can_Be_Good_Tokenizers_for_Latent_Diffusion_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.18457)

**Session:** Poster Session 6


![Poster](posters/image_generation/40032.png)
...
## 329. Leveraging Verifier-Based Reinforcement Learning in Image Editing

> 🇯🇵 **検証者基盤強化学習活用画像編集**

> 💡 検証機構を含む強化学習で高品質な画像編集を実現する。

**著者:** Hanzhong Guo, Jie Wu, Jie Liu, Yu Gao, Zilyu Ye, Linxiao Yuan, Xionghui Wang, Yizhou Yu, Weilin Huang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Guo_Leveraging_Verifier-Based_Reinforcement_Learning_in_Image_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.27505)
...
## 330. StreamDiT: Real-Time Streaming Text-to-Video Generation

> 🇯🇵 **StreamDiT: リアルタイムストリーミングテキスト動画生成**

> 💡 低遅延リアルタイム生成: ストリーミング処理で高速なテキスト動画生成を実時間実現

**著者:** Akio Kodaira, Tingbo Hou, Ji Hou, Markos Georgopoulos, Felix Juefei-Xu, Masayoshi Tomizuka, Yue Zhao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kodaira_StreamDiT_Real-Time_Streaming_Text-to-Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2507.03745)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/40044.png)
...
## 331. Aligning Multi-Character Narrative Image Generation with Multi-Aspect Human Preferences

> 🇯🇵 **マルチキャラクター物語画像生成とマルチアスペクト人間選好の整列**

> 💡 複数キャラクターと人間選好をマルチアスペクトで整列させた生成を実現する。

**著者:** Ziyi Gao, Zhipeng Wei, Jingjing Chen, Stewart Tan, Hao li, Yi-Ping Phoebe Chen
...
![Poster](posters/image_generation/39993.png)
...
## 332. STCDiT: Spatio-Temporally Consistent Diffusion Transformer for High-Quality Video Super-Resolution

> 🇯🇵 **時空間一貫性拡散トランスによる高品質ビデオ超解像**

> 💡 空間時間的一貫性を保証するトランスで、高品質ビデオ超解像を実現する。

**著者:** Junyang Chen, Jiangxin Dong, Long Sun, Yixin Yang, Jinshan Pan

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chen_STCDiT_Spatio-Temporally_Consistent_Diffusion_Transformer_for_High-Quality_Video_Super-Resolution_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.18786)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Alzayer_Coupled_Diffusion_Sampling_for_Training-Free_Multi-View_Image_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.14981) | [🌐 Project](https://coupled-diffusion.github.io)

**Session:** Poster Session 6


![Poster](posters/image_generation/38199.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://coupled-diffusion.github.io" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 334. Scan Clusters, Not Pixels: A Cluster-Centric Paradigm for Efficient Ultra-high-definition Image Restoration

> 🇯🇵 **画素ではなくクラスタを走査せよ: 効率的な超高精細画像復元のためのクラスタ中心パラダイム**

> 💡 クラスタ中心走査でUHD画像復元の計算量を大幅削減し性能も向上

**著者:** Chen Wu, Ling Wang, Zhuoran Zheng, Yuning Cui, Zhixiong Yang, Xiangyu Chen, Yue Zhang, Weidong Jiang, Jingyuan Xia

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wu_Scan_Clusters_Not_Pixels_A_Cluster-Centric_Paradigm_for_Efficient_Ultra-high-definition_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.21917)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/39422.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chu_VisionDirector_Vision-Language_Guided_Closed-Loop_Refinement_for_Generative_Image_Synthesis_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.19243)
...
## 341. When Pretty Isn’t Useful: Investigating Why Modern Text-to-Image Models Fail as Reliable Training Data Generators

> 🇯🇵 **テキスト画像モデルが信頼できる訓練データ生成器として機能しない理由の調査**

> 💡 最新のテキスト画像モデルが美観中心の狭い分布に崩壊し、合成データとしての有用性が実際のテストセットで低下することを実証する。

**著者:** Krzysztof Adamkiewicz, Brian B. Moser, Stanislav Frolov, Tobias Christian Nauen, Federico Raue, Andreas Dengel

**Links:** [📄 Paper](https://cvpr.thecvf.com/virtual/2026/poster/37721)

**Session:** Poster Session 6


![Poster](posters/image_generation/37721.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chung_SeaCache_Spectral-Evolution-Aware_Cache_for_Accelerating_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.18993)
...
## 343. RAPID: Reusing Attention Sparsity with Inter-step Adaptation for Efficient Video Diffusion

> 🇯🇵 **注意機構を用いた高度な特徴学習フレームワーク**

> 💡 注意機構を活用して、モデルの判断根拠を可視化し、より正確な予測性能を実現する手法を提案した。

**著者:** Shangran Lin, Lu Lu, Jian Chen, Qiang Liu
...
![Poster](posters/video_generation/38522.png)
...
## 344. LLaDA-MedV: Exploring Large Language Diffusion Models for Biomedical Image Understanding

> 🇯🇵 **LLaDA-MedV: 医用画像理解のための大規模言語拡散モデルの探索**

> 💡 大規模言語拡散モデルを医用画像解析に適用し、言語理解と画像処理を統合。

**著者:** XUANZHAO DONG, Wenhui Zhu, Xiwen Chen, Zhipeng Wang, Peijie Qiu, Shao Tang, Xin Li, Yalin Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Dong_LLaDA-MedV_Exploring_Large_Language_Diffusion_Models_for_Biomedical_Image_Understanding_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2508.01617)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/38975.png)
...
## 345. NAMI: Efficient Image Generation via Bridged Progressive Rectified Flow Transformers

> 🇯🇵 **橋接プログレッシブ整流フロートランスフォーマー効率的画像生成**

> 💡 階層的フロー処理で効率的な画像生成を実現する。

**著者:** Yuhang Ma, Bo Cheng, Shanyuan Liu, Hongyi Zhou, Liebucha Wu, Dawei Leng, Yuhui Yin

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ma_NAMI_Efficient_Image_Generation_via_Bridged_Progressive_Rectified_Flow_Transformers_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2503.09242)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/38287.png)
...
## 346. Landscape-Awareness for Geometric View Diffusion Model

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Yan-Ting Chen, Hao-Wei Chen, Tsu-Ching Hsiao, Chun-Yi Lee

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chen_Landscape-Awareness_for_Geometric_View_Diffusion_Model_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2605.19865)

**Session:** Poster Session 6


![Poster](posters/image_generation/38334.png)
...
## 347. Image Generation from Contextually-Contradictory Prompts

> 🇯🇵 **文脈矛盾プロンプトからの画像生成**

> 💡 プロンプト分解フレームワークと大規模言語モデルで文脈矛盾を検出・解決し、拡散段階に適応したプロキシプロンプトで精密な意味制御を実現する。

**著者:** Saar Huberman, Or Patashnik, Omer Dahary, Ron Mokady, Daniel Cohen-Or

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Huberman_Image_Generation_from_Contextually-Contradictory_Prompts_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2506.01929)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/38239.png)
...
## 348. Elucidating the Design Space of Arbitrary-Noise-Based Diffusion Models

> 🇯🇵 **任意ノイズベース拡散モデル設計空間の詳細解析**

> 💡 任意ノイズ条件での拡散モデル設計の自由度を解析する。

**著者:** Xingyu Qiu, Mengying Yang, Xinghua Ma, Dong Liang, Fanding Li, Gongning Luo, wei wang, Kuanquan Wang, Shuo Li

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Qiu_Elucidating_the_Design_Space_of_Arbitrary-Noise-Based_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2507.18534)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/37063.png)
...
## 349. FRAMER: Frequency-Aligned Self-Distillation with Adaptive Modulation Leveraging Diffusion Priors for Real-World Image Super-Resolution

> 🇯🇵 **周波数整列自己蒸留適応変調拡散事前分布活用画像超解像**

> 💡 周波数整列と拡散事前分布で、現実世界画像の高品質超解像を実現する。

**著者:** Seungho Choi, Jeahun Sung, Jihyong Oh

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Choi_FRAMER_Frequency-Aligned_Self-Distillation_with_Adaptive_Modulation_Leveraging_Diffusion_Priors_for_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.01390)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Image_Diffusion_Preview_with_Consistency_Solver_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.13592) | [🌐 Project](https://g-u-n.github.io/projects/consolver/)

**Session:** Poster Session 6


![Poster](posters/image_generation/39634.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://g-u-n.github.io/projects/consolver/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 351. Causal Motion Diffusion Models for Autoregressive Motion Generation

> 🇯🇵 **自己回帰動作生成のための因果Motion Diffusion Models**

> 💡 因果VAEと拡散Transformerで高速な長期人体動作生成を実現

**著者:** Qing Yu, Akihisa Watanabe, Kent Fujiwara

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yu_Causal_Motion_Diffusion_Models_for_Autoregressive_Motion_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.22594) | [🌐 Project](https://yu1ut.com/CMDM-HP/)

**Session:** Poster Session 6


![Poster](posters/video_generation/36884.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://yu1ut.com/CMDM-HP/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Qiu_ImageRAGTurbo_Towards_One-step_Text-to-Image_Generation_with_Retrieval-Augmented_Diffusion_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.12640)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/image_generation/38676.png)
...
## 353. SmokeSVD: Smoke Reconstruction from A Single View via Progressive Novel View Synthesis and Refinement with Diffusion Models

> 🇯🇵 **動画拡散モデルによる単一視点からの煙再構成（SmokeSVD）**

> 💡 拡散モデルと物理的一貫性最適化を組み合わせた、単一ビデオからの動的流体煙の効率的な再構成。

**著者:** Chen Li, Shanshan Dong, Sheng Qiu, Jianmin Han, Yibo Zhao, Zan Gao, Taku Komura, Kemeng Huang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_SmokeSVD_Smoke_Reconstruction_from_A_Single_View_via_Progressive_Novel_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2507.12156)

**Session:** Oral Session 2D: Spatio-Temporal Reconstruction
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kim_HalluGen_Synthesizing_Realistic_and_Controllable_Hallucinations_for_Evaluating_Image_Restoration_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.03345)
...
## 355. PureCC: Pure Learning for Text-to-Image Concept Customization

> 🇯🇵 **PureCC：テキスト画像変換の純粋学習型概念カスタマイズ**

> 💡 純粋学習型でテキスト画像変換の概念をカスタマイズ。

**著者:** Zhichao Liao, Xiaole Xian, Qingyu Li, Wenyu Qin, Meng Wang, Weicheng Xie, Siyang Song, Pingfa Feng, Long ZENG, Liang Pan

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liao_PureCC_Pure_Learning_for_Text-to-Image_Concept_Customization_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.07561) | [🌐 Project](https://github.com/lzc-sg/PureCC)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/36347.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/lzc-sg/PureCC" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Butt_GenColorBench_A_Color_Evaluation_Benchmark_for_Text-to-Image_Generation_CVPR_2026_paper.html)
...
## 359. Low-Rank Residual Diffusion Models

> 🇯🇵 **低ランク残差拡散モデル**

> 💡 低ランク残差構造で拡散モデルを効率化する。

**著者:** Junfu Tan, Jiang Yuan

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Tan_Low-Rank_Residual_Diffusion_Models_CVPR_2026_paper.html)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/39473.png)
...
## 360. UniPercept: A Unified Diffusion Model for Generalizable Visual Perception

> 🇯🇵 **UniPercept：汎用視覚知覚のための統一拡散モデル**

> 💡 基盤・アダプター構造で多様な知覚タスク間の共通知識を学習し、僅少データとパラメータ数で新規タスクへの効率的適応を実現する汎用知覚フレームワーク。

**著者:** Zuyan Zhao, Zhenliang He, Meina Kan, Shiguang Shan, Xilin Chen

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhao_UniPercept_A_Unified_Diffusion_Model_for_Generalizable_Visual_Perception_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/image_generation/36647.png)
...
## 361. Guiding a Diffusion Model by Swapping Its Tokens

> 🇯🇵 **トークン交換による拡散モデルのガイディング**

> 💡 トークン交換によって拡散モデルをガイディング
...
## 362. EMR-Diff: Edge-aware Multimodal Residual Diffusion Model for Hyperspectral Image Super-resolution

> 🇯🇵 **エッジ認識マルチモーダル残差拡散ハイパースペクトル超解像**

> 💡 エッジ情報を保持したマルチモーダル残差拡散で、ハイパースペクトル画像超解像を実現する。

**著者:** Tao Zhang, Shengtao Yao, Rong Zeng, Zunjie Zhu, Bolun Zheng, Yaoqi Sun, Ying Fu, Chenggang Yan

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_EMR-Diff_Edge-aware_Multimodal_Residual_Diffusion_Model_for_Hyperspectral_Image_Super-resolution_CVPR_2026_paper.html) | [🌐 Project](https://github.com/luocz55/EMR-Diff)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/36782.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/luocz55/EMR-Diff" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 363. JANUS: A Lightweight Framework for Jailbreaking Text-to-Image Models via Distribution Optimization

> 🇯🇵 **JANUS: 分布最適化によるテキスト・トゥ・イメージ・モデルのジェイルブレイク用軽量フレームワーク**

> 💡 T2Iモデルに対して、黒箱で構造化プロンプト分布を最適化することで効率的なジェイルブレイク攻撃を実現するフレームワーク。

**著者:** Haolun Zheng, Yu He, Tailun Chen, Shuo Shao, Zhixuan Chu, Hongbin zhou, Lan Tao, Zhan Qin, Kui Ren

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zheng_JANUS_A_Lightweight_Framework_for_Jailbreaking_Text-to-Image_Models_via_Distribution_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.21208)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/37882.png)
...
## 364. When Understanding Becomes a Risk: Authenticity and Safety Risks in the Emerging Image Generation Paradigm
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Leng_When_Understanding_Becomes_a_Risk_Authenticity_and_Safety_Risks_in_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.24079)

**Session:** Poster Session 6


![Poster](posters/image_generation/38599.png)
...
## 365. Where Culture Fades: Revealing the Cultural Gap in Text-to-Image Generation

> 🇯🇵 **文化が薄れる場所: テキストから画像生成における文化的ギャップの解明**

> 💡 多言語T2Iの文化表現欠落を解析し文化活性化戦略で一貫性を改善する
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Shi_Where_Culture_Fades_Revealing_the_Cultural_Gap_in_Text-to-Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.17282)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/image_generation/36797.png)
...
## 366. UniLDiff: Unlocking the Power of Diffusion Priors for All-in-One Image Restoration

> 🇯🇵 **[需要な翻訳]**

> 💡 [需要なまとめ]

**著者:** Zihan Cheng, Liangtai Zhou, Dian Chen, Ni Tang, Xiaotong Luo, Yuan Xie, Yanyun Qu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Cheng_UniLDiff_Unlocking_the_Power_of_Diffusion_Priors_for_All-in-One_Image_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2507.23685)

**Session:** Poster Session 6


![Poster](posters/image_generation/38761.png)
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ren_Frequency-Aware_Flow_Matching_for_High-Quality_Image_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.15521)
...
## 368. BulletTime: Decoupled Control of Time and Camera Pose for Video Generation

> 🇯🇵 **BulletTime: 時間とカメラ制御の分離型動画生成**

> 💡 時間とカメラの独立制御: 時間進行とカメラ動きを独立して制御することで高度な表現効果を実現
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_BulletTime_Decoupled_Control_of_Time_and_Camera_Pose_for_Video_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.05076)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/37809.png)
...
## 369. StableMTL: Repurposing Latent Diffusion Models for Multi-Task Learning from Partially Annotated Synthetic Datasets
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Cao_StableMTL_Repurposing_Latent_Diffusion_Models_for_Multi-Task_Learning_from_Partially_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2506.08013)

**Session:** Poster Session 6


![Poster](posters/image_generation/38387.png)


**Abstract:** Multi-task learning for dense prediction is limited by the need for extensive annotation for every task, although recent works have explored training with partial task labels.Leveraging the generalization power of diffusion models, we extend the partial learning setup to a zero-shot setting, training a multi-task model on multiple synthetic datasets, each labeled for only a subset of tasks. Our method, StableMTL, repurposes an image generator for latent regression. Adapting a denoising framework with task encoding, task conditioning and a tailored training scheme. Instead of per-task losses requiring careful balancing, a unified latent loss is adopted, enabling seamless scaling to more tasks. To encourage inter-task synergy, we introduce a multi-stream model with a task-attention mechanism that converts N-to-N task interactions into efficient N-to-one attention, promoting effective cross-task sharing. StableMTL outperforms baselines on 7 tasks across 8 benchmarks.


---

## 370. Causality in Video Diffusers is Separable from Denoising

> 🇯🇵 **動画Diffuserにおける因果性はdenoisingから分離可能である**

> 💡 時間因果推論と各フレーム描画を分離して動画拡散生成全体を高速化

**著者:** Xingjian Bai, Guande He, Zhengqi Li, Eli Shechtman, Xun Huang, Zongze Wu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Bai_Causality_in_Video_Diffusers_is_Separable_from_Denoising_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.10095)
...
## 371. Diff4Splat: Repurposing Video Diffusion Models for Dynamic Scene Generation

> 🇯🇵 **動画拡散モデルを用いた動的シーン生成**

> 💡 動画拡散モデルを4D幾何制約と統合し、単一画像と軌跡から高速に3Dガウスシーンを生成する手法を提案した。

**著者:** Panwang Pan, Chenguo Lin, Chenxin Li, Jingjing Zhao, Yuchen Lin, Haopeng Li, yunlong lin, Kairun Wen, Yixuan Yuan, Yadong Mu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Pan_Diff4Splat_Repurposing_Video_Diffusion_Models_for_Dynamic_Scene_Generation_CVPR_2026_paper.html)
...
## 374. CubeComposer: Spatio-Temporal Autoregressive 4K 360° Video Generation from Perspective Video

> 🇯🇵 **立方体合成：透視ビデオからの時空間自動回帰4K 360°ビデオ生成**

> 💡 360°ビデオの立方体表現と時空間自動回帰モデルで、4K解像度での高品質360°ビデオ生成を実現する。

**著者:** Lingen Li, Guangzhi Wang, Xiaoyu Li, Zhaoyang Zhang, Qi Dou, Jinwei Gu, Tianfan Xue, Ying Shan

**Links:** [📄 Paper](https://cvpr.thecvf.com/virtual/2026/poster/38446) | [🌐 Project](https://lg-li.github.io/project/cubecomposer)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/38446.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://lg-li.github.io/project/cubecomposer" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 375. STARFlow-V: End-to-End Video Generative Modeling with Autoregressive Normalizing Flows

> 🇯🇵 **自己回帰正規化フローによるエンドツーエンドビデオ生成**

> 💡 正規化フロー基盤モデルでエンドツーエンド学習と因果推定を実現し、拡散モデルの誤差蓄積を軽減する。
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Gu_STARFlow-V_End-to-End_Video_Generative_Modeling_with_Autoregressive_Normalizing_Flows_CVPR_2026_paper.html)
...
## 376. A Self-Conditioned Representation Guided Diffusion Model for Realistic Text-to-LiDAR Scene Generation

> 🇯🇵 **自己条件付き表現ガイド拡散モデルによる現実的テキストLiDARシーン生成**

> 💡 自己条件付けでリアルなLiDARシーン生成。

**著者:** Wentao Qu, Guofeng Mei, Yang Wu, Yongshun Gong, Xiaoshui Huang, Liang Xiao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Qu_A_Self-Conditioned_Representation_Guided_Diffusion_Model_for_Realistic_Text-to-LiDAR_Scene_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.19004) | [🌐 Project](https://github.com/QWTforGithub/T2LDM)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/image_generation/36863.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/QWTforGithub/T2LDM" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 377. Guiding Diffusion Models with Fine-Grained Conditions and Semantics-Preserving Sampling for One-Shot Federated Learning

> 🇯🇵 **細粒度条件意味保持サンプリングワンショット連合学習拡散誘導**

> 💡 細粒度条件と意味保持で連合学習での拡散モデル性能を向上させる。

**著者:** Xiaojun Deng, Tianchi Liao, Zhiyuan Liu, Chuan Chen, Zibin Zheng

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Deng_Guiding_Diffusion_Models_with_Fine-Grained_Conditions_and_Semantics-Preserving_Sampling_for_CVPR_2026_paper.html)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/image_generation/38770.png)
...
## 378. LacTokGen: Latent Consistency Tokenizer for 1024-pixel Image Generation by 256 Tokens

> 🇯🇵 **潜在一貫性トークン化1024ピクセル256トークン画像生成**

> 💡 効率的トークン化で、高解像度画像の低トークン数での生成を実現する。

**著者:** Qingsong Xie, Luyuan Zhang, Zhao Zhang, Siyuan Li, Zhe Huang, Zhenyu Yang, Haonan Lu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xie_LacTokGen_Latent_Consistency_Tokenizer_for_1024-pixel_Image_Generation_by_256_CVPR_2026_paper.html)
