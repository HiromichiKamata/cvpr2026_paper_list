...
**Total: 220 papers** | Poster: 163 | Project page: 44 | 和訳済み: 220
...
## 2. Hierarchical Enhancement of Semantic Priors for Disentangled Text-Driven Motion Generation

> 🇯🇵 **非絡み化テキスト駆動モーション生成のための階層的意味先験の強化**

> 💡 テキストから人間モーションを生成する際に、段階的な意味先験強化と適応的クロスモーダル推論を統合し、解釈可能で制御可能なモーション表現を実現した。

**著者:** Wenhan Lv, Shaopan Wang, Xiangyu Wu, Tianchu Hang, Zhongquan Jian, Qingqiang Wu
...
![Poster](posters/video_generation/38424.png)
...
## 3. DeltaQuant: 4-bit Video Diffusion Models with Spatiotemporal Delta Smoothing
...
## 4. PAM: A Pose–Appearance–Motion Engine for Sim-to-Real HOI Video Generation
...
## 5. HVG-3D: Bridging Real and Simulation Domains for 3D-Conditional Hand-Object Interaction Video Synthesis
...
## 6. Open-world Hand-Object Interaction Video Generation Based on Structure and Contact-aware Representation
...
## 7. EgoEdit: Dataset, Real-Time Streaming Model, and Benchmark for Egocentric Video Editing
...
## 8. Inference-time Physics Alignment of Video Generative Models with Latent World Models
...
## 9. SMRABooth: Subject and Motion Representation Alignment for Customized Video Generation
...
## 11. PyramidalWan: On Making Pretrained Video Model Pyramidal for Efficient Inference
...
## 12. OneStory: Coherent Multi-Shot Video Generation with Adaptive Memory
...
## 13. MultiShotMaster: A Controllable Multi-Shot Video Generation Framework
...
## 14. Training-free Detection of Generated Videos via Spatial-Temporal Likelihoods
...
## 15. DUO-VSR: Dual-Stream Distillation for One-Step Video Super-Resolution
...
## 16. VSRELL: A Simple Baseline for Video Super-Resolution and Enhancement in Low-Light Environment
...
## 17. Next-Scale Autoregressive Models for Text-to-Motion Generation

> 🇯🇵 **次世代自己回帰モデルによるテキスト・動作生成**

> 💡 テキストから複雑な動作生成: 自己回帰モデルでテキスト記述から人間の複雑で自然な動作パターンを自動生成

**著者:** Zhiwei Zheng, Shibo Jin, Lingjie Liu, Mingmin Zhao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zheng_Next-Scale_Autoregressive_Models_for_Text-to-Motion_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.03799)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/37205.png)
...
## 18. RoMo: A Large-Scale, Richly Organized Dataset and Semantic Taxonomy for Human Motion Generation

> 🇯🇵 **RoMo: ロボット動作の大規模整理型データセットと手法**

> 💡 ロボット動作の大規模学習基盤: ロボット動作を体系的に整理した大規模データセットと対応手法を提供

**著者:** Jiahao Zhang, Joseph Liu, Young-Yoon Lee, Seonghyeon Moon, Victor Zordan, Guy Tevet, C. Karen Liu, Stephen Gould, Oren Jacob, Haomiao Jiang, Mubbasir Kapadia, Yizhak Ben-Shabat

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_RoMo_A_Large-Scale_Richly_Organized_Dataset_and_Semantic_Taxonomy_for_CVPR_2026_paper.html)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/38346.png)
...
## 19. Generative Video Motion Editing with 3D Point Tracks
...
## 20. BulletTime: Decoupled Control of Time and Camera Pose for Video Generation
...
## 21. Learning to Generate Highly Dynamic Videos using Synthetic Motion Data
...
## 22. Stereo World Model: Camera-Guided Stereo Video Generation
...
## 23. VDFE: Difference-Aware 3D Scene Editing with Non-Intrusive Video Diffusion Priors for Multi-View Consistency and Efficiency
...
## 24. Towards Realistic and Consistent Orbital Video Generation via 3D Foundation Priors
...
## 25. VideoRealBench: A Chain-of-Thought Realism Evaluation Benchmark for Generated Human-Centric Videos
...
## 26. Goal Force: Teaching Video Models To Accomplish Physics-Conditioned Goals
...
## 27. SAGA: Source Attribution of Generative AI Videos
...
## 28. VMD-FACT: A New Video Dataset and MLLM-based method for Detecting Realistic AI-Generated Video Misinformation
...
## 29. TGT: Text-Grounded Trajectories for Locally Controlled Video Generation
...
## 30. FFP-300K: Scaling First-Frame Propagation for Generalizable Video Editing
...
## 31. V-RGBX: Video Editing with Accurate Controls over Intrinsic Properties
...
## 32. PoseAnything: General Pose-guided Video Generation with Part-aware Temporal Coherence
...
## 33. AlcheMinT: Fine-grained Temporal Control for Multi-Reference Consistent Video Generation
...
## 34. EVATok: Adaptive Length Video Tokenization for Efficient Visual Autoregressive Generation
...
## 35. Rethinking Position Embedding as a Context Controller for Multi-Reference and Multi-Shot Video Generation
...
## 36. Stand-In: A Lightweight and Plug-and-Play Identity Control for Video Generation
...
## 37. VABench: A Comprehensive Benchmark for Audio-Video Generation
...
## 38. LinVideo: A Post-Training Framework towards O(n) Attention in Efficient Video Generation
...
## 39. MoCoDiff: A Controllable Autoregressive Diffusion Model for Expressive Motion Generation
...
## 40. ParTY: Part-Guidance for Expressive Text-to-Motion Synthesis

> 🇯🇵 **モーション生成と制御のための統合フレームワーク**

> 💡 複雑なモーション生成において、より正確で制御可能な表現を実現する新しいアプローチを提案した。

**著者:** KunHo Heo, SuYeon Kim, Yonghyun Gwon, Youngbin Kim, MyeongAh Cho

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Heo_ParTY_Part-Guidance_for_Expressive_Text-to-Motion_Synthesis_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.09611) | [🌐 Project](https://visualsciencelab-khu.github.io/ParTY_project/)
...
<iframe src="https://visualsciencelab-khu.github.io/ParTY_project/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 41. Unified Number-Free Text-to-Motion Generation Via Flow Matching

> 🇯🇵 **モーション生成と制御のための統合フレームワーク**

> 💡 複雑なモーション生成において、より正確で制御可能な表現を実現する新しいアプローチを提案した。

**著者:** Guanhe Huang, Oya Celiktutan

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Huang_Unified_Number-Free_Text-to-Motion_Generation_Via_Flow_Matching_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.27040) | [🌐 Project](https://githubhgh.github.io/umf/)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/36841.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://githubhgh.github.io/umf/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 43. PerformRecast: Expression and Head Pose Disentanglement for Portrait Video Editing
...
## 44. CineScene: Implicit 3D as Effective Scene Representation for Cinematic Video Generation
...
## 45. RecEdit-Drive: 3D Reconstruction-Guided Spatiotemporal Video Editing for Autonomous Driving Scenes
...
## 46. UniVBench: Towards Unified Evaluation for Video Foundation Models
...
## 47. Identity-Preserving Image-to-Video Generation via Reward-Guided Optimization
...
## 48. TGTrack: Temporal Generative Learning for Unified Single Object Tracking

> 🇯🇵 **TGTrack: 統一単一物体追跡のための時間生成学習**

> 💡 生成型物体追跡: 時間方向の生成学習で様々な物体を統一的に高精度追跡

**著者:** Wanting Geng, Xin Chen, Chuanyu Sun, Jie Zhao, Ben Kang, Dong Wang, Huchuan Lu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Geng_TGTrack_Temporal_Generative_Learning_for_Unified_Single_Object_Tracking_CVPR_2026_paper.html)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/37963.png)


**Abstract:** Existing single object trackers typically treat temporal modeling superficially by passing limited inter-frame information, such as propagated tokens or template updates, without intrinsic temporal supervision learning. To address this limitation, we propose TGTrack, a new unified tracking framework that incorporates a temporally generative supervision task to guide the model in learning temporal dynamics. The core of TGTrack is a temporally generative learning paradigm equipped with a transformer-based generative decoder, which consists of a gated fusion module and an autoregressive prediction mechanism. This joint design enables the model to infer future scenarios from preceding information, thereby improving its ability to model both visual appearance and temporal dynamics. Furthermore, we introduce a time token embedding to explicitly encode the temporal position of each frame. Experiments on 11 benchmarks spanning five modalities show that TGTrack achieves state-of-the-art performance in robust unified tracking. For instance, TGTrack-B384 achieves an AUC of 75.3\% on LaSOT. Code and models will be made available.


---

## 49. SwitchCraft: Training-Free Multi-Event Video Generation with Attention Controls
...
## 50. StreamDiT: Real-Time Streaming Text-to-Video Generation
...
## 51. TempoMaster: Efficient Long Video Generation via Next-Frame-Rate Prediction
...
## 52. SynMotion: Semantic-Visual Adaptation for Motion Customized Video Generation
...
## 53. OpenT2M: No-frill Motion Generation with Open-source, Large-scale, High-quality Data
...
## 54. Towards Decompositional Human Motion Generation with Energy-Based Diffusion Models
...
## 55. PAMotion: Physics-Aware Motion Generation for Full-Body Interaction with Multiple Objects

> 🇯🇵 **モーション生成と制御のための統合フレームワーク**

> 💡 複雑なモーション生成において、より正確で制御可能な表現を実現する新しいアプローチを提案した。

**著者:** Yan Di, Yuheng Li, Yaoxing Wang, Mengge Liu, Shan Gao, Xiangyang Ji
...
## 57. Learning Transferable Temporal Primitives for Video Reasoning via Synthetic Videos
...
## 58. SWIFT: Sliding Window Reconstruction for Few-Shot Training-Free Generated Video Attribution
...
## 59. ExPose: Reinforcing Video Generation Models for Extreme Pose Estimation
...
## 60. Attention Surgery: An Efficient Recipe to Linearize Your Video Diffusion Transformer
...
## 61. Compressed-Domain-Aware Online Video Super-Resolution
...
## 62. VIVA: VLM-Guided Instruction-Based Video Editing with Reward Optimization
...
## 63. Reward Forcing: Efficient Streaming Video Generation with Rewarded Distribution Matching Distillation
...
## 64. GenieDrive: Towards Physics-Aware Driving World Model with 4D Occupancy Guided Video Generation
...
## 65. Accelerating Diffusion-based Video Editing via Heterogeneous Caching: Beyond Full Computing at Sampled Denoising Timestep
...
## 66. Mind the Generative Details: Direct Localized Detail Preference Optimization for Video Diffusion Models
...
## 67. RAPID: Reusing Attention Sparsity with Inter-step Adaptation for Efficient Video Diffusion
...
## 68. CineBrain: A Large-Scale Multi-Modal Audiovisual Brain Dataset for Brain-Conditioned Video Generation
...
## 69. ID-Crafter: VLM-Grounded Online RL for Compositional Multi-Subject Video Generation
...
## 70. Gloria: Consistent Character Video Generation via Content Anchors
...
## 71. DreamShot: Personalized Storyboard Synthesis with Video Diffusion Prior
...
## 72. M4V: Multimodal Mamba for Efficient Text-to-Video Generation
...
## 73. Anti-I2V: Safeguarding your Photos from Malicious Image-to-video Generation
...
## 74. AutoCut: End-to-end advertisement video editing based on multimodal discretization and controllable generation
...
## 75. CoT-Edit: Let CoT Guide Instruction Video Editing
...
## 76. Scaling Instruction-Based Video Editing with a High-Quality Synthetic Dataset
...
## 77. Dual-Granularity Memory for Efficient Video Generation
...
## 78. Unified Camera Positional Encoding for Controlled Video Generation
...
## 79. Chain of Event-Centric Causal Thought for Physically Plausible Video Generation
...
## 80. LoL: Longer than Longer, Scaling Video Generation to Hour
...
## 81. Rethinking Diffusion Model-Based Video Super-Resolution: Leveraging Dense Guidance from Aligned Features
...
## 82. Towards Highly-Constrained Human Motion Generation with Retrieval-Guided Diffusion Noise Optimization
...
## 83. MoLingo: Motion–Language Alignment for Text-to-Human Motion Generation

> 🇯🇵 **MoLingo: テキストから人間動作生成のためのMotion-Language Alignment**

> 💡 意味整合潜在空間とcross-attentionで高忠実なT2M生成を実現

**著者:** Yannan He, Garvita Tiwari, Xiaohan Zhang, Pankaj Bora, Tolga Birdal, Jan Lenssen, Gerard Pons-Moll

**Links:** [📄 Paper](https://cvpr.thecvf.com/virtual/2026/poster/39458)

**Session:** Poster Session 6


![Poster](posters/video_generation/39458.png)
...
## 84. Video-as-Answer: Predict and Generate Next Video Event with Joint-GRPO
...
## 85. DriveLaW: Unifying Planning and Video Generation in a Latent Driving World
...
## 86. StereoWorld: Geometry-Aware Monocular-to-Stereo Video Generation
...
## 87. AniMimic: Imitating 3D Animation from Video Priors
...
## 88. VerseCrafter: Dynamic Realistic Video World Model with 4D Geometric Control
...
## 89. WorldStereo: Bridging Controllable Video Generation and Scene Reconstruction via 3D Geometric Memories
...
## 90. Taming Video Models for 3D and 4D Generation via Zero-Shot Camera Control
...
## 91. Improving Motion in Image-to-Video Models via Adaptive Low-Pass Guidance
...
## 92. ReHyAt: Recurrent Hybrid Attention for Video Diffusion Transformers
...
## 93. Thinking with Video: Video Generation as a Promising Multimodal Reasoning Paradigm
...
## 94. Generative Video Compression with One-Dimensional Latent Representation
...
## 95. EvoID: Reinforced Evolution for Identity-Preserving Video Generation
...
## 96. Causal Motion Diffusion Models for Autoregressive Motion Generation
...
## 97. NS-Diff: Fluid Navier–Stokes Guided Video Diffusion via Reinforcement Learning
...
## 98. PropFly: Learning to Propagate via On-the-Fly Supervision from Pre-trained Video Diffusion Models
...
## 99. AdaCluster: Adaptive Query-Key Clustering for Sparse Attention in Video Generation
...
## 100. EasyOmnimatte: Taming Pretrained Inpainting Diffusion Models for End-to-End Video Layered Decompositio
...
![Poster](posters/video_generation/37696.png)
...
## 101. Causality in Video Diffusers is Separable from Denoising
...
## 102. Adaptive Video Distillation: Mitigating Oversaturation and Temporal Collapse in Few-Step Generation
...
## 103. RFDM: Residual Flow Diffusion Models for Video Editing
...
## 104. D2Cache: Second-Order Delta Caching for Higher Video Diffusion Acceleration
...
## 105. Text-Driven 3D Hand Motion Generation from Sign Language Data
...
## 106. Accelerating Autoregressive Video Diffusion via History-Guided Cache and Residual Correction
...
## 107. MusicInfuser: Making Video Diffusion Listen and Dance
...
## 108. PriVi: Towards a General-Purpose Video Model for Primate Behavior in the Wild

> 🇯🇵 **姿勢推定と動作解析の統合フレームワーク**

> 💡 人間やオブジェクトの姿勢推定において、複雑な環境での高精度認識を実現する新しい方法を提案した。

**著者:** Felix B. Mueller, Jan F. Meier, Timo Lüddecke, Richard Vogg, Roger L. Freixanet, Valentin Hassler, Tiffany Bosshard, Elif Karakoc, William O&amp;#x27;Hearn, Sofia M. Pereira, Sandro Sehner, Kaja Wierucka, Judith Burkart, Claudia Fichtel, Julia Fischer, Alexander Gail, Catherine Hobaiter, Julia Ostner, Liran Samuni, Oliver Schülke, Neda Shahidi, Erin G. Wessling, Alexander S. Ecker

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Mueller_PriVi_Towards_a_General-Purpose_Video_Model_for_Primate_Behavior_in_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.09675)
...
## 109. FrankenMotion: Part-level Human Motion Generation and Composition

> 🇯🇵 **FrankenMotion: 部位レベルの人体動作生成と合成**

> 💡 部位別かつ時間構造化プロンプトで未見の複合人体動作全体を生成

**著者:** Chuqiao Li, Xianghui Xie, Yong Cao, Andreas Geiger, Gerard Pons-Moll

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_FrankenMotion_Part-level_Human_Motion_Generation_and_Composition_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.10909)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/37551.png)
...
## 110. EasyV2V: A High-quality Instruction-based Video Editing Framework
...
## 111. Hear What You See: Video-to-Audio Generation with Diffusion Transformer and Semantic-Temporal Alignment-Ranked Direct Preference Optimization
...
## 112. From Static to Dynamic: Exploring Self-supervised Image-to-Video Representation Transfer Learning
...
## 113. LAMP: Language-Assisted Motion Planning for Controllable Video Generation
...
## 114. SceMoS: Scene-Aware 3D Human Motion Synthesis by Planning with Geometry-Grounded Tokens

> 🇯🇵 **複雑なシーン理解のための多段階処理アーキテクチャ**

> 💡 複数のオブジェクトと相互作用を含む複雑なシーン認識において、より包括的な理解を実現する手法を開発した。

**著者:** Anindita Ghosh, Vladislav Golyanik, Taku Komura, Philipp Slusallek, Christian Theobalt, Rishabh Dabral

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ghosh_SceMoS_Scene-Aware_3D_Human_Motion_Synthesis_by_Planning_with_Geometry-Grounded_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.20476)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/38150.png)
...
## 115. Diverse Video Generation with Determinantal Point Process-Guided Policy Optimization
...
## 116. DTG-Restore: Training-Free Diffusion Refinement for Generative Video Super-Resolution
...
## 117. Infinity-RoPE: Action-Controllable Infinite Video Generation Emerges From Autoregressive Self-Rollout
...
## 118. InterPhys: Physics-aware Human Motion Synthesis in a Dynamic Scene

> 🇯🇵 **複雑なシーン理解のための多段階処理アーキテクチャ**

> 💡 複数のオブジェクトと相互作用を含む複雑なシーン認識において、より包括的な理解を実現する手法を開発した。

**著者:** Chaoyue Xing, Wei Mao, Miaomiao Liu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xing_InterPhys_Physics-aware_Human_Motion_Synthesis_in_a_Dynamic_Scene_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2605.01036)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/36660.png)
...
## 119. Interpretable Motion-Attentive Maps: Spatio-Temporally Localizing Concepts in Video Diffusion Transformers
...
## 120. PHANTOM: Physics-Infused Video Generation via Joint Modeling of Visual and Latent Physical Dynamics
...
## 121. How Much 3D Do Video Foundation Models Encode?
...
## 122. Ref4D-VideoBench: Four-Dimensional Reference-Based Evaluation of Text-to-Video Generative Models
...
## 123. PS-SR: Pseudo-Single-Step Video Super-Resolution via Speculative Diffusion
...
## 124. STARFlow-V: End-to-End Video Generative Modeling with Autoregressive Normalizing Flows
...
## 125. RunawayEvil: Jailbreaking the Image-to-Video Generative Models
...
## 126. Efficient Training for Human Video Generation with Entropy-Guided Prioritized Progressive Learning
...
## 127. VISTA: A Test-Time Self-Improving Video Generation Agent
...
## 128. PhysVid: Physics Aware Local Conditioning for Generative Video Models
...
## 129. VGA-Bench: A Unified Benchmark and Multi-Model Framework for Video Aesthetics and Generation Quality Evaluation
...
## 130. Content-Aware Dynamic Patchification for Efficient Video Diffusion
...
## 131. EgoFlow: Gradient-Guided Flow Matching for Egocentric 6DoF Object Motion Generation

> 🇯🇵 **自己中心的動画での6DoF物体動作生成**

> 💡 自己中心視点動画から勾配誘導フロー整合で、3D物体の6DoF動作生成を実現する。

**著者:** Abhishek Saroha, Huajian Zeng, Xingxing Zuo, Daniel Cremers, Xi Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Saroha_EgoFlow_Gradient-Guided_Flow_Matching_for_Egocentric_6DoF_Object_Motion_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.01421)
...
## 132. Generative Neural Video Compression via Video Diffusion Prior
...
## 133. FloodDiffusion: Tailored Diffusion Forcing for Streaming Motion Generation

> 🇯🇵 **ストリーミング動作生成の強制拡散モデル**

> 💡 時間展開拡散モデルによりストリーミング動作を効率的に生成する手法を開発する。

**著者:** YIYI CAI, Yuhan Wu, Kunhang Li, YOU ZHOU, Bo Zheng, Haiyang Liu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Cai_FloodDiffusion_Tailored_Diffusion_Forcing_for_Streaming_Motion_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.03520)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/36963.png)
...
## 134. VideoCoF: Unified Video Editing with Temporal Reasoner
...
## 135. Open the Motion Door: Atomic Motion Decomposition and Recomposition for Open-Vocabulary Motion Generation

> 🇯🇵 **原子動作分解再構成による語彙開放動作生成**

> 💡 動作を原子単位に分解し再構成することで、未知の組み合わせの新規動作生成を実現する。

**著者:** Ke Fan, Jiangning Zhang, Ran Yi, Jingyu Gong, Yabiao Wang, yating wang, Xin Tan, Chengjie Wang, Lizhuang Ma

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Fan_Open_the_Motion_Door_Atomic_Motion_Decomposition_and_Recomposition_for_CVPR_2026_paper.html)
...
## 137. BAgger: Backwards Aggregation for Mitigating Drift in Autoregressive Video Diffusion Models
...
## 138. Training-free Motion Factorization for Compositional Video Generation
...
## 139. HandWorld: Hand-Centric Unified Video Action Generation
...
## 140. DreamingComics: A Story Visualization Pipeline via Subject and Layout Customized Generation using Video Models
...
## 141. Spatia: Video Generation with Updatable Spatial Memory
...
## 142. DynamicsBoost: Dynamic Plausible Video Generation via Annotation-Free Continuation Preference Optimization
...
## 143. GaussFusion: Improving 3D Reconstruction in the Wild with A Geometry-Informed Video Generator
...
## 144. STCDiT: Spatio-Temporally Consistent Diffusion Transformer for High-Quality Video Super-Resolution
...
## 145. Geometry-as-context: Modulating Explicit 3D in Scene-consistent Video Generation to Geometry Context
...
## 146. EditCtrl: Disentangled Local and Global Control for Real-Time Generative Video Editing
...
## 147. EgoX: Egocentric Video Generation from a Single Exocentric Video
...
## 148. VideoMaMa: Mask-Guided Video Matting via Generative Prior
...
## 149. MotionMaster: Generalizable Text-Driven Motion Generation and Editing

> 🇯🇵 **テキスト駆動動作生成・編集の汎化モデル**

> 💡 テキストから多様な動作を生成・編集できる汎化性の高い統一モデルを開発する。

**著者:** Nan Jiang, yunhao li, Lexi Pang, Zimo He, Siyuan Huang, Yixin Zhu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Jiang_MotionMaster_Generalizable_Text-Driven_Motion_Generation_and_Editing_CVPR_2026_paper.html)
...
## 151. CubeComposer: Spatio-Temporal Autoregressive 4K 360° Video Generation from Perspective Video
...
## 152. FlashVSR: Towards Real-time Diffusion-Based Streaming Video Super Resolution
...
## 153. What Are You Doing? A Closer Look at Controllable Human Video Generation
...
## 154. GT-SVJ: Generative-Transformer-Based Self-Supervised Video Judge For Efficient Video Reward Modeling
...
## 155. Scaling Zero-Shot Reference-to-Video Generation
...
## 156. PyraTok: Language-Aligned Pyramidal Tokenizer for Video Understanding and Generation
...
## 157. Iterative Closed-Loop Motion Synthesis for Scaling the Capabilities of Humanoid Control

> 🇯🇵 **ヒューマノイド制御能力スケーリングのための反復閉ループ動作合成**

> 💡 反復型閉ループ手法でヒューマノイド制御の汎化能力を拡張する。

**著者:** Weisheng Xu, Qiwei Wu, Jiaxi Zhang, Jing Tan, Yangfan Li, Yuetong Fang, Jiaqi Xiong, Kai Wu, Rong OU, Renjing Xu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xu_Iterative_Closed-Loop_Motion_Synthesis_for_Scaling_the_Capabilities_of_Humanoid_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.21599)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/38388.png)
...
## 158. PLACID: Identity-Preserving Multi-Object Compositing via Video Diffusion with Synthetic Trajectories
...
## 159. Harmony: Harmonizing Audio and Video Generation through Cross-Task Synergy
...
## 160. NeoVerse: Enhancing 4D World Model with in-the-wild Monocular Videos
...
## 161. DisCa: Accelerating Video Diffusion Transformers with Distillation-Compatible Learnable Feature Caching
...
## 162. InstantViR: Real-Time Video Inverse Problem Solver with Distilled Diffusion Prior
...
## 163. LaVR: Scene Latent Conditioned Generative Video Trajectory Re-Rendering using Large 4D Reconstruction Models
...
## 164. SVBench: Evaluation of Video Generation Models on Social Reasoning
...
## 165. Transition Matching Distillation for Fast Video Generation
...
## 166. Lighting-grounded Video Generation with Renderer-based Agent Reasoning
...
## 167. Generating Humanless Environment Walkthroughs from Egocentric Walking Tour Videos
...
## 168. Stability-Driven Motion Generation for Object-Guided Human-Human Co-Manipulation

> 🇯🇵 **物体指導人物協調操作の安定性駆動動作生成**

> 💡 物理的安定性を考慮した人間協調操作の動作生成を実現する。

**著者:** Jiahao Xu, Xiaohan Yuan, Xingchen Wu, Chongyang Xu, Kun Li, Buzhen Huang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xu_Stability-Driven_Motion_Generation_for_Object-Guided_Human-Human_Co-Manipulation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.20336)

**Session:** Poster Session 6


![Poster](posters/video_generation/39306.png)
...
## 169. TempoControl: Temporal Attention Guidance for Text-to-Video Models
...
## 170. Endless World: Real-Time 3D-Aware Long Video Generation
...
## 171. TEAR: Temporal-aware Automated Red-teaming for Text-to-Video Models
...
## 172. CineBrain: A Large-Scale Multi-Modal Audiovisual Brain Dataset for Brain-Conditioned Video Generation
...
## 173. TEAR: Temporal-aware Automated Red-teaming for Text-to-Video Models
...
## 174. HoloCine: Holistic Generation of Cinematic Multi-Shot Long Video Narratives
...
## 175. Reasoning Diffusion for Unpaired Test Time Out-of-distribution Text-Image to Video Generation
...
## 176. ORV: 4D Occupancy-centric Robot Video Generation
...
## 177. Omni2Sound: Towards Unified Video-Text-to-Audio Generation
...
## 178. ConsID-Gen: View-Consistent and Identity-Preserving Image-to-Video Generation
...
## 179. Video Generation with Stable Transparency via Shiftable RGB-A Distribution Learner
...
## 181. Benchmarking Single-Factor Physical Video-to-Audio Generation
...
## 182. UniAVGen: Unified Audio and Video Generation with Asymmetric Cross-Modal Interactions
...
## 183. Free-Lunch Long Video Generation via Layer-Adaptive O.O.D Correction
...
## 184. ShotDirector: Directorially Controllable Multi-Shot Video Generation with Cinematographic Transitions
...
## 185. Are Image-to-Video Models Good Zero-Shot Image Editors?
...
## 186. FastLightGen: Fast and Light Video Generation with Fewer Steps and Parameters
...
## 187. Thermal Diffusion Matters: Infrared Spatial-Temporal Video Super-Resolution through Heat Conduction Priors
...
## 188. TextOVSR: Text-Guided Real-World Opera Video Super-Resolution
...
## 189. 3D-Aware Implicit Motion Control for View-Adaptive Human Video Generation
...
## 190. MotionEnhancer: Leveraging Video Diffusion for Motion-Enhanced Vision-Language Models
...
## 191. FlexTraj: Image-to-Video Generation with Flexible Point Trajectory Control
...
## 192. Diff4Splat: Repurposing Video Diffusion Models for Dynamic Scene Generation
...
## 193. EgoControl: Controllable Egocentric Video Generation via 3D Full-Body Poses
...
## 194. Physical Simulator In-the-Loop Video Generation
...
## 195. FVBench: Benchmarking Deepfake Video Detection Capability of Large Multimodal Models
...
## 196. Your One-Stop Solution for AI-Generated Video Detection
...
## 197. UnityVideo: Unified Multi-Modal Multi-Task Learning for Enhancing World-Aware Video Generation
...
## 198. Skyra: AI-Generated Video Detection via Grounded Artifact Reasoning
...
## 199. Thinking with Frames: Generative Video Distortion Evaluation via Frame Reward Model
...
## 200. VMonarch: Efficient Video Diffusion Transformers with Structured Attention
...
## 201. MoReGen: Multi-Agent Motion-Reasoning Engine for Code-based Text-to-Video Synthesis
...
## 202. TV2TV: A Unified Framework for Interleaved Language and Video Generation
...
## 203. SLVMEval: Synthetic Meta Evaluation Benchmark for Text-to-Long Video Generation
...
## 204. FlowDirector: Training-Free Flow Steering for Precise Text-to-Video Editing
...
## 205. Goal-Driven Reward by Video Diffusion Models for Reinforcement Learning
...
## 206. SyncMos: Scalable Motion Synchronisation for Multi-Agent Scene Interaction

> 🇯🇵 **複数エージェント場面相互作用のための拡張可能動作同期化**

> 💡 依存関係認識物語計画と時間ワーピング制御で、複数エージェント間の時間同期型相互作用動画生成を実現した。

**著者:** Lingxiao Li, Dongwon Kim, Lingyan Ruan, Taesoo Kwon, Bin Chen, Taehyun Rhee

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_SyncMos_Scalable_Motion_Synchronisation_for_Multi-Agent_Scene_Interaction_CVPR_2026_paper.html) | [🌐 Project](https://www.lingxiao.one/SyncMos_Project_page/)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/38060.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://www.lingxiao.one/SyncMos_Project_page/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 207. FlashMotion: Few-Step Controllable Video Generation with Trajectory Guidance
...
## 208. EchoVDiff: Cardiac-Cycle Echocardiography Video Generation from Arbitrary Frame
...
## 209. SURF: Signature-Retained Fast Video Generation
...
## 210. Lynx: Towards High-Fidelity Personalized Video Generation
...
## 211. Real-Time Generation of Streamable Talking Portrait Video with Reference-Guided Deep Compression VAEs
...
## 212. Multi-level Causal LLM-based Text-to-Motion Generation with Human Alignment

> 🇯🇵 **人間整合性を備えたマルチレベル因果LLMベースのテキストからモーション生成**

> 💡 因果的モーション表現と選好最適化で人に整合する自然動作を生成

**著者:** Chen Xiaodong, Qian Bao, Xudong Liu, Jianping Fang, Jintao Fang, Yongdong Zhang, Tao Mei, Wu Liu
...
![Poster](posters/video_generation/39904.png)
...
## 213. LaMoGen: Language to Motion Generation Through LLM-Guided Symbolic Inference

> 🇯🇵 **LaMoGen: LLM誘導の記号推論による言語からモーション生成**

> 💡 LabanLite記号で言語を解釈し説明可能な動作を合成する

**著者:** Junkun JIANG, Ho Yin Au, Jingyu Xiang, Jie Chen

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Jiang_LaMoGen_Language_to_Motion_Generation_Through_LLM-Guided_Symbolic_Inference_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.11605) | [🌐 Project](https://jjkislele.github.io/LaMoGen/)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/37790.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://jjkislele.github.io/LaMoGen/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 214. SymphoMotion: Joint Control of Camera Motion and Object Dynamics for Coherent Video Generation
...
## 215. Pantheon360: Taming Digital Twin Generation via 3D-Aware 360° Video Diffusion
...
## 216. WorldReel: 4D Video Generation with Consistent Geometry and Motion Modeling
...
## 217. CoCoVideo: The High-Quality Commercial-Model-Based Contrastive Benchmark for AI-Generated Video Detection
...
## 218. TiViBench: Benchmarking Think-in-Video Reasoning for Video Generation
...
## 219. SoliReward: Mitigating Susceptibility to Reward Hacking and Annotation Noise in Video Generation Reward Models
...
## 220. AnyID: Ultra-Fidelity Universal Identity-Preserving Video Generation from Any Visual References
