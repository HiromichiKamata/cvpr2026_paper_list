# CVPR 2026 — Video Generation Papers
...
## 1. DeRVOS: Decoupling Consistent Trajectory Generation and Multimodal Understanding for Referring Video Object Segmentation

> 🇯🇵 **DeRVOS: 参照ビデオ物体分割における一貫した軌跡生成とマルチモーダル理解の分離**

> 💡 ビデオ内の参照対象物を分割する為、軌跡生成と理解を分離した手法。

**著者:** WENXUAN CHENG, Ming Dai, Huimin Lu, Wankou Yang
...
## 2. VIVA: VLM-Guided Instruction-Based Video Editing with Reward Optimization

> 🇯🇵 **VIVA: VLM誘導の指示型動画編集**

> 💡 ビジョン言語モデル活用の動画編集: 大型言語モデルで自然言語指示から自動動画編集

**著者:** Xiaoyan Cong, Haotian Yang, Angtian Wang, Yizhi Wang, Yiding Yang, Canyu Zhang, Chongyang Ma

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Cong_VIVA_VLM-Guided_Instruction-Based_Video_Editing_with_Reward_Optimization_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.16906)
...
> 💡 AI生成動画の出典追跡: 生成動画がどの学習データに由来するかを特定する帰属分析技術

**著者:** Rohit Kundu, Vishal Mohanty, Hao Xiong, Shan Jia, Athula Balachandran, Amit K. Roy-Chowdhury

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kundu_SAGA_Source_Attribution_of_Generative_AI_Videos_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.12834)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/38675.png)
...
> 🇯🇵 **VABench: 音声動画生成のための包括的ベンチマーク**

> 💡 音声動画統合評価基盤: 音声と動画の統合生成技術を体系的かつ公正に評価するベンチマーク

**著者:** Daili Hua, Xizhi Wang, Bohan Zeng, Xinyi Huang, Hao Liang, Junbo Niu, Xinlong Chen, Quanqing Xu, Wentao Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Hua_VABench_A_Comprehensive_Benchmark_for_Audio-Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.09299)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/39684.png)
...
## 5. EasyOmnimatte: Taming Pretrained Inpainting Diffusion Models for End-to-End Video Layered Decompositio
...
## 6. PAVAS: Physics-Aware Video-to-Audio Synthesis

> 🇯🇵 **PAVAS: 物理認識ビデオ音声合成**

> 💡 物理法則を考慮したビデオから音声への合成技術。

**著者:** Oh Hyun-Bin, Yuhta Takida, Toshimitsu Uesaka, Tae-Hyun Oh, Yuki Mitsufuji

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference)

**Session:** Oral Session 3D: Multimodal Modeling
...
## 7. Training-free Detection of Generated Videos via Spatial-Temporal Likelihoods
...
> 🇯🇵 **時間的に変化するビジュアルシーンの動き予測**

> 💡 時間変化する場面の将来フレーム予測。

**著者:** Hesong Wang, Xin Jin, Lu Lu, Chenhaowen Li, Jian Chen, Qiang Liu, Huan Wang
...
> 🇯🇵 **SymphoMotion: 一貫した動画生成のためのカメラ運動と物体動力学の統合制御**

> 💡 カメラ軌道と物体3D動態を同時制御し一貫性ある動画生成を実現

**著者:** Guiyu Zhang, Yabo Chen, Xunzhi Xiang, Junchao Huang, Zhongyu Wang, Li Jiang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_SymphoMotion_Joint_Control_of_Camera_Motion_and_Object_Dynamics_for_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.03723)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/36961.png)
...
## 10. Less is More: Data-Efficient Adaptation for Controllable Text-to-Video Generation
...
## 11. FVBench: Benchmarking Deepfake Video Detection Capability of Large Multimodal Models

> 🇯🇵 **深偽動画検出能力ベンチマーク**

> 💡 42個の最新生成モデルから生成した120K超の多様な動画で構成し、大規模マルチモーダルモデルの深偽検出能力を評価するベンチマークを構築した。

**著者:** Wang Jiarui, Huiyu Duan, Juntong Wang, Xiongkuo Min

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_FVBench_Benchmarking_Deepfake_Video_Detection_Capability_of_Large_Multimodal_Models_CVPR_2026_paper.html)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/39030.png)
...
## 12. Learning Transferable Temporal Primitives for Video Reasoning via Synthetic Videos

> 🇯🇵 **動画生成における転移可能な時間基本要素の学習**

> 💡 汎用時間パターン抽出: 動画の基本的な時間パターンを学習して異領域に転移応用

**著者:** Sontao Jiang, Sibo Song, Chenyi Zhou, Yuan Wang, Ruizhe Chen, Tongkun Guan, Ruilin Luo, Yan Zhang, Zhihang Tang, Yuchong Sun, Hang Zhang, Zhibo Yang, Shuai Bai, Junyang Lin, Zuozhu Liu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Jiang_Learning_Transferable_Temporal_Primitives_for_Video_Reasoning_via_Synthetic_Videos_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.17693)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/39346.png)
...
## 13. FlashPortrait: 6x Faster Infinite Portrait Animation with Adaptive Latent Prediction
...
## 14. EchoFoley: Event-Centric Hierarchical Control for Video Grounded Creative Sound Generation

> 🇯🇵 **EchoFoley: ビデオ接地型創作音生成の事象中心階層制御**

> 💡 イベント情報を活用した創作音生成制御技術。

**著者:** Bingxuan Li, Yiming Cui, Yicheng He, Yiwei Wang, Shu Zhang, Longyin Wen, Yulei Niu
...
## 15. Physical Simulator In-the-Loop Video Generation
...
## 16. DreamStereo: Towards Real-Time Stereo Inpainting for HD Videos

> 🇯🇵 **DreamStereo: HDビデオ向けリアルタイムステレオ画像補完**

> 💡 高解像度ビデオの欠落部分をリアルタイムで補完。

**著者:** Huang yuan, Sijie Zhao, Jing Cheng, Hao Xu, Shaohui Jiao
...
## 17. Rethinking Diffusion Model-Based Video Super-Resolution: Leveraging Dense Guidance from Aligned Features
...
## 20. Ultra-Fast Neural Video Compression

> 🇯🇵 **超高速ニューラルビデオ圧縮**

> 💡 ニューラルネットワークを用いた高速圧縮技術。

**著者:** Jiahao Li, Wenxuan Xie, Zhaoyang Jia, Bin Li, Zongyu Guo, Xiaoyi Zhang, Yan Lu
...
## 21. CineBrain: A Large-Scale Multi-Modal Audiovisual Brain Dataset for Brain-Conditioned Video Generation

> 🇯🇵 **脳条件付けビデオ生成のための大規模マルチモーダル脳データセット**

> 💡 脳信号とビデオの大規模ペアデータで脳条件付けビデオ生成を実現する。

**著者:** Jianxiong Gao, Yichang Liu, baofeng yang, Jianfeng Feng, Yanwei Fu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Gao_CineBrain_A_Large-Scale_Multi-Modal_Audiovisual_Brain_Dataset_for_Brain-Conditioned_Video_CVPR_2026_paper.html)
...
**Abstract:** Most research decoding brain signals into images, often using them as priors for generative models, has focused only on visual content. This overlooks the brain's natural ability to integrate auditory and visual information, for instance, sound strongly influences how we perceive visual scenes. To investigate this,we propose a new task of reconstructing continuous video stimuli from multimodal brain signals recorded during audiovisual stimulation. To enable this, we introduce CineBrain, the first large-scale dataset that synchronizes fMRI and EEG during audiovisual viewing, featuring six hours of The Big Bang Theory episodes for cross-modal alignment. We also conduct the first systematic exploration of combining fMRI and EEG for video reconstruction and present CineSync, a framework for reconstructing dynamic video using a Multi-Modal Fusion Encoder and a Neural Latent Decoder. CineSync achieves state-of-the-art performance in dynamic reconstruction, leveraging the complementary strengths of fMRI and EEG to improve visual fidelity. Our analysis shows that auditory cortical activations enhance decoding accuracy, highlighting the role of auditory input in visual perception.


---

## 22. GenieDrive: Towards Physics-Aware Driving World Model with 4D Occupancy Guided Video Generation
...
> 🇯🇵 **V-DPM: 動的ポイントマップによる4Dビデオ再構成**

> 💡 動的ポイントマップを利用した立体ビデオ再構成。
...
## 24. Mind the Generative Details: Direct Localized Detail Preference Optimization for Video Diffusion Models
...
## 25. SMRABooth: Subject and Motion Representation Alignment for Customized Video Generation

> 🇯🇵 **SMRABooth: 被写体・動作表現整合による人物動画生成**

> 💡 人物動画の整合性改善: 被写体情報と動作表現を統合することで一貫性ある人物動画を高品質に生成

**著者:** Xuancheng Xu, Li Yaning, Sisi You, Bing-Kun Bao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xu_SMRABooth_Subject_and_Motion_Representation_Alignment_for_Customized_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.12193)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/40145.png)
...
## 26. PhysVid: Physics Aware Local Conditioning for Generative Video Models

> 🇯🇵 **物理認識局所条件付けによる生成ビデオモデル**

> 💡 物理制約を局所的に組み込むことで、物理的に正確で自然なビデオ生成を実現する。

**著者:** Saurabh Pathak, Elahe Arani, Mykola Pechenizkiy, Bahram Zonooz

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Pathak_PhysVid_Physics_Aware_Local_Conditioning_for_Generative_Video_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.26285) | [🌐 Project](https://5aurabhpathak.github.io/PhysVid/)

**Session:** Poster Session 6


![Poster](posters/video_generation/39347.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://5aurabhpathak.github.io/PhysVid/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 27. UniVBench: Towards Unified Evaluation for Video Foundation Models

> 🇯🇵 **UniVBench: 動画基盤モデルの統一的評価に向けて**

> 💡 統一型評価ベンチマーク: 動画基盤モデル群を統一基準で公正かつ体系的に評価

**著者:** Jianhui Wei, Xiaotian Zhang, Yichen Li, Yuan Wang, Yan Zhang, Ziyi Chen, Zhihang Tang, Wei Xu, Zuozhu Liu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wei_UniVBench_Towards_Unified_Evaluation_for_Video_Foundation_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.21835)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/39254.png)
...
## 28. ConsID-Gen: View-Consistent and Identity-Preserving Image-to-Video Generation
...
## 29. Content-Aware Dynamic Patchification for Efficient Video Diffusion
...
## 30. RHINO: Reconstructing Human Interactions with Novel Objects from Monocular Videos

> 🇯🇵 **RHINO: 単眼ビデオからの人物と新規物体相互作用再構成**

> 💡 単眼動画から人物と物体の相互作用を再構成。

**著者:** Lixin Xue, Chengwei Zheng, Georgios Paschalidis, Chen Guo, Manuel Kaufmann, Juan Zarate, Dimitrios Tzionas
...
## 31. Scaling Instruction-Based Video Editing with a High-Quality Synthetic Dataset
...
## 32. DeX-Portrait: Disentangled and Expressive Portrait Animation via Explicit and Latent Motion Representations
...
## 33. OmniSonic: Towards Universal and Holistic Audio Generation from Video and Text

> 🇯🇵 **ビデオ処理技術**

> 💡 ビデオ処理技術

**著者:** Weiguo Pian, Saksham Singh Kushwaha, Zhimin Chen, Shijian Deng, Kai Wang, Yunhui Guo, Yapeng Tian
...
## 34. 3D sans 3D Scans: Scalable Pre-training from Video-Generated Point Clouds

> 🇯🇵 **ビデオ処理技術**

> 💡 ビデオ処理技術

**著者:** Ryousuke Yamada, Kohsuke Ide, Yoshihiro Fukuhara, Hirokatsu Kataoka, Gilles Puy, Andrei Bursuc, Yuki M Asano
...
## 35. Echoes Over Time: Unlocking Length Generalization in Video-to-Audio Generation Models

> 🇯🇵 **ビデオ処理技術**

> 💡 ビデオ処理技術

**著者:** Christian Simon, Masato Ishii, Wei-Yao Wang, Koichi Saito, Akio Hayakawa, Dongseok Shim, Zhi Zhong, Shuyang Cui, Takashi Shibuya, Shusuke Takahashi, Yuki Mitsufuji

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://echoesovertime.github.io/)
...
<iframe src="https://echoesovertime.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 36. Streaming Diffusion Model for Fast Infrared and Visible Video Fusion
...
## 37. FastLightGen: Fast and Light Video Generation with Fewer Steps and Parameters

> 🇯🇵 **高速軽量動画生成：少ないステップとパラメータで**

> 💡 モデルサイズと推論ステップ数を同時に圧縮する蒸留フレームワークにより、高品質な軽量動画生成を実現した。

**著者:** Shitong Shao, Yufei Gu, Zeke Xie

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Shao_FastLightGen_Fast_and_Light_Video_Generation_with_Fewer_Steps_and_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.01685)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/38044.png)
...
## 38. RecEdit-Drive: 3D Reconstruction-Guided Spatiotemporal Video Editing for Autonomous Driving Scenes

> 🇯🇵 **3次元コンテンツ生成と認識のための深層学習手法**

> 💡 3D形状やシーン理解において、より正確で効率的な学習方法を開発した。

**著者:** Yipeng Wu, Xin WANG, Chenghan Yang, Chong Wang, Dongdong Wu, Wanchao Su, Hengshuang Zhao, Wei Feng, Kairui Yang, Di Lin

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wu_RecEdit-Drive_3D_Reconstruction-Guided_Spatiotemporal_Video_Editing_for_Autonomous_Driving_Scenes_CVPR_2026_paper.html)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/37289.png)


**Abstract:** High-quality video editing and processing are crucial in domains such as filmmaking and autonomous driving, where accurate visual refinement and data preparation are essential. However, it is challenging to achieve precise control over dynamic objects while maintaining spatiotemporal consistency. Current approaches typically utilize text prompts or 2D structural priors for video editing to ensure consistency, yet they struggle to effectively constrain the spatial variations of dynamic 3D objects. In this paper, we introduce $\textbf{RecEdit-Drive}$, a framework that integrates $\textbf{Spatial Feature Warping}$ and $\textbf{Spatiotemporal Collaborative Modeling}$ to effectively control 3D object variations and enhance video consistency. The spatial feature warping enhances precise control over the edited foreground 3D objects, enhancing spatial consistency in the generated videos; and the spatiotemporal collaborative modeling seamlessly integrates edited foreground objects into the background, yielding realistic and consistent edited videos. Besides, we design an inference strategy to reconstruct an accurate background structure through noise manipulation, providing a reliable reference for foreground instance editing at early denoising stages. We perform extensive qualitative and quantitative comparisons regarding general video editing and downstream tasks on the public datasets, demonstrating the state-of-the-art performance of our proposed method.


---

## 39. Taming Video Models for 3D and 4D Generation via Zero-Shot Camera Control
...
## 40. Ego-InBetween: Generating Object State Transitions in Ego-Centric Videos

> 🇯🇵 **ビデオ処理技術**

> 💡 ビデオ処理技術

**著者:** Mengmeng Ge, Takashi Isobe, Xu Jia, Yanan Sun, Zetong Yang, Weinong Wang, Dong Zhou, Dong Li, Huchuan Lu, Emad Barsoum
...
## 41. VMonarch: Efficient Video Diffusion Transformers with Structured Attention

> 🇯🇵 **構造化注意による効率的動画拡散トランスフォーマ**

> 💡 Monarchベース構造化疎注意で時空間パターンを効率的に表現し、長動画処理の注意計算を5倍以上高速化した。

**著者:** Cheng Liang, Haoxian Chen, Liang Hou, Qi Fan, Gangshan Wu, Xin Tao, Limin Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liang_VMonarch_Efficient_Video_Diffusion_Transformers_with_Structured_Attention_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.22275)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/38736.png)
...
## 42. Lighting-grounded Video Generation with Renderer-based Agent Reasoning
...
## 43. Ov3R: Open-Vocabulary Semantic 3D Reconstruction from RGB Videos
...
## 45. EfficientMonoHair: Fast Strand-Level Reconstruction from Monocular Video via Multi-View Direction Fusion

> 🇯🇵 **ビデオダイナミクス理解のための統一フレームワーク**

> 💡 ビデオの動きと物理を統合理解する方法。

**著者:** Da Li, Dominik Engel, Deng Luo, Ivan Viola
...
## 46. Geometry-as-context: Modulating Explicit 3D in Scene-consistent Video Generation to Geometry Context

> 🇯🇵 **シーン一貫性ビデオ生成の幾何文脈変調**

> 💡 3D幾何を場面一貫性の文脈として活用し、リアルで一貫性のあるビデオを生成する。

**著者:** JiaKui Hu, Jialun Liu, Liying Yang, Xinliang Zhang, Kaiwen Li, Shuang Zeng, Yuanwei Li, Haibin Huang, Chi Zhang, Yanye Lu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Hu_Geometry-as-context_Modulating_Explicit_3D_in_Scene-consistent_Video_Generation_to_Geometry_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.21929)
...
## 47. Hierarchical Codec Diffusion for Video-to-Speech Generation

> 🇯🇵 **ビデオ処理技術**

> 💡 ビデオ処理技術

**著者:** Jiaxin Ye, Gaoxiang Cong, Chenhui Wang, Xin-Cheng Wen, Zhaoyang Li, Boyuan Cao, Hongming Shan
...
## 48. ForeHOI: Feed-forward 3D Object Reconstruction from Daily Hand-Object Interaction Videos
...
## 49. Any2Any 3D Diffusion Models with Knowledge Transfer: A Radiotherapy Planning Study
...
## 50. MotionEnhancer: Leveraging Video Diffusion for Motion-Enhanced Vision-Language Models
...
## 51. Hear What Matters! Text-conditioned Selective Video-to-Audio Generation

> 🇯🇵 **ビデオ処理技術**

> 💡 ビデオ処理技術

**著者:** Junwon Lee, Juhan Nam, Jiyoung Lee
...
## 52. VideoRealBench: A Chain-of-Thought Realism Evaluation Benchmark for Generated Human-Centric Videos

> 🇯🇵 **VideoRealBench: 思考チェーン型動画現実性評価ベンチマーク**

> 💡 生成動画の現実性評価: 思考チェーン推論を用いて生成動画の現実的妥当性を体系的に評価

**著者:** Min Yang, Xinwen Zhang, Jialei Tang, Xin Zhou, Kehan Li, Zeyi Huang, Limin Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yang_VideoRealBench_A_Chain-of-Thought_Realism_Evaluation_Benchmark_for_Generated_Human-Centric_Videos_CVPR_2026_paper.html)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/38670.png)
...
## 53. Unified Spatiotemporal Token Compression for Video-LLMs at Ultra-Low Retention

> 🇯🇵 **ビデオ処理技術**

> 💡 ビデオ処理技術

**著者:** Junhao Du, XUE JIALONG, Anqi Li, Jincheng Dai, Guo Lu
...
## 54. FoleyDirector: Directing Temporal Controllable Video-to-Audio Generation via Fine-Grained Temporal Scripts

> 🇯🇵 **ビデオ処理技術**

> 💡 ビデオ処理技術

**著者:** You Li, Dewei Zhou, Fan Ma, Fu Li, Dongliang He, Yi Yang
...
## 55. Thinking with Video: Video Generation as a Promising Multimodal Reasoning Paradigm

> 🇯🇵 **Thinking with Video: 有望なマルチモーダル推論パラダイムとしての動画生成**

> 💡 動画生成を統一媒体とする新たなマルチモーダル推論枠組みを提案
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Tong_Thinking_with_Video_Video_Generation_as_a_Promising_Multimodal_Reasoning_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.04570) | [🌐 Project](https://github.com/tongjingqi/Thinking-with-Video)

**Session:** Poster Session 6


![Poster](posters/video_generation/39525.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/tongjingqi/Thinking-with-Video" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 56. TempoControl: Temporal Attention Guidance for Text-to-Video Models
...
## 57. Pantheon360: Taming Digital Twin Generation via 3D-Aware 360° Video Diffusion
...
## 58. SimRecon: SimReady Compositional Scene Reconstruction from Real Videos
...
## 59. Benchmarking Single-Factor Physical Video-to-Audio Generation

> 🇯🇵 **単一要因物理ビデオ音声生成ベンチマーク**

> 💡 ビデオ生成モデルの物理推論能力を評価するベンチマークFlatSoundsを提案し、キャプション依存性と物理精度の相互作用を明らかにした。

**著者:** Tingle Li, Siddharth Gururani, Kevin Shih, Gantavya Bhatt, Sang-gil Lee, Zhifeng Kong, Arushi Goel, Gopala Anumanchipalli, Ming-Yu Liu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_Benchmarking_Single-Factor_Physical_Video-to-Audio_Generation_CVPR_2026_paper.html)
...
> 💡 大規模ビデオで事前学習したモデルの3D理解度を測定し、生成モデルが3D専門モデルを超える認識を持つことを示す。

**著者:** Zixuan Huang, Xiang Li, Zhaoyang Lv, James M.

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Huang_How_Much_3D_Do_Video_Foundation_Models_Encode_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.19949)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/36662.png)
...
## 61. Active Intelligence in Video Avatars via Closed-loop World Modeling

> 🇯🇵 **ビデオ処理技術**

> 💡 ビデオ処理技術

**著者:** Xuanhua He, Tianyu Yang, Ke Cao, Rui-Qi Wu, Cheng Meng, Yong Zhang, Zhuoliang Kang, Xiaoming Wei, Qifeng Chen
...
## 62. Ani3DHuman: Photorealistic 3D Human Animation with Self-guided Stochastic Sampling
...
## 63. Hear What You See: Video-to-Audio Generation with Diffusion Transformer and Semantic-Temporal Alignment-Ranked Direct Preference Optimization
...
## 64. ReHyAt: Recurrent Hybrid Attention for Video Diffusion Transformers
...
## 65. EvoID: Reinforced Evolution for Identity-Preserving Video Generation

> 🇯🇵 **EvoID: Identity-Preserving Video Generationのための強化進化**

> 💡 動的報酬とTeacher-Studentで本人性を保つ動画生成を強化

**著者:** Yiheng Zhang, Zhaofan Qiu, Zunxu Liu, Yingwei Pan, Ting Yao, Tao Mei

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_EvoID_Reinforced_Evolution_for_Identity-Preserving_Video_Generation_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/video_generation/36684.png)
...
## 66. Transition Matching Distillation for Fast Video Generation
...
## 67. ELITE: Efficient Gaussian Head Avatar from a Monocular Video via Learned Initialization and Test-time Generative Adaptation

> 🇯🇵 **ビデオ処理技術**

> 💡 ビデオ処理技術

**著者:** Kim Youwang, Lee Hyoseok, Park Subin, Gerard Pons-Moll, Tae-Hyun Oh

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://kim-youwang.github.io/elite)
...
<iframe src="https://kim-youwang.github.io/elite" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 68. Vanast: Virtual Try-On with Human Image Animation via Synthetic Triplet Supervision
...
## 69. Beyond Fixed Formulas: Data-Driven Linear Predictor for Efficient Diffusion Models
...
## 70. Improving Motion in Image-to-Video Models via Adaptive Low-Pass Guidance

> 🇯🇵 **適応的Low-Pass GuidanceによるImage-to-Videoモデルの動き改善**

> 💡 初期denoisingで低周波化しI2V動画の運動量と整合性を向上

**著者:** William June Suk Choi, Kyungmin Lee, Sihyun Yu, Yisol Choi, Jinwoo Shin, Kimin Lee

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Choi_Improving_Motion_in_Image-to-Video_Models_via_Adaptive_Low-Pass_Guidance_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2506.08456) | [🌐 Project](https://choi403.github.io/ALG/)
...
<iframe src="https://choi403.github.io/ALG/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 71. HumanVBench: Probing Human-Centric Video Understanding in MLLMs with Automatically Synthesized Benchmarks
...
## 72. Reconstruction-Guided Slot Curriculum: Addressing Object Over-Fragmentation in Video Object-Centric Learning
...
## 74. TV2TV: A Unified Framework for Interleaved Language and Video Generation

> 🇯🇵 **言語と動画の統一インターリーブ生成フレームワーク**

> 💡 言語とフレーム予測を交互に行うトランスフォーマ混合で、複雑な動画生成において言語推論で動作決定を支援する統一生成モデルを提案した。

**著者:** Xiaofeng Zhang, Youssef Emad, Melissa Hall, John Nguyen, Karthik Padthe, Liam Robbins, Amir Bar, Delong Chen, Michal Drozdzal, Maha Elbayad, Yushi Hu, Shang-Wen Li, Jakob Verbeek, XuDong Wang, Marjan Ghazvininejad, Luke Zettlemoyer, Emily Dinan

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Han_TV2TV_A_Unified_Framework_for_Interleaved_Language_and_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.05103)
...
## 75. Accelerating Diffusion-based Video Editing via Heterogeneous Caching: Beyond Full Computing at Sampled Denoising Timestep

> 🇯🇵 **異種計算による拡散型動画編集の高速化**

> 💡 異種計算資源統合: GPU・CPU等の異なる計算資源を効果的に組み合わせ編集を加速

**著者:** Tianyi Liu, Ye Lu, Linfeng Zhang, Chen Cai, Jianjun Gao, Yi Wang, Kim-Hui Yap, Lap-Pui Chau

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liu_Accelerating_Diffusion-based_Video_Editing_via_Heterogeneous_Caching_Beyond_Full_Computing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.24260)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/37741.png)
...
## 76. WorldStereo: Bridging Controllable Video Generation and Scene Reconstruction via 3D Geometric Memories
...
## 79. Efficient Training for Human Video Generation with Entropy-Guided Prioritized Progressive Learning
...
## 80. Generative Video Compression with One-Dimensional Latent Representation

> 🇯🇵 **一次元潜在表現による生成的動画圧縮**

> 💡 1次元潜在トークンで空間・時間冗長性を削減し動画圧縮効率を向上

**著者:** Zihan Zheng, Zhaoyang Jia, Naifu Xue, Jiahao Li, Bin Li, Zongyu Guo, Xiaoyi Zhang, Zhenghao Chen, Houqiang Li, Yan Lu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zheng_Generative_Video_Compression_with_One-Dimensional_Latent_Representation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.15302)

**Session:** Poster Session 6


![Poster](posters/video_generation/38329.png)
...
## 81. Real-Time Generation of Streamable Talking Portrait Video with Reference-Guided Deep Compression VAEs
...
## 82. HVG-3D: Bridging Real and Simulation Domains for 3D-Conditional Hand-Object Interaction Video Synthesis

> 🇯🇵 **確率的スコアマッチング規制による拡散モデル安定性の強化**

> 💡 拡散モデルに確率的スコアマッチング正則化を導入し、学習安定性と生成品質を改善。

**著者:** Mingjin Chen, Junhao Chen, Zhaoxin Fan, Yujian Lee, Zichen Dang, Lili Wang, Yawen Cui, Lap-Pui Chau, Yi Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chen_HVG-3D_Bridging_Real_and_Simulation_Domains_for_3D-Conditional_Hand-Object_Interaction_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.03305)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/38501.png)
...
## 85. Goal Force: Teaching Video Models To Accomplish Physics-Conditioned Goals

> 🇯🇵 **Goal Force: 動画モデルが物理的タスク達成を学習**

> 💡 目標志向型動画生成: 物理シミュレーションと報酬設計で特定の物理タスク達成を目指す動画を生成

**著者:** Nate Gillman, Yinghua Zhou, Zitian Tang, Evan Luo, Arjan Chakravarthy, Daksh Aggarwal, Michael Freeman, Chen Sun

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Gillman_Goal_Force_Teaching_Video_Models_To_Accomplish_Physics-Conditioned_Goals_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.05848) | [🌐 Project](https://goal-force.github.io/)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/36562.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://goal-force.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 86. FlashVSR: Towards Real-time Diffusion-Based Streaming Video Super Resolution
...
## 87. Your One-Stop Solution for AI-Generated Video Detection

> 🇯🇵 **AI生成動画検出のための包括的ベンチマーク**

> 💡 31個の生成モデルと440K動画により、33個の検出器の1500以上の評価を実施し、AI生成動画検出の包括的分析を提供した。

**著者:** Long Ma, Zihao Xue, Yan Wang, Zhiyuan Yan, Jin Xu, Xiaorui Jiang, Haiyang Yu, Yong Liao, Zhen Bi

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ma_Your_One-Stop_Solution_for_AI-Generated_Video_Detection_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.11035)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/37101.png)
...
## 88. Exploring Spatiotemporal Feature Propagation for Video-Level Compressive Spectral Reconstruction: Dataset, Model and Benchmark

> 🇯🇵 **ビデオ処理技術**

> 💡 ビデオ処理技術

**著者:** Lijing Cai, Zhan Shi, Chenglong Huang, Jinyao Wu, Qiping Li, Zikang Huo, Linsen Chen, Chongde Zi, Xun Cao

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://github.com/nju-cite/DynaSpec)
...
<iframe src="https://github.com/nju-cite/DynaSpec" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 89. Skyra: AI-Generated Video Detection via Grounded Artifact Reasoning

> 🇯🇵 **根拠的人工物推論によるAI生成動画検出**

> 💡 AI生成動画の知覚可能な視覚人工物を識別し、その根拠に基づいて検出と説明を行うマルチモーダル大規模言語モデルを提案した。

**著者:** Yifei Li, Wenzhao Zheng, Yanran Zhang, Runze Sun, Yu Zheng, Lei Chen, Jie Zhou, Jiwen Lu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_Skyra_AI-Generated_Video_Detection_via_Grounded_Artifact_Reasoning_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.15693)
...
## 90. Illumination-Consistent Human-Scene Reconstruction from Monocular Video

> 🇯🇵 **ビデオ処理技術**

> 💡 ビデオ処理技術

**著者:** Rongbin Zheng, Wensheng Li, Lingzhe Zeng, Dong Wang, Chengying Gao
...
## 91. Diverse Video Generation with Determinantal Point Process-Guided Policy Optimization
...
## 92. Adaptive Video Distillation: Mitigating Oversaturation and Temporal Collapse in Few-Step Generation
...
## 93. PHANTOM: Physics-Infused Video Generation via Joint Modeling of Visual and Latent Physical Dynamics

> 🇯🇵 **PHANTOM: 視覚と潜在物理ダイナミクスの共同モデリングによる物理注入型動画生成**

> 💡 潜在物理状態を同時推定し視覚的かつ物理一貫な未来動画を生成する

**著者:** Ying Shen, Jerry Xiong, Tianjiao Yu, Ismini Lourentzou

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Shen_PHANTOM_Physics-Infused_Video_Generation_via_Joint_Modeling_of_Visual_and_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.08503)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/39897.png)
...
## 94. TempoMaster: Efficient Long Video Generation via Next-Frame-Rate Prediction

> 🇯🇵 **TempoMaster: 効率的長編動画生成のためのニューラルキャッシュ**

> 💡 長時間動画の効率生成: ニューラルキャッシュ活用で長編動画を高速かつ高品質に生成

**著者:** Yukuo Ma, Cong Liu, Junke Wang, Junqi Liu, Haibin Huang, Zuxuan Wu, Chi Zhang, Xuelong Li

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ma_TempoMaster_Efficient_Long_Video_Generation_via_Next-Frame-Rate_Prediction_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.12578)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/38022.png)
...
## 95. StreamingTOM: Streaming Token Compression for Efficient Video Understanding

> 🇯🇵 **ビデオ処理技術**

> 💡 ビデオ処理技術

**著者:** Xueyi Chen, Keda Tao, Kele Shao, Huan Wang
...
## 96. GauMVC: Generative Decoupled Gaussian Representation for Human-centric Multi-view Video Compression

> 🇯🇵 **ビデオ処理技術**

> 💡 ビデオ処理技術

**著者:** Ruoke Yan, Mingjia Yang, Xinfeng Zhang, Haocheng Tang, Qian Yin, Zhipin Deng, Kai Zhang, Li zhang, Siwei Ma
...
## 97. Accelerating Autoregressive Video Diffusion via History-Guided Cache and Residual Correction
...
## 98. PLACID: Identity-Preserving Multi-Object Compositing via Video Diffusion with Synthetic Trajectories
...
## 99. Spk2VidNet: A Hierarchical Recurrent Architecture for High-Fidelity Video Reconstruction from Long Spike-Camera Streams

> 🇯🇵 **Spk2VidNet: スパイクカメラストリームからの高忠実度ビデオ再構成**

> 💡 スパイクカメラストリームから高品質ビデオを再構成。

**著者:** Yuanlin Wang, Ruiqin Xiong, Jiyu Xie, Zhenkun Zhu, Zhaofei Yu, Xiaopeng Fan, Tiejun Huang
...
## 100. What Are You Doing? A Closer Look at Controllable Human Video Generation

> 🇯🇵 **操作可能な人物ビデオ生成の詳細分析**

> 💡 テキスト・姿勢・動作指令の異なる操作条件下での人物ビデオ生成の詳細検証を行う。

**著者:** Emanuele Bugliarello, Anurag Arnab, Roni Paiss, Christy Koh, Pieter-Jan Kindermans, Cordelia Schmid

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Bugliarello_What_Are_You_Doing_A_Closer_Look_at_Controllable_Human_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2503.04666)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/38705.png)
...
## 101. Scaling4D: Pushing the Frontier of Video Novel View Synthesis through Large-Scale Monocular Videos

> 🇯🇵 **Scaling4D: 大規模単眼ビデオによるビデオ新規視点合成推進**

> 💡 大規模単眼ビデオで視点合成を推進する手法。

**著者:** Hongrui Cai, Junjie Luo, Zhihong Fu, Shengnan Zhu, Jiawei Wen, Wanquan Feng, Songtao Zhao, Qian HE
...
## 102. PAM: A Pose–Appearance–Motion Engine for Sim-to-Real HOI Video Generation

> 🇯🇵 **PAM: ロボット制御のための姿勢・外観・動作エンジン**

> 💡 ロボット学習の転移学習: シミュレーション環境の姿勢・外観・動作情報を実機制御に効果的に転移させるエンジン

**著者:** Mingju Gao, Kaisen Yang, Huan-ang Gao, Bohan Li, Ao Ding, Wenyi Li, Yangcheng Yu, Jinkun Liu, Shaocong Xu, Yike Niu, Haohan Chi, Hao Chen, Hao Tang, Yu Zhang, Li Yi, Hao Zhao

**Links:** [📄 Paper](https://cvpr.thecvf.com/virtual/2026/poster/36577)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/36577.png)
...
## 103. Omni2Sound: Towards Unified Video-Text-to-Audio Generation

> 🇯🇵 **全情報源音声生成：統一ビデオテキスト音声生成**

> 💡 動画・テキストから統一的に音声を生成する全情報対応モデルを開発する。

**著者:** yusheng dai, Zehua Chen, Yuxuan Jiang, Qiuhong Ke, Jianfei Cai, Jun Zhu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Dai_Omni2Sound_Towards_Unified_Video-Text-to-Audio_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.02731)
...
## 105. Chain of Event-Centric Causal Thought for Physically Plausible Video Generation
...
## 106. Towards Realistic and Consistent Orbital Video Generation via 3D Foundation Priors

> 🇯🇵 **現実的で一貫した円軌道動画生成への取り組み**

> 💡 円軌道カメラ動画の現実化: カメラが円軌道を描く動画を現実的で時間的に一貫して生成

**著者:** Rong Wang, Ruyi Zha, Ziang Cheng, Jiayu Yang, Pulak Purkait, Hongdong Li

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Towards_Realistic_and_Consistent_Orbital_Video_Generation_via_3D_Foundation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.12309)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/37613.png)
...
## 107. Reasoning Diffusion for Unpaired Test Time Out-of-distribution Text-Image to Video Generation

> 🇯🇵 **分布外テキスト画像ビデオ生成の推論拡散**

> 💡 推論ベース拡散で分布外データへの汎化能力を強化したビデオ生成を実現する。

**著者:** Zirui Pan, Xin Wang, Yipeng Zhang, Hong Chen, Kecheng Zheng, Wenwu Zhu
...
![Poster](posters/video_generation/37798.png)
...
## 108. StereoWorld: Geometry-Aware Monocular-to-Stereo Video Generation

> 🇯🇵 **StereoWorld: 幾何認識型単眼からステレオへの動画生成**

> 💡 幾何正則化と大規模学習データで高忠実な単眼ステレオ変換を実現
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xing_StereoWorld_Geometry-Aware_Monocular-to-Stereo_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.09363)

**Session:** Poster Session 6


![Poster](posters/video_generation/36229.png)
...
## 109. FUN REC Reconstructing Functional 3D Scenes from Egocentric Interaction Videos

> 🇯🇵 **FUN REC: 一人称相互作用ビデオから機能的3Dシーン再構成**
...
**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://functionalscenes.github.io)
...
<iframe src="https://functionalscenes.github.io" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 110. HoloCine: Holistic Generation of Cinematic Multi-Shot Long Video Narratives

> 🇯🇵 **全体的多シーン長動画物語生成シネマティック化**

> 💡 複数シーンを協調制御して長編映画風の物語ビデオを生成する。

**著者:** Yihao Meng, Hao Ouyang, Yue Yu, Qiuyu Wang, Wen Wang, Ka Leong Cheng, Hanlin Wang, Shuailei Ma, Yixuan LI, Chen Cheng, Yanhong Zeng, Xing Zhu, Yujun Shen, Huamin Qu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Meng_HoloCine_Holistic_Generation_of_Cinematic_Multi-Shot_Long_Video_Narratives_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.20822)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/38771.png)
...
## 111. Generating Humanless Environment Walkthroughs from Egocentric Walking Tour Videos
...
## 112. UniAVGen: Unified Audio and Video Generation with Asymmetric Cross-Modal Interactions

> 🇯🇵 **非対称クロスモーダル相互作用による統一音声ビデオ生成**

> 💡 マルチモーダル拡散モデルと非対称クロスモーダル機構により、高精度な口唇同期と意味的一貫性を備えた音声ビデオ生成を実現した。

**著者:** Guozhen Zhang, Zixiang Zhou, Teng Hu, Ziqiao Peng, Youliang Zhang, Yi Chen, Yuan Zhou, qinglin lu, Limin Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_UniAVGen_Unified_Audio_and_Video_Generation_with_Asymmetric_Cross-Modal_Interactions_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.03334)
...
> 🇯🇵 **Audio-sync ビデオインスタンス編集と粒度認識マスク精錬**
...
## 114. MotionV2V: Editing Motion in a Video
...
## 115. CineBrain: A Large-Scale Multi-Modal Audiovisual Brain Dataset for Brain-Conditioned Video Generation

> 🇯🇵 **CineBrain: 脳活動条件付きビデオ生成用マルチモーダル脳データセット**
...
**Session:** Oral Session 6B: Multimodal Reasoning
...
## 116. ShotDirector: Directorially Controllable Multi-Shot Video Generation with Cinematographic Transitions

> 🇯🇵 **映画的遷移を備えた指向可能なマルチショット動画生成**

> 💡 パラメータレベルのカメラ制御と編集パターン認識プロンプティングにより、映画的表現力を持つマルチショット動画生成を実現した。

**著者:** Xiaoxue Wu, Xinyuan Chen, Yaohui Wang, Yu Qiao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wu_ShotDirector_Directorially_Controllable_Multi-Shot_Video_Generation_with_Cinematographic_Transitions_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.10286)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/39217.png)
...
## 117. Anti-I2V: Safeguarding your Photos from Malicious Image-to-video Generation
...
## 118. DeltaQuant: 4-bit Video Diffusion Models with Spatiotemporal Delta Smoothing
...
## 119. Thermal Diffusion Matters: Infrared Spatial-Temporal Video Super-Resolution through Heat Conduction Priors

> 🇯🇵 **熱拡散に基づく赤外動画時空間超解像**

> 💡 熱伝導物理に基づくフレームワークにより、赤外動画の時空間超解像と物理的一貫性を同時に実現した。

**著者:** Mingxuan Zhou, Shuang Li, Yutang Zhang, Jing Geng, Yirui Shen, Jingxuan Kang, Fuzhen Zhuang, Shuigen Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhou_Thermal_Diffusion_Matters_Infrared_Spatial-Temporal_Video_Super-Resolution_through_Heat_Conduction_CVPR_2026_paper.html)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/38748.png)
...
## 120. Ref4D-VideoBench: Four-Dimensional Reference-Based Evaluation of Text-to-Video Generative Models

> 🇯🇵 **参照動画による4次元テキスト生成ビデオ評価ベンチマーク**

> 💡 参照ビデオを用いた細粒度多次元評価により、生成ビデオの意味・動き・時間・常識の一貫性を厳密に診断する。

**著者:** Jiajia Wei, YuJia He, Yuhan Hou, Hang Qi, Sihua Wang, Jincheng Shi, Kwok Fung Li, Zibin Zheng, Weibin Wu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wei_Ref4D-VideoBench_Four-Dimensional_Reference-Based_Evaluation_of_Text-to-Video_Generative_Models_CVPR_2026_paper.html)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/36624.png)
...
## 121. AdaCluster: Adaptive Query-Key Clustering for Sparse Attention in Video Generation

> 🇯🇵 **AdaCluster: 動画生成の疎Attentionのための適応的Query-Keyクラスタリング**

> 💡 QueryとKeyの適応的クラスタリングでDiT推論を高速化

**著者:** Haoyue Tan, Shengnan Wang, Yulin Qiao, juncheng zhang, Youhui Bai, Ping Gong, Zewen Jin, Cheng Li

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Tan_AdaCluster_Adaptive_Query-Key_Clustering_for_Sparse_Attention_in_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.18348)

**Session:** Poster Session 6


![Poster](posters/video_generation/39599.png)
...
## 122. Are Image-to-Video Models Good Zero-Shot Image Editors?
...
## 123. MuKV: Multi-Grained KV Cache Compression for Long Streaming Video Question-Answering

> 🇯🇵 **MuKV: 長時間ストリーミングビデオQA用マルチ粒度KVキャッシュ圧縮**

> 💡 長時間ビデオQA効率化キャッシュ圧縮技術。

**著者:** Junbin Xiao, Jiajun Chen, Tianxiang Sun, Xun Yang, Angela Yao
...
## 124. Phased DMD: Few-step Distribution Matching Distillation via Score Matching within Subintervals
...
## 125. VideoCoF: Unified Video Editing with Temporal Reasoner
...
## 126. Video Generation with Stable Transparency via Shiftable RGB-A Distribution Learner

> 🇯🇵 **安定透明度による移動可能RGB-A分布学習ビデオ生成**

> 💡 透明度を安定的に制御する新しい分布学習で、透明物体を含むビデオ生成を実現する。

**著者:** Haotian Dong, Wenjing Wang, Chen Li, Jing LYU, Di Lin

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Dong_Video_Generation_with_Stable_Transparency_via_Shiftable_RGB-A_Distribution_Learner_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2509.24979)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/40227.png)
...
## 127. Plenoptic Video Generation

> 🇯🇵 **全方位映像生成: プレノプティック関数による立体動画生成**

> 💡 光場理論による立体映像生成: プレノプティック関数を用いて高度な立体感を備えた全方位動画を実現

**著者:** Xiao Fu, Shitao Tang, Min Shi, Xian Liu, Jinwei Gu, Ming-Yu Liu, Dahua Lin, Chen-Hsuan Lin

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Fu_Plenoptic_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.05239)
...
## 128. GaussFusion: Improving 3D Reconstruction in the Wild with A Geometry-Informed Video Generator

> 🇯🇵 **幾何情報統合3D再構成ビデオ生成**

> 💡 幾何認識ビデオ生成で、野生環境での高精度3D再構成を実現する。

**著者:** Liyuan Zhu, Manjunath Narayana, Michal Stary, Will Hutchcroft, Gordon Wetzstein, Iro Armeni

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhu_GaussFusion_Improving_3D_Reconstruction_in_the_Wild_with_A_Geometry-Informed_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.25053)
...
## 129. LottieGPT: Tokenizing Vector Animation for Autoregressive Generation
...
## 130. DriveLaW: Unifying Planning and Video Generation in a Latent Driving World

> 🇯🇵 **DriveLaW: 潜在運転世界における計画と動画生成の統合**

> 💡 世界モデル潜在表現を共有し将来動画予測と運転軌道計画を一体化
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xia_DriveLaW_Unifying_Planning_and_Video_Generation_in_a_Latent_Driving_CVPR_2026_paper.html) | [🌐 Project](https://github.com/xiaomi-research/drivelaw)

**Session:** Poster Session 6


![Poster](posters/video_generation/37002.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/xiaomi-research/drivelaw" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 131. VidPrism: Heterogeneous Mixture of Experts for Image-to-Video Transfer

> 🇯🇵 **視覚認識のための多段階特徴抽出手法**

> 💡 画像理解において、複数スケールの特徴を効果的に統合する新しいアーキテクチャを提案した。

**著者:** Rui Lin, Chuanming Wang, Huadong Ma

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lin_VidPrism_Heterogeneous_Mixture_of_Experts_for_Image-to-Video_Transfer_CVPR_2026_paper.html)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/38143.png)
...
## 132. Gloria: Consistent Character Video Generation via Content Anchors

> 🇯🇵 **Gloria: 一貫した人物キャラクタ動画生成**

> 💡 キャラクタ一貫性維持: キャラクタの外観動きを保ちながら長時間にわたり自然な動画生成

**著者:** Yuhang Yang, Fan Zhang, Huaijin Pi, Ailing Zeng, Shuai Guo, Guowei Xu, Wei Zhai, Yang Cao, Zheng-Jun Zha

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yang_Gloria_Consistent_Character_Video_Generation_via_Content_Anchors_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.29931)

**Session:** Poster Session 6


![Poster](posters/video_generation/40247.png)
...
## 133. HandWorld: Hand-Centric Unified Video Action Generation

> 🇯🇵 **エッジデバイスでの連合学習による分散推論の実現**

> 💡 エッジデバイス上での連合学習で、プライバシーを保ちながら分散推論を実現。

**著者:** Zhihao Sun, Zhiying Du, Xitong Yang, Zuxuan Wu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Sun_HandWorld_Hand-Centric_Unified_Video_Action_Generation_CVPR_2026_paper.html)
...
## 135. EgoX: Egocentric Video Generation from a Single Exocentric Video
...
## 136. Harmony: Harmonizing Audio and Video Generation through Cross-Task Synergy

> 🇯🇵 **オーディオビデオ生成のクロスタスク相乗効果による調和化**

> 💡 音声・映像生成を統合し、相乗効果で高品質マルチモーダル生成を実現する。

**著者:** Teng Hu, Zhentao Yu, Guozhen Zhang, Zihan Su, zhengguang zhou, Youliang Zhang, Yuan Zhou, qinglin lu, Ran Yi

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Hu_Harmony_Harmonizing_Audio_and_Video_Generation_through_Cross-Task_Synergy_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.21579)
...
## 137. Goal-Driven Reward by Video Diffusion Models for Reinforcement Learning
...
## 138. AlcheMinT: Fine-grained Temporal Control for Multi-Reference Consistent Video Generation
...
## 139. StreamDiT: Real-Time Streaming Text-to-Video Generation
...
## 140. OneStory: Coherent Multi-Shot Video Generation with Adaptive Memory

> 🇯🇵 **OneStory: 一貫性のある複数ショット動画生成**

> 💡 複数ショット統合生成: 異なるカメラアングルからの複数ショットを統合してストーリー性のある一貫した動画を生成
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/An_OneStory_Coherent_Multi-Shot_Video_Generation_with_Adaptive_Memory_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.07802)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/37293.png)
...
> 🇯🇵 **大規模4D再構成モデルによる場面潜在条件付けビデオ軌跡再レンダリング**

> 💡 大規模3D再構成モデルで場面情報を条件付け、高品質ビデオを再生成する。

**著者:** Mingyang Xie, Numair Khan, Tianfu Wang, Naina Dhingra, Seonghyeon Nam, Haitao Yang, Zhuo Hui, Christopher Metzler, Andrea Vedaldi, Hamed Pirsiavash, Lei Luo

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xie_LaVR_Scene_Latent_Conditioned_Generative_Video_Trajectory_Re-Rendering_using_Large_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.14674)
...
## 142. AnyLift: Scaling Motion Reconstruction from Internet Videos via 2D Diffusion

> 🇯🇵 **AnyLift: インターネットビデオからの動き再構成2D拡散スケーリング**

> 💡 インターネットビデオの動き再構成拡散法。

**著者:** Hongjie Li, Heng Yu, Jiaman Li, Hong-Xing Yu, Ehsan Adeli, C. Karen Liu, Jiajun Wu
...
## 143. STCDiT: Spatio-Temporally Consistent Diffusion Transformer for High-Quality Video Super-Resolution
...
## 145. DisCa: Accelerating Video Diffusion Transformers with Distillation-Compatible Learnable Feature Caching
...
## 146. AniMimic: Imitating 3D Animation from Video Priors
...
## 147. SwitchCraft: Training-Free Multi-Event Video Generation with Attention Controls
...
## 148. Compressed-Domain-Aware Online Video Super-Resolution

> 🇯🇵 **圧縮領域対応のオンライン動画超解像**

> 💡 圧縮形式からの直接処理: JPEG等の圧縮形式から直接リアルタイム超解像処理を実現

**著者:** Yuhang Wang, Hai Li, Shujuan Hou, Zhetao Dong, Xiaoyao Yang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Compressed-Domain-Aware_Online_Video_Super-Resolution_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.07694)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/39700.png)
...
## 149. Infinity-RoPE: Action-Controllable Infinite Video Generation Emerges From Autoregressive Self-Rollout
...
## 150. CoT-Edit: Let CoT Guide Instruction Video Editing

> 🇯🇵 **CoT-Edit: 思考チェーンで指示型動画編集を誘導**

> 💡 推論活用の自動編集: 思考チェーン推論で編集意図を正確に理解した自動動画編集

**著者:** Sen Liang, Fengbin Guan, Youliang Zhang, Xin Li, Zhibo Chen

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liang_CoT-Edit_Let_CoT_Guide_Instruction_Video_Editing_CVPR_2026_paper.html)

**Session:** Poster Session 6


![Poster](posters/video_generation/39113.png)
...
## 151. EgoControl: Controllable Egocentric Video Generation via 3D Full-Body Poses
...
## 152. ExPose: Reinforcing Video Generation Models for Extreme Pose Estimation

> 🇯🇵 **ExPose: 強化学習で動画生成モデルを改善**

> 💡 報酬最適化による品質向上: 報酬学習で生成動画の表現品質と多様性を大幅改善

**著者:** Youngho Yoon, Wonjune Cho, Hyunho Ha, Sujung Kim, Kuk-Jin Yoon

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yoon_ExPose_Reinforcing_Video_Generation_Models_for_Extreme_Pose_Estimation_CVPR_2026_paper.html)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/36566.png)
...
## 154. Denoising as Path Planning: Training-Free Acceleration of Diffusion Models with DPCache
...
## 155. FlashMotion: Few-Step Controllable Video Generation with Trajectory Guidance

> 🇯🇵 **少ステップ軌跡制御動画生成による高速動作**

> 💡 多ステップ生成から少ステップ生成への蒸留で軌跡精度を保ちながら、高速で高品質な制御可能動画生成を実現した。

**著者:** Quanhao Li, Zhen Xing, Rui Wang, Haidong Cao, Qi Dai, Daoguo Dong, Zuxuan Wu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_FlashMotion_Few-Step_Controllable_Video_Generation_with_Trajectory_Guidance_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.12146)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/37354.png)
...
## 156. VerseCrafter: Dynamic Realistic Video World Model with 4D Geometric Control
...
## 157. Single-step Diffusion-based Video Coding with Semantic-Temporal Guidance

> 🇯🇵 **単一ステップ拡散ベースセマンティック統合ビデオ符号化**

> 💡 単一ステップ拡散によるビデオ符号化。

**著者:** Naifu Xue, Zhaoyang Jia, Jiahao Li, Bin Li, Zihan Zheng, Yuan Zhang, Yan Lu
...
## 158. MusicInfuser: Making Video Diffusion Listen and Dance
...
## 159. From Static to Dynamic: Exploring Self-supervised Image-to-Video Representation Transfer Learning

> 🇯🇵 **静止から動的へ: 自己教師ありImage-to-Video表現転移学習の探究**

> 💡 時間一貫性と意味分離性の両立を図り自己教師あり動画表現転移を改善

**著者:** Yang Liu, Qianqian Xu, Peisong Wen, Siran Dai, Xilin Zhao, Qingming Huang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liu_From_Static_to_Dynamic_Exploring_Self-supervised_Image-to-Video_Representation_Transfer_Learning_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.26597)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/37533.png)
...
## 160. PyraTok: Language-Aligned Pyramidal Tokenizer for Video Understanding and Generation

> 🇯🇵 **言語整列ピラミッド型トークン化ビデオ理解生成**

> 💡 階層的トークン化により言語と整列した効率的なビデオ理解・生成モデルを実現する。

**著者:** Onkar Susladkar, Tushar Prakash, Adheesh Juvekar, Kiet A. Nguyen, Dong-Hwan Jang, Inderjit S Dhillon, Ismini Lourentzou

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Susladkar_PyraTok_Language-Aligned_Pyramidal_Tokenizer_for_Video_Understanding_and_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.16210) | [🌐 Project](https://plan-lab.github.io/projects/pyratok/)

**Session:** Poster Session 6


![Poster](posters/video_generation/39433.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://plan-lab.github.io/projects/pyratok/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 161. BAgger: Backwards Aggregation for Mitigating Drift in Autoregressive Video Diffusion Models
...
## 162. Bridging Brain and Semantics: A Hierarchical Framework for Semantically Enhanced fMRI-to-Video Reconstruction

> 🇯🇵 **脳とセマンティクス橋渡し: ビデオ理解階層フレームワーク**

> 💡 脳セマンティクス統合ビデオ理解フレームワーク。

**著者:** Yujie Wei, Chenglong Ma, Jianxiong Gao, Chenhui Wang, Shiwei Zhang, Biao Gong, Shuai Tan, Hangjie Yuan, Hongming Shan
...
## 163. AE2VID: Event-based Video Reconstruction via Aperture Modulation

> 🇯🇵 **AE2VID: イベントベースビデオ再構成絞り実験法**

> 💡 イベント駆動型ビデオ再構成技術。

**著者:** Chenxu Bai, Boyu Li, Peiqi Duan, xinyu zhou, Hanyue Lou, Boxin Shi
...
## 166. Otil: Accelerating Diffusion Model Inference via Communication-Efficient Multi-GPU Parallelism
...
## 167. Lynx: Towards High-Fidelity Personalized Video Generation

> 🇯🇵 **高忠実度個人化動画生成**

> 💡 顔埋め込みと密集VAE特徴を用いた軽量適応器で、高い個人化保持と時間的一貫性を備えた個人化動画合成を実現した。

**著者:** Shen Sang, Tiancheng Zhi, Tianpei Gu, Jing Liu, Linjie Luo

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Sang_Lynx_Towards_High-Fidelity_Personalized_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2509.15496)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/38913.png)
...
## 168. SoliReward: Mitigating Susceptibility to Reward Hacking and Annotation Noise in Video Generation Reward Models

> 🇯🇵 **SoliReward: 動画生成報酬モデルにおける報酬ハッキングとアノテーション雑音の軽減**

> 💡 単独注釈と新損失で報酬モデルの雑音耐性と報酬ハック耐性を向上

**著者:** Jiesong Lian, Ruizhe Zhong, Zixiang Zhou, Xiaoyue Mi, Long Hu, Yuan Zhou, qinglin lu, yixue Hao, Junchi Yan

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lian_SoliReward_Mitigating_Susceptibility_to_Reward_Hacking_and_Annotation_Noise_in_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.22170)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/39298.png)
...
## 169. Accelerating Streaming Video Large Language Models via Hierarchical Token Compression

> 🇯🇵 **ストリーミングビデオ大規模言語モデル加速化**
...
## 170. PAVAS: Physics-Aware Video-to-Audio Synthesis
...
## 171. Learning to Generate Highly Dynamic Videos using Synthetic Motion Data
...
## 172. TROPHIES: Temporal Reconstruction of Places, Humans, and Cameras from Multi-view Videos

> 🇯🇵 **TROPHIES: 場所と人間の時間的再構成**

> 💡 場所と人物の時間的再構成技術。

**著者:** Jinpeng Liu, Yukang Xu, Yutong Li, Xingyu Liu
...
## 173. EchoVDiff: Cardiac-Cycle Echocardiography Video Generation from Arbitrary Frame
...
## 174. EVATok: Adaptive Length Video Tokenization for Efficient Visual Autoregressive Generation

> 🇯🇵 **EVATok: 効率的ビジュアル自己回帰生成のための適応長さ動画トークン化**

> 💡 適応トークン化による効率化: 動画内容に応じてトークン長を動的に調整し生成効率を向上

**著者:** Tianwei Xiong, Jun Hao Liew, Zilong Huang, Zhijie Lin, Jiashi Feng, Xihui Liu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xiong_EVATok_Adaptive_Length_Video_Tokenization_for_Efficient_Visual_Autoregressive_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.12267)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/36588.png)
...
## 175. TextOVSR: Text-Guided Real-World Opera Video Super-Resolution

> 🇯🇵 **テキスト誘導オペラ動画超解像**

> 💡 分解記述テキストと内容記述テキストで異なる支構造を指定し、現実的な劣化オペラ動画の超解像を実現した。

**著者:** Hua Chang, Xin Xu, Wei Liu, Jiayi Wu, Kui Jiang, Fei Ma, Qi Tian

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Chang_TextOVSR_Text-Guided_Real-World_Opera_Video_Super-Resolution_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.15153)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/39100.png)
...
## 176. Stand-In: A Lightweight and Plug-and-Play Identity Control for Video Generation
...
## 177. TEAR: Temporal-aware Automated Red-teaming for Text-to-Video Models

> 🇯🇵 **テキスト生成ビデオモデルの時間認識自動赤チーム化**

> 💡 時間的要素を考慮した対抗的攻撃で生成モデルの脆弱性を自動検出する。

**著者:** Jiaming He, Guanyu Hou, Hongwei Li, Zhicong Huang, Kangjie Chen, Yi Yu, Wenbo Jiang, Guowen Xu, Tianwei Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/He_TEAR_Temporal-aware_Automated_Red-teaming_for_Text-to-Video_Models_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.21145)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/39111.png)
...
## 178. Cross-Subject EEG-to-Video Reconstruction and Beyond

> 🇯🇵 **被験者間EEGからビデオ再構成と応用**

> 💡 脳波信号からビデオを再構成する方法。

**著者:** Runduo Han, Hongchen Tan
...
## 179. EasyV2V: A High-quality Instruction-based Video Editing Framework
...
## 180. NOVA: Sparse Control, Dense Synthesis for Pair-Free Video Editing
...
## 181. RAPID: Reusing Attention Sparsity with Inter-step Adaptation for Efficient Video Diffusion
...
## 182. Cross-Modal Emotion Transfer for Emotion Editing in Talking Face Video
...
**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://chanhyeok-choi.github.io/C-MET/)
...
<iframe src="https://chanhyeok-choi.github.io/C-MET/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 183. GT-SVJ: Generative-Transformer-Based Self-Supervised Video Judge For Efficient Video Reward Modeling

> 🇯🇵 **生成トランスフォーマー基盤自己教師ビデオ評価者**

> 💡 ビデオ品質を効率的に評価する自己教師学習ベースの報酬モデルを開発する。

**著者:** Shivanshu Shekhar, Uttaran Bhattacharya, Raghavendra Addanki, Mehrab Tanjim, Somdeb Sarkhel, Tong Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Shekhar_GT-SVJ_Generative-Transformer-Based_Self-Supervised_Video_Judge_For_Efficient_Video_Reward_Modeling_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.05202)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/39856.png)
...
## 184. Tracking-Guided 4D Generation: Foundation-Tracker Motion Priors for 3D Model Animation
...
## 185. VGA-Bench: A Unified Benchmark and Multi-Model Framework for Video Aesthetics and Generation Quality Evaluation

> 🇯🇵 **ビデオ美的品質統合評価ベンチマーク**

> 💡 ビデオの美的・生成品質を統一的に評価する複合型フレームワークとベンチマークを提供する。

**著者:** Longteng Jiang, DanDan Zheng, Qianqian Qiao, Heng Huang, Huaye Wang, Yihang Bo, Bao Peng, Jingdong Chen, JUN ZHOU, Xin Jin

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Jiang_VGA-Bench_A_Unified_Benchmark_and_Multi-Model_Framework_for_Video_Aesthetics_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.10127)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/37438.png)
...
## 186. DetectSCI: Toward Object-Guided ROI Reconstruction for High-Resolution Video Snapshot Compressive Imaging

> 🇯🇵 **DetectSCI: オブジェクト誘導ROI再構成**

> 💡 物体誘導型ROI領域再構成技術。

**著者:** Xingjian Jiang, Lishun Wang, Ping Wang, Xin Yuan
...
## 187. Stereo World Model: Camera-Guided Stereo Video Generation

> 🇯🇵 **立体世界モデル: カメラ誘導による立体動画生成**

> 💡 カメラ制御による立体映像生成: カメラパラメータを自在に制御して高度な立体感ある動画を生成

**著者:** Yangtian Sun, Zehuan Huang, Yifan Niu, Lin Ma, Yan-Pei Cao, Yuewen Ma, Xiaojuan Qi

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Sun_Stereo_World_Model_Camera-Guided_Stereo_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.17375)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/40111.png)
...
## 188. UniComp: Rethinking Video Compression Through Informational Uniqueness

> 🇯🇵 **UniComp: 情報論理によるビデオ圧縮再考**

> 💡 情報理論ベースビデオ圧縮手法。

**著者:** Chao Yuan, Shimin Chen, Minliang Lin, Limeng Qiao, Guanglu Wan, Lin Ma

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://github.com/TimeMarker-LLM/UniComp)
...
<iframe src="https://github.com/TimeMarker-LLM/UniComp" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 189. Generative Video Motion Editing with 3D Point Tracks

> 🇯🇵 **3D点軌跡を用いた生成動画の動作編集**

> 💡 3D軌跡による動画編集: 3次元点軌跡情報を活用してAI生成動画の動作を柔軟かつ正確に編集

**著者:** Yao-Chih Lee, Zhoutong Zhang, Gabriel Huang, Jui-Hsien Wang, Joon-Young Lee, Jia-Bin Huang, Eli Shechtman, Zhengqi Li

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lee_Generative_Video_Motion_Editing_with_3D_Point_Tracks_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.02015)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/39272.png)
...
## 190. MoReGen: Multi-Agent Motion-Reasoning Engine for Code-based Text-to-Video Synthesis

> 🇯🇵 **コード領域物理推論エンジンによるテキスト動画生成**

> 💡 複数エージェント大規模言語モデルと物理シミュレータを統合し、ニュートン力学に準拠した物理的に正確な動画生成を実現した。

**著者:** Xiangyu Bai, He Liang, Bishoy Galoaa, Utsav Nandi, Shayda Moezzi, Yuhang He, Sarah Ostadabbas

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Bai_MoReGen_Multi-Agent_Motion-Reasoning_Engine_for_Code-based_Text-to-Video_Synthesis_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.04221)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/36837.png)
...
## 191. One-Shot Flow, Any-Time Frame: A Bidirectional Warping Framework for Event-Based Video Frame Interpolation

> 🇯🇵 **One-Shot Flow, Any-Time Frame: 双方向補間**

> 💡 単一光フロー双方向フレーム補間。

**著者:** Linghui Fu, Yuhan Liu, Hao Chen, Zhen Yang, Yongjian Deng
...
## 192. Question-guided Visual Compression with Memory Feedback for Long-Term Video Understanding

> 🇯🇵 **質問誘導ビデオ圧縮メモリ効果**

> 💡 質問ガイド型ビデオ圧縮技術。

**著者:** Sosuke Yamao, Natsuki Miyahara, Yuankai Qi, Shun Takeuchi
...
## 193. NS-Diff: Fluid Navier–Stokes Guided Video Diffusion via Reinforcement Learning

> 🇯🇵 **NS-Diff: 強化学習による流体Navier-Stokes誘導動画Diffusion**

> 💡 Navier-Stokes制約と物理注入で流体・剛体動画の妥当性を向上

**著者:** Zijun Deng, Yuxin Peng

**Links:** [📄 Paper](https://cvpr.thecvf.com/virtual/2026/poster/36346)

**Session:** Poster Session 6


![Poster](posters/video_generation/36346.png)
...
## 194. Attention Surgery: An Efficient Recipe to Linearize Your Video Diffusion Transformer
...
## 197. DynamicsBoost: Dynamic Plausible Video Generation via Annotation-Free Continuation Preference Optimization

> 🇯🇵 **動力学推定によるビデオ生成品質向上**

> 💡 物理的に妥当な動力学制約で、より自然で物理的に正確なビデオ生成を実現する。

**著者:** Jiaxing Li, Jiepeng Wang, Junyao Gao, Yang Liu, Eric Li, Bo An, Hao-Xiang Guo

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_DynamicsBoost_Dynamic_Plausible_Video_Generation_via_Annotation-Free_Continuation_Preference_Optimization_CVPR_2026_paper.html)
...
## 198. UnityVideo: Unified Multi-Modal Multi-Task Learning for Enhancing World-Aware Video Generation

> 🇯🇵 **世界認識強化マルチモーダルマルチタスク学習動画生成**

> 💡 複数のセグメンテーションと動作表現に統一的に対応する拡散モデルで、物理制約を備えた高品質な動画生成を実現した。

**著者:** Jiehui Huang, Yuechen Zhang, Xu He, Yuan Gao, Zhi Cen, Bin Xia, Yan Zhou, Xin Tao, Pengfei Wan, Jiaya Jia

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Huang_UnityVideo_Unified_Multi-Modal_Multi-Task_Learning_for_Enhancing_World-Aware_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.07831)
...
## 199. VDFE: Difference-Aware 3D Scene Editing with Non-Intrusive Video Diffusion Priors for Multi-View Consistency and Efficiency

> 🇯🇵 **VDFE: 差分考慮型の非介入3Dシーン編集**

> 💡 非介入3D編集技術: 差分情報に基づき直感的に3次元シーンの細微な変更を実現可能に

**著者:** Chao Zhang, Fang Liu, Shuo Li, Yang Liu, Jiahao Wang, Xinyan Huang, Lingling Li, Puhua Chen, Xu Liu, Wenping Ma, Siqi Yu
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Tan_SynMotion_Semantic-Visual_Adaptation_for_Motion_Customized_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2506.23690)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/39125.png)
...
## 201. SURF: Signature-Retained Fast Video Generation

> 🇯🇵 **特徴保持高速動画生成**

> 💡 ノイズ再シフトと段階的解像度切り替えで、元モデルの特徴を保持しながら高解像度動画生成を大幅に高速化した。

**著者:** Kaixin Ding, Xi Chen, Sihui Ji, Yuan Gao, Liang Hou, Xin Tao, Hengshuang Zhao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ding_SURF_Signature-Retained_Fast_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.21002) | [🌐 Project](https://kxding.github.io/project/SURF/)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/38746.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://kxding.github.io/project/SURF/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 202. EgoEdit: Dataset, Real-Time Streaming Model, and Benchmark for Egocentric Video Editing

> 🇯🇵 **EgoEdit: 一人称映像編集のためのデータセット・実時間モデル・ベンチマーク**

> 💡 一人称映像の革新的編集: 実時間処理可能で使いやすいエゴセントリック動画編集システムの構築と評価
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_EgoEdit_Dataset_Real-Time_Streaming_Model_and_Benchmark_for_Egocentric_Video_CVPR_2026_paper.html)
...
## 203. Perceptual Neural Video Compression with Color Separation and Rank Chain

> 🇯🇵 **知覚ニューラルビデオ圧縮色分離**

> 💡 色分離型知覚ビデオ圧縮。

**著者:** xiongzhuang liang, Chuanbo Tang, Zhuoyuan Li, Li Li, Dong Liu
...
## 204. V-RGBX: Video Editing with Accurate Controls over Intrinsic Properties

> 🇯🇵 **V-RGBX: RGB情報と追加データによる精密動画編集**

> 💡 多様な制御信号による動画編集: RGB情報に加えて追加データチャネルを活用した正確な動画編集

**著者:** Ye Fang, Tong Wu, Valentin Deschaintre, Duygu Ceylan, Iliyan Georgiev, Chun-Hao Huang, Yiwei Hu, Xuelin Chen, Tuanfeng Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Fang_V-RGBX_Video_Editing_with_Accurate_Controls_over_Intrinsic_Properties_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.11799)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/39040.png)
...
## 205. Real-Time Neural Video Compression with Unified Intra and Inter Coding

> 🇯🇵 **リアルタイムニューラルビデオ圧縮統一情報**

> 💡 リアルタイム処理ニューラル圧縮。

**著者:** Hui Xiang, Yifan Bian, Li Li, Jingran Wu, Xianguo Zhang, Dong Liu
...
## 206. Towards Holistic Modeling for Video Frame Interpolation with Auto-regressive Diffusion Transformers

> 🇯🇵 **ビデオフレーム補間全体的モデリング**

> 💡 フレーム補間の全体的モデリング。

**著者:** Xinyu Peng, Han Li, Yuyang Huang, Ziyang Zheng, Yaoming Wang, Xin Chen, Wenrui Dai, Chenglin Li, Junni Zou, Hongkai Xiong
...
> 🇯🇵 **無限世界：リアルタイム3D認識長動画生成**

> 💡 3D認識メカニズムで、任意長の一貫性ある長動画をリアルタイム生成する。

**著者:** Ke Zhang, Jiacong Xu, Yiqun Mei, Vishal M. Patel

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_Endless_World_Real-Time_3D-Aware_Long_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.12430)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/38750.png)
...
## 208. DTG-Restore: Training-Free Diffusion Refinement for Generative Video Super-Resolution
...
## 209. ID-Crafter: VLM-Grounded Online RL for Compositional Multi-Subject Video Generation

> 🇯🇵 **ID-Crafter: VLM基盤のオンライン強化学習**

> 💡 身元保持型動画構成: ビジョン言語モデルと強化学習で身元情報を保ちながら動画生成

**著者:** Panwang Pan, Jingjing Zhao, Yuchen Lin, Chenguo Lin, Chenxin Li, Hengyu Liu, Tingting Shen, Yadong Mu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Pan_ID-Crafter_VLM-Grounded_Online_RL_for_Compositional_Multi-Subject_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2511.00511)
...
## 210. TEAR: Temporal-aware Automated Red-teaming for Text-to-Video Models
...
## 211. Inference-time Physics Alignment of Video Generative Models with Latent World Models

> 🇯🇵 **推論時物理整合性による動画生成モデルの改善**

> 💡 生成動画の現実性向上: 推論時に物理法則を適用して生成動画の物理的一貫性と妥当性を確保

**著者:** Jianhao Yuan, Zhang Xiaofeng, Felix Friedrich, Nicolas Beltran-Velez, Melissa Hall, Reyhane Askari, Xiaofeng Zhang, Nicolas Ballas, Michal Drozdzal, Adriana Romero-Soriano

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yuan_Inference-time_Physics_Alignment_of_Video_Generative_Models_with_Latent_World_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.10553)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/37877.png)
...
## 212. CoCoVideo: The High-Quality Commercial-Model-Based Contrastive Benchmark for AI-Generated Video Detection

> 🇯🇵 **CoCoVideo: AI生成動画検出のための高品質商用モデルベース対照ベンチマーク**

> 💡 商用生成器由来の高品質偽動画対で検出性能と汎化性を厳密評価する

**著者:** Huidong Feng, Wentao Chen, Jie Chen, Xinqi Cai, Ruolong Ma, Yinglin Zheng, Yuxin Lin, Ming Zeng

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Feng_CoCoVideo_The_High-Quality_Commercial-Model-Based_Contrastive_Benchmark_for_AI-Generated_Video_Detection_CVPR_2026_paper.html)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/37152.png)
...
## 213. VideoMaMa: Mask-Guided Video Matting via Generative Prior
...
## 214. VMD-FACT: A New Video Dataset and MLLM-based method for Detecting Realistic AI-Generated Video Misinformation

> 🇯🇵 **VMD-FACT: 新しい動画データセットとMLLM型ファクトチェック手法**

> 💡 動画ファクトチェック基盤: マルチモーダル大型言語モデルで動画コンテンツの事実性を自動検証

**著者:** Yongkang Zhang, Dongyu She, Baiyu Ji, Qichuan Geng, Zhong Zhou, Yan Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_VMD-FACT_A_New_Video_Dataset_and_MLLM-based_method_for_Detecting_CVPR_2026_paper.html)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/38488.png)
...
## 215. Reward Forcing: Efficient Streaming Video Generation with Rewarded Distribution Matching Distillation
...
## 216. LoL: Longer than Longer, Scaling Video Generation to Hour
...
## 217. SVBench: Evaluation of Video Generation Models on Social Reasoning

> 🇯🇵 **社会推論に基づくビデオ生成モデル評価ベンチマーク**

> 💡 社会的推論能力が必要な複雑シーン生成の評価ベンチマークを提供する。

**著者:** Wenshuo Peng, Gongxuan Wang, Tianmeng Yang, Chuanhao Li, Xiaojie Xu, Hui He, Kaipeng Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Peng_SVBench_Evaluation_of_Video_Generation_Models_on_Social_Reasoning_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.21507)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/video_generation/36501.png)
...
## 218. FFP-300K: Scaling First-Frame Propagation for Generalizable Video Editing

> 🇯🇵 **FFP-300K: 第1フレーム伝搬の大規模スケーリング**

> 💡 効率的フレーム伝搬方式: 第1フレーム情報の伝搬を大規模化して高速かつ高品質な生成を実現

**著者:** Xijie Huang, Chengming Xu, Donghao Luo, Xiaobin Hu, Peng Tang, Xu Peng, Jiangning Zhang, Chengjie Wang, Yanwei Fu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Huang_FFP-300K_Scaling_First-Frame_Propagation_for_Generalizable_Video_Editing_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.01720)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/39643.png)
...
## 219. VISTA: A Test-Time Self-Improving Video Generation Agent

> 🇯🇵 **テスト時自己改善ビデオ生成エージェント**

> 💡 テスト時に自己改善メカニズムで適応的に学習するエージェントで、生成ビデオの品質を動的に向上させる。

**著者:** Do Xuan Long, Xingchen Wan, Hootan Nakhost, Chen-Yu Lee, Tomas Pfister, Sercan O Arik

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Long_VISTA_A_Test-Time_Self-Improving_Video_Generation_Agent_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.15831)
...
## 220. InstantViR: Real-Time Video Inverse Problem Solver with Distilled Diffusion Prior
...
## 221. D2Cache: Second-Order Delta Caching for Higher Video Diffusion Acceleration
...
## 222. DreamingComics: A Story Visualization Pipeline via Subject and Layout Customized Generation using Video Models

> 🇯🇵 **キャラと配置カスタマイズによるストーリー可視化コミックス**

> 💡 主体と配置の指定でストーリーを可視化し、コミック風ビデオを生成する手法を提案する。

**著者:** Patrick Kwon, Chen Chen

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kwon_DreamingComics_A_Story_Visualization_Pipeline_via_Subject_and_Layout_Customized_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.01686)
...
## 223. NeoVerse: Enhancing 4D World Model with in-the-wild Monocular Videos

> 🇯🇵 **野生動画で拡張された4D世界モデル新版**

> 💡 単眼動画を活用して4D世界モデルの学習データを大幅に拡張する。

**著者:** Yuxue Yang, Lue Fan, Ziqi Shi, Junran Peng, Feng Wang, Zhaoxiang Zhang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yang_NeoVerse_Enhancing_4D_World_Model_with_in-the-wild_Monocular_Videos_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.00393) | [🌐 Project](https://neoverse-4d.github.io/)

**Session:** Poster Session 6


![Poster](posters/video_generation/37770.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://neoverse-4d.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 224. TGT: Text-Grounded Trajectories for Locally Controlled Video Generation

> 🇯🇵 **TGT: ローカル制御のためのテキスト軌跡学習**

> 💡 テキスト指示による軌跡制御: テキスト記述に基づいて動画内の被写体や効果の軌跡を細かく制御

**著者:** Guofeng Zhang, Angtian Wang, Jacob Fang Fang, Liming Jiang, Haotian Yang, Bo Liu, Yiding Yang, Guang Chen, Longyin Wen, Alan L. Yuille, Chongyang Ma

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_TGT_Text-Grounded_Trajectories_for_Locally_Controlled_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2510.15104)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/38830.png)
...
## 225. CineScene: Implicit 3D as Effective Scene Representation for Cinematic Video Generation
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Huang_CineScene_Implicit_3D_as_Effective_Scene_Representation_for_Cinematic_Video_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.06959)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/37186.png)
...
## 226. Identity-Preserving Image-to-Video Generation via Reward-Guided Optimization
...
## 227. F^2HDR: Two-Stage HDR Video Reconstruction via Flow Adapter and Physical Motion Modeling

> 🇯🇵 **F^2HDR: フロー型HDRビデオ再構成**

> 💡 光フロー活用HDR動画再構成。

**著者:** Huanjing Yue, Dawei Li, Shaoxiong Tu, Jingyu Yang
...
## 228. MultiAnimate: Pose-Guided Image Animation Made Extensible
...
## 229. PersonaLive! Expressive Portrait Image Animation for Live Streaming
...
## 230. 4DEquine: Disentangling Motion and Appearance for 4D Equine Reconstruction from Monocular Video

> 🇯🇵 **4DEquine: 馬の動きと外観分離**

> 💡 四足動物動き分離4D再構成。

**著者:** Jin Lyu, Liang An, Pujin Cheng, Yebin Liu, Xiaoying Tang
...
## 231. WorldReel: 4D Video Generation with Consistent Geometry and Motion Modeling

> 🇯🇵 **WorldReel: 幾何と運動の一貫モデリングによる4D動画生成**

> 💡 RGBと4D表現を同時生成し視点変化下でも整合した動画を実現

**著者:** Shaoheng Fang, Hanwen Jiang, Yunpeng Bai, Niloy J. Mitra, Qixing Huang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Fang_WorldReel_4D_Video_Generation_with_Consistent_Geometry_and_Motion_Modeling_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.07821)
...
## 232. Video-as-Answer: Predict and Generate Next Video Event with Joint-GRPO
...
## 234. Open-world Hand-Object Interaction Video Generation Based on Structure and Contact-aware Representation

> 🇯🇵 **オープンワールド手物体相互作用ビデオ生成**

> 💡 多様な手物体相互作用の自動生成: 様々な環境での手と物体の複雑な相互作用シーンを高度に生成

**著者:** Haodong Yan, Hang Yu, Zhide Zhong, Weilin Yuan, Xin Gong, Zehang Luo, Chengxi Heyu, Junfeng Li, Wenxuan Song, Shunbo Zhou, Haoang Li

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yan_Open-world_Hand-Object_Interaction_Video_Generation_Based_on_Structure_and_Contact-aware_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.01677)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/video_generation/39230.png)
...
## 235. Training-free Motion Factorization for Compositional Video Generation
...
## 236. Scaling Zero-Shot Reference-to-Video Generation

> 🇯🇵 **ゼロショット参照動画ビデオ生成のスケーリング**

> 💡 参照動画からゼロショット条件でビデオを生成する手法の大規模化を実現する。
...
**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhou_Scaling_Zero-Shot_Reference-to-Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.06905)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/37698.png)
...
## 237. One-to-All Animation: Alignment-Free Character Animation and Image Pose Transfer
...
## 238. DUO-VSR: Dual-Stream Distillation for One-Step Video Super-Resolution
...
## 239. LinVideo: A Post-Training Framework towards O(n) Attention in Efficient Video Generation
...
## 240. Spatia: Video Generation with Updatable Spatial Memory

> 🇯🇵 **更新可能空間記憶によるビデオ生成**

> 💡 空間記憶を動的に更新することで、一貫性と制御性に優れたビデオ生成を実現する。

**著者:** Jinjing Zhao, Fangyun Wei, Zhening Liu, Hongyang Zhang, Chang Xu, Yan Lu

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhao_Spatia_Video_Generation_with_Updatable_Spatial_Memory_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.15716)
...
## 241. When Numbers Speak: Aligning Textual Numerals and Visual Instances in Text-to-Video Diffusion Models
...
## 242. DreamShot: Personalized Storyboard Synthesis with Video Diffusion Prior
...
## 243. Free-Lunch Long Video Generation via Layer-Adaptive O.O.D Correction
...
## 244. Interpretable Motion-Attentive Maps: Spatio-Temporally Localizing Concepts in Video Diffusion Transformers

> 🇯🇵 **解釈可能な運動注視マップ: Video Diffusion Transformerにおける概念の時空間局在化**

> 💡 動画DiT内で運動概念に対応する対象と時刻を時空間的に可視化する

**著者:** Youngjun Jun, seil kang, Woojung Han, Seong Jae Hwang

**Links:** [📄 Paper](https://cvpr.thecvf.com/virtual/2026/poster/38242)
...
## 245. EditCtrl: Disentangled Local and Global Control for Real-Time Generative Video Editing

> 🇯🇵 **リアルタイム生成ビデオ編集の局所・大域制御分離**

> 💡 局所と大域制御を分離して、リアルタイムで柔軟なビデオ編集を実現する。

**著者:** Yehonathan Litman, Shikun Liu, Dario Seyb, Nicholas Milef, Yang Zhou, Carl Marshall, Shubham Tulsiani, Caleb Leak

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Litman_EditCtrl_Disentangled_Local_and_Global_Control_for_Real-Time_Generative_Video_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.15031)
...
## 246. Mesh4D: 4D Mesh Reconstruction and Tracking from Monocular Video

> 🇯🇵 **Mesh4D: 単眼ビデオから4Dメッシュ再構成**

> 💡 単眼動画から4Dメッシュ再構成。

**著者:** Zeren Jiang, Chuanxia Zheng, Iro Laina, Diane Larlus, Andrea Vedaldi

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://mesh-4d.github.io/)
...
<iframe src="https://mesh-4d.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 247. StreamAvatar: Streaming Diffusion Models for Real-Time Interactive Human Avatars
...
## 248. BulletTime: Decoupled Control of Time and Camera Pose for Video Generation
...
## 249. Thinking with Frames: Generative Video Distortion Evaluation via Frame Reward Model

> 🇯🇵 **フレーム報酬モデルによる生成動画歪み評価**

> 💡 フレームレベルの構造歪み認識に特化した報酬モデルで、異常な物体表現と相互作用の検出を実現した。

**著者:** Yuan Wang, Borui Liao, Huijuan Huang, Jinda Lu, Ouxiang Li, Kuien Liu, Meng Wang, Xiang Wang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Thinking_with_Frames_Generative_Video_Distortion_Evaluation_via_Frame_Reward_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2601.04033)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/video_generation/36522.png)
...
## 250. Diff4Splat: Repurposing Video Diffusion Models for Dynamic Scene Generation
...
## 251. PoseAnything: General Pose-guided Video Generation with Part-aware Temporal Coherence
...
## 252. FlowDirector: Training-Free Flow Steering for Precise Text-to-Video Editing
...
## 253. VideoWeaver: Multimodal Multi-View Video-to-Video Transfer for Embodied Agents

> 🇯🇵 **VideoWeaver: マルチモーダルマルチビュービデオ変換**

> 💡 マルチビューマルチモーダルビデオ処理。

**著者:** George Eskandar, Fengyi Shen, Mohammad Altillawi, Dong Chen, Yang Bai, Liudi Yang, Ziyuan Liu
...
## 254. Unified Camera Positional Encoding for Controlled Video Generation

> 🇯🇵 **制御型動画生成のための統一カメラ位置埋め込み**

> 💡 統一カメラ制御手法: カメラ位置を統一フレームワークで制御して自由な視点動画生成

**著者:** Cheng Zhang, Boying Li, Meng Wei, Yan-Pei Cao, Camilo Cruz Gambardella, Dinh Phung, Jianfei Cai

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_Unified_Camera_Positional_Encoding_for_Controlled_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.07237)

**Session:** Poster Session 6


![Poster](posters/video_generation/37196.png)
...
## 255. ActivityForensics: A Comprehensive Benchmark for Localizing Manipulated Activity in Videos

> 🇯🇵 **ActivityForensics: 長期活動理解ベンチマーク**

> 💡 長期活動理解ベンチマークデータセット。

**著者:** Peijun Bao, Anwei Luo, Gang Pan, Alex C. Kot, Xudong Jiang
...
## 256. CamDirector: Towards Long-Term Coherent Video Trajectory Editing

> 🇯🇵 **CamDirector: 長期一貫ビデオ軌跡生成**

> 💡 長期一貫性ビデオ軌跡生成技術。

**著者:** Kejia Yin, Zhihao Shi, Weilin Wan, Yuhongze Zhou, YUANHAO YU, Xinxin Zuo, Qiang Sun, Juwei Lu
...
## 257. CubeComposer: Spatio-Temporal Autoregressive 4K 360° Video Generation from Perspective Video
...
## 258. M4V: Multimodal Mamba for Efficient Text-to-Video Generation

> 🇯🇵 **M4V: 効率的テキスト動画生成のためのマルチモーダルMamba**

> 💡 Mambaベースの効率生成: マルチモーダルMambaで線形計算量でテキスト動画を高速生成

**著者:** Jiancheng Huang, Gengwei Zhang, Zequn Jie, Siyu Jiao, Yinlong Qian, Ling Chen, Yunchao Wei, Lin Ma

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Huang_M4V_Multimodal_Mamba_for_Efficient_Text-to-Video_Generation_CVPR_2026_paper.html)
...
## 259. STARFlow-V: End-to-End Video Generative Modeling with Autoregressive Normalizing Flows
...
## 260. 3D-Aware Implicit Motion Control for View-Adaptive Human Video Generation

> 🇯🇵 **3次元認識暗黙動作制御による視点適応人体動画生成**

> 💡 複数視点で訓練した暗黙動作表現により、2Dポーズの視点依存性と3Dモデルの不正確さを超越した人体動画生成を実現した。

**著者:** Zhixue Fang, Xu He, Songlin Tang, Haoxian Zhang, Qingfeng Li, Xiaoqiang Liu, Pengfei Wan, Kun Gai

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Fang_3D-Aware_Implicit_Motion_Control_for_View-Adaptive_Human_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2602.03796)
...
## 261. Flowception: Temporally Expansive Flow Matching for Video Generation

> 🇯🇵 **時間展開フロー整合によるビデオ生成**

> 💡 フロー整合を時間方向に展開することで、高速で高品質なビデオ生成を実現する。

**著者:** Tariq Berrada Ifriqi, John Nguyen, Karteek Alahari, Jakob Verbeek, Ricky T. Q. Chen

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ifriqi_Flowception_Temporally_Expansive_Flow_Matching_for_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2512.11438)
...
## 262. DreamStyle: A Unified Framework for Video Stylization
...
## 263. AutoCut: End-to-end advertisement video editing based on multimodal discretization and controllable generation

> 🇯🇵 **AutoCut: 広告動画編集に基づくエンドツーエンドシステム**

> 💡 全自動広告編集化: 機械学習で広告動画の企画から完成まで全編集プロセスを自動化

**著者:** Milton Zhou, Sizhong Qin, Yongzhi Li, Quan Chen, Peng Jiang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhou_AutoCut_End-to-end_advertisement_video_editing_based_on_multimodal_discretization_and_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2603.28366)

**Session:** Poster Session 6


![Poster](posters/video_generation/38841.png)
...
## 264. Rethinking Position Embedding as a Context Controller for Multi-Reference and Multi-Shot Video Generation

> 🇯🇵 **マルチモーダル生成の文脈制御器としての位置埋め込みの再考**

> 💡 位置埋め込みの機能拡張: 従来の位置情報から文脈制御への再解釈で新しい制御メカニズムを実現

**著者:** Binyuan Huang, Yuning Lu, Weinan Jia, hualiang wang, Mu Liu, Daiqing Yang

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Huang_Rethinking_Position_Embedding_as_a_Context_Controller_for_Multi-Reference_and_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2604.03738) | [🌐 Project](https://poco-multiref-multishot.github.io/)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/video_generation/38316.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://poco-multiref-multishot.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 265. SemVideo: Reconstructs What You Watch from Brain Activity via Hierarchical Semantic Guidance

> 🇯🇵 **セムビデオ：階層的意味ガイダンスを用いた脳活動からの視聴内容再構成**

> 💡 脳活動から視聴ビデオを階層的意味ガイダンスで再構成

**著者:** Minghan Yang, LAN YANG, Ke Li, Honggang Zhang, Kaiyue Pang, Yi-Zhe Song
...
## 266. PerformRecast: Expression and Head Pose Disentanglement for Portrait Video Editing
...
## 267. FlexTraj: Image-to-Video Generation with Flexible Point Trajectory Control
...
## 268. Dual-Granularity Memory for Efficient Video Generation

> 🇯🇵 **効率的動画生成のための二層粒度メモリ機構**

> 💡 多層メモリによる効率化: 異なる粒度のメモリ機構を組み合わせ動画生成を効率化

**著者:** Hongjun Wang, Lin Liu, Jianguo Li, Tao Lin
...
![Poster](posters/video_generation/40225.png)
...
## 269. SWIFT: Sliding Window Reconstruction for Few-Shot Training-Free Generated Video Attribution
...
## 270. ORV: 4D Occupancy-centric Robot Video Generation

> 🇯🇵 **4D職業中心ロボット動画生成**

> 💡 4次元空間占有表現でロボットの周辺環境をシミュレートするビデオ生成を実現する。

**著者:** Xiuyu Yang, Bohan Li, Shaocong Xu, Nan Wang, Chongjie Ye, Zhaoxi Chen, Minghan Qin, Yikang Ding, Zheng Zhu, Xin Jin, Hang Zhao, Hao Zhao

**Links:** [📄 Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Yang_ORV_4D_Occupancy-centric_Robot_Video_Generation_CVPR_2026_paper.html) | [📋 arXiv](https://arxiv.org/abs/2506.03079)
