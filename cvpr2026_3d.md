# CVPR 2026 — 3D / Scene Papers

**Total: 417 papers** | Poster: 397 | Project page: 68 | 和訳済み: 417

*Generated: 2026-05-29 12:24*

> 📝 **データソース:** `threed_enriched.json` — レイアウト変更は `generate_md.py` を編集後に再実行してください。

---

## 1. Yo'City: Personalized and Boundless 3D Realistic City Scene Generation via Self-Critic Expansion

> 🇯🇵 **Yo'City：自己批判拡張による個人化・無限拡張な3D現実都市生成**

> 💡 大規模言語モデルの推論能力を活用し、ユーザーカスタマイズ可能で無限拡張可能な3D都市生成フレームワークを提案。

**著者:** Keyang Lu, Sifan Zhou, Hongbin Xu, Gang Xu, Zhifei Yang, Yikai Wang, Zhen Xiao, Jieyi Long, Ming Li
...
## 2. LaRP: Efficient Multi-View Inpainting with Latent Reprojection Priors

> 🇯🇵 **LaRP：潜在特性投影事前知識による効率的マルチビュー修復**

> 💡 3D基礎モデルからの明示的な対応を活用し、拡散型修復モデルとマルチビュー対応潜在特性を結合した高速修復手法。

**著者:** Gaoyang Zhang, Xinguo Liu
...
![Poster](posters/3d/36245.png)


**Abstract:** The task of multi-view inpainting necessitates 3D consistency in the inpainted images. Most prior methods first employ single-view 2D inpainting and then enforce multi-view consistency in a post-hoc 3D optimization stage, which leads to undesirable artifacts and lengthy optimization times. The existing single-stage method, MVInpainter, uses video priors and is pose-free, making it less suitable for inputs beyond video sequences. In this paper, we propose a framework that trains an inpainting model to condition on the explicit and reliable multi-view correspondences from a 3D foundation model. Central to our framework is a cross-view conditioning architecture, LaRP, carefully designed to utilize both the generative prior of a pretrained diffusion inpainting model and the reprojected cross-view appearance latents. We additionally propose a scalable data pipeline for stable training of LaRP. Extensive experiments demonstrate that LaRP outperforms prior methods in 3D consistency and novel view synthesis quality competitive with the state-of-the-art, while being ∼50x faster.


---

## 3. Gaussian Splatting-based Low-Rank Tensor Representation for Multi-Dimensional Image Recovery

> 🇯🇵 **ガウシアンスプラッティングベース低ランクテンソル表現による多次元画像復元**

> 💡 2D・1Dガウシアンスプラッティングを活用した低ランクテンソル表現により、局所高周波情報をより正確に捕捉。

**著者:** Yiming Zeng, Xile Zhao, Wei-Hao Wu, Teng-Yu Ji, Chao Wang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.14270)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/38121.png)
...
## 4. HAD: Hallucination-Aware Diffusion Priors for 3D Reconstruction

> 🇯🇵 **HAD：幻覚認識拡散事前知識による3D再構成**

> 💡 拡散事前知識による幻覚成分を検出・マスクし、スパースビュー3D再構成の品質向上と不正な3Dアーティファクト削減を実現。

**著者:** Xi Liu, Weiwei Sun, Joe Ren, Christopher Broaddus, Siyu Huang, Laurent Guigues

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2605.16873)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/36554.png)
...
## 5. Energy-GS: Image Energy-guided Pose Alignment Gaussian Splatting with redesigned pose gradient flow

> 🇯🇵 **Energy-GS：画像エネルギー誘導姿勢整列ガウシアンスプラッティング**

> 💡 画像エネルギー制約により段階的なカメラ姿勢整列を実現し、RGBのみから高品質な3Dシーン表現と正確な姿勢推定を同時実現。

**著者:** Yu Gao, Lutong Su, Ruixiang Huang, Tianji Jiang, Jiadong Tang, Yufeng Yue, Yi Yang
...
> 🇯🇵 **WorldGen：テキストから走行可能で相互作用可能な3D世界生成**

> 💡 テキスト指示から高品質メッシュで構成された大規模ナビゲーション可能な3D世界を自動生成し、標準ゲームエンジンとの互換性を確保。
...
**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.16825) | [🌐 Project](https://www.meta.com/blog/worldgen-3d-world-generation-reality-labs-generative-ai-research/?srsltid=AfmBOooRABG9qtZuBqCxzHWIt-btGamC8G1Ng6BnOvmwUo5VsHQcms5L)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39770.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://www.meta.com/blog/worldgen-3d-world-generation-reality-labs-generative-ai-research/?srsltid=AfmBOooRABG9qtZuBqCxzHWIt-btGamC8G1Ng6BnOvmwUo5VsHQcms5L" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
> 🇯🇵 **運動認識ガウシアングループ化による動的シーン時空予測**

> 💡 4D ガウシアンスプラッティングに基づき、運動認識ガウシアングループ化を導入し、物理的に一貫した長期シーン予測を実現。

**著者:** Junmyeong Lee, Hoseung Choi, Minsu Cho

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.21668) | [🌐 Project](https://slime0519.github.io/mogaf/)

**Session:** Poster Session 6


![Poster](posters/3d/38382.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://slime0519.github.io/mogaf/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 11. Feed-Forward One-Shot Animatable Textured Mesh Avatar Reconstruction
...
## 12. NimbusGS: Unified 3D Scene Reconstruction under Hybrid Weather

> 🇯🇵 **NimbusGS: ハイブリッド気象下での統一的な3Dシーン再構成**

> 💡 劣化した多視点画像からハイブリッド気象条件下で高品質3D再構成を実現

**著者:** Yanying Li, Jinyang Li, Shengfeng He, Yangyang Xu, Junyu Dong, Yong Du

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.27228)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/37965.png)
...
## 13. Cross-Instance Gaussian Splatting Registration via Geometry-Aware Feature-Guided Alignment

> 🇯🇵 **幾何学特徴ガイド型3Dガウススプラッティング登録**

> 💡 2つの独立した3DGSモデルを類似変換で効率的に整列させる手法

**著者:** Roy Amoyal, Oren Freifeld, Chaim Baskin

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.21936)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/36830.png)
...
## 14. MatSpray: Fusing 2D Material World Knowledge on 3D Geometry

> 🇯🇵 **MatSpray: 3D幾何への2D材質知識の統合**

> 💡 2D画像の材質情報を3D幾何学に融合して表現力を向上

**著者:** Philipp Langsteiner, Jan-Niklas Dihlmann, Hendrik Lensch

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.18314)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37936.png)
...
## 15. Revisiting Pose Sensitivity in Splat-based Computed Tomography under Sparse-view Reconstruction

> 🇯🇵 **スプラットベース計算トモグラフィにおける姿勢感度の再検討**

> 💡 計算トモグラフィにおける姿勢パラメータの感度分析

**著者:** Kiseok Choi, Hyeongjun Cho, Inchul Kim, Min H. Kim

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://vclab.kaist.ac.kr/cvpr2026p2/)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36920.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://vclab.kaist.ac.kr/cvpr2026p2/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 16. Uncertainty-driven 3D Gaussian Splatting Active Mapping via Anisotropic Visibility Field

> 🇯🇵 **不確実性駆動型3Dガウススプラッティング能動マッピング**

> 💡 不確実性推定により最適な観測位置を自動決定する手法
...
## 17. AvatarPointillist: AutoRegressive 4D Gaussian Avatarization

> 🇯🇵 **アバターポイント化: 自動回帰型4Dガウシアンアバター生成**

> 💡 動的4D人間アバターを自動回帰型アルゴリズムで効率生成

**著者:** Hongyu Liu, Xuan Wang, Zijian Wu, yating wang, Ziyu Wan, Yue Ma, Runtao Liu, Boyao Zhou, Yujun Shen, Qifeng Chen

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.04787)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39841.png)
...
## 18. ProgressiveAvatars: Progressive Animatable 3D Gaussian Avatars
...
## 19. SwiftTailor: Efficient 3D Garment Generation with Geometry Image Representation

> 🇯🇵 **SwiftTailor: 幾何学情報を用いた効率的3D服飾生成**

> 💡 幾何学制約を活用して高速に高品質3D衣類を生成

**著者:** Phuc Pham, Uy Dieu Tran, Binh-Son Hua, Phong Nguyen

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.19053) | [🌐 Project](https://qualcomm-ai-research.github.io/SwiftTailor)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36938.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://qualcomm-ai-research.github.io/SwiftTailor" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 20. BEA-GS: BEyond RAdiance Supervision in 3DGS for Precise Object Extraction

> 🇯🇵 **BEA-GS: 3Dガウススプラッティングにおける放射照度監督を超えて**

> 💡 放射照度以外の監督信号を取り入れた精密オブジェクト検出

**著者:** Alessio Mazzucchelli, María Naranjo Almeida, Jorge Bustos Sanchez, Mariella Dimiccoli, Francesc Moreno-Noguer, Jordi Sanchez-Riera, Adrian Penate-Sanchez
...
> 💡 都市スケールの完全な3Dシーンを一貫して生成

**著者:** Seungwoo Yoon, Jinmo Kim, Jaesik Park

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.29387)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/36815.png)
...
## 22. Olbedo: An Albedo and Shading Aerial Dataset for Large-Scale Outdoor Environments

> 🇯🇵 **Olbedo: 大規模アルベド・シェーディング航空データセット**

> 💡 航空画像から大規模な材質・光影情報を抽出するデータセット

**著者:** Shuang Song, Debao Huang, Deyan Deng, Haolin Xiong, Yang Tang, Yajie Zhao, Rongjun Qin

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.22025)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/36175.png)
...
## 23. Neural Field-Based 3D Surface Reconstruction of Microstructures from Multi-Detector Signals in Scanning Electron Microscopy

> 🇯🇵 **ニューラル場ベース微細構造の3D表面再構成**

> 💡 ニューラル場で微小スケール3D構造を高精度再構成

**著者:** Shuo Chen, Yijin Li, Xi Zheng, Guofeng Zhang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2508.04728)

**Session:** Oral Session 2B: Materials & Lighting


![Poster](posters/3d/40257.png)
...
## 24. GLINT: Modeling Scene-Scale Transparency via Gaussian Radiance Transport

> 🇯🇵 **GLINT: ガウシアン放射照度による景観透光性モデリング**

> 💡 ガウシアン放射照度で透光性効果を正確にモデル化

**著者:** Youngju Na, Jaeseong Yun, Soohyun Ryu, Hyunsu Kim, Sung-Eui Yoon, Suyong Yeon

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.26181)

**Session:** Oral Session 2B: Materials & Lighting


![Poster](posters/3d/40261.png)
...
## 25. DiffuView: Multi-View Diffusion Pretraining for 3D Aware Robotic Manipulation

> 🇯🇵 **DiffuView: 3D認識ロボットに向けた多視点拡散事前学習**

> 💡 拡散モデルで3D認識用の事前学習表現を獲得

**著者:** Kaizhao Zhang, Tian Niu, Tianyu Liu, Chenen Guo, Zijun Xu, Qingda Hu, Wenchao Ding
...
## 26. Energy-GS: Image Energy-guided Pose Alignment Gaussian Splatting with redesigned pose gradient flow

> 🇯🇵 **Energy-GS: 画像エネルギーガイド型姿勢配置ガウススプラッティング**
...
**Session:** Oral Session 2C: Gaussian Splatting & Reconstruction


![Poster](posters/3d/40277.png)
...
## 27. PackUV: Packed Gaussian UV Maps for 4D Volumetric Video

> 🇯🇵 **PackUV: 4Dボリューメトリックビデオ向けパックガウシアンUVマップ**

> 💡 効率的UV圧縮で4Dビデオボリュームを高速レンダリング

**著者:** Aashish Rai, Angela Xing, Anushka Agarwal, Xiaoyan Cong, Zekun Li, Tao Lu, Aayush Prakash, Srinath Sridhar

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.23040)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36872.png)
...
## 28. GaussianFluent: Gaussian Simulation for Dynamic Scenes with Mixed Materials

> 🇯🇵 **GaussianFluent: 動的シーン向けガウシアンシミュレーション**

> 💡 物理シミュレーションで動く3Dシーンを生成

**著者:** Bei Huang, Yixin Chen, Ruijie Lu, Gang Zeng, Hongbin Zha, Yuru Pei, Siyuan Huang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.09265)

**Session:** Oral Session 4C: Spatial Reasoning


![Poster](posters/3d/40287.png)
...
## 29. Proxy-GS: Unified Occlusion Priors for Training and Inference in Structured 3D Gaussian Splatting

> 🇯🇵 **Proxy-GS: 学習と推論における統一オクルージョン事前情報**

> 💡 プロキシモデルで隠蔽情報を統一的に処理

**著者:** Yuanyuan Gao, YUNING GONG, Yifei Liu, Jingfeng Li, Dan Xu, Yanci Zhang, Dingwen Zhang, Xiao Sun, Zhihang Zhong

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2509.24421)

**Session:** Oral Session 2C: Gaussian Splatting & Reconstruction


![Poster](posters/3d/40289.png)
...
## 30. POLAR: A Portrait OLAT Dataset and Generative Framework for Illumination-Aware Face Modeling

> 🇯🇵 **POLAR: 肖像OLAT生成フレームワーク**

> 💡 OLAT技術で肖像写真を3Dアバターに変換

**著者:** Zhuo Chen, Chengqun Yang, Zhuo Su, Zheng Lv, Jingnan Gao, Xiaoyuan Zhang, Xiaokang Yang, Yichao Yan

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.13192)

**Session:** Oral Session 5D: Human-Centric Modeling & Lighting


![Poster](posters/3d/40290.png)
...
## 31. Learning Hierarchical Hyperbolic Mixture Model for Part-aware 3D Generation

> 🇯🇵 **パーツ認識向けニューラル双曲混合モデル学習**

> 💡 双曲幾何学でパーツ認識の階層構造を学習

**著者:** Qitong Yang, Mingtao Feng, Zijie Wu, Huixin Zhu, Weisheng Dong, Yaonan Wang, Ajmal Mian
...
## 32. RAVEN: Erasing Invisible Watermarks via Novel View Synthesis

> 🇯🇵 **RAVEN: 新規視点合成による不可視透かし削除**

> 💡 視点合成で元画像の不可視透かしを除去

**著者:** Fahad Shamshad, Nils Lukas, Karthik Nandakumar

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.08832)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/37332.png)
...
## 33. RAVEN: Erasing Invisible Watermarks via Novel View Synthesis

> 🇯🇵 **RAVEN：ノベルビュー合成による見えない透かし削除**

> 💡 セマンティック一貫性を保つビューポイント変換でAI生成画像の見えない透かし削除が可能なことを実証。

**著者:** Fahad Shamshad, Nils Lukas, Karthik Nandakumar

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.08832)

**Session:** Oral Session 1B: Visual Security


![Poster](posters/3d/40294.png)
...
## 34. PhyGaP: Physically-Grounded Gaussians with Polarization Cues

> 🇯🇵 **PhyGaP：偏光手がかりを用いた物理的基盤ガウシアン**

> 💡 偏光情報を活用して反射分解と高忠実度な再照明実現。

**著者:** Jiale Wu, Xiaoyang Bai, Zongqi He, Weiwei Xu, YIFAN PENG

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.14001) | [🌐 Project](https://kelvar00.github.io/PhyGaP/)

**Session:** Oral Session 2B: Materials & Lighting


![Poster](posters/3d/40313.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://kelvar00.github.io/PhyGaP/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 35. Your Latent Mask is Wrong: Pixel-Equivalent Latent Compositing for Diffusion Models
...
## 36. Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images

> 🇯🇵 **Uni3R：汎用ガウシアンスプラッティングによる統一3D再構成と意味理解**

> 💡 姿勢なしマルチビュー画像から単一順伝播で3D再構成・セマンティックセグメンテーション・深度予測同時実現。

**著者:** Xiangyu Sun, Haoyi Jiang, Liu Liu, Seungtae Nam, Gyeongjin Kang, Xinjie wang, Wei Sui, Zhizhong Su, Wenyu Liu, Xinggang Wang, Eunbyung Park

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2508.03643)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/38472.png)
...
## 37. GaussFusion: Improving 3D Reconstruction in the Wild with A Geometry-Informed Video Generator
...
## 38. Points-to-3D: Structure-Aware 3D Generation with Point Cloud Priors

> 🇯🇵 **Points-to-3D：ポイントクラウド事前知識による構造認識3D生成**

> 💡 ポイントクラウド事前知識を拡散モデルに統合し、幾何学的に制御可能な高忠実度3Dアセット生成。

**著者:** Jiatong Xia, Zicheng Duan, Anton van den Hengel, Lingqiao Liu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.18782)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/38855.png)
...
## 39. EmoTaG: Emotion-Aware Talking Head Synthesis on Gaussian Splatting with Few-Shot Personalization

> 🇯🇵 **EmoTaG：感情認識トーキングヘッド合成ガウシアンスプラッティング**

> 💡 FLAME パラメータ空間での運動予測で感情表現豊かな少数ショット3D会話ヘッド合成実現。

**著者:** Haolan Xu, Keli Cheng, Lei Wang, Ning Bi, Xiaoming Liu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.21332)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/38921.png)
...
## 40. Underground Plant Exploration: Non-Destructive 3D Root Assessment with GPR Based on Point Graph Neural Network

> 🇯🇵 **地下根系探査：GPRベースポイントグラフニューラルネットワークによる非破壊3D根評価**

> 💡 GPRのB-スキャンからポイントグラフネットワークで根の3D構造を非破壊推定。

**著者:** Yuwei Zhou, Guoyu Lu
...
## 41. Rethinking Pose Refinement in 3D Gaussian Splatting under Pose Prior and Geometric Uncertainty

> 🇯🇵 **3Dガウシアンスプラッティングにおける姿勢事前知識と幾何不確実性の再考**

> 💡 モンテカルロ姿勢サンプリングとフィッシャー情報PnP最適化で姿勢・幾何不確実性対処。

**著者:** ManGyu Kong, Jaewon Lee, Seongwon Lee, Euntai Kim

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.16538)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39076.png)
...
## 42. EMGauss: Continuous Slice-to-3D Reconstruction via Dynamic Gaussian Modeling in Volume Electron Microscopy

> 🇯🇵 **EMGauss：容積電子顕微鏡における動的ガウシアンモデリング連続スライス・3D再構成**

> 💡 ガウシアンスプラッティングでスライス時間発展表現し、教師-生徒ブートストラップで微細構造再構成。

**著者:** Yumeng He, Zanwei Zhou, Yekun Zheng, Chen Liang, Yunbo Wang, Xiaokang Yang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.06684)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/39195.png)
...
## 43. Learning Differentiable Hierarchies in 3D Gaussian Splatting

> 🇯🇵 **3Dガウシアンスプラッティングにおける学習可能な階層化表現**

> 💡 寄与度ランキングによるガウシアン階層学習で柔軟なレベルオブディテール表現実現。

**著者:** Youqi Pan, Wugen Zhou, Hongbin Zha
...
## 44. MatLat: Material Latent Space for PBR Texture Generation

> 🇯🇵 **MatLat：PBRテクスチャ生成のための材料潜在空間**

> 💡 VAE微調整で材料潜在空間学習し複数PBRチャネル一貫性保ちながら高品質テクスチャ生成。

**著者:** Kyeongmin Yeo, Yunhong Min, Jaihoon Kim, Minhyuk Sung

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.17302)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/39717.png)
...
## 45. Evidential Neural Radiance Fields

> 🇯🇵 **根拠的ニューラル放射輝度フィールド**

> 💡 NeRFに統合された確率フレームワークで単一順伝播から偶然的・認識的不確実性同時推定。

**著者:** Ruxiao Duan, Alex Wong

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.23574)

**Session:** Oral Session 5A: Dynamic Perception


![Poster](posters/3d/40372.png)
...
## 46. Thermal is Always Wild: Characterizing and Addressing Challenges in Thermal-Only Novel View Synthesis

> 🇯🇵 **熱カメラはいつも予測不可能：熱画像のみのノベルビュー合成における課題と対処**

> 💡 低動的範囲と放射計ドリフト問題対処し前処理最適化で熱画像のみ高品質合成実現。

**著者:** M. Kerem Aydin, Vishwanath Saragadam, Emma Alexander

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.20448)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/39537.png)
...
## 47. WildRayZer: Self-supervised Large View Synthesis in Dynamic Environments

> 🇯🇵 **WildRayZer：動的環境での自己教師あり大規模ビュー合成**

> 💡 分析合成テストで運動マスク生成し背景補完焦点の順伝播で動的シーン高品質合成実現。

**著者:** Xuweiyi Chen, Wentao Zhou, Zezhou Cheng

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.10716)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/39707.png)
...
## 48. InfiniBench: Infinite Benchmarking for Visual Spatial Reasoning with Customizable Scene Complexity

> 🇯🇵 **InfiniBench：カスタマイズ可能シーン複雑度によるビジュアル空間推理無限ベンチマーク**

> 💡 パラメータ化シーン生成でVLMの空間推理能力を無限にカスタマイズ可能に評価。

**著者:** Haoming Wang, Qiyao Xue, Wei Gao

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.18200)

**Session:** Oral Session 4C: Spatial Reasoning


![Poster](posters/3d/40382.png)
...
## 49. PhysGaia: A Physics-aware Benchmark with Multi-Body Interactions for Dynamic Novel View Synthesis

> 🇯🇵 **PhysGaia：マルチボディ相互作用のある動的ノベルビュー合成用物理認識ベンチマーク**

> 💡 複雑な多物体相互作用と多様物質を含む物理準拠シーンで動的ノベルビュー合成ベンチマーク。

**著者:** Mijeong Kim, Gunhee Kim, Jungyoon Choi, WonJae Roh, Bohyung Han

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2506.02794)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39978.png)
...
## 50. I-Scene: 3D Instance Models are Implicit Generalizable Spatial Learners

> 🇯🇵 **I-Scene：3Dインスタンスモデルは暗黙の汎用空間学習器**

> 💡 事前学習3Dインスタンス生成器で空間推理を学習し、未見レイアウトへの汎化可能。

**著者:** Lu Ling, Yunhao Ge, Yichen Sheng, Aniket Bera

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.13683)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39992.png)
...
> 🇯🇵 **MOSAIC-GS：単眼シーン再構成の高度な初期化による複雑動的環境ガウシアンスプラッティング**

> 💡 幾何手がかり活用し初期化段階で3D動的推定し、単眼高忠実度再構成と実時間レンダリング実現。

**著者:** Svitlana Morkva, Vaishakh Patil, Alessio Tonioni, Michael Oechsle, Maximum Wilder-Smith, Marco Hutter

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.05368)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/38905.png)
...
## 54. FilterGS: Traversal-Free Parallel Filtering and Adaptive Shrinking for Large-Scale LoD 3D Gaussian Splatting

> 🇯🇵 **FilterGS：大規模LoD 3Dガウシアンスプラッティングのための走査自由並列フィルタリング**

> 💡 並列フィルタリングと適応的ガウシアン縮小で大規模シーン最先端レンダリング速度実現。

**著者:** Yixian Wang, HaoLin Yu, Jiadong Tang, Yu Gao, Xihan Wang, Yufeng Yue, Yi Yang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.23891)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/38832.png)
...
## 55. From None to All: Self-Supervised 3D Reconstruction via Novel View Synthesis

> 🇯🇵 **From None to All：ノベルビュー合成による自己教師あり3D再構成**

> 💡 ポーズ不要マルチビュー画像から自教師学習で3Dガウシアンと姿勢パラメータ同時推定。

**著者:** Ranran Huang, Weixun Luo, Ye Mao, Krystian Mikolajczyk

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.27455)

**Session:** Poster Session 6


![Poster](posters/3d/36461.png)
...
## 56. 3D-LATTE: Latent Space 3D Editing from Textual Instructions

> 🇯🇵 **3D-LATTE：テキスト指示による潜在空間3D編集**

> 💡 ネイティブ3D拡散モデル潜在空間で訓練自由編集、高忠実度で広範囲な意味的操作実現。

**著者:** Maria Parelli, Michael Oechsle, Michael Niemeyer, Federico Tombari, Andreas Geiger

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2509.00269)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/39440.png)
...
## 57. DynamicTree: Interactive Real Tree Animation via Sparse Voxel Spectrum
...
## 58. Multimodal Semantic Bias Mitigation for Diverse Text-To-3D Generation

> 🇯🇵 **Multimodal Semantic Bias Mitigation for Diverse Text-To-3D Generation：多様テキスト・3D生成の意味バイアス軽減**

> 💡 テキスト・3D大モデルのクロスモーダルバイアス検出・軽減で複雑プロンプト理解強化。

**著者:** Yukuan Min, Muli Yang, Jinhao Zhang, Yuxuan Wang, Yihang Zhu, Jiexi Yan, Cheng Deng
...
## 60. Neural Gabor Splatting: Enhanced Gaussian Splatting with Neural Gabor for High-frequency Surface Reconstruction

> 🇯🇵 **Neural Gabor Splatting：高周波面再構成のためのニューラルGaborによるガウシアンスプラッティング拡張**

> 💡 各ガウシアンにMLPで高周波変動表現し周波数認識密度化で高周波面正確再構成実現。

**著者:** Haato Watanabe, Nobuyuki Umetani

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.15941) | [🌐 Project](https://haatowatanabe.com/projects/neural-gabor-splatting/)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/36251.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://haatowatanabe.com/projects/neural-gabor-splatting/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 61. AudioAvatar: Personalized Audio-driven Whole-body Talking Avatars

> 🇯🇵 **AudioAvatar：個人化オーディオ駆動全身会話アバター**

> 💡 単画像から音声直接駆動の全身光学写実的3D会話アバターで高度な同期・表現力実現。

**著者:** Seungeun Lee, SeungJun Moon, Hah Min Lew, Ji-Su Kang, Gyeong-Moon Park
...
## 64. SAGE: Scalable Agentic 3D Scene Generation for Embodied AI

> 🇯🇵 **SAGE：体現型AIのためのスケーラブルエージェント3Dシーン生成**

> 💡 エージェント型フレームワークでタスク指示から物理的有効なシミュレータ対応3D環境自動生成。
...
**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.10116)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39689.png)
...
## 65. EcoSplat: Efficiency-controllable Feed-forward 3D Gaussian Splatting from Multi-view Images

> 🇯🇵 **EcoSplat：マルチビュー画像からの効率制御可能順伝播3Dガウシアンスプラッティング**

> 💡 推論時にプリミティブ数制御可能な順伝播3DGS、密ビュー設定で最先端の効率・品質実現。

**著者:** Minh-Quan Viet Bui, Jongmin Park, Juan Luis Gonzalez Bello, Jaeho Moon, Jihyong Oh, Munchurl Kim

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.18692) | [🌐 Project](https://kaist-viclab.github.io/ecosplat-site/)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36740.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://kaist-viclab.github.io/ecosplat-site/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 66. OLATverse: A Large-scale Real-world Object Dataset with Precise Lighting Control

> 🇯🇵 **OLATverse：精密照明制御を備えた大規模現実物体データセット**

> 💡 765現実物体の900万画像、331個別制御光源で逆レンダリング・再照明の大規模ベンチマーク実現。

**著者:** Xilong Zhou, Jianchun Chen, Pramod Rao, Timo Teufel, Linjie Lyu, Tigran Minasian, Oleksandr Sotnychenko, Xiaoxiao Long, Marc Habermann, Christian Theobalt

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.02483)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/38221.png)
...
## 67. ActionMesh: Animated 3D Mesh Generation with Temporal 3D Diffusion
...
## 68. RnG: A Unified Transformer for Complete 3D Modeling from Partial Observations

> 🇯🇵 **RnG：完全3D再構成と編集のための統一トランスフォーマー**

> 💡 放射フィールド画像化とニューラルグラフィックスで3D再構成・編集を統合したエンドツーエンドアプローチ。

**著者:** Mochu Xiang, Zhelun Shen, Xuesong li, Jiahui Ren, Jing Zhang, Chen Zhao, Shanshan Liu, Haocheng Feng, Jingdong Wang, Yuchao Dai

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.01194)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/40159.png)
...
## 69. Large-scale Codec Avatars: The Unreasonable Effectiveness of Large-scale Avatar Pretraining

> 🇯🇵 **大規模コーデックアバター：無制限の表現と個人化**

> 💡 単一ビデオから大規模個人化アバター生成で、制限のない表情・動作表現を実現。
...
**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.02320)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/40096.png)
...
## 70. Chorus: Multi-Teacher Pretraining for Holistic 3D Gaussian Scene Encoding

> 🇯🇵 **Chorus：ホログラムアバター学習のための複数教師事前学習**

> 💡 複数の学習タスクから事前学習し、単一光学系で多様なアバター生成を実現。

**著者:** Yue Li, Qi Ma, Runyi Yang, Mengjiao Ma, Bin Ren, Nikola Popovic, Nicu Sebe, Theo Gevers, Luc Van Gool, Danda Paudel, Martin R. Oswald

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.17817)

**Session:** Oral Session 4A: Geometric Understanding


![Poster](posters/3d/40395.png)
...
## 71. Physically Inspired Gaussian Splatting for HDR Novel View Synthesis

> 🇯🇵 **Physically Inspired Gaussian Splatting for Dynamic Objects：動的物体の物理啓発ガウシアンスプラッティング**

> 💡 物理ベースの運動予測でガウシアンスプラッティングの動的シーン再構成の精度向上。

**著者:** Huimin Zeng, Yue Bai, hailing wang, Yun Fu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.28020)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37039.png)
...
## 72. From Rays to Projections: Better Inputs for Feed-Forward View Synthesis

> 🇯🇵 **光線から投影へ：ビュー合成の高度な入力表現**

> 💡 投影ベース入力表現でニューラルビュー合成の効率と品質を大幅改善。

**著者:** Zirui Wu, Zeren Jiang, Martin R. Oswald, Jie Song

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.05116)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/39088.png)
...
## 73. Ego-1K – A Large-Scale Multiview Video Dataset for Egocentric Vision

> 🇯🇵 **Ego-1K：大規模一人称ビデオデータセット**

> 💡 1000本以上の一人称ビデオを含む、複雑な手・物体相互作用のための大規模マルチビューデータセット。

**著者:** Jae Yong Lee, Daniel Scharstein, Akash Bapat, Hao Hu, Andrew Fu, Haoru Zhao, Paul Sammut, Xiang Li, Stephen Jeapes, Anik Gupta, Lior David, Saketh Madhuvarasu, Jay Girish Joshi, Jason Wither
...
## 77. Part-aware Modeling of Articulated Objects using 3D Gaussian Splatting

> 🇯🇵 **Part-aware Modeling of Articulated Objects：関節物体のパート認識モデリング**

> 💡 パート分解を用いた関節物体の構造化表現で、複雑な運動再構成を実現。

**著者:** Tianjiao Yu, Vedant Shah, Muntasir Wahed, Ying Shen, Kiet A. Nguyen, Ismini Lourentzou
...
## 78. REArtGS++: Generalizable Articulation Reconstruction with Temporal Geometry Constraint via Planar Gaussian Splatting

> 🇯🇵 **REArtGS++：汎用関節再構成ガウシアンスプラッティング**

> 💡 パート単位のガウシアン表現で、未見の関節物体への汎化可能な動的再構成実現。

**著者:** Di Wu, Liu Liu, Anran Huang, 玉研 刘, Qiaojun Yu, Shaofan Liu, Liangtu Song, Cewu Lu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.17059)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/38821.png)
...
## 79. GOR-IS: 3D Gaussian Object Removal In the Intrinsic Space

> 🇯🇵 **GOR-IS：3Dガウシアン物体除去スプラッティング**

> 💡 ガウシアンスプラッティングで物体を選択的に除去し、背景の高品質復元。

**著者:** Yonghao Zhao, Yupeng Gao, Jian Yang, Jin Xie, Beibei Wang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2605.00498) | [🌐 Project](https://applezyh.github.io/GOR-IS-project-page/)

**Session:** Poster Session 6


![Poster](posters/3d/37925.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://applezyh.github.io/GOR-IS-project-page/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 80. One Algorithm to Align Them All

> 🇯🇵 **One Algorithm to Align Them All：ワンアルゴリズム全配置整列**

> 💡 複数の3D表現方式を統一的に配置整列する汎用アルゴリズム。

**著者:** Boyi Pang, Savva Ignatyev, Vladimir Ippolitov, Ramil Khafizov, Yurii Melnik, Oleg Voynov, Maksim Nakhodnov, Aibek Alanov, Xiaopeng Fan, Peter Wonka, Evgeny Burnaev

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.11194)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/37263.png)
...
## 81. Faster-GS: Analyzing and Improving Gaussian Splatting Optimization

> 🇯🇵 **Faster-GS：ガウシアンスプラッティング解析と改善**

> 💡 ガウシアンスプラッティングの計算ボトルネック分析・最適化で高速化実現。

**著者:** Florian Hahlbohm, Linus Franke, Martin Eisemann, Marcus Magnor

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.09999) | [🌐 Project](https://fhahlbohm.github.io/faster-gaussian-splatting/)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/36550.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://fhahlbohm.github.io/faster-gaussian-splatting/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 82. Let it Snow! Animating 3D Gaussian Scenes with Dynamic Weather Effects via Physics-Guided Score Distillation
...
## 83. Chorus: Multi-Teacher Pretraining for Holistic 3D Gaussian Scene Encoding

> 🇯🇵 **Chorus：ホログラムアバター学習のための複数教師事前学習**

> 💡 複数学習タスクから事前学習し単一光学系で多様アバター生成を実現。
...
## 84. GaussianVision: Vision-Language Alignment from Compressed Image Representations using 2D Gaussian Splatting

> 🇯🇵 **GaussianVision：ビジョン言語配置ガウシアンスプラッティング**

> 💡 ガウシアンスプラッティングに言語情報を統合し、意味的理解と可視化を実現。

**著者:** Yasmine Omri, Connor Ding, Tsachy Weissman, Thierry Tambe

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2509.22615)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/38934.png)
...
## 85. TokenGS: Decoupling 3D Gaussian Prediction from Pixels with Learnable Tokens

> 🇯🇵 **TokenGS：3Dガウシアン予測の分離**

> 💡 トークンベース表現でガウシアン予測を分離し、効率的・スケーラブルな3D生成実現。

**著者:** Jiawei Ren, Michal Tyszkiewicz, Jiahui Huang, Žan Gojčič

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.15239)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/38791.png)
...
## 86. GLINT: Modeling Scene-Scale Transparency via Gaussian Radiance Transport

> 🇯🇵 **GLINT：シーンスケール透明性モデリング**

> 💡 シーンレベルの透明性・反射を表現するニューラル放射輝度フィールド拡張。
...
## 87. Color-Encoded Illumination for High-Speed Volumetric Scene Reconstruction

> 🇯🇵 **Color-Encoded Illumination for High-Speed 3D Reconstruction：高速3D再構成のための色符号化照明**

> 💡 色符号化照明で構造化光の情報密度を大幅向上し高速精密3D再構成実現。

**著者:** David Novikov, Eilon Vaknin, Narek Tumanyan, Mark Sheinin

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.26920) | [🌐 Project](https://davidnovikov.github.io/color-encoded-illumination-website/)

**Session:** Poster Session 6


![Poster](posters/3d/39506.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://davidnovikov.github.io/color-encoded-illumination-website/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 88. PrITTI: Primitive-based Generation of Controllable and Editable 3D Semantic Urban Scenes

> 🇯🇵 **PrITTI：プリミティブベース複雑3D形状生成**

> 💡 プリミティブコンポーネント重ね合わせで多様で複雑な3D形状を直感的に生成。

**著者:** Christina Ourania Tze, Daniel Dauner, Yiyi Liao, Dzmitry Tsishkou, Andreas Geiger

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2506.19117)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/38262.png)
...
## 89. LangField4D: Learning Identity-Adaptive and Spatio-Temporal Continuous 4D Language Fields for Dynamic Scenes

> 🇯🇵 **LangField4D：アイデンティティ適応言語4Dシーン生成**

> 💡 言語指示と個人化情報から動的シーンを生成し、アバター作成を統合化。

**著者:** Yichao Xu, Qiaowei Miao, Jinsheng Quan, Wei Yang, Zhihui Li, Yawei Luo
...
## 90. PointNSP: Autoregressive 3D Point Cloud Generation with Next-Scale Level-of-Detail Prediction

> 🇯🇵 **PointNSP：自己回帰3Dポイントクラウド生成**

> 💡 自己回帰トークンで3Dポイントクラウドを効率的に段階生成。

**著者:** Ziqiao Meng, Qichao Wang, Zhiyang Dou, Zixing Song, Zhipeng Zhou, Irwin King, Peilin Zhao
...
> 🇯🇵 **MeshSplatting：差分可能メッシュレンダリング**

> 💡 メッシュベースレンダリングを差分可能化し、3D最適化を新たに可能化。
...
**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.06818)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/38397.png)


**Abstract:** Primitive-based splatting methods like 3D Gaussian Splatting (3DGS) have revolutionized novel view synthesis with real-time rendering.However, their point-based representations remain incompatible with mesh-based pipelines that power AR/VR and game engines. We present MeshSplatting, a mesh-based reconstruction approach that jointly optimizes geometry and appearance through differentiable rendering.By enforcing connectivity via restricted Delaunay triangulation and refining surface consistency, MeshSplatting creates end-to-end smooth, visually high-quality meshes that render efficiently in real-time 3D engines.On Mip-NeRF360, it boosts PSNR by +0.69 dB over the current state-of-the-art MiLo for mesh-based novel view synthesis, while training 2x faster and using 2x less memory, bridging neural rendering and interactive 3D graphics for seamless real-time scene interaction.


---

## 92. MeshSplatting: Differentiable Rendering with Opaque Meshes
...
## 93. EDGS: Eliminating Densification for Efficient Convergence of 3DGS

> 🇯🇵 **EDGS：ガウシアンスプラッティング密度化効率化**

> 💡 密度化処理の最適化で、ガウシアンスプラッティングの訓練効率を大幅向上。

**著者:** Dmytro Kotovenko, Olga Grebenkova, Björn Ommer

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2504.13204)

**Session:** Poster Session 6


![Poster](posters/3d/38055.png)


**Abstract:** 3D Gaussian Splatting reconstructs scenes by starting from a sparse Structure-from-Motion initialization and refiningunder-reconstructed regions. This process is slow, as it requires multiple densification steps where Gaussians arerepeatedly split and adjusted, following a lengthy optimization path. Moreover, this incremental approach often yieldssuboptimal renderings in high-frequency regions. We propose a fundamentally different approach: eliminate densification with a one-step approximation of scenegeometry using triangulated pixels from dense image correspondences. This dense initialization allows us to estimatethe rough geometry of the scene while preserving rich details from input RGB images, providing each Gaussian withwell-informed color, scale, and position. As a result, we dramatically shorten the optimization path and remove theneed for densification. Unlike methods that rely on sparse keypoints, our dense initialization ensures uniform detailacross the scene, even in high-frequency regions where other methods struggle. Moreover, since all splats are initializedin parallel at the start of optimization, we remove the need to wait for densification to adjust new Gaussians.EDGS reaches LPIPS and SSIM performance of standard 3DGS significantly faster than existing efficiency-focused approaches. When trained further, it exceeds the reconstruction quality of state-of-the-art models aimed at maximizing fidelity. Our method is fully compatible with other acceleration techniques, making it a versatile and efficient solution that can be integrated with existing approaches.


---

## 94. EmbodiedSplat: Online Feed-Forward Semantic 3DGS for Open-Vocabulary 3D Scene Understanding

> 🇯🇵 **EmbodiedSplat：オンライン順伝播意味ガウシアンスプラッティング**

> 💡 オンライン学習で体現型AIに適応的な意味ガウシアンスプラッティング実現。

**著者:** Seungjun Lee, Zihan Wang, Yunsong Wang, Gim Hee Lee

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.04254) | [🌐 Project](https://0nandon.github.io/EmbodiedSplat/)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/38273.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://0nandon.github.io/EmbodiedSplat/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 95. VT-Intrinsic: Physics-Based Decomposition of Reflectance and Shading using a Single Visible-Thermal Image Pair

> 🇯🇵 **VT-Intrinsic：物理ベース本質的分解**

> 💡 物理的にリアルな画像分解で、物体の本質的性質を抽出・操作可能。

**著者:** Zeqing Yuan, Mani Ramanagopal, Aswin C. Sankaranarayanan, Srinivasa G. Narasimhan

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2509.10388)

**Session:** Poster Session 6


![Poster](posters/3d/38435.png)
...
## 96. TokenHand: Discrete Token Representation for Efficient Hand Mesh Reconstruction

> 🇯🇵 **TokenHand：離散トークン手表現**

> 💡 トークンベース表現で手ポーズ・形状を効率的に表現・生成。

**著者:** Xinguo He, Yixin Shen, Rahul Chaudhari
...
## 97. GeoDiff4D: Geometry-Aware Diffusion for 4D Head Avatar Reconstruction

> 🇯🇵 **GeoDiff4D：幾何認識4D拡散生成**

> 💡 幾何制約を統合した拡散モデルで、構造的に妥当な4Dシーン生成。

**著者:** Chao Xu, Xiaochen Zhao, xiang deng, Jingxiang Sun, Donglin Di, Zhuo Su, Yebin Liu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.24161) | [🌐 Project](https://lyxcc127.github.io/geodiff4d/)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/39338.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://lyxcc127.github.io/geodiff4d/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 98. Plug-and-Play PDE Optimization for 3D Gaussian Splatting: Toward High-Quality Rendering and Reconstruction

> 🇯🇵 **Plug-and-Play PDE Optimization for 3D Gaussian：3Dガウシアン用プラグインPDE最適化**

> 💡 PDE最適化を3Dガウシアンに組み込む汎用フレームワーク。

**著者:** Yifan Mo, Youcheng Cai, Ligang Liu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2509.13938)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/38666.png)
...
## 99. Eulerian Gaussian Splatting using Hashed Probability Pyramids

> 🇯🇵 **Eulerian Gaussian Splatting using Hashed：ハッシュを用いたオイラー的ガウシアンスプラッティング**

> 💡 オイラー的表現とハッシュ構造で動的シーン高速効率レンダリング実現。

**著者:** Mia Gaia Polansky, George Kopanas, Stephan Garbin, Todd Zickler, Dor Verbin
...
## 100. Seeing through Light and Darkness: Sensor-Physics Grounded Deblurring HDR NeRF from Single-Exposure Images and Events

> 🇯🇵 **光と闇を透視する：センサー融合による暗所3D再構成**

> 💡 複数センサー融合で低照度環境下の高精度3D再構成を実現。

**著者:** Yunshan Qi, Lin Zhu, Nan Bao, Yifan Zhao, Jia Li

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.15475)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/38203.png)
...
## 101. A Polarized Reflection and Material Dataset of Real World Objects

> 🇯🇵 **偏光反射・材質データセット**

> 💡 偏光情報を含む材質性質の大規模リアルデータセット。

**著者:** Jing Yang, Krithika Dharanikota, Emily Jia, Haiwei Chen, Yajie Zhao
...
## 102. MeshFlow: Efficient Artistic Mesh Generation via MeshVAE and Flow-based Diffusion Transformer

> 🇯🇵 **MeshFlow：効率的芸術的メッシュ生成**

> 💡 流れベース変形で芸術的メッシュを効率的に生成・最適化。
...
## 103. PhysX-Anything: Simulation-Ready Physical 3D Assets from Single Image

> 🇯🇵 **PhysX-Anything：シミュレーション対応物理理解**

> 💡 画像から物理パラメータを推定し、ゲームエンジン互換シミュレーション可能化。

**著者:** Ziang Cao, Fangzhou Hong, Zhaoxi Chen, Liang Pan, Ziwei Liu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.13648) | [🌐 Project](https://physx-anything.github.io/)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/39582.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://physx-anything.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 104. ParticleGS: Learning Neural Gaussian Particle Dynamics from Videos for Prior-free Physical Motion Extrapolation

> 🇯🇵 **ParticleGS：ニューラルガウシアンパーティクル学習**

> 💡 パーティクルベース表現でガウシアンスプラッティングの流体・煙表現拡張。

**著者:** Jinsheng Quan, Qiaowei Miao, Yichao Xu, Zizhuo Lin, Ying Li, Wei Yang, Zhihui Li, Yawei Luo

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2505.20270)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/40059.png)
...
## 105. B^3-Seg: Camera-Free, Training-Free 3DGS Segmentation via Analytic EIG and Beta-Bernoulli Bayesian Updates

> 🇯🇵 **B^3-Seg：カメラフリー訓練フリー3Dガウシアンセグメンテーション**

> 💡 事前学習モデルでカメラキャリブレーション・訓練不要のセグメンテーション実現。

**著者:** Hiromichi Kamata, Samuel Arthur Munro, Fuminori Homma

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://sony.github.io/B3-Seg-project/)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/38552.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://sony.github.io/B3-Seg-project/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 106. Scal3R: Scalable Test-Time Training for Large-Scale 3D Reconstruction

> 🇯🇵 **Scal3R：テスト時ビッグモデル補助スケーラブル3D再構成**

> 💡 大規模言語・ビジョンモデル補助でテスト時スケーリング可能な3D再構成。

**著者:** Tao Xie, Peishan Yang, Yudong Jin, Yingfeng Cai, Wei Yin, Weiqiang Ren, Qian Zhang, Wei Hua, Sida Peng, Xiaoyang Guo, Xiaowei Zhou

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.08542) | [🌐 Project](https://zju3dv.github.io/scal3r/)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36180.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://zju3dv.github.io/scal3r/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 107. SketchFaceGS: Real-Time Sketch-Driven Face Editing and Generation with Gaussian Splatting
...
## 108. GaussianZoom: Progressive Zoom-in Generative 3D Gaussian Splatting with Geometric and Semantic Guidance

> 🇯🇵 **GaussianZoom：段階的ズームイン生成**

> 💡 解像度段階的向上でガウシアンスプラッティングの高解像度シーン生成実現。

**著者:** Jiale Shi, Jiarui Hu, Zesong Yang, Kaixuan Luan, Hujun Bao, Zhaopeng Cui

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2605.18252)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39578.png)
...
## 109. Generating Humanless Environment Walkthroughs from Egocentric Walking Tour Videos
...
## 110. AToken: A Unified Tokenizer for Vision

> 🇯🇵 **AToken：ビジョン言語用統一トークナイザー**

> 💡 ビジョンと言語統一トークン化で、マルチモーダル理解を効率化。

**著者:** Jiasen Lu, Liangchen Song, Mingze Xu, Byeongjoo Ahn, Yanjun Wang, Chen Chen, Afshin Dehghan, Yinfei Yang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2509.14476)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/37070.png)
...
## 111. AToken: A Unified Tokenizer for Vision
...
**Session:** Oral Session 5B: Generalization and Adaptation


![Poster](posters/3d/40282.png)
...
## 112. MatE: Material Extraction from Single-Image via Geometric Prior

> 🇯🇵 **MatE：単一画像からの材料抽出**

> 💡 単一画像から材料の反射・テクスチャ等を逆レンダリングで抽出。

**著者:** Zeyu Zhang, Wei Zhai, Jian Yang, Yang Cao

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.18312)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36437.png)
...
## 113. 3DReflecNet: A Large-Scale Dataset for 3D Reconstruction of Reflective, Transparent, and Low-Texture Objects

> 🇯🇵 **3DReflecNet：反射・透明・低テクスチャ物体3D再構成用大規模データセット**

> 💡 22TB以上の合成・実世界データで困難材質特性への3Dビジョン手法向上支援。
...
## 114. RetimeGS: Continuous-Time Reconstruction of 4D Gaussian Splatting

> 🇯🇵 **RetimeGS：連続時間再構成ガウシアンスプラッティング**

> 💡 連続時間表現で任意フレームレート動的シーン再構成・フレーム補間実現。

**著者:** Xuezhen Wang, Li Ma, Yulin Shen, Zeyu Wang, Pedro V. Sander

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.13783)

**Session:** Oral Session 2C: Gaussian Splatting & Reconstruction


![Poster](posters/3d/40312.png)
...
## 115. Selfi: Self-improving Reconstruction Engine via 3D Geometric Feature Alignment

> 🇯🇵 **Selfi：自己改善再構成エンジン**

> 💡 フィードバックループで段階的に品質向上する自己改善3D再構成。

**著者:** Youming Deng, Songyou Peng, Junyi Zhang, Kathryn Heal, Tiancheng Sun, John Flynn, Steve Marschner, Lucy Chai

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.08930)

**Session:** Oral Session 2C: Gaussian Splatting & Reconstruction


![Poster](posters/3d/40355.png)
...
## 116. Z-Order Transformer for Feed-Forward Gaussian Splatting

> 🇯🇵 **Z-Order Transformer Feed-Forward Gaussian：Z順序トランスフォーマー順伝播ガウシアン**

> 💡 Z順序曲線でピクセル系列化し、順伝播3Dガウシアン高速化。

**著者:** Can Wang, Lei Liu, Wei Jiang, Dong Xu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2605.13465)

**Session:** Oral Session 2C: Gaussian Splatting & Reconstruction


![Poster](posters/3d/40291.png)
...
## 117. SmokeSVD: Smoke Reconstruction from A Single View via Progressive Novel View Synthesis and Refinement with Diffusion Models
...
## 118. 3D-LATTE: Latent Space 3D Editing from Textual Instructions

> 🇯🇵 **3D-LATTE：テキスト指示による潜在空間3D編集**

> 💡 ネイティブ3D拡散モデル潜在空間で訓練自由編集、高忠実度意味操作実現。
...
## 119. Native and Compact Structured Latents for 3D Generation

> 🇯🇵 **ネイティブ・コンパクト構造化潜在空間**

> 💡 3D生成モデル固有の構造化潜在表現でコンパクト・解釈可能な3D表現。
...
**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.14692)

**Session:** Oral Session 3C: Generative Editing


![Poster](posters/3d/40283.png)
...
## 120. OLATverse: A Large-scale Real-world Object Dataset with Precise Lighting Control

> 🇯🇵 **OLATverse：精密照明制御を備えた大規模現実物体データセット**

> 💡 765現実物体900万画像、331個別制御光源で逆レンダリング・再照明ベンチマーク。
...
## 121. ManifoldNeuS: Manifold-aware View Optimizability for Pose-Free Neural Surface Reconstruction

> 🇯🇵 **ManifoldNeuS：多様体認識ビュー最適化神経表面**

> 💡 ビューポイント選択を多様体幾何で最適化し、ニューラル表面高速再構成実現。

**著者:** Xinxin Liu, Xue Wang, Guoqing Zhou, Qing Wang
...
## 124. MetroGS: Efficient and Stable Reconstruction of Geometrically Accurate High-Fidelity Large-Scale Scenes

> 🇯🇵 **MetroGS：効率的安定3Dガウシアン再構成**

> 💡 地下鉄行きアルゴリズムで安定した最適化、効率的な3Dガウシアン再構成。

**著者:** Kehua Chen, Tianlu Mao, Xinzhu Ma, Hao Jiang, Zehao Li, Zihan Liu, Shuqin Gao, Honglong Zhao, Feng Dai, Yucheng Zhang, Zhaoqi Wang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.19172)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/39509.png)
...
## 127. Dynamic-eDiTor: Training-Free Text-Driven 4D Scene Editing with Multimodal Diffusion Transformer

> 🇯🇵 **Dynamic-eDiTor：訓練自由テキスト駆動動的3D編集**

> 💡 テキスト指示で動的3Dシーンを訓練なしで編集・操作可能。

**著者:** Dong In Lee, Hyungjun Doh, Seunggeun Chi, Runlin Duan, Sangpil Kim, Karthik Ramani

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.00677)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/37824.png)
...
## 128. FaithFusion: Harmonizing Reconstruction and Generation via Pixel-wise Information Gain

> 🇯🇵 **FaithFusion：再構成融合調和**

> 💡 複数の再構成手法から一貫性ある融合結果で最適な3D表現実現。

**著者:** YuAn Wang, Xiaofan Li, Chi Huang, Wenhao Zhang, Hao Li, Bosheng Wang, Xun Sun, Jun Wang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.21113)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/38211.png)
...
## 129. IR-HGP: Physically-Aware Gaussian Inverse Rendering for High-Illumination Scenes via Generative Priors

> 🇯🇵 **IR-HGP：物理認識ガウシアン逆レンダリング**

> 💡 物理法則制約を統合したガウシアンベース逆レンダリング。

**著者:** Qingan Zhang, Wensheng Li, Chengying Gao
...
## 130. Speeding Up the Learning of 3D Gaussians with Much Shorter Gaussian Lists

> 🇯🇵 **3Dガウシアン学習高速化**

> 💡 ガウシアンスプラッティング訓練プロセスの計算最適化で高速化実現。

**著者:** Jiaqi Liu, Zhizhong Han

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.09277)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/38493.png)
...
## 131. Breaking the 3D Dataset Bottleneck: Fast Scalable Generation of Aligned 3D Assets from Scratch for Category 6D Pose Estimation and Robotic Grasping

> 🇯🇵 **3Dデータセットボトルネック突破：高速生成パイプライン**

> 💡 自動生成パイプラインで大規模3Dデータセット作成時間を劇的削減。

**著者:** Duret Guillaume, Danylo Mazurak, Florence Zara, Jan Peters, Liming Chen
...
## 133. FlowPortal: Residual-Corrected Flow for Training-Free Video Relighting and Background Replacement

> 🇯🇵 **フローポータル：学習不要なビデオ再照明と背景置き換え**

> 💡 残差補正フロー機構を用いた学習不要なビデオ再照明と背景置き換えフレームワーク

**著者:** Wenshuo Gao, Junyi Fan, Jiangyue Zeng, Shuai Yang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.18346)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/37556.png)
...
## 134. Adaptive Anisotropic Gaussian Splatting for Multi-contrast MRI Arbitrary-Scale Super-Resolution with Anatomy Guidance

> 🇯🇵 **適応的異方性ガウシアンスプラッティング：解剖学的ガイダンス付き多コントラストMRI任意倍率超解像**

> 💡 異方性2Dガウシアンカーネルを用いた多コントラストMRI超解像手法

**著者:** Qiuhai Yan, Kang Chen, Zhengjie Lu, Tingting Wang, Faming Fang, Guixu Zhang
...
## 135. Correspondence-Attention Alignment for Multi-View Diffusion Models
...
## 136. MatMart: Material Reconstruction of 3D Objects via Diffusion

> 🇯🇵 **マットマート：拡散モデルによる3D物体の材質再構成**

> 💡 2段階再構成と視点間材質相互注目を用いた3D材質再構成フレームワーク

**著者:** Xiuchao Wu, Pengfei Zhu, Jiangjing Lyu, Xinguo Liu, Jie Guo, Yanwen Guo, Weiwei Xu, Chengfei Lv

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.18900)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/38401.png)


**Abstract:** Applying diffusion models to physically-based material estimation and generation has recently gained prominence. In this paper, we propose MatMart, a novel material reconstruction framework for 3D objects, offering the following advantages. First, MatMart adopts a two-stage reconstruction, starting with accurate material prediction from inputs and followed by prior-guided material generation for unobserved views, yielding high-fidelity results. Second, by utilizing progressive inference alongside the proposed view-material cross-attention (VMCA), MatMart enables reconstruction from an arbitrary number of input images, demonstrating strong scalability and flexibility. Finally, MatMart achieves both material prediction and generation capabilities through end-to-end optimization of a single diffusion model, without relying on additional pre-trained models, thereby exhibiting enhanced stability across various types of objects. Extensive experiments demonstrate that MatMart achieves superior performance in material reconstruction compared to existing methods.


---

## 137. Spectral-Geometric Neural Fields for Pose-Free LiDAR View Synthesis

> 🇯🇵 **スペクトル幾何ニューラルフィールド：ポーズ自由なLiDAR新規視点合成**

> 💡 スペクトル情報と幾何学的一貫性を統合したポーズ最適化型LiDARNeRF

**著者:** Yinuo Jiang, Jun Cheng, Yiran Wang, Cheng Cheng

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.12903)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/36676.png)
...
## 138. Are We Ready for RL in Text-to-3D Generation? A Progressive Investigation

> 🇯🇵 **テキスト to 3D生成の強化学習：段階的調査研究**

> 💡 テキスト to 3D自回帰生成における報酬設計とRL手法の系統的研究

**著者:** Yiwen Tang, Ziyu Guo, Kaixin Zhu, Ray Zhang, Qizhi Chen, Dongzhi Jiang, Junli Liu, Bohan Zeng, Haoming Song, Delin Qu, Tianyi Bai, Dan Xu, Wentao Zhang, Bin Zhao

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.10949)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/39631.png)
...
## 139. Repurposing 3D Generative Model for Autoregressive Layout Generation

> 🇯🇵 **3Dジェネレーティブモデルの自回帰レイアウト生成への流用**

> 💡 3D拡散モデルと双進導自回転蒸留機構を用いた3Dシーンレイアウト生成

**著者:** Haoran Feng, Yifan Niu, Zehuan Huang, Yangtian Sun, Chunchao Guo, Yuxin Peng, Lu Sheng

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.16299)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/40185.png)
...
## 140. Consistent Instance Field for Dynamic Scene Understanding

> 🇯🇵 **一貫性インスタンスフィールド：動的シーン理解**

> 💡 変形可能3Dガウシアンに基づく連続確率時空間表現による動的シーン理解

**著者:** Junyi Wu, Van Nguyen Nguyen, Benjamin Planche, Jiachen Tao, Changchang Sun, Zhongpai Gao, Zhenghao Zhao, Anwesa Choudhuri, Gengyu Zhang, Meng Zheng, Feiran Wang, Terrence Chen, Yan Yan, Ziyan Wu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.14126) | [🌐 Project](https://adreamwu.github.io/Consistent-Instance-Field/)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/39740.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://adreamwu.github.io/Consistent-Instance-Field/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 141. Tavatar: Topology-Aware Gaussian Attribute Derivation for Animatable Human Avatars
...
## 142. ReWeaver: Towards Simulation-Ready and Topology-Accurate Garment Reconstruction

> 🇯🇵 **リウィーバー：シミュレーション対応かつ位相正確な衣服再構成**

> 💡 スパース多視点画像からの衣服と縫製パターン位相再構成フレームワーク

**著者:** Ming Li, Hui Shan, Kai Zheng, Chentao Shen, Siyu Liu, Yanwei Fu, Zhen Chen, Xiangru Huang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.16672)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/38489.png)


**Abstract:** High-quality 3D garment reconstruction plays a crucial role in mitigating the sim-to-real gap in applications such as digital avatars, virtual try-on and robotic manipulation. However, existing garment reconstruction methods, typically rely on the unstructured representations, such as 3D Gaussian Splats, which struggle to provide accurate reconstructions of garment topology and sewing structures. As a result, the reconstructed outputs are often unsuitable for high-fidelity physical simulation. We propose \textbf{ReWeaver}, a novel framework for topology-accurate 3D garment and sewing pattern reconstruction from \textit{sparse} multi-view RGB images. Given as few as four input views, ReWeaver predicts seams and panels as well as their connectivities in both the 2D UV space and the 3D space. The reconstructed seams and panels align precisely with the input images, and can be easily converted into simulation-ready and photorealistic 3D garments suitable for high-fidelity physics-based animation and virtual content creation. To enable effective training, we construct a large-scale dataset \textbf{GCD-TS}, comprising multi-view RGB images, 3D garment geometries, textured human body meshes and annotated sewing patterns. The dataset contains over 100,000 synthetic samples covering a wide range of complex geometries and topologies. Extensive experiments show that ReWeaver consistently outperforms existing methods in terms of topology accuracy, geometry alignment and seam-panel consistency.


---

## 143. FHAvatar: Fast and High-Fidelity Reconstruction of Face-and-Hair Composable 3D Head Avatar from Few Casual Captures

> 🇯🇵 **FHアバター：少数カジュアル撮影からの高忠実度顔髪合成3D頭部アバター再構成**

> 💡 平面ガウシアンと毛束ガウシアンの分離表現による顔髪合成3Dアバター再構成

**著者:** Yujie Sun, Zhuoqiang CAI, Chaoyue Niu, Jianchuan Chen, Zhiwen Chen, Chengfei Lv, Fan Wu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.23345)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/37858.png)
...
## 144. Diff4Splat: Repurposing Video Diffusion Models for Dynamic Scene Generation
...
## 145. CustomTex: High-fidelity Indoor Scene Texturing via Multi-Reference Customization

> 🇯🇵 **カスタムテックス：複数参照カスタマイズによる高忠実度室内シーン質感化**

> 💡 参照画像駆動の二重蒸留最適化による高品質シーンテクスチャマッピング

**著者:** Weilin Chen, Jiahao Rao, Wenhao Wang, Xinyang Li, Xuan Cheng, Liujuan Cao

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.19121)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/38697.png)
...
> 🇯🇵 **ユニプアール：統一オブジェクトレベル実シムー知覚**

> 💡 未知物体6Dポーズと実シムギャップを統一的に処理する知覚フレームワーク

**著者:** Chuanrui Zhang, Yingshuang Zou, ZhengXian Wu, Yonggen Ling, Yuxiao Yang, Ziwei Wang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.19616) | [🌐 Project](https://xingyoujun.github.io/unipr/)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/38136.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://xingyoujun.github.io/unipr/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 147. PoseGaussian: 6D Pose Estimation for Unseen Objects via Sparse-View Object-Level 3D Gaussian Splatting

> 🇯🇵 **ポーズガウシアン：未知物体の6Dポーズ推定**

> 💡 ガウシアンスプラッティングで未知物体の高精度6Dポーズ推定を実現

**著者:** Wubin Shi, Shaoyan Gai, Feipeng Da
...
## 148. RT-Splatting: Joint Reflection-Transmission Modeling with Gaussian Splatting

> 🇯🇵 **RTスプラッティング：反射伝送結合モデリング**

> 💡 反射伝送成分の結合モデルで透過物体の高忠実度再構成を実現

**著者:** Ji Shi, Xianghua Ying, Bowei Xing, Ruohao Guo, Wenzhen Yue

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2605.18263)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/38303.png)
...
## 149. Pose-Free Omnidirectional Gaussian Splatting for 360-Degree Videos with Consistent Depth Priors

> 🇯🇵 **ポーズフリー全方向ガウシアンスプラッティング：3Dシーン再構成**

> 💡 カメラポーズ未知のままガウシアンスプラッティング最適化を実現

**著者:** Chuanqing Zhuang, Xin Lu, Zehui Deng, Zhengda Lu, Yiqun Wang, Junqi Diao, Jun Xiao

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.23324)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/37030.png)
...
## 150. Distilling Unsigned Distance Function for Surface Reconstruction from 3D Gaussian Splatting

> 🇯🇵 **符号なし距離関数の蒸留：表面再構成**

> 💡 ガウシアンから符号なし距離関数蒸留で解析的表面を獲得

**著者:** Qian Li, Rao Fu, Jiangtao Li, Fan Liu
...
## 154. VAD-GS: Visibility-Aware Densification for 3D Gaussian Splatting in Dynamic Urban Scenes

> 🇯🇵 **可視性認識密度化3Dガウシアンスプラッティング**

> 💡 可視性認識で密度化対象を最適化し高品質ガウシアン配置を実現

**著者:** Yikang Zhang, Rui Fan
...
## 155. GauMVC: Generative Decoupled Gaussian Representation for Human-centric Multi-view Video Compression
...
## 156. A Geometric Algebra-Informed 3DGS Framework for Wireless Channel Prediction

> 🇯🇵 **幾何代数情報3DGS広角画像フレームワーク**

> 💡 幾何代数を活用した広角画像での高忠実度3Dガウシアン再構成

**著者:** Jingzhou Shen, Tianya Zhao, Xuyu Wang
...
## 157. ActivePolicy: Active Gaussian Reconstruction and Optimization Strategy Based on Global-Local Information Gain

> 🇯🇵 **アクティブポリシー：能動ガウシアン再構成と最適化**

> 💡 能動的ポリシー学習で効率的ガウシアン再構成を実現

**著者:** Yingzhao Li, Yanjie Liu, lijun zhao
...
## 158. SV-GS: Sparse View 4D Reconstruction with Skeleton-Driven Gaussian Splatting

> 🇯🇵 **SV-GS：スケルトンガイド4D再構成のスパース視点**

> 💡 スケルトン事前知識でスパース視点からの4D再構成を高度化

**著者:** Jun-Jee Chao, Volkan Isler

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.00285)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/36728.png)
...
## 159. SparseSplat: Towards Applicable Feed-Forward 3D Gaussian Splatting with Pixel-Unaligned Prediction

> 🇯🇵 **スパーススプラット：実用的なフィードフォワード3Dガウシアンへ**

> 💡 フィードフォワード型で実装的スパース視点3D再構成を実現

**著者:** Zicheng Zhang, Xiangting Meng, Ke Wu, Wenchao Ding

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.03069)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/36466.png)
...
## 160. GenSplat: Bridging the Generalization Gap in 3DGS Language Comprehension

> 🇯🇵 **ジェンスプラット：3DGS一般化ギャップへの橋渡し**

> 💡 生成的アプローチで3Dガウシアン一般化性能を大幅向上

**著者:** Fang Liu, Yuhao Liu, Ke Xu, Gerhard Hancke, Rynson W.H. Lau
...
## 161. Perceptual 3D Simulation With Physical World Modeling

> 🇯🇵 **知覚的3Dシミュレーション物理世界モデル**

> 💡 知覚と物理を統合した高忠実度3Dシミュレーション手法

**著者:** Wanhee Lee, Klemen Kotar, Rahul Venkatesh, Jared Watrous, Daniel L.K. Yamins
...
## 162. UAVLight: A Benchmark for Illumination-Robust 3D Reconstruction in Unmanned Aerial Vehicle (UAV) Scenes

> 🇯🇵 **UAVライト：照明ロバスト3D再構成ベンチマーク**

> 💡 変動照明下での堅牢な3D再構成評価ベンチマーク

**著者:** Kang DU, Xue Liao, Junpeng Xia, Chaozheng Guo, Yi Gu, Yirui Guan, Duotun Wang, Sheng Huang, Zeyu Wang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.21565) | [🌐 Project](https://uavlight.github.io/)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/39340.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://uavlight.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 163. Pano3DComposer: Feed-Forward Compositional 3D Scene Generation from Single Panoramic Image

> 🇯🇵 **パノ3Dコンポーザー：フィードフォワード合成3Dシーン**

> 💡 パノラマビューから合成3Dシーン生成のフィードフォワード手法

**著者:** Zidian Qiu, Ancong Wu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.05908)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/38938.png)
...
## 164. MeshWeaver: Sparse-Voxel-Guided Surface Weaving for Autoregressive Mesh Generation

> 🇯🇵 **メッシュウィーバー：スパース体素ガイド曲面織成**

> 💡 体素ガイダンスで高品質編み目サーフェス再構成を実現
...
## 165. CraftMesh: High-Fidelity Generative Mesh Manipulation via Poisson Seamless Fusion

> 🇯🇵 **クラフトメッシュ：高忠実度生成的メッシュ操作**

> 💡 生成モデルで高品質で柔軟なメッシュ操作と生成を実現

**著者:** James Jincheng Hu, Yuxiao Wu, Youcheng Cai, Ligang Liu
...
## 167. Video2Robo: 3DGS-based Synthetic Data from One Video Enables Scalable Robot Learning

> 🇯🇵 **ビデオ2ロボ：1つのビデオから3DGSを用いた合成データでロボット学習を実現**

> 💡 単一ビデオから3DGS表現を用いてロボット学習用の高品質合成データを生成するフレームワーク

**著者:** Yinan Deng, Kejia Hu, Ye Chen, Jianyu Dou, Jiahui Wang, Jingyu Zhao, Haojia Ao, Yi Yang, Yufeng Yue

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://video2robo.github.io/)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/39571.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://video2robo.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>

</details>


**Abstract:** Scalable robot learning is hindered by the high cost of acquiring diverse, high-quality embodied data. Existing data generation approaches partially mitigate this issue but typically depend on hard-to-access hardware and labor-intensive manual effort, with limited generalization to diverse scene configurations. To overcome these limitations, we propose Video2Robo, a framework that generates high-quality and diverse robot data directly from a single human demonstration video, enabling seamless deployment on physical robots. At its core, Video2Robo leverages 3D Gaussian Splatting (3DGS) as a powerful scene representation, enabling high-fidelity rendering and explicit 3D scene editing. The framework tracks temporally consistent motion trajectories of task-relevant objects from raw video footage and identifies key task skills, guiding robots to execute tasks kinematically plausibly under novel object arrangements. Furthermore, by augmenting backgrounds, textures, lighting, and camera views, Video2Robo further enhances the diversity of generated data. Extensive evaluations in both simulation and real-world environments demonstrate that policies trained on Video2Robo data achieve superior generalization and transfer performance.


---

## 168. MoCapAnything: Unified 3D Motion Capture for Arbitrary Skeletons from Monocular Videos

> 🇯🇵 **モーション何でもキャプチャ：単眼ビデオからの任意スケルトン統合3Dモーションキャプチャ**

> 💡 参照ガイド分解型フレームワークで任意リギング3Dアセットからアニメーション駆動回転を再構成

**著者:** Kehong Gong, Zhengyu Wen, Xiaoyu He, Mingxi Xu, Qi WANG, ning Zhang, Zhengyu Li, Dongze Lian, Wei Zhao, He Xiaoyu, Mingyuan Zhang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.10881)

**Session:** Poster Session 1 & Exhibit Hall


![Poster](posters/3d/38556.png)
...
## 169. Neural Field-Based 3D Surface Reconstruction of Microstructures from Multi-Detector Signals in Scanning Electron Microscopy

> 🇯🇵 **ニューラルフィールドベース3D表面再構成：走査型電子顕微鏡のマルチ検出器信号**

> 💡 物理的先行知識を組み込んだニューラルフィールドによるSEM画像からの高忠実度3D再構成
...
## 170. PhyGaP: Physically-Grounded Gaussians with Polarization Cues

> 🇯🇵 **フィジガップ：偏光キューを用いた物理的基盤ガウシアン**

> 💡 偏光情報を活用した物理的反射分解とガウシアンスプラッティングの高忠実度再ライティング

**著者:** Jiale Wu, Xiaoyang Bai, Zongqi He, Weiwei Xu, YIFAN PENG

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.14001)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37789.png)
...
## 171. Proxy-GS: Unified Occlusion Priors for Training and Inference in Structured 3D Gaussian Splatting

> 🇯🇵 **プロキシGS：構造化3Dガウシアンスプラッティングの統一的遮蔽先行知識**

> 💡 高速プロキシシステムで遮蔽認識ガウシアンを導入し大規模シーンで2.5倍以上高速化
...
## 172. RetimeGS: Continuous-Time Reconstruction of 4D Gaussian Splatting

> 🇯🇵 **リタイムGS：4Dガウシアンスプラッティングの連続時間再構成**

> 💡 時間的エイリアシング軽減による大モーション下でのゴーストフリー連続フレーム補間

**著者:** Xuezhen Wang, Li Ma, Yulin Shen, Zeyu Wang, Pedro V. Sander

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.13783) | [🌐 Project](https://william-wang2.github.io/RetimeGS/)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37783.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://william-wang2.github.io/RetimeGS/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 173. Selfi: Self-improving Reconstruction Engine via 3D Geometric Feature Alignment

> 🇯🇵 **セルフィ：3D幾何学的特徴アラインメントによる自己改善再構成エンジン**

> 💡 再投影整合性損失を用いた視視点合成とカメラ位置推定の同時最適化
...
## 174. Z-Order Transformer for Feed-Forward Gaussian Splatting

> 🇯🇵 **Z順序トランスフォーマー：フィードフォワード型ガウシアンスプラッティング**

> 💡 Z順序戦略で空間コヒーレント配列化し単一フォワードパスでガウシアン予測
...
## 175. SmokeSVD: Smoke Reconstruction from A Single View via Progressive Novel View Synthesis and Refinement with Diffusion Models
...
## 176. Affostruction: 3D Affordance Grounding with Generative Reconstruction

> 🇯🇵 **アフォストラクション：生成的再構成による3Dアフォーダンス接地**

> 💡 流ベースアフォーダンス予測と能動的視点選択を結合した完全形状アフォーダンス推定

**著者:** Chunghyun Park, Seunghyeon Lee, Minsu Cho

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.09211) | [🌐 Project](https://chrockey.github.io/Affostruction/)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39102.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://chrockey.github.io/Affostruction/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 177. Unified Primitive Proxies for Structured Shape Completion

> 🇯🇵 **統一プリミティブプロキシ：構造化形状完成**

> 💡 プリミティブプロキシで単一パスで完全幾何形状と意味論を持つ図形完成を実現

**著者:** Zhaiyu Chen, Yuqing Wang, Xiao Xiang Zhu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.00759) | [🌐 Project](https://unico-completion.github.io/)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/38587.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://unico-completion.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 178. S2D: Sparse to Dense Lifting for 3D Reconstruction with Minimal Inputs

> 🇯🇵 **S2D：スパースから密への変換による最小入力での3D再構成**

> 💡 効率的1ステップ拡散モデルで疎ポイントクラウドから高忠実度3DGS再構成を実現

**著者:** Yuzhou Ji, Qijian Tian, He Zhu, Xiaoqi Jiang, Guangzhi Cao, Lizhuang Ma, Yuan Xie, Xin Tan

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.10893)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39010.png)
...
## 179. Aesthetic Camera Viewpoint Suggestion with 3D Aesthetic Field

> 🇯🇵 **審美カメラ視点提案：3D審美フィールド**

> 💡 2D審美モデルから3D審美フィールド蒸留で勾配最適化による効率的視点提案

**著者:** Sheyang Tang, Armin Shafiee Sarvestani, Jialu Xu, Xiaoyu Xu, Zhou Wang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.20363) | [🌐 Project](https://sheyangtang.com/aesthetic-field/)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/38154.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://sheyangtang.com/aesthetic-field/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 180. CoRoGS: Contextual Gaussian Splatting for Robust Large-Deviation View Synthesis

> 🇯🇵 **コロGS：文脈認識ガウシアンスプラッティングによる大画角新規視点合成**

> 💡 ガウシアングラフメッセージパッシングで文脈的推論と段階的グラフ拡張による大偏差視点合成

**著者:** Xin Ma, Peng Lu, Yisong Chen, Chengwei Pan, Sheng Li
...
## 182. Dynamic-Static Decomposition for Novel View Synthesis of Dynamic Scenes with Spiking Neurons

> 🇯🇵 **動的静的分解：スパイキングニューロンで動的シーン新規視点合成**

> 💡 スパイキングニューロンネットワークで動的シーン背景分離と時間的コヒーレンス保証

**著者:** Lingyun Dai, Zehao Chen, Yan Liu, Shi Gu, Peng Lin, De Ma, Huajin Tang, Qian Zheng, Gang Pan
...
## 183. HandDreamer: Zero-Shot Text to 3D Hand Model Generation using Corrective Hand Shape Guidance

> 🇯🇵 **ハンドドリーマー：ゼロショット手3Dモデル生成**

> 💡 テキストプロンプトから多様な手ジェスチャー3Dモデルをゼロショット生成

**著者:** Green Rosh, Prateek Kukreja, Vishakha SR, Pawan Prasad B H

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.04425) | [🌐 Project](https://github.com/SamsungLabs/HandDreamer)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37496.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/SamsungLabs/HandDreamer" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 184. MatPedia: A Universal Generative Foundation for High-Fidelity Material Synthesis

> 🇯🇵 **マットペディア：高品質材質自由な汎用基盤**

> 💡 大規模材質多様性に対応した普遍的生成基盤モデル

**著者:** Di Luo, Shuhui Yang, Mingxin Yang, Jiawei Lu, Yixuan Tang, Xintong Han, Zhuo Chen, Beibei Wang, Chunchao Guo

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.16957)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37061.png)
...
## 185. Clair Obscur: an Illumination-Aware Method for Real-World Image Vectorization

> 🇯🇵 **クレール・オブスキュア：照明認識リアルタイム再構成**

> 💡 光の物理的正確性を保持したリアルタイム3D再構成手法

**著者:** Xingyue Lin, Shuai Peng, Xiangyu Xie, Jianhua Zhu, Yuxuan Zhou, Liangcai Gao

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.20034)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36638.png)
...
## 186. GaussianDWM: 3D Gaussian Driving World Model for Unified Scene Understanding and Multi-Modal Generation

> 🇯🇵 **ガウシアンドライビングワールドモデル：未知環境自動運転**

> 💡 ガウシアンで環境ダイナミクスモデルし運転予測と制御を統合

**著者:** Tianchen Deng, Xuefeng Chen, Yi Chen, Qu Chen, Yuyao Xu, Lijin Yang, Le Xu, Yu Zhang, Bo Zhang, Wuxiong Huang, Hesheng Wang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.23180)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37891.png)
...
## 187. StreamAvatar: Streaming Diffusion Models for Real-Time Interactive Human Avatars
...
## 188. STAvatar: Soft Binding and Temporal Density Control for Monocular 3D Head Avatars Reconstruction

> 🇯🇵 **STアバター：柔軟結合と時間密度制御**

> 💡 時間密度制御で アバター変形の時間コヒーレンスと品質を同時実現

**著者:** Jiankuo Zhao, Xiangyu Zhu, Zidu Wang, Zhen Lei

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.19854)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36794.png)
...
## 189. CrowdGaussian: Reconstructing High-Fidelity 3D Gaussians for Human Crowd from a Single Image

> 🇯🇵 **クラウドガウシアン：群衆高忠実度3D再構成**

> 💡 群衆シーンから高忠実度3Dガウシアン再構成を高密度実現

**著者:** Yizheng Song, Yiyu Zhuang, Qipeng Xu, Haixiang Wang, Jiahe Zhu, Jing Tian, Siyu Zhu, Hao Zhu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.17779)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37611.png)
...
## 190. Scaling4D: Pushing the Frontier of Video Novel View Synthesis through Large-Scale Monocular Videos
...
## 191. AeroAgent: A Vision–Physics–Decision Framework for Aerodynamic Vehicle Design

> 🇯🇵 **エアロエージェント：視覚物理決定フレームワーク無人機**

> 💡 視覚物理予測で自律航行ロボットの意思決定を最適化

**著者:** Ye Liu, Shouyi Li, Huiyu Yang, Jianghang gu, Wenhao Fan, Zhongxin Yang, Ding Wang, Simeng Chen, Zirun Jiang, Yuanwei Bin, Shiyi Chen, Yuntian Chen
...
## 193. MSCD-GS: Motion-Separated Cooperative Deblurring Dynamic Reconstruction via Gaussian Splatting

> 🇯🇵 **MSCDGS：運動分離協調デブラー動的ガウシアン**

> 💡 運動分離と協調処理でぼやけた動的シーンの鮮明再構成

**著者:** yongjian liao, Xu Zou, Wenjun Chen, Huixuan Li, Xiaoen Xie, Chunxi Li, Shixiang Huang, Gang Zhang, Jiahuan Zhou, Sheng Zhong, Luxin Yan
...
## 194. iSplat: Iterative Learning for Fine-Grained Gaussian Splatting

> 🇯🇵 **アイスプラット：微細粒度ガウシアン反復学習**

> 💡 反復最適化で微細粒度ガウシアン表現を段階的精密化

**著者:** Haifeng Wu, Wei Long, Shuhang Gu, Lixin Duan, Wen Li
...
## 195. Off The Grid: Detection of Primitives for Feed-Forward 3D Gaussian Splatting

> 🇯🇵 **オフザグリッド：フィードフォワードプリミティブ検出**

> 💡 グリッド外プリミティブ位置を直接検出するフィードフォワード手法

**著者:** Arthur Moreau, Richard Shaw, Michal Nazarczuk, Jisu Shin, Thomas Tanay, Zhensong Zhang, Songcen Xu, Eduardo Pérez-Pellitero

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.15508)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36893.png)
...
## 196. MAPo: Motion-Aware Partitioning of Deformable 3D Gaussian Splatting for High-Fidelity Dynamic Scene Reconstruction

> 🇯🇵 **マップオー：変形可能3Dガウシアン運動分離分割**

> 💡 運動認識で変形可能オブジェクトの動き領域を最適分割

**著者:** Han Jiao, Jiakai Sun, Yexing Xu, Lei Zhao, Wei Xing, Huaizhong Lin

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2508.19786)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36637.png)
...
## 197. FreeArtGS: Articulated Gaussian Splatting Under Free-moving Scenario

> 🇯🇵 **フリーアートGS：自由度関節ガウシアンスプラッティング**

> 💡 自由度制御で関節物体の柔軟な動きガウシアン表現

**著者:** Hang Dai, Hongwei Fan, Han Zhang, Duojin Wu, Jiyao Zhang, Hao Dong

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.22102) | [🌐 Project](https://freeartgs.github.io)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36810.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://freeartgs.github.io" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 198. HeroGS: Hierarchical Guidance for Robust 3D Gaussian Splatting under Sparse Views

> 🇯🇵 **ヒーロGS：堅牢3Dガウシアンの階層ガイダンス**

> 💡 階層的構造ガイダンスで堅牢なガウシアン再構成と生成

**著者:** Jiashu Li, Xumeng Han, Zhaoyang Wei, Zipeng Wang, Kuiran Wang, Guorong Li, Zhenjun Han, Jianbin Jiao

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.01099)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39946.png)
...
## 199. SharpTimeGS: Sharp and Stable Dynamic Gaussian Splatting via Lifespan Modulation

> 🇯🇵 **シャープタイムGS：寿命変調による鮮明で安定した動的ガウシアンスプラッティング**

> 💡 学習可能な寿命パラメータで静動領域の時間適応的統一表現と長期安定性を実現

**著者:** Zhanfeng Liao, Jiajun Zhang, Hanzhang Tu, Zhixi Wang, Yunqi Gao, Hongwen Zhang, Yebin Liu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.02989)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36990.png)
...
## 200. PhysIR-Splat: Physically Consistent Thermal Infrared Radiative Transfer in 3D Gaussian Splatting

> 🇯🇵 **フィジアイアールスプラット：3Dガウシアンスプラッティングの物理的整合熱赤外放射移動**

> 💡 温度、放射率、環境放射の物理モデル化で熱赤外3D再構成と新規視点合成を実現

**著者:** Jingyuan Gao, Yumeng Hu, Fei Gao, Mingjin Zhang
...
## 202. SplatSuRe: Selective Super-Resolution for Multi-view Consistent 3D Gaussian Splatting

> 🇯🇵 **スプラットシュアー：マルチビュー一貫な3Dガウシアンスプラッティング選択的超解像**

> 💡 カメラ位置で未サンプリング領域を特定し選択的超解像で多視点一貫性を達成

**著者:** Pranav Asthana, Alex Hanson, Allen Tu, Tom Goldstein, Matthias Zwicker, Amitabh Varshney

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.02172) | [🌐 Project](https://splatsure.github.io/)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36956.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://splatsure.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 203. MotionScale: Reconstructing Appearance, Geometry, and Motion of Dynamic Scenes with Scalable 4D Gaussian Splatting

> 🇯🇵 **モーションスケール：動的シーンの外観幾何運動をスケーラブル4Dガウシアンで再構成**

> 💡 クラスタベース基底の適応的運動フィールドで複雑動的シーンの高忠実度再構成

**著者:** Haoran Zhou, Gim Hee Lee

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.29296)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39124.png)
...
## 204. PRIMU: Uncertainty Estimation for Novel Views in Gaussian Splatting from Primitive-Based Representations of Error and Coverage

> 🇯🇵 **プリム：ガウシアンスプラッティングにおけるプリミティブベース不確実性推定**

> 💡 プリミティブレベルのエラー表現で安全クリティカルアプリケーション向け不確実性推定

**著者:** Thomas Gottwald, Edgar Heinert, Peter Stehr, Chamuditha Jayanga Galappaththige, Matthias Rottmann

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2508.02443)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39071.png)
...
## 205. TGSFormer: Scalable Temporal Gaussian Splatting for Embodied Semantic Scene Completion

> 🇯🇵 **TGSフォーマー：体現的意味シーン完成のスケーラブル時間ガウシアンスプラッティング**

> 💡 永続的ガウシアンメモリと信頼度注目で時間融合し非有界シーンのSSCを実現

**著者:** Rui Qian, Haozhi Cao, Tianchen Deng, TIANXIN HU, Weixiang Guo, Shenghai Yuan, Lihua Xie

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.00300)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37598.png)
...
## 206. Disco-GS: Gaussian Splatting in Dynamic Color Lighting

> 🇯🇵 **ディスコGS：動的色彩照明下のガウシアンスプラッティング**

> 💡 変動色光下で正準外観復元と3D再構成を同時実現するエンドツーエンドフレームワーク

**著者:** Ashish Kumar, A. N. Rajagopalan
...
## 207. SGI: Structured 2D Gaussians for Efficient and Compact Large Image Representation

> 🇯🇵 **SGI：効率的でコンパクトな高解像度画像表現への構造化2Dガウシアン**

> 💡 シード基盤構造で多スケール局所空間を定義し7.5倍圧縮を達成する高速最適化

**著者:** Zixuan Pan, Kaiyuan Tang, Jun Xia, Yifan Qin, Lin Gu, Chaoli Wang, Jianxu Chen, Yiyu Shi

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.07789) | [🌐 Project](https://github.com/zx-pan/SGI)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36866.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/zx-pan/SGI" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 208. Dynamic Black-hole Emission Tomography with Physics-informed Neural Fields

> 🇯🇵 **動的ブラックホール放射断層撮影：物理情報ニューラルフィールド**

> 💡 速度フィールドと放射率の同時再構成で流体力学制約を実装したブラックホール3D画像化

**著者:** Berthy T. Feng, Andrew A. Chael, David Bromley, Aviad Levis, William Freeman, Katherine L. Bouman

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.08029) | [🌐 Project](https://github.com/berthyf96/pidef)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37695.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/berthyf96/pidef" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 209. Generalizable Radio-Frequency Radiance Fields for Spatial Spectrum Synthesis

> 🇯🇵 **グラフ：空間スペクトラム合成の汎用RF放射場**

> 💡 幾何認識トランスフォーマーで地理的近接送信機の補間理論を利用した汎用RF合成

**著者:** Kang Yang, Yuning Chen, Wan Du

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2502.05708) | [🌐 Project](https://kangyangg.com/projects/graf/)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37339.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://kangyangg.com/projects/graf/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 210. GeoRelight: Learning Joint Geometrical Reconstruction and Relighting with Flexible Multi-Modal Diffusion Transformers

> 🇯🇵 **ジオリライト：柔軟マルチモーダル拡散トランスで幾何再構成と再ライティングを共同学習**

> 💡 等方ND正投影深度表現と混合データ学習で単一写真からの物理的整合再ライティング

**著者:** Yuxuan Xue, Ruofan Liang, Egor Zakharov, Timur Bagautdinov, Chen Cao, Giljoo Nam, Shunsuke Saito, Gerard Pons-Moll, Javier Romero
...
> 🇯🇵 **ブドウ栽培者3D：エージェント型テキスト誘導3D編集に向けて**

> 💡 マルチモーダルLLMで分解編集指示を推論し3D潜在空間で反転ベース修復編集

**著者:** Yankuan Chi, Xiang Li, Zixuan Huang, James M.
...
## 212. MV2UV: Generating High-quality UV Texture Maps with Multiview Prompts

> 🇯🇵 **MV2UV：マルチビュープロンプトから高品質UVテクスチャマップ生成**

> 💡 マルチビュー生成と未観測部分修復でUV空間モデルから高品質テクスチャ統合生成

**著者:** Zheng Zhang, Qinchuan Zhang, Yuteng Ye, Zhi Chen, Penglei Ji, Mengfei Li, Wenxiao ZHANG, Yuan Liu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.15436)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37737.png)
...
## 213. MeshRipple: Structured Autoregressive Generation of Artist-Meshes

> 🇯🇵 **メッシュリップル：構造化自回帰アーティストメッシュ生成**

> 💡 フロンティア認識トークン化と疎注目グローバルメモリで位相的完全性が高い自回帰メッシュ生成

**著者:** JunKai Lin, Hang Long, Huipeng Guo, Jielei Zhang, JiaYi Yang, Tianle Guo, Yang Yang, Jianwen Li, Wenxiao ZHANG, Matthias Nießner, Wei Yang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.07514)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36563.png)
...
## 214. FACE: A Face-based Autoregressive Representation for High-Fidelity and Efficient Mesh Generation

> 🇯🇵 **フェイス：高忠実度効率的メッシュ生成のフェースベース自回帰表現**

> 💡 メッシュ面の自回帰モデル化でトポロジー完全性と高速生成を同時実現

**著者:** Hanxiao Wang, Yuanchen Guo, Ying-Tian Liu, Zi-Xin Zou, Biao Zhang, Weize Quan, Ding Liang, Yan-Pei Cao, Dong-Ming Yan

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.01515)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39237.png)
...
## 215. Easy3E: Feed-Forward 3D Asset Editing via Rectified Voxel Flow

> 🇯🇵 **イージー3E：反正流フィードフォワード3Dアセット編集**

> 💡 反正流ベース潜在空間編集でテキスト誘導3Dアセット高速編集を実現

**著者:** Shimin Hu, Yuanyi Wei, Fei Zha, Yudong Guo, Juyong Zhang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.21499) | [🌐 Project](https://ustc3dv.github.io/Easy3E/)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37819.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://ustc3dv.github.io/Easy3E/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 218. From Manuals to Actions: A Unified VLA Model for Chain-of-Thought Manual Generation and Robotic Manipulation

> 🇯🇵 **マニュアルから行動へ：マニピュレータ統一視言語アクションモデル**

> 💡 マニュアル情報から実ロボット制御へのマルチタスク学習

**著者:** Chenyang Gu, Jiaming Liu, Hao Chen, Runzhong Huang, Qingpo Wuwu, Xiaoqi Li, Zhuoyang Liu, Ying Li, Ray Zhang, Peng Jia, Pheng-Ann Heng, Shanghang Zhang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://sites.google.com/view/maunalvla/)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37779.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://sites.google.com/view/maunalvla/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 219. SCAPO: Self-Supervised Category-Level Articulated Pose Estimation from a Single 3D Observation

> 🇯🇵 **スカポ：自己監督カテゴリレベル関節物体認識**

> 💡 自己監督学習で関節物体の動き状態を階層的に認識
...
## 220. ArtPro: Self-Supervised Articulated Object Reconstruction with Adaptive Integration of Mobility Proposals

> 🇯🇵 **アートプロ：自己監督関節物体再構成**

> 💡 自己監督スキームで関節動作をガイドとした高品質3D再構成

**著者:** Xuelu Li, Zhaonan Wang, Xiaogang Wang, Lei Wu, Manyi Li, Changhe Tu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.22666)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39742.png)
...
## 221. Illumination-Consistent Human-Scene Reconstruction from Monocular Video
...
## 222. Faithful Contouring: Near-Lossless 3D Voxel Representation Free from Iso-surface

> 🇯🇵 **忠実なコンタリング：ほぼロスレス3Dボクセル表現**

> 💡 ロスレスに近いエンコーディングで高忠実度3Dボクセル圧縮表現

**著者:** Yihao Luo, Xianglong He, Chuanyu Pan, Yiwen Chen, Jiaqi Wu, Yangguang Li, Wanli Ouyang, Yuanming Hu, Guang Yang, Choon Hwai Yap

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.04029)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/38053.png)
...
## 223. Faithful Contouring: Near-Lossless 3D Voxel Representation Free from Iso-surface

> 🇯🇵 **忠実なコンタリング2：最適化ボクセル境界符号化**

> 💡 最適化コンタリングで複雑形状のボクセル境界正確表現
...
## 224. Native and Compact Structured Latents for 3D Generation

> 🇯🇵 **ネイティブとコンパクト構造潜在3D生成**

> 💡 構造化潜在表現で効率的で高品質な3D生成を実現
...
## 225. Mesh4D: 4D Mesh Reconstruction and Tracking from Monocular Video
...
## 226. Visual Personalization Turing Test

> 🇯🇵 **ビジュアルパーソナライゼーションチューリングテスト**

> 💡 知覚的識別不可能性に基づくビジュアルパーソナライゼーション評価パラダイム

**著者:** Rameen Abdal, James Burgess, Sergey Tulyakov, Kuan-Chieh Jackson Wang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.22680)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/37807.png)
...
## 227. Charge: A Comprehensive Novel View Synthesis Benchmark and Dataset to Bind Them All

> 🇯🇵 **チャージ：新規視点合成ベンチマークとデータセット統一**

> 💡 高品質アニメ映画から生成した詳細テクスチャとマルチモーダル注釈の3Dシーンデータセット

**著者:** Michal Nazarczuk, Thomas Tanay, Arthur Moreau, Zhensong Zhang, Eduardo Pérez-Pellitero

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.13639)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/39802.png)
...
## 228. Hermite Radial Basis Function for Surface Reconstruction via Differentiable Rendering

> 🇯🇵 **エルミート放射基底関数：微分可能レンダリングで表面再構成**

> 💡 局所RBFとその微分から構成した全局陰関数で幾何表現と高速レンダリングを実現
...
## 229. FluidGaussian: Propagating Simulation-Based Uncertainty Toward Functionally-Intelligent 3D Reconstruction

> 🇯🇵 **フルイッドガウシアン：流体構造相互作用で機能的知能3D再構成へ不確実性伝播**

> 💡 流体シミュレーションベース不確実性で物理的妥当性を考慮した高忠実度3D再構成

**著者:** Yuqiu Liu, Jialin Song, Marissa Ramirez de Chanlatte, Rochishnu Chowdhury, Rushil Paresh Desai, Wuyang Chen, Daniel Martin, Michael Mahoney

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.21356)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/37982.png)
...
## 230. LagerNVS: Latent Geometry for Fully Neural Real-time Novel View Synthesis

> 🇯🇵 **ラガーNVS：完全ニューラル実時間新規視点合成の潜在幾何**

> 💡 3Dバイアスを保持した潜在シーン符号化でフィードフォワード高速新規視点合成実現

**著者:** Stanislaw Szymanowicz, Minghao Chen, Jianyuan Wang, Christian Rupprecht, Andrea Vedaldi

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.20176)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/37035.png)
...
## 231. Turbo-GS: Accelerating 3D Gaussian Fitting for High-Resolution Radiance Fields

> 🇯🇵 **ターボGS：高解像度放射フィールド向け3Dガウシアンフィッティング高速化**

> 💡 拡張レンダリングと収束認識予算制御で4K高速フィッティングと高品質合成を両立

**著者:** Ankit Dhiman, Tao Lu, Srinath Ravi, Emre Arslan, Angela Xing, Yuanbo Xiangli, R. Venkatesh Babu, Srinath Sridhar

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://ivl.cs.brown.edu/research/turbo-gs)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/38796.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://ivl.cs.brown.edu/research/turbo-gs" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 232. REALM: An MLLM-Agent Framework for Open World 3D Reasoning Segmentation and Editing on Gaussian Splatting

> 🇯🇵 **REALM: ガウシアンスプラッティングにおける3D推論セグメンテーションと編集用MLLM-エージェント框架**

> 💡 複雑な人間指示と正確な3D物体領域化を橋渡しするMLLM-エージェント框架。ガウシアンスプラッティング上で推論ベースのセグメンテーションを実現。

**著者:** Changyue Shi, Minghao Chen, Yiping Mao, Chuxiao Yang, Xinyuan Hu, Jiajun Ding, Zhou Yu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2510.16410)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/39656.png)
...
## 233. RI-Mamba: Rotation-Invariant Mamba for Robust Text-to-Shape Retrieval

> 🇯🇵 **RI-Mamba: テキスト-3D形状検索用の回転不変状態空間モデル**

> 💡 ポイントクラウド用の初の回転不変状態空間モデル。任意方向の物体に対応した大規模3D形状検索手法。

**著者:** Khanh Nguyen, Dasith de Silva Edirimuni, Ghulam Mubashar Hassan, Ajmal Mian

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.11673) | [🌐 Project](https://ndkhanh360.github.io/project-rimamba/)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/37273.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://ndkhanh360.github.io/project-rimamba/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 234. BuildAnyPoint: 3D Building Structured Abstraction from Diverse Point Clouds

> 🇯🇵 **BuildAnyPoint: 多様なポイントクラウドからの3D建物構造抽象化**

> 💡 LiDARやStructure-from-Motionから多様な分布のポイントクラウド用3D建物構造抽象化フレームワーク。

**著者:** Tongyan Hua, Haoran Gong, Yuan Liu, Di Wang, Ying-Cong Chen, Wufan Zhao

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.23645)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/37403.png)
...
## 235. Animator-Centric Skeleton Generation on Objects with Fine-Grained Details
...
## 236. ST4R-Splat: Spatio-Temporal Referring Segmentation in 4D Gaussian Splatting

> 🇯🇵 **ST4R-Splat: 4Dガウシアンスプラッティングにおける時空間参照セグメンテーション**

> 💡 動的シーン内の時空間参照表現に基づく初のセグメンテーション框架。自然言語から4D動的物体の分割を実現。

**著者:** Yuming Meng, Dong Wu, Hongbin Zha
...
## 237. EmoDiffTalk: Emotion-aware Diffusion for Editable 3D Gaussian Talking Head

> 🇯🇵 **EmoDiffTalk: 感情対応拡散による編集可能3Dガウシアン話者頭部生成**

> 💡 3Dガウシアンスプラッティング用感情対応拡散。表情操作と感情編集に対応した3D話者頭部合成。

**著者:** Chang Liu, Tianjiao Jing, Chengcheng Ma, Xuanqi Zhou, Zhengxuan Lian, Qin Jin, Hongliang Yuan, Shi-Sheng Huang
...
## 238. Zero-Shot Reconstruction of Animatable 3D Avatars with Cloth Dynamics from a Single Image
...
## 239. UIKA: Fast Universal Head Avatar from Pose-Free Images

> 🇯🇵 **UIKA: ポーズフリー画像からの高速汎用頭部アバター生成**

> 💡 単一画像や多視点動画から実行可能なガウシアン頭部モデル生成。リアルタイムレンダリング対応の頭部アバター。

**著者:** Zijian Wu, Boyao Zhou, Liangxiao Hu, Hongyu Liu, Yuan Sun, Xuan Wang, Xun Cao, Yujun Shen, Hao Zhu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.07603)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/39803.png)
...
## 240. FlexAvatar: Flexible Large Reconstruction Model for Animatable Gaussian Head Avatars with Detailed Deformation
...
## 241. VDFE: Difference-Aware 3D Scene Editing with Non-Intrusive Video Diffusion Priors for Multi-View Consistency and Efficiency
...
## 242. Towards Realistic and Consistent Orbital Video Generation via 3D Foundation Priors
...
## 243. NaTex: Seamless Texture Generation as Latent Color Diffusion

> 🇯🇵 **NaTex: 潜在色拡散としてのシームレステクスチャ生成**

> 💡 3D空間内で直接テクスチャ色を予測する新しいテクスチャ生成框架。色ポイントクラウド拡散による高精度テクスチャ生成。

**著者:** Zeqiang Lai, Yunfei Zhao, Zibo Zhao, Xin Yang, Xin Huang, Jingwei Huang, Xiangyu Yue, Chunchao Guo

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.16317)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/38363.png)
...
## 244. GaussianGrow: Geometry-aware Gaussian Growing from 3D Point Clouds with Text Guidance

> 🇯🇵 **GaussianGrow: テキスト誘導3Dポイントクラウドからの幾何対応ガウシアン成長法**

> 💡 3Dポイントクラウドからテキスト誘導で成長させるガウシアン生成手法。幾何的正確性を自然に保証。

**著者:** Weiqi Zhang, Junsheng Zhou, Haotian Geng, Kanle Shi, Shenkun Xu, Yi Fang, Yu-Shen Liu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.05721)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/36262.png)
...
> 🇯🇵 **PhysGS: 物理特性推定のベイズ推論ガウシアンスプラッティング**

> 💡 視覚的手掛かりと視覚言語事前知識から密な物理特性を推定するガウシアンスプラッティング拡張手法。

**著者:** Samarth Chopra, Jing Liang, Gershom Seneviratne, Dinesh Manocha

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.18570)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/36542.png)
...
## 246. 3D Gaussian Splatting at Arbitrary Resolutions with Compact Proxy Anchors

> 🇯🇵 **3Dガウシアンスプラッティング: コンパクト代理アンカーによる任意解像度対応**

> 💡 任意解像度でのエイリアシングフリーレンダリングを実現。解像度適応型ガウシアン表現による効率的な視点合成。

**著者:** Mingyun Jeong, Seongro Yoon, Francois Bremond, Donghyeon Cho
...
## 249. GaussianPile: A Unified Sparse Gaussian Splatting Framework for Slice-based Volumetric Reconstruction

> 🇯🇵 **GaussianPile: 統一スパースガウススプラッティングフレームワーク**

> 💡 スパース条件で統一的な3D表現を実現

**著者:** Di Kong, Yikai Wang, Wenjie Guo, Yifan Bu, Boya Zhang, Yuexin Duan, Xiawei Yue, Wenbiao Du, Yiman Zhong, Yuwen Chen, Cheng Ma

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.20611)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/39074.png)
...
## 250. Confidence-Guided Multi-Scale Aggregation for Sparse-View High-Resolution 3D Gaussian Splatting

> 🇯🇵 **信頼度ガイド型マルチスケール集約スパースビュー超解像**

> 💡 複数スケール特徴で限定視点からの高精度再構成

**著者:** Qinzheng Zhou, Zaychik Liu, Lijing Lu, Zhihang Li
...
## 251. ULF-Loc: Unbiased Landmark Feature for Robust Visual Localization with 3D Gaussian Splatting

> 🇯🇵 **ULF-Loc: 不偏ランドマーク特徴ロバスト視覚位置特定**

> 💡 ランドマーク特徴で頑健なロボット位置推定

**著者:** Yingdong Gu, Shaocheng Yan, Zhenjun Zhao, Yuan Kou, Jianxin Luo, Pengcheng Shi, Jiayuan Li

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2605.04730) | [🌐 Project](https://github.com/Cyril-gyd/ULF-Loc)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/36460.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/Cyril-gyd/ULF-Loc" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 252. Robust3DGSW: Toward Robust Watermarking for Quantization-Aware 3D Gaussian Splatting

> 🇯🇵 **Robust3DGSW: 量子化対応ロバスト3DGS透かし**

> 💡 圧縮後も保持される透かしで3Dモデル保護

**著者:** Boyu Wang, Jun Xia, Mingsong Chen
...
## 253. L^2DGS: Low-Light Dynamic Gaussian Splatting

> 🇯🇵 **L²DGS: 低照度動的ガウススプラッティング**
...
## 254. StableMaterials: Enhancing Diversity in Material Generation via Semi-Supervised Learning

> 🇯🇵 **StableMaterials: 材質生成の多様性向上**

> 💡 物理的制約下で多様な材質テクスチャを生成

**著者:** Giuseppe Vecchio

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2406.09293) | [🌐 Project](https://gvecchio.com/stablematerials)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/37188.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://gvecchio.com/stablematerials" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 255. NI-Tex: Non-isometric Image-based Garment Texture Generation

> 🇯🇵 **NI-Tex: 非等距離画像ベース衣類テクスチャ生成**

> 💡 単一画像から衣類のテクスチャマップを高品質生成

**著者:** Hui Shan, Ming Li, Haitao Yang, Kai Zheng, Sizhe Zheng, Yanwei Fu, Xiangru Huang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.18765)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/37495.png)
...
## 256. UniPixie: Unified and Probabilistic 3D Physics Learning via Flow Matching

> 🇯🇵 **UniPixie: 統一確率的3D物理学習フレームワーク**

> 💡 確率モデルで3D物理現象を統一的に学習

**著者:** Qilin Huang, Quynh Anh Huynh, Long Le, Chen Wang, Chuhao Chen, Ryan Lucas, Eric Eaton, Lingjie Liu
...
## 257. UniTEX: Universal High Fidelity Generative Texturing for 3D Shapes

> 🇯🇵 **UniTEX: 3D汎用高忠実度テクスチャ生成**

> 💡 任意の3Dモデルに対応する統一テクスチャ生成システム

**著者:** Yixun Liang, Kunming Luo, Xiao Chen, Rui Chen, Jiawei Zhou, Weiyu Li, Jiarui Liu, Fei-Peng Tian, Ping Tan

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2505.23253)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/37750.png)
...
## 258. PartDiffuser: Part-wise 3D Mesh Generation via Discrete Diffusion

> 🇯🇵 **PartDiffuser: 部品別3Dメッシュ離散拡散生成**

> 💡 部品単位で段階的に3Dメッシュを生成

**著者:** Yichen Yang, Hong Li, Haodong Zhu, linin, guojun lei, Sheng Xu, Baochang Zhang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.18801)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/39879.png)
...
## 259. LoST: Level of Semantics Tokenization for 3D Shapes

> 🇯🇵 **LoST: 3D形状意味トークン化**

> 💡 3D形状を意味レベルでトークン化処理

**著者:** Niladri Shekhar Dutt, Zifan Shi, Paul Guerrero, Chun-Hao Huang, Duygu Ceylan, Niloy J. Mitra, Xuelin Chen

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.17995) | [🌐 Project](https://lost3d.github.io/)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/38787.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://lost3d.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 260. Lafite: A Generative Latent Field for 3D Native Texturing

> 🇯🇵 **Lafite: 3D生成潜在場**

> 💡 潜在表現空間で効率的な3Dテクスチャ生成

**著者:** Chia-Hao Chen, Yuanchen Guo, Zi-Xin Zou, Ze Yuan, Guan Luo, Xiaojuan Qi, Ding Liang, Yan-Pei Cao, Song-Hai Zhang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.04786)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/39000.png)
...
## 261. LATTICE: Democratize High-Fidelity 3D Generation at Scale

> 🇯🇵 **LATTICE: 大規模高忠実度3D生成民主化**

> 💡 スケーラブルな高品質3D生成を実現

**著者:** Zeqiang Lai, Yunfei Zhao, Zibo Zhao, Haolin Liu, Qingxiang Lin, Jingwei Huang, Chunchao Guo, Xiangyu Yue

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.03052)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/39661.png)
...
## 262. Dehallu3D: Hallucination-Mitigated 3D Generation from a Single Image via Cyclic View Consistency Refinement

> 🇯🇵 **Dehallu3D: 単一画像幻想軽減3D生成**

> 💡 単一画像から幻想を抑制した信頼できる3D生成

**著者:** Xiwen Wang, Shichao Zhang, Ruowei Wang, mao li, Chenyu Zhou, Ji-Zhe Zhou, Qijun Zhao, Hailun Zhang
...
## 263. MeshMosaic: Scaling Artist Mesh Generation via Local-to-Global Assembly

> 🇯🇵 **MeshMosaic: 局所-全体アーティストメッシュ拡張生成**

> 💡 アーティストメッシュ生成を局所最適化で拡張

**著者:** Rui Xu, Tianyang Xue, Qiujie Dong, Le Wan, Zhe Zhu, Peng Li, Zhiyang Dou, Cheng Lin, Shiqing Xin, Yuan Liu, Wenping Wang, Taku Komura

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2509.19995)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/39157.png)
...
## 264. Learning to Solve PDEs on Neural Shape Representations

> 🇯🇵 **ニューラル形状表現によるPDE解法学習**

> 💡 ニューラルネットで微分方程式を3D形状上で解く

**著者:** Lilian Welschinger, Yilin Liu, Zican Wang, Niloy J. Mitra

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.21311)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/38418.png)
...
## 265. Geometry-Aware Cross-Modal Graph Alignment for Referring Segmentation in 3D Gaussian Splatting

> 🇯🇵 **幾何学認識クロスモーダル参照セグメンテーション**

> 💡 マルチモーダルで幾何学一貫性を保ったセグメント

**著者:** Yuwen Tao, Kanglei Zhou, Chang Li, Liyuan Wang
...
## 267. GSV2X: Geometry-Aware Uncertainty Modeling and Orthogonal Fusion for Robust Roadside Perception

> 🇯🇵 **GSV2X: 頑健な路側知覚のための幾何対応不確実性モデリングと直交融合**

> 💡 多視点路側センサからの3D知覚。カメラとLiDARの頑健な融合フレームワーク。

**著者:** jianqiang xu, Gensheng Pei, 刘华峰 Liu, Yazhou Yao

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://github.com/Kilitoku/GSV2X)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/39909.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/Kilitoku/GSV2X" width="100%" height="600" loading="lazy" style="border:none;"></iframe>

</details>


**Abstract:** Reliable 3D perception from multi-view roadside sensors hinges on the robust fusion of camera and LiDAR data, a task complicated by geometric misalignments and sensor calibration errors. This paper presents GSV2X, a fusion framework that tackles these challenges through two core contributions. First, to achieve robustness against spatial uncertainty, we lift 2D image features into a unified Bird's-Eye-View (BEV) space by representing them as 3D Gaussian distributions. By incorporating learnable perturbations guided by camera geometry, our model explicitly accounts for potential calibration inaccuracies. Second, to maximize the synergy between modalities, we propose a new orthogonal fusion module. This module employs constrained attention to enforce orthogonality between camera and LiDAR features, effectively disentangling redundant information and promoting the learning of complementary representations. Extensive experiments on the challenging RCooper dataset demonstrate that GSV2X sets a new state-of-the-art in multi-view roadside perception and exhibits remarkable robustness in complex, real-world scenarios.


---

## 268. GaussianFluent: Gaussian Simulation for Dynamic Scenes with Mixed Materials

> 🇯🇵 **GaussianFluent: 混合材料を含む動的シーン用ガウシアンシミュレーション**

> 💡 脆性破壊を含む複雑な動的物体の写真リアリスティック物理シミュレーション。
...
## 269. No Calibration, No Depth, No Problem: Cross-Sensor View Synthesis with 3D Consistency

> 🇯🇵 **キャリブレーション不要、深度推定不要: 3D一貫性を備えたクロスセンサ視点合成**

> 💡 異なるセンサ間のRGB-X視点合成。複雑なキャリブレーション不要な実用的手法。

**著者:** Cho-Ying Wu, Zixun Huang, Xinyu Huang, Liu Ren

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.23559)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39514.png)
...
## 270. LumiX: Structured and Coherent Text-to-Intrinsic Generation

> 🇯🇵 **LumiX: テキストから固有特性への構造化一貫生成**

> 💡 テキストプロンプトから物理的に一貫した固有特性マップを生成する拡散フレームワーク。

**著者:** Xu Han, Biao Zhang, Xiangjun Tang, Xianzhi Li, Peter Wonka

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.02781)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/38123.png)
...
## 271. Geometric-Photometric Event-based 3D Gaussian Ray Tracing

> 🇯🇵 **幾何的-光学的イベントベース3Dガウシアンレイトレーシング**

> 💡 イベントカメラの高時間解像度を活用した3Dガウシアンスプラッティング再構成手法。

**著者:** Kai Kohyama, Yoshimitsu Aoki, Guillermo Gallego, Shintaro Shiba

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.18640) | [🌐 Project](https://e3ai.github.io/gpert/)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36860.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://e3ai.github.io/gpert/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 272. Spherical Voronoi: Directional Appearance as a Differentiable Partition of the Sphere

> 🇯🇵 **球面ボロノイ: 球面の方向性外観微分可能分割**

> 💡 3Dガウシアンスプラッティング用の学習可能な方向領域分割による外観表現手法。

**著者:** Francesco Di Sario, Daniel Rebain, Dor Verbin, Marco Grangetto, Andrea Tagliasacchi

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.14180) | [🌐 Project](https://sphericalvoronoi.github.io/)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39795.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://sphericalvoronoi.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 273. 4DSurf: High-Fidelity Dynamic Scene Surface Reconstruction

> 🇯🇵 **4DSurf: 高忠実度動的シーン表面再構成**

> 💡 大変形と時間的一貫性を備えた一般的な動的シーン表面再構成フレームワーク。

**著者:** Renjie Wu, Hongdong Li, Jose M. Alvarez, Miaomiao Liu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.28064)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37019.png)
...
## 274. Learning 3D Representations for Spatial Intelligence from Unposed Multi-View Images

> 🇯🇵 **ポーズなし多視点画像からの空間知能用3D表現学習**

> 💡 ポーズなしスパース視点から幾何・外観・意味論的一貫性を備えた3D表現を学習。

**著者:** bo zhou, Qiuxia Lai, Zeren Sun, Xiangbo Shu, Yazhou Yao, Wenguan Wang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.10573)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39813.png)
...
## 275. Depth Peeling for High-Fidelity Gaussian-Enhanced Surfel Rendering

> 🇯🇵 **深度ペーリング: 高忠実度ガウシアン拡張サーフェルレンダリング**

> 💡 エイリアシング除去を実現する深度ペーリング戦略によるガウシアン拡張サーフェルレンダリング。
...
> 💡 単一視点事前知識と多視点一貫性を活用した物理ベース材質高品質再構成手法。

**著者:** Peter Kocsis, Lukas Höllein, Matthias Nießner

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://peter-kocsis.github.io/IntrinsicImageFusion/)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37085.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://peter-kocsis.github.io/IntrinsicImageFusion/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 277. EchoPOSE: 6D Pose Estimation of Sparse Echocardiograms for Left-Ventricular 3D Shape Reconstruction

> 🇯🇵 **EchoPOSE: 心臓超音波スパース6D姿勢推定**

> 💡 医療超音波から心臓の6D位置姿勢を推定

**著者:** Lucas Iijima, Yihao Luo, Dario Sesia, Amit Kaura, Jamil Mayet, Choon Hwai Yap
...
## 278. Clay-to-Stone: Phase-wise 3D Gaussian Splatting for Monocular Articulated Hand-Object Manipulation Modeling

> 🇯🇵 **Clay-to-Stone: 単眼段階的3Dガウススプラッティング**

> 💡 単一画像から段階的に3D最適化を実行

**著者:** Xingyu Liu, Pengfei Ren, Qi Qi, Haifeng Sun, Zirui Zhuang, Jianxin Liao, Jingyu Wang
...
## 280. Relightful Video Portrait Harmonization

> 🇯🇵 **Relightful ビデオ肖像調和**

> 💡 ビデオ肖像の再照明を自然に調和

**著者:** Jun Myeong Choi, Jae Shin Yoon, Luchao Qi, Roni Sengupta, Joon-Young Lee
...
## 281. ReLaGS: Relational Language Gaussian Splatting

> 🇯🇵 **ReLaGS: 関係言語ガウススプラッティング**

> 💡 言語により3Dシーン要素の関係を表現

**著者:** Yaxu Xie, Abdalla Arafa, Alireza Javanmardi, Christen Millerdurai, Jia Cheng Hu, Shaoxiang Wang, Alain Pagani, Didier Stricker

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.17605) | [🌐 Project](https://dfki-av.github.io/ReLaGS/)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39756.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://dfki-av.github.io/ReLaGS/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 282. NERFIFY: A Multi-Agent Framework for Turning NeRF Papers into Code

> 🇯🇵 **NERFIFY: NeRF論文実装マルチエージェントフレームワーク**

> 💡 NeRF関連論文を自動実装するエージェント

**著者:** Seemandhar Jain, Keshav Gupta, Kunal Gupta, Manmohan Chandraker

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.00805)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37989.png)
...
## 283. CGHair: Compact Gaussian Hair Reconstruction with Card Clustering

> 🇯🇵 **CGHair: カードクラスタ髪コンパクト再構成**

> 💡 カード原始で髪の毛を効率的に再構成

**著者:** Haimin Luo, Srinjay Sarkar, Albert Mosella-Montoro, Francisco Vicente Carrasco, Fernando De la Torre

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://humansensinglab.github.io/CGHair/)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/38164.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://humansensinglab.github.io/CGHair/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 284. HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
## 285. RelightAnyone: A Generalized Relightable 3D Gaussian Head Model

> 🇯🇵 **RelightAnyone: 汎用再照明3Dガウシアン頭部**

> 💡 任意人物の頭部を照明変化で表現

**著者:** Yingyan Xu, Pramod Rao, Sebastian Weiss, Gaspard Zoss, Markus Gross, Christian Theobalt, Marc Habermann, Derek Bradley

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://studios.disneyresearch.com/2026/05/31/relightanyone-a-generalized-relightable-3d-gaussian-head-model/)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39845.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://studios.disneyresearch.com/2026/05/31/relightanyone-a-generalized-relightable-3d-gaussian-head-model/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 286. Gen3R: 3D Scene Generation Meets Feed-Forward Reconstruction

> 🇯🇵 **Gen3R: フィードフォワード3Dシーン生成再構成**

> 💡 単一パスで3Dシーン生成と再構成を統合

**著者:** Jiaxin Huang, Yuanbo Yang, Bangbang Yang, Lin Ma, Yuewen Ma, Yiyi Liao

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.04090)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/38668.png)
...
## 287. RigMo: Unifying Rig and Motion Learning for Generative Animation
...
## 288. Seele: A Unified Acceleration Framework for Real-Time Gaussian Splatting on Mobile Devices

> 🇯🇵 **Seele: リアルタイムガウシアン統一高速化**

> 💡 ガウシアンレンダリングを高速リアルタイム実現

**著者:** He Zhu, Xiaotong Huang, Zihan Liu, Weikai Lin, Xiaohong Liu, Zhezhi He, Jingwen Leng, Minyi Guo, Yu Feng
...
## 289. GHPT: Real-Time Relightable Gaussian Splatting using Hybrid Path Tracing

> 🇯🇵 **GHPT: ハイブリッド処理リアルタイム再照明ガウシアン**

> 💡 ハイブリッド計算でリアルタイム再照明

**著者:** Jinyang Bo, Fan Dou, Wenrui Quan, Shangxun Liu, Yang Xu, Yuhe Zhang, Kang Li, GuoHua Geng
...
## 290. PolarGuide-GSDR: 3D Gaussian Splatting Driven by Polarization Priors and Deferred Reflection for Real-World Reflective Scenes

> 🇯🇵 **PolarGuide-GSDR: 偏光駆動型3Dガウススプラッティング**

> 💡 偏光情報でガウシアン再構成を高精度化

**著者:** Derui Shan, Qian Qiao, Hao Lu, Tao Du, Peng Lu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.02664)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36441.png)
...
## 293. 3D Gaussian Splatting with Self-Constrained Priors for High Fidelity Surface Reconstruction

> 🇯🇵 **3DGS自己制約事前情報高精度化**

> 💡 自己制約を活用した高精度ガウシアン

**著者:** Takeshi Noda, Yu-Shen Liu, Zhizhong Han

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.19682)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37283.png)
...
## 294. TWINGS: Thin Plate Splines Warp-aligned Initialization for Sparse-View Gaussian Splatting

> 🇯🇵 **TWINGS: 薄板スプラインワープ配置ガウススプラッティング**

> 💡 薄板スプラインで初期化を最適化

**著者:** Hyeseong Kim, Geonhui Son, Deukhee Lee, Dosik Hwang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2605.22069)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37013.png)
...
> 🇯🇵 **SpeeDe3DGS: 高速変形3Dガウス時間最適化**

> 💡 時間軸で変形3Dを高速最適化

**著者:** Allen Tu, Haiyang Ying, Alex Hanson, Yonghan Lee, Tom Goldstein, Matthias Zwicker

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2506.07917) | [🌐 Project](https://speede3dgs.github.io/)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39310.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://speede3dgs.github.io/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
> 🇯🇵 **FastGS: 100秒で3Dガウススプラッティング学習**

> 💡 超高速3D最適化アルゴリズム実装

**著者:** Shiwei Ren, Tianci Wen, Yongchun Fang, Biao Lu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.04283)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39191.png)
...
## 297. BrepGaussian: CAD reconstruction from Multi-View Images with Gaussian Splatting

> 🇯🇵 **BrepGaussian: マルチビューCAD再構成**

> 💡 複数画像からCAD品質3D復元

**著者:** Jiaxing Yu, Dongyang Ren, Hangyu Xu, Zhouyuxiao Yang, Yuanqi Li, Jie Guo, Zhengkang Zhou, Yanwen Guo

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.21105)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37810.png)
...
## 298. BA-GS: Bayesian Adaptive Gaussian Splatting for SFM-Free 3D Reconstruction

> 🇯🇵 **BA-GS: ベイズ適応ガウススプラッティング自由度SFM**

> 💡 適応的最適化でカメラ自由度SFM実現

**著者:** Zhongjie Ma, Di Lin, Xin WANG, Haotian Dong, Chong Wang, Dongdong Wu, Changqing Zhang
...
## 300. HTTM: Head-wise Temporal Token Merging for Faster VGGT

> 🇯🇵 **HTTM: VGGTの高速化のためのヘッド単位時間的トークンマージング**

> 💡 3D再構成モデルVGGTの推論加速手法。多ヘッド粒度でのトークンマージにより7倍高速化を実現。

**著者:** Weitian Wang, Lukas Meiner, Rai Shubham, Cecilia De La Parra, Akash Kumar

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.21317)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/40184.png)
...
## 301. OrienPose: Orientation-Guided Novel View Synthesis for Single-Image Unseen Object Pose Estimation

> 🇯🇵 **OrienPose: 方向誘導型単一画像から未見物体のポーズ推定**

> 💡 未見物体の3Dポーズを単一画像から推定。方向対応の新規視点合成による信頼性向上。

**著者:** Yating Liu, Zhaoshuai Qi, Yang Zou, Yongnan Yang, Shizhou Zhang, Yanning Zhang
...
## 302. REVIVE 3D: Refinement via Encoded Voluminous Inflated prior for Volume Enhancement

> 🇯🇵 **REVIVE 3D: エンコード体積膨張事前知識による体積強化精密化**

> 💡 平面画像から体積的な3D資産生成。膨張事前知識と潜在拡散による3D生成。

**著者:** Hankyeol Lee, WOOYEOL BAEK, Seongdo Kim, Jongyoo Kim

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.27504)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37149.png)
...
## 303. Muses: Designing, Composing, Generating Nonexistent Fantasy 3D Creatures without Training

> 🇯🇵 **Muses: 訓練不要なファンタジー3D生物設計・合成・生成**

> 💡 3Dスケルトンベース骨組みを利用した創造的ファンタジー生物の生成手法。

**著者:** Hexiao Lu, Xiaokun Sun, Zeyu Cai, Hao Guo, Ying Tai, Jian Yang, Zhenyu Zhang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.03256)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/38088.png)
...
## 304. EI-Part: Explode for Completion and Implode for Refinement

> 🇯🇵 **EI-Part: 完成化のための展開と精密化のための内爆**

> 💡 部分レベル3D形状生成。意味論的で構造的に一貫した部分の高品質生成フレームワーク。

**著者:** wanhu sun, Zhongjin Luo, Heliang Zheng, Jiahao Chang, Chongjie Ye, Huiang He, Shengchu Zhao, Rongfei Jia, Xiaoguang Han
...
## 305. Fast3Dcache: Training-free 3D Geometry Synthesis Acceleration

> 🇯🇵 **Fast3Dcache: 訓練不要な3D幾何合成加速**

> 💡 拡散モデルの3D生成推論加速。キャッシング戦略により27%速度向上と54%計算削減を実現。

**著者:** Mengyu Yang, Yanming Yang, Chenyi Xu, Chenxi Song, Yufan Zuo, Tong Zhao, Ruibo Li, Chi Zhang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.22533)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36821.png)
...
## 306. ViLearn: Accelerating Training Convergence of Image-to-3D Generation via Visibility Learning

> 🇯🇵 **ViLearn: 可視性学習によるImage-to-3D生成訓練収束加速**

> 💡 単一画像から3D形状生成の訓練効率改善。可視・非可視領域分離により4.4倍収束加速。

**著者:** Rui Chen, Jianfeng Zhang, Jing Lin, Xuanyu Yi, Yixun Liang, Guan Luo, Xiu Li, Zeming Li, Ping Tan
...
## 308. X-Part: High Fidelity And Structure Coherent Shape Decomposition And Completion

> 🇯🇵 **X-Part: 高忠実度で構造的に一貫した形状分解と補完**

> 💡 制御可能な部分レベル3D形状生成。意味論的に有意で構造的に一貫した部分生成。
...
## 309. TopoMesh: High-Fidelity Mesh Autoencoding via Topological Unification

> 🇯🇵 **TopoMesh: 位相統一化による高忠実度メッシュ自動符号化**

> 💡 Dual Marching Cubesに基づくメッシュ自動符号化。鋭い特徴を保存した高品質再構成。

**著者:** Guan Luo, Xiu Li, Rui Chen, Xuanyu Yi, Jing Lin, Chia-Hao Chen, Jiahang Liu, Song-Hai Zhang, Jianfeng Zhang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.24278)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36524.png)
...
## 310. TEXTRIX: Latent Attribute Grid for Native Texture Generation and Beyond

> 🇯🇵 **TEXTRIX: ネイティブテクスチャ生成潜在属性グリッド**

> 💡 潜在属性格子で高品質テクスチャを効率生成

**著者:** Yifei Zeng, Yajie Bao, Jiachen Qian, Shuang Wu, Youtian Lin, Hao Zhu, Buyu Li, Feihu Zhang, Xun Cao, Yao Yao

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.02993)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/39959.png)
...
## 311. ExMesh: EXplicit Mesh Reconstruction with Topology Adaptation

> 🇯🇵 **ExMesh: 位相適応明示的メッシュ再構成**

> 💡 動的位相適応でメッシュ再構成品質向上

**著者:** Chuanjin Fan, Lifan Wu, Wenjie Chang, Hanzhi Chang, Wenfei Yang, Tianzhu Zhang
...
## 312. SceneMaker: Open-set 3D Scene Generation with Decoupled De-occlusion and Pose Estimation Model

> 🇯🇵 **SceneMaker: 分離済み3D世界シーン生成**

> 💡 要素を分離して制御可能な3Dシーン生成

**著者:** Yukai Shi, Weiyu Li, Zihao Wang, Hongyang Li, Xingyu Chen, Ping Tan, Lei Zhang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.10957)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37661.png)
...
## 313. Sculpt4D: Generating 4D Shapes via Sparse-Attention Diffusion Transformers

> 🇯🇵 **Sculpt4D: スパース注意拡散型4D形状生成**

> 💡 効率的注意機構で4D彫刻形状生成

**著者:** Minghao Yin, Wenbo Hu, Jiale Xu, Ying Shan, Kai Han

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.21592)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37514.png)
...
## 314. PhysGen: Physically Grounded 3D Shape Generation for Industrial Design

> 🇯🇵 **PhysGen: 産業向け物理基礎3D形状生成**

> 💡 物理制約で産業用3D設計モデル生成

**著者:** Yingxuan You, Chen Zhao, Hantao Zhang, Ming Xu, Pascal Fua

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.00422)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/38377.png)
...
## 315. Learning Latent Proxies for Controllable Single-Image Relighting

> 🇯🇵 **制御可能単一画像再照明潜在プロキシ学習**

> 💡 潜在プロキシ最適化で再照明を制御

**著者:** Haoze Zheng, Zihao Wang, Xianfeng Wu, Yajing Bai, Yexin Liu, Yun LI, Xiaogang Xu, Harry Yang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.15555)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/38906.png)
...
## 318. Bringing Your Portrait to 3D Presence

> 🇯🇵 **3D存在感への肖像表現**

> 💡 2D肖像から3Dアバター表現へ変換

**著者:** Jiawei Zhang, Lei Chu, Jiahao Li, Zhenyu Zang, Chong Li, Xiao Li, Xun Cao, Hao Zhu, Yan Lu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.22553)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/37550.png)
...
## 319. POLAR: A Portrait OLAT Dataset and Generative Framework for Illumination-Aware Face Modeling
...
## 320. Scaling View Synthesis Transformers
...
## 322. DualPrim: Compact 3D Reconstruction with Positive and Negative Primitives

> 🇯🇵 **DualPrim: 正負原始コンパクト3D再構成**

> 💡 正負両信号でメモリ効率的3D表現

**著者:** Xiaoxu Meng, Zhongmin Chen, Bo Yang, Weikai Chen, Weixiao Liu, Lin Gao

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.16133)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/38870.png)
...
## 323. FastEventDGS: Deformable Gaussian Splatting for Fast Dynamic Scenes from a Single Event Camera

> 🇯🇵 **FastEventDGS: 動的ガウシアン高速イベント化**

> 💡 イベント駆動で動的3Dを高速処理

**著者:** Zijia Dai, Nico Messikommer, Rong Zou, Nikola Zubic, Davide Scaramuzza, Laurent Kneip
...
## 324. Event-Based Motion Deblurring Using Task-Oriented 3D Gaussian Event Representations

> 🇯🇵 **イベント駆動タスク指向3Dガウシアンモーション除去**

> 💡 イベントカメラで動きぼけ除去

**著者:** Shengdong Xue, Haoxiang Ma, Hao Chen, Zhen Yang, Yongjian Deng
...
## 325. Catalyst4D: High-Fidelity 3D-to-4D Scene Editing via Dynamic Propagation

> 🇯🇵 **Catalyst4D: 動的シーン編集高忠実度3D-4D**

> 💡 高品質動的シーン編集システム

**著者:** Shifeng Chen, Yihui Li, Jun Liao, Hongyu Yang, Di Huang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.12766)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/36798.png)
...
## 326. Semantic Foam: Unifying Spatial and Semantic Scene Decomposition

> 🇯🇵 **セマンティックフォーム: 空間意味シーン分解統一**

> 💡 空間と意味情報を統一分解

**著者:** Amr Sharafeldin, Aryan Mikaeili, Thomas Walker, Shrisudhan Govindarajan, Daniel Rebain, Kwang Moo Yi, Andrea Tagliasacchi

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.26262)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/38623.png)


**Abstract:** Current generation scene reconstruction methods like 3D Gaussian Splatting are capable of producing photo-realistic novel view synthesis at real-time speeds, yet see only limited adoption in many practical graphics applications.One significant contributing factor to this gap is the difficulty of interacting with and editing these representations in comparison to classic human-authored 3D assets.While work has been done to impose semantic decomposition onto these representations, there are still significant limitations in the quality and consistency of these segmentations.We address this by proposing a semantically decomposed variant of the recently introduced Radiant Foam method.Our approach, Semantic Foam, combines the natural spatial volumetric decomposition provided by Radiant Foam's Voronoi mesh with an explicit semantic feature field parameterized on the cells.The explicit mesh structure enables direct spatial regularization that prevents artifacts caused by inconsistent supervision across views or occlusion, which affect similar approaches for other point-based representations.We show that our method achieves superior performance on object-level segmentation compared to Gaussian Grouping and SAGA.


---

## 327. NVGS: Neural Visibility for Occlusion Culling in 3D Gaussian Splatting

> 🇯🇵 **NVGS: 3Dガウシアンオクルージョン除去**

> 💡 ニューラル可視性でレンダリング最適化

**著者:** Brent Zoomers, Florian Hahlbohm, Joni Vanherck, Lode Jorissen, Marcus Magnor, Nick Michiels

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.19202) | [🌐 Project](https://brent-zoomers.github.io/nvgs/)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/37295.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://brent-zoomers.github.io/nvgs/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 328. NeAR: Coupled Neural Asset–Renderer Stack

> 🇯🇵 **NeAR: ニューラル資産レンダラ結合スタック**

> 💡 資産とレンダラを統合的に学習

**著者:** Hong Li, Chongjie Ye, Houyuan Chen, Weiqing Xiao, Ziyang Yan, Lixing Xiao, Zhaoxi Chen, Jianfeng XIANG, Shaocong Xu, Xuhui Liu, Yikai Wang, Baochang Zhang, Xiaoguang Han, Jiaolong Yang, Hao Zhao
...
> 🇯🇵 **PhysGM: フィードフォワード4D大規模物理ガウシアン**

> 💡 物理ベース4D生成で大規模シミュレーション

**著者:** chunji lv, Zequn Chen, Donglin Di, Weinan Zhang, Hao Li, Wei Chen, Yinjie Lei, Changsheng Li

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2508.13911)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/37338.png)
...
## 330. ReasonX: MLLM-Guided Intrinsic Image Decomposition

> 🇯🇵 **ReasonX: MLLMによる固有画像分解**

> 💡 MLLMを用いた相対比較評価により、固有画像分解を教師なしで改善

**著者:** Alara Dirik, Tuanfeng Wang, Duygu Ceylan, Stefanos Zafeiriou, Anna Frühstück

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.04222) | [🌐 Project](https://alaradirik.github.io/reasonx/)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/38856.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://alaradirik.github.io/reasonx/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 331. SPREAD: Spatial-Physical REasoning via geometry Aware Diffusion

> 🇯🇵 **SPREAD: 幾何認識拡散による空間物理的推論**

> 💡 グラフトランスフォーマーで3Dシーンの空間・物理関係を統合的に学習

**著者:** Minzhang Li, Kuixiang Shao, xuebing li, Yuyang Jiao, Yinuo Bai, Hengan Zhou, Sixian Shen, Jiayuan Gu, Jingyi Yu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.27573) | [🌐 Project](https://l-avenir.github.io/SPREAD/)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/39576.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://l-avenir.github.io/SPREAD/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 332. ExtrinSplat: Decoupling Geometry and Semantics for Open-Vocabulary Understanding in 3D Gaussian Splatting

> 🇯🇵 **ExtrinSplat: 3D ガウシアンスプラッティングの幾何とセマンティクス分離**

> 💡 オープン語彙理解のため、軽量なテキストインデックスで幾何と意味を分離

**著者:** Jiayu Ding, Xinpeng Liu, Zhiyi Pan, Shiqiang Long, Ge Li

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2509.22225)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/39130.png)
...
## 333. PoseMaster: A Unified 3D Native Framework for Stylized Pose Generation
...
## 334. HOG-Layout: Hierarchical 3D Scene Generation, Optimization and Editing via Vision-Language Models

> 🇯🇵 **HOG-Layout: ビジョン言語モデルによる階層的3Dシーン生成最適化編集**

> 💡 LLM/VLMにより段階的に3Dシーンを生成・最適化・リアルタイム編集

**著者:** Haiyan Jiang, Deyu Zhang, dongdong weng, Weitao Song, Henry Been-Lirn Duh

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.10772)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/36270.png)
...
## 335. MajutsuCity: Language-driven Aesthetic-adaptive City Generation with Controllable 3D Assets and Layouts

> 🇯🇵 **MajutsuCity: 制御可能な3Dアセットと構成による言語駆動都市生成**

> 💡 自然言語で多様な3D都市シーンを構造的に一貫性を保ちながら合成

**著者:** Zilong Huang, Jun He, Xiaobin Huang, Ziyi Xiong, Yang Luo, Junyan Ye, Weijia Li, Yiping Chen, Ting Han

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.20415)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/39672.png)
...
## 336. Changes in Real Time: Online Scene Change Detection with Multi-View Fusion

> 🇯🇵 **Changes in Real Time: マルチビュー融合によるオンラインシーン変化検出**

> 💡 複数視点から観察しながら、リアルタイムでシーン変化を姿勢不変に検出

**著者:** Chamuditha Jayanga Galappaththige, Jason Lai, Lloyd Windrim, Donald Dansereau, Niko Suenderhauf, Dimity Miller

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.12370) | [🌐 Project](https://chumsy0725.github.io/O-SCD/)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/39367.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://chumsy0725.github.io/O-SCD/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 337. High-Fidelity Mobile Avatars with Pruned Local Blendshapes

> 🇯🇵 **高忠実度モバイルアバタ: 削減局所ブレンドシェイプ法**

> 💡 局所線形ブレンドシェイプでモバイル実行可能な高品質人間アバタを実現

**著者:** Youyi Zhan, He Wang, Tianjia Shao, Kun Zhou

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2605.01854)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/36606.png)
...
## 338. PhysSkin: Real-Time and Generalizable Physics-Based Animation via Self-Supervised Neural Skinning
...
## 339. FreeForm: Reduced-Order Deformable Simulation from Particle-Based Skinning Eigenmodes

> 🇯🇵 **FreeForm: スキニング固有モードによる削減秩序変形シミュレーション**

> 💡 粒子法とスキニング固有モードで網なし削減秩序弾性体シミュレーションを実現

**著者:** Donglai Xiang, Vismay Modi, Rishit Dagli, Ty Trusty, Gilles Daviet, Anka Chen, Nicholas Sharp, David I. W. Levin
...
## 340. 4DEquine: Disentangling Motion and Appearance for 4D Equine Reconstruction from Monocular Video
...
## 341. PhysHO: Physics-Based Dynamic 3D Gaussian Human and Object from Monocular Video

> 🇯🇵 **PhysHO: 単眼動画からの物理ベース動的3Dガウシアン人間・物体**

> 💡 MPMと学習ベース構成モデルで単眼から人物・物体相互作用を物理的に再構成

**著者:** Suyi Jiang, Gim Hee Lee
...
## 342. Urban-GS: A Unified 3D Gaussian Splatting Framework for Compact and High-Fidelity Aerial-to-Street Reconstruction

> 🇯🇵 **Urban-GS: 航空街路統合再構成のための統一3Dガウシアンスプラッティング**

> 💡 航空・街路画像融合で都市シーンを高速圧縮再構成し描画品質を向上

**著者:** Meng Wang, Changqun Xia, Yuze Wang, Junyi Wang, Wantong Duan, Xinxiong Xie, Yue Qi
...
## 345. GS^2: Graph-based Spatial Distribution Optimization for Compact 3D Gaussian Splatting

> 🇯🇵 **GS²: グラフ空間分布最適化圧縮**

> 💡 グラフベース最適化でガウシアン圧縮

**著者:** Xianben Yang, Tao Wang, Yuxuan Li, Yi Jin, Haibin Ling

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.01884)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/37256.png)
...
## 346. OnlinePG: Online Open-Vocabulary Panoptic Mapping with 3D Gaussian Splatting

> 🇯🇵 **OnlinePG: 3Dガウシアンオンライン開放語彙パノプティック**

> 💡 リアルタイムオンライン3Dパノプティック探索

**著者:** Hongjia Zhai, Qi Zhang, Xiaokun Pan, Xiyu Zhang, Yitong Dong, Huaqi Zhang, Dan Xu, Guofeng Zhang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.18510)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/40123.png)
...
## 347. Learning Explicit Continuous Motion Representation for Dynamic Gaussian Splatting from Monocular Videos

> 🇯🇵 **動的明示的連続モーション表現学習**

> 💡 連続表現で滑らかなモーション生成

**著者:** Xuankai Zhang, Junjin Xiao, Shangwei Huang, Wei-Shi Zheng, Qing Zhang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.25058) | [🌐 Project](https://github.com/hhhddddddd/se3bsplinegs)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/39975.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://github.com/hhhddddddd/se3bsplinegs" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 348. MLLMSplat: A 2D MLLM-Powered Framework for 3D Gaussian Splatting Understanding, Generation, and Editing

> 🇯🇵 **MLLMSplat: 2D多言語大規模3Dガウシアンフレームワーク**

> 💡 マルチモーダルLLMで3D生成実現

**著者:** Jingqiao Xiu, Can Wang, Dong Xu
...
## 349. Dropping Anchor and Spherical Harmonics for Sparse-view Gaussian Splatting

> 🇯🇵 **アンカー球調和スパースビューガウシアン削除**

> 💡 調和基底でスパース条件3D最適化

**著者:** Shuangkang Fang, I-Chao Shen, Xuanyang Zhang, Zesheng Wang, Yufeng Wang, Wenrui Ding, Gang Yu, Takeo Igarashi

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.20933)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/38632.png)
...
## 350. RAP: Fast Feedforward Rendering-Free Attribute-Guided Primitive Importance Score Prediction for Efficient 3D Gaussian Splatting Processing

> 🇯🇵 **RAP: 高速フィードフォワード属性ガイド原始型**

> 💡 属性制御でフィードフォワード生成

**著者:** Kaifa Yang, Qi Yang, Yiling Xu, Zhu Li

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.19753) | [🌐 Project](https://sekiroyyy.github.io/rap_webpage/)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/37154.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://sekiroyyy.github.io/rap_webpage/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 351. Scene Grounding in the Wild

> 🇯🇵 **野生環境シーン接地**

> 💡 自然環境でシーン理解を実現

**著者:** Tamir Cohen, Leo Segre, Shay Shomer-Chai, Shai Avidan, Hadar Averbuch-Elor
...
## 352. SR3R: Rethinking Super-Resolution 3D Reconstruction With Feed-Forward Gaussian Splatting

> 🇯🇵 **SR3R: フィードフォワード超解像3D再構成再考**

> 💡 超解像手法で3D再構成を高精度化

**著者:** Xiang Feng, Xiangbo Wang, Tieshi Zhong, Chengkai Wang, Yiting Zhao, Tianxiang Xu, Zhenzhong Kuang, Feiwei Qin, Xuefei Yin, Yanming Zhu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.24020)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/39398.png)
...
## 353. Dark3R: Learning Structure from Motion in the Dark

> 🇯🇵 **Dark3R：暗闇でのStructure from Motion学習**

> 💡 極低照度の生画像から3D教師なしで頑健なSfMと暗所新規視点合成を実現

**著者:** Andrew Y. Guo, Anagh Malik, SaiKiran Tedla, Yutong Dai, Yiqian Qin, Zach Salehe, Benjamin Attal, Sotiris Nousias, Kiriakos N. Kutulakos, David B. Lindell

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.05330)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/39382.png)
...
## 354. M3DLayout: A Multi-Source Dataset of 3D Indoor Layouts and Structured Descriptions for 3D Generation

> 🇯🇵 **M3DLayout：3D生成のための3D屋内レイアウトと構造化記述のマルチソースデータセット**

> 💡 実スキャンやCAD等を統合した大規模屋内レイアウトデータセットで文本駆動3D生成を強化

**著者:** Yiheng Zhang, Zhuojiang Cai, Mingdao Wang, Meitong Guo, Tianxiao Li, Li Lin, Yuwang Wang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2509.23728)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/36515.png)
...
## 355. UniPart: Part-Level 3D Generation with Unified 3D Geom–Seg Latents

> 🇯🇵 **UniPart：統一3D幾何・セグメント潜在表現による部位レベル3D生成**

> 💡 統一潜在表現と二段階拡散で部位分割可能な高品質3D形状生成を実現

**著者:** Xufan He, Yushuang Wu, Xiaoyang Guo, Chongjie Ye, Jiaqing Zhou, Tianlei Hu, Xiaoguang Han, Dong Du
...
## 356. Photo3D: Advancing Photorealistic 3D Generation through Structure‑Aligned Detail Enhancement

> 🇯🇵 **Photo3D：構造整合型詳細強化による写実的3D生成の進展**

> 💡 構造整合した多視点詳細強化により写実的外観と3D整合性を両立する

**著者:** Xinyue Liang, Zhiyuan Ma, Lingchen Sun, Yanjun Guo, Lei Zhang
...
![Poster](posters/3d/36318.png)


**Abstract:** Although recent 3D‑native generators have made great progress in synthesizing reliable geometry, they still fall short in achieving realistic appearances. A key obstacle lies in the lack of diverse and high-quality real-world 3D assets with rich surface details, since capturing such data is intrinsically difficult due to the diverse scales of scenes, non‑rigid motions of objects, and the limited precision of scanners.We introduce Photo3D, a framework for advancing photorealistic 3D generation, which is driven by the image data generated by the GPT‑4o‑Image model.Considering that the generated images can distort 3D structures due to their lack of multi‑view consistency, we design a structure‑aligned multi‑view synthesis pipeline and construct a detail‑enhanced multi‑view dataset paired with 3D geometry. Building on it, we present a realistic detail enhancement scheme that leverages perceptual feature adaptation and semantic structure matching to enforce appearance consistency with the realistic detail priors while preserving the structural consistency with the 3D-native geometry. While our scheme is general to different 3D-native generators, we present dedicated training strategies to facilitate the optimization of geometry-texture coupled and decoupled 3D-native generation paradigms. Experiments demonstrate that Photo3D generalizes well across diverse 3D‑native generation paradigms and achieves state‑of‑the‑art photorealistic 3D generation performance.  Codes, models and datasets will be released.


---

## 357. Mesh-Pro: Asynchronous Advantage-guided Ranking Preference Optimization for Artist-style Quadrilateral Mesh Generation

> 🇯🇵 **Mesh-Pro：アーティスト風四角形メッシュ生成のための非同期優位度誘導ランキング選好最適化**

> 💡 非同期オンライン強化学習と新表現で高品質な芸術的四角形メッシュ生成を達成
...
**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.00526)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/39044.png)
...
## 358. Order Matters: 3D Shape Generation from Sequential VR Sketches
...
## 359. Think-Then-Generate: Structural Chain-of-Thought Reasoning for Consistent 3D Generation

> 🇯🇵 **Think-Then-Generate：一貫した3D生成のための構造的思考連鎖推論**

> 💡 構造的CoT推論と多視点整合で幻覚を抑え一貫した3D生成を実現

**著者:** Xinyue Liu, Jin Liu, Hongbo Wang, Ran He, Huaibo Huang
...
## 360. SE(3)-Equivariance with Geometric and Topological Guidance for Category-Level Object Pose Estimation

> 🇯🇵 **幾何・位相誘導とSE(3)等変性によるカテゴリレベル物体姿勢推定**

> 💡 幾何再構成とSE(3)等変特徴で未知物体の姿勢推定精度と汎化を向上

**著者:** Sheng Yu, Di-Hua Zhai, Yuanqing Xia
...
## 361. Test-Time 3D Occupancy Prediction

> 🇯🇵 **テスト時3D占有予測**

> 💡 訓練不要で3Dガウシアンと基盤モデルを統合し柔軟な占有予測を行う

**著者:** Fengyi Zhang, Xiangyu Sun, Huitong Yang, Zheng Zhang, Zi Huang, Yadan Luo

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2503.08485)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/38612.png)
...
## 362. dMLLM-TTS: Self-Verified and Efficient Test-Time Scaling for Diffusion Multi-Modal Large Language Models

> 🇯🇵 **dMLLM-TTS：拡散型マルチモーダル大規模言語モデルの自己検証型・高効率テスト時スケーリング**

> 💡 自己検証と階層探索でdMLLMの生成品質を大幅向上し計算量も削減

**著者:** Yi Xin, Siqi Luo, Tianxiang Xu, Qi Qin, Haoxing Chen, Kaiwen Zhu, Zhiwei Zhang, Yangfan He, Rongchao Zhang, Jinbin Bai, Shuo Cao, Bin Fu, Junjun He, Yihao Liu, Yuewen Cao, Xiaohong Liu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.19433)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/36886.png)
...
## 363. Structure-to-Intensity Diffusion for Adverse-Weather LiDAR Generation

> 🇯🇵 **悪天候LiDAR生成のための構造から強度への拡散**

> 💡 幾何を先に復元して強度を条件付き生成し悪天候LiDARの現実性を高める

**著者:** Peiyang Ni, Longyu Yang, Lu Zhang, Kuniaki Saito, Yap-Peng Tan, Fumin Shen, Heng Tao Shen, Xiaofeng Zhu, Ping Hu
...
## 365. tttLRM: Test-Time Training for Long Context and Autoregressive 3D Reconstruction

> 🇯🇵 **tttLRM: 長文脈自己回帰型3D再構成のテスト時間訓練**

> 💡 テスト時間訓練層により長文脈自己回帰型3D再構成を線形計算量で実現

**著者:** Chen Wang, Hao Tan, Wang Yifan, Zhiqin Chen, Yuheng Liu, Kalyan Sunkavalli, Sai Bi, Lingjie Liu, Yiwei Hu

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.20160) | [🌐 Project](https://cwchenwang.github.io/tttLRM)

**Session:** Poster Session 6


![Poster](posters/3d/38483.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://cwchenwang.github.io/tttLRM" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 366. Node-RF: Learning Generalized Continuous Space-Time Scene Dynamics with Neural ODE-based NeRFs

> 🇯🇵 **Node-RF: ニューラルODEベースNeRFによる汎化的連続時空間シーン動力学**

> 💡 ニューラルODEとNeRFを統合し、長期外挿可能な連続時空間シーン表現

**著者:** Hiran Sarkar, Liming Kuang, Yordanka Velikova, Benjamin Busam

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.12078)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/36384.png)
...
## 367. EventHub: Data Factory for Generalizable Event-Based Stereo Networks without Active Sensors

> 🇯🇵 **EventHub: アクティブセンサ不要なイベントベースステレオ用データファクトリ**

> 💡 RGBカラー画像からプロキシデータを生成し、一般化可能なイベントステレオを訓練

**著者:** Luca Bartolomei, Fabio Tosi, Matteo Poggi, Stefano Mattoccia, Guillermo Gallego

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.02331)

**Session:** Poster Session 6


![Poster](posters/3d/38887.png)
...
## 368. Multi-Scale Gaussian-Language Map for Zero-shot Embodied Navigation and Reasoning

> 🇯🇵 **Multi-Scale Gaussian-Language Map: ゼロショット具体化ナビゲーション推論**

> 💡 幾何と多スケール意味論にガウシアンと自然言語インタフェースを統合

**著者:** Sixian Zhang, Yiyao Wang, Xinhang Song, Keming Zhang, Zijian Xu, Shuqiang Jiang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2605.01736)

**Session:** Poster Session 6


![Poster](posters/3d/36951.png)
...
## 369. PR-IQA: Partial-Reference Image Quality Assessment for Diffusion-Based Novel View Synthesis

> 🇯🇵 **PR-IQA: 拡散ベース新規視点合成のための部分参照画像品質評価**

> 💡 参照画像から幾何一貫性のある部分品質マップを計算し完成化

**著者:** Inseong Choi, Siwoo Lee, Seung-Hun Nam, Soohwan Song

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.04576)

**Session:** Poster Session 6


![Poster](posters/3d/39478.png)
...
## 370. iLRM: An Iterative Large 3D Reconstruction Model

> 🇯🇵 **iLRM: 反復的大規模3D再構成モデル**

> 💡 2段階注意機構で多視点相互作用を分解し、高速スケーラブル3D再構成

**著者:** Gyeongjin Kang, Seungtae Nam, Seung kwon Yang, Xiangyu Sun, Sameh Khamis, Abdelrahman Mohamed, Eunbyung Park

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2507.23277)

**Session:** Poster Session 6


![Poster](posters/3d/38572.png)
...
## 371. MoRel: Long-Range Flicker-Free 4D Motion Modeling via Anchor Relay-based Bidirectioanl Blending with Hierarchical Densification

> 🇯🇵 **MoRel: アンカーリレー双方向ブレンディングの長範囲4Dモーション**

> 💡 キーフレーム間のアンカーレベル変形を双方向ブレンドし時間一貫性

**著者:** Sangwoon Kwak, WEEYOUN KWON, Jun Young Jeong, Geonho Kim, Won-Sik Cheong, Jihyong Oh
...
## 372. Multi-view Pyramid Transformer: Look Coarser to See Broader

> 🇯🇵 **Multi-view Pyramid Transformer: より広く見るため粗く見る**

> 💡 局所グローバル階層で数十〜数百画像から大規模シーン単一パス再構成

**著者:** Gyeongjin Kang, Seung kwon Yang, Seungtae Nam, Younggeun Lee, Jungwoo Kim, Eunbyung Park

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2512.07806)

**Session:** Poster Session 6


![Poster](posters/3d/39334.png)
...
## 373. CaT-GS: Efficient 3DGS Rendering for Large Scale Scenes via Inter-frame Caching and Tile Scheduling

> 🇯🇵 **CaT-GS: フレーム間キャッシュとタイル最適化による効率的大規模レンダリング**

> 💡 フレーム間キャッシュとタイル負荷均衡で大規模シーン10倍高速化

**著者:** TingJia Zhang, Bo Chen, Shengzhong Liu, Fan Wu, Guihai Chen
...
## 374. VDE: Training-Free Accelerating Rectified Flow Model via Velocity Decomposition and Estimation

> 🇯🇵 **VDE：速度分解と推定による訓練不要なRectified Flowモデル高速化**

> 💡 速度の平行・直交成分を解析的に推定し高品質を保って推論を高速化

**著者:** Junwen Tan, Jinglin Liang, Hongyuan Chen, Shuangping Huang
...
## 378. Mark4D: Temporally-Consistent Watermarking for 4D Gaussian Splatting

> 🇯🇵 **Mark4D：4D Gaussian Splattingのための時間整合型ウォーターマーキング**

> 💡 運動経路に沿う埋め込みで4DGSに不可視かつ頑健な透かしを時間一貫で付与

**著者:** Jaejin Lee, Minjae Jeong, Joonhyuk Park, Yechan Hwang, Seunghun Baek, Won Hwa Kim
...
## 379. Motion-Aware Animatable Gaussian Avatars Deblurring
...
## 380. ELITE: Efficient Gaussian Head Avatar from a Monocular Video via Learned Initialization and Test-time Generative Adaptation
...
## 381. AniMimic: Imitating 3D Animation from Video Priors
...
## 382. VerseCrafter: Dynamic Realistic Video World Model with 4D Geometric Control
...
## 383. ScenDi: 3D-to-2D Scene Diffusion Cascades for Urban Generation

> 🇯🇵 **ScenDi：都市生成のための3Dから2Dへのシーン拡散カスケード**

> 💡 3D拡散で粗い都市構造を作り2D動画拡散で外観詳細と視点制御を両立

**著者:** Hanlei Guo, Jiahao Shao, Xinya Chen, Xiyang Tan, Sheng Miao, Yujun Shen, Yiyi Liao

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2601.15221)

**Session:** Poster Session 6


![Poster](posters/3d/38304.png)
...
## 384. GeodesicNVS: Probability Density Geodesic Flow Matching for Novel View Synthesis
...
## 385. RenderFlow: Single-Step Neural Rendering via Flow Matching
...
## 386. SunFaded: Illumination-Aware Gaussian Splatting for Dark Scenes with Camera-Mounted Active Lighting

> 🇯🇵 **SunFaded：カメラ搭載能動照明付き暗所向け照明認識ガウシアンスプラッティング**

> 💡 移動光源の影響を分離して暗所シーンの外観一貫性と幾何精度を改善する

**著者:** Wenjie Chang, Tianle Ding, Wenfei Yang, Tianzhu Zhang
...
## 387. TokenSplat: Token-aligned 3D Gaussian Splatting for Feed-forward Pose-free Reconstruction

> 🇯🇵 **TokenSplat：順伝播型ポーズ不要再構成のためのトークン整合3D Gaussian Splatting**

> 💡 特徴空間で対応トークンを整合し反復なしで姿勢推定と3D再構成を両立

**著者:** Yihui Li, Chengxin Lv, Zichen Tang, Hongyu Yang, Di Huang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.00697)

**Session:** Poster Session 6


![Poster](posters/3d/36739.png)
...
## 388. AeroGS: Scale-Aware Gaussian Splatting for Pose-Free Dynamic UAV Scene Reconstruction

> 🇯🇵 **AeroGS：ポーズ不要な動的UAVシーン再構成のためのスケール認識ガウシアンスプラッティング**

> 💡 スケール認識時空間アンカーで空撮動画から軌跡復元と動的再構成を同時に行う

**著者:** Tingyun Li, Xinyi Liu, Yongjun Zhang, Yi Wan, Xiaoan Liu, Weiwei Fan, Jiahao Liu
...
## 391. Hierarchical Visual Relocalization with Nearest View Synthesis from Feature Gaussian Splatting

> 🇯🇵 **特徴Gaussian Splattingの最近傍視点合成による階層的ビジュアル再局在化**

> 💡 粗密で異なる特徴を使い分けるハイブリッド照合で再局在化精度を高める

**著者:** Huaqi Tao, Bingxi Liu, Guangcheng Chen, Fulin Tang, Li He, Hong Zhang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.29185)

**Session:** Poster Session 6


![Poster](posters/3d/39318.png)
...
## 392. Tracking-Guided 4D Generation: Foundation-Tracker Motion Priors for 3D Model Animation
...
## 393. 3D Gaussian Splatting from Unposed Spike Stream

> 🇯🇵 **未姿勢スパイクストリームからの3D Gaussian Splatting**

> 💡 スパイクカメラの未姿勢観測から高速度シーンの姿勢推定と3D再構成を実現

**著者:** Yijia Guo, Tong Hu, Liwen Hu, Lei Ma, Tiejun Huang
...
## 395. ClipGStream: Clip-Stream Gaussian Splatting for Any Length and Any Motion Multi-View Dynamic Scene Reconstruction

> 🇯🇵 **ClipGStream：任意長・任意運動の多視点動的シーン再構成のためのクリップストリームGaussian Splatting**

> 💡 クリップ単位最適化で長尺多視点動画像の高品質かつ低メモリ再構成を実現

**著者:** Jie Liang, Jiahao Wu, Chao Wang, Jiayu Yang, Xiaoyun Zheng, Kaiqiang Xiong, Zhanke Wang, Jinbo Yan, Feng Gao, Ronggang Wang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.13746)

**Session:** Poster Session 6


![Poster](posters/3d/37570.png)
...
## 396. MoRGS: Efficient Per-Gaussian Motion Reasoning for Streamable Dynamic 3D Scenes

> 🇯🇵 **MoRGS：ストリーム可能な動的3Dシーンのための効率的なGaussian単位運動推論**

> 💡 光フローと運動信頼度で各ガウシアンの真の動きを捉え時系列整合性を向上

**著者:** Wonjoon Lee, Sungmin Woo, Donghyeong Kim, Jungho Lee, Sangheon Park, Sangyoun Lee

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.25042)

**Session:** Poster Session 6


![Poster](posters/3d/36695.png)
...
## 397. GH-NAF: Grid-Adaptive Hash-Level–Attended Neural Attenuation Fields for Discrepancy-Aware CBCT

> 🇯🇵 **GH-NAF：不一致考慮CBCTのためのグリッド適応ハッシュ層注意ニューラル減衰場**

> 💡 不確実性で各ハッシュ層を独立学習しCBCT再構成のアーチファクトを低減

**著者:** Seong Je Oh, Ju Hwan Lee, Chae Yeon Lim, Donghwan Lee, Myung Jin Ching, Kyungsu Kim

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://limchaeyeon1003.github.io/GH_NAF_CVPR/)

**Session:** Poster Session 6


![Poster](posters/3d/40015.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://limchaeyeon1003.github.io/GH_NAF_CVPR/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 398. NG-GS: NeRF-guided 3D Gaussian Splatting Segmentation

> 🇯🇵 **NG-GS：NeRF誘導3D Gaussian Splattingセグメンテーション**

> 💡 NeRF整合と連続特徴場で3DGS物体境界のギザつきを抑え高精度分割を実現

**著者:** Yi He, Tao Wang, Yi Jin, Congyan Lang, Yidong Li, Haibin Ling

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2604.14706)

**Session:** Poster Session 6


![Poster](posters/3d/37364.png)
...
## 399. FISHuman: Fine-grained Single-image 3D Human Reconstruction via Multi-view 4D Remeshing

> 🇯🇵 **FISHuman：多視点4Dリメッシュによる高精細単一画像3D人体再構成**

> 💡 生成多視点の不整合を4Dリメッシュで統合し高精細で編集可能な人体を復元

**著者:** Hanxi Liu, Yifang Men, Zhouhui Lian
...
## 401. Semantics Lead the Way: Harmonizing Semantic and Texture Modeling with Asynchronous Latent Diffusion
...
## 402. Rewis3d: Reconstruction Improves Weakly-Supervised Semantic Segmentation

> 🇯🇵 **Rewis3d: 再構成が弱教師セマンティックセグメンテーションを改善**

> 💡 3D再構成を補助信号として、疎な注釈から2D画像のセグメンテーション改善

**著者:** Jonas Ernst, Wolfgang Boettcher, Lukas Hoyer, Jan Lenssen, Bernt Schiele

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2603.06374)

**Session:** Poster Session 2 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/38160.png)
...
## 403. TokenLight: Precise Lighting Control in Images using Attribute Tokens

> 🇯🇵 **TokenLight: 属性トークンを使用した画像の正確な照明制御**

> 💡 属性トークンで強度・色・光位置を符号化し、画像の正確な照明制御を実現

**著者:** Sumit Chaturvedi, Yannick Hold-Geoffroy, Mengwei Ren, Jingyuan Liu, He Zhang, Yiqun Mei, Julie Dorsey, ZHIXIN SHU

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://vrroom.github.io/tokenlight/)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/39839.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://vrroom.github.io/tokenlight/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 404. Relightable Holoported Characters: Capturing and Relighting Dynamic Human Performance from Sparse Views

> 🇯🇵 **Relightable Holoported Characters: 疎視点から動的人間の光照射再現**

> 💡 トランスフォーマーベース相互注意で動的人間の自由視点再照射を単一パス実行
...
## 405. Evidential Neural Radiance Fields

> 🇯🇵 **証拠理論に基づくニューラル放射輝度場**

> 💡 単一推論でNeRFの偶然的不確実性と認識的不確実性を高精度に推定。
...
## 406. InfiniBench: Infinite Benchmarking for Visual Spatial Reasoning with Customizable Scene Complexity

> 🇯🇵 **InfiniBench: 空間推論の無限カスタマイズ可能ベンチマーク**

> 💡 パラメータ化複雑度で3Dシーン自動生成し、VLM空間推論を評価
...
## 407. WRIVINDER: Towards Spatial Intelligence for Geo-locating Ground Images onto Satellite Imagery

> 🇯🇵 **WRIVINDER: 地面画像を衛星画像に地理参照する空間知能**

> 💡 3Dシーン再構成と意味グラウンディングで、衛星画像へのゼロショット位置決定

**著者:** Chandrakanth Gudavalli, Tajuddin Manhar Mohammed, Abhay Yadav, Ananth Vishnu Bhaskar, Hardik Prajapati, Cheng Peng, Rama Chellappa, Shivkumar Chandrasekaran, B.S. Manjunath

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2602.14929)

**Session:** Poster Session 5 & Exhibit Hall


![Poster](posters/3d/39144.png)
...
## 408. SASNet: Spatially-Adaptive Sinusoidal Networks for INRs

> 🇯🇵 **SASNet: 暗黙的神経表現のための空間適応正弦波ネットワーク**

> 💡 凍結周波数埋め込みと学習空間マスクで、安定した高周波再構成を実現

**著者:** Haoan Feng, Diana Aldana, Tiago Novello, Leila De Floriani

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2503.09750)

**Session:** Poster Session 6


![Poster](posters/3d/38366.png)
...
## 409. Circular-DPO: Aligning Multi-Stage 3D Generative Models via Preference Feedback Loop

> 🇯🇵 **Circular-DPO: 嗜好フィードバックループで多段3D生成を整列**

> 💡 直接嗜好最適化で最終出力から初期段階への嗜好信号フィードバック

**著者:** Zejian Li, Jiarui Ma, Han Xu, Weiting Zheng, Yangrui Zhu, Chenye Meng, Pei Chen, Ling Yang, Zhiyuan Yang, Changyuan Yang, Guang Yang, Immanuel Koh, Lingyun Sun
...
## 410. LumiMotion: Improving Gaussian Relighting with Scene Dynamics

> 🇯🇵 **LumiMotion: シーン動力学でガウシアン照射を改善**

> 💡 シーン動的領域の動きをシグナルとして逆レンダリングで照明分離を改善

**著者:** Joanna Kaleta, Piotr Wójcik, Kacper Marzol, Tomasz Trzciński, Kacper Kania, Marek Kowalski

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [🌐 Project](https://joaxkal.github.io/LumiMotion/)

**Session:** Poster Session 6


![Poster](posters/3d/39896.png)


<details>
<summary>🌐 Project Page プレビュー</summary>

<iframe src="https://joaxkal.github.io/LumiMotion/" width="100%" height="600" loading="lazy" style="border:none;"></iframe>
...
## 411. Any2Any 3D Diffusion Models with Knowledge Transfer: A Radiotherapy Planning Study
...
## 412. More Natural, More Real: Object-aware Gaussian Splatting for 3D Visual Decoding from Human Brain

> 🇯🇵 **More Natural, More Real: 脳からの3D視覚復号用オブジェクト認識ガウシアン**

> 💡 融合時空間ネットワークで脳活動から多視点安定な3Dオブジェクト再構成

**著者:** Haodong Jing, Dongyao Jiang, Jixin Wang, Junhao Jia, Yanshu Li, Yongqiang Ma, Nanning Zheng
...
## 413. LuxRemix: Lighting Decomposition and Remixing for Indoor Scenes

> 🇯🇵 **LuxRemix：屋内シーンの照明分解と再編集**

> 💡 単一の多視点撮影から屋内照明を分解し、光源ごとの再照明をリアルタイム操作。
...
## 414. Velox: Learning Representations of 4D Geometry and Appearance

> 🇯🇵 **Velox：4次元形状と外観の表現学習**

> 💡 動的点群を4D形状トークンに圧縮し、生成・追跡・布シミュレーションに活用。

**著者:** Anagh Malik, Dorian Chan, Xiaoming Zhao, David B. Lindell, Oncel Tuzel, Rick Chang

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2605.04527)

**Session:** Poster Session 3 & Exhibit Hall


![Poster](posters/3d/37365.png)
...
## 415. Wave-Former: Through-Occlusion 3D Reconstruction via Wireless Shape Completion

> 🇯🇵 **Wave-Former：無線形状補完による遮蔽越しの3次元再構成**

> 💡 ミリ波信号と物理考慮型補完により、完全遮蔽物体の3D形状を高精度復元。

**著者:** Laura Dodds, Maisy Lam, Waleed Akbar, Yibo Cheng, Fadel Adib

**Links:** [📄 Paper](https://openreview.net/group?id=thecvf.com/CVPR/2026/Conference) | [📋 arXiv](https://arxiv.org/abs/2511.14152)

**Session:** Poster Session 4 & Exhibit Hall w/ Coffee Break


![Poster](posters/3d/36247.png)
...
## 416. MV-Fashion: Towards Enabling Virtual Try-On and Size Estimation with Multi-View Paired Data

> 🇯🇵 **MV-Fashion：多視点ペアデータによる仮想試着とサイズ推定の実現へ**

> 💡 仮想試着とサイズ推定向けに、多視点動画と商品画像を備えた大規模データセット。

**著者:** Hunor Laczko, Libang Jia, Loc-Phat Truong, Diego Hernández, Sergio Escalera, Jordi Gonzàlez, Meysam Madadi
...
## 417. HumanNOVA: Photorealistic, Universal and Rapid 3D Human Avatar Modeling from a Single Image
